<!-- GENERATED VIEW. Canonical record: jira/records/issues/subtasks/POST-SUBTASK-073_train_naive_historical_average_home_field_rating_regularized_linear_tree_boostin.json -->
# POST-SUBTASK-073 — [POST-SUBTASK-073] Train naive, historical-average, home-field, rating, regularized linear, tree-boosting, market-free, and market-aware baselines with bounded searches
...
```json
{
  ...
  "ai_context_notes": [
    ...
    "Read the exact source sections in `jira/sources/issue_source_manifests/POST-SUBTASK-073.json`; inspect only the listed implementation files and prerequisite outputs.",
  ...
  "blocked_reason": "UNSATISFIED_HARD_DEPENDENCIES: POST-SUBTASK-072",
  "blocks": [
    "POST-SUBTASK-074",
    "POST-SUBTASK-075"
  ],
  "canonical_record": "jira/records/issues/subtasks/POST-SUBTASK-073_train_naive_historical_average_home_field_rating_regularized_linear_tree_boostin.json",
  "canonical_source_role": "AUTHORITATIVE_LOCAL_SPECIFICATION",
  "completion_evidence_contract": {
    "acceptance_matrix_required": true,
    "artifact_hashes_required": true,
    "completion_claim_limit": "IMPLEMENTED",
    "downstream_consumer": "POST-SUBTASK-074",
  ...
  "gap_ids": [],
  "generated_markdown": "jira/issues/subtasks/POST-SUBTASK-073_train_naive_historical_average_home_field_rating_regularized_linear_tree_boostin.md",
  ...
  "operational_jira": {
    "assignee": "",
    "jira_issue_id": "24563",
    "jira_updated_at": "2026-08-09T00:03:47.375-0500",
  ...
  "required_tests": [
    {
      ...
      "expectation": "Run as a regression check after completing POST-SUBTASK-073; retain command, exit code, and relevant output.",
    ...
    },
    {
      ...
      "path": "artifacts/modeling/baseline_candidate_runs.json",
  ...
  "risk_failure_conditions": [
    "The work would be invalid if any prerequisite artifact, source/data/code/config identity, or declared maturity differs from the pinned issue contract for POST-SUBTASK-073.",
    ...
    "Acceptance failure: the evidence cannot demonstrate that the declared output `artifacts/modeling/baseline_candidate_runs.json` is produced with deterministic identity, provenance, and validation metadata appropriate to this work.",
  ...
  "title": "[POST-SUBTASK-073] Train naive, historical-average, home-field, rating, regularized linear, tree-boosting, market-free, and market-aware baselines with bounded searches",
  ...
  "work_packet_path": "jira/ai/work_packets/POST-SUBTASK-073.md",
