...
1. `jira/records/issues/stories/POST-STORY-001_canonical_handoff_and_target_environment_preflight.json`
2. `jira/sources/issue_source_manifests/POST-STORY-001.json`
3. `jira/index/ISSUE_GOVERNANCE_CONTEXT.csv` row for `POST-STORY-001`.
