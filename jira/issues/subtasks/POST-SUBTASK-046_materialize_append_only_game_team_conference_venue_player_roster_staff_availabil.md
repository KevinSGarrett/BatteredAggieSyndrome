...
```json
{
  ...
  "blocked_reason": "UNSATISFIED_HARD_DEPENDENCIES: POST-SUBTASK-045",
  "blocks": [
    "POST-SUBTASK-047",
    "POST-SUBTASK-048"
  ],
  ...
  "critical_path": true,
  "definition_of_done": [
    "The atomic scope in POST-SUBTASK-046 is completed without absorbing sibling work or weakening any protected requirement, control, split, judging rule, rights decision, or security boundary.",
  ...
  "end_to_end_validation": "Validate that `artifacts/pit/asof_state_manifest.json` can be parsed and consumed by `POST-SUBTASK-047` using only documented identities and interfaces; the consumer must reject missing, stale, schema-incompatible, rights-blocked, or provenance-incomplete input without manual repair.",
  ...
  "operational_jira": {
    "assignee": "",
    "jira_issue_id": "24536",
    "jira_updated_at": "2026-08-09T00:03:36.005-0500",
  ...
  "specificity_fingerprint": "585d0fe5479bf7ff1abf1b3014f6f426bad0f87246fb30ec8ec45b5f32cbf255",
  "stop_conditions": [
...
1. The atomic scope in POST-SUBTASK-046 is completed without absorbing sibling work or weakening any protected requirement, control, split, judging rule, rights decision, or security boundary.
