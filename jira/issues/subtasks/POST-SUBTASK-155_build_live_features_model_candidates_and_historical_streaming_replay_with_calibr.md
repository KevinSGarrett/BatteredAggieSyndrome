...
```json
{
  ...
  "critical_path": false,
  "definition_of_done": [
    "The atomic scope in POST-SUBTASK-155 is completed without absorbing sibling work or weakening any protected requirement, control, split, judging rule, rights decision, or security boundary.",
  ...
  "end_to_end_validation": "Validate that `artifacts/live/live_model_prototype.json` can be parsed and consumed by `POST-SUBTASK-156` using only documented identities and interfaces; the consumer must reject missing, stale, schema-incompatible, rights-blocked, or provenance-incomplete input without manual repair.",
  ...
  "operational_jira": {
    "assignee": "",
    "jira_issue_id": "24645",
    "jira_updated_at": "2026-08-09T00:04:14.138-0500",
  ...
  "specificity_fingerprint": "3186010762d9032d9729f9bfcc2d2f080b52d18d7e4919d6f02fa01eaf13280c",
  "stop_conditions": [
...
1. The atomic scope in POST-SUBTASK-155 is completed without absorbing sibling work or weakening any protected requirement, control, split, judging rule, rights decision, or security boundary.
...
Validate that `artifacts/live/live_model_prototype.json` can be parsed and consumed by `POST-SUBTASK-156` using only documented identities and interfaces; the consumer must reject missing, stale, schema-incompatible, rights-blocked, or provenance-incomplete input without manual repair.
