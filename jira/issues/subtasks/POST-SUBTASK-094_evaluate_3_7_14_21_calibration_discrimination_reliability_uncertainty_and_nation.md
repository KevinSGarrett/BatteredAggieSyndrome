<!-- GENERATED VIEW. Canonical record: jira/records/issues/subtasks/POST-SUBTASK-094_evaluate_3_7_14_21_calibration_discrimination_reliability_uncertainty_and_nation.json -->
# POST-SUBTASK-094 — [POST-SUBTASK-094] Evaluate ≥3/7/14/21 calibration, discrimination, reliability, uncertainty, and national/A&M/peer/regime scorecards on sealed predictions
...
```json
{
  ...
  "acceptance_criteria": [
    ...
    "The declared output `artifacts/bas/bas_protected_scorecard.json` is produced with deterministic identity, provenance, and validation metadata appropriate to this work.",
  ...
  "ai_context_notes": [
    ...
    "Read the exact source sections in `jira/sources/issue_source_manifests/POST-SUBTASK-094.json`; inspect only the listed implementation files and prerequisite outputs.",
  ...
  "blocked_reason": "UNSATISFIED_HARD_DEPENDENCIES: POST-SUBTASK-093;POST-SUBTASK-102",
  "blocks": [
    "POST-SUBTASK-095",
    "POST-SUBTASK-096"
  ],
  "canonical_record": "jira/records/issues/subtasks/POST-SUBTASK-094_evaluate_3_7_14_21_calibration_discrimination_reliability_uncertainty_and_nation.json",
  "canonical_source_role": "AUTHORITATIVE_LOCAL_SPECIFICATION",
  "completion_evidence_contract": {
    "acceptance_matrix_required": true,
    "artifact_hashes_required": true,
    "completion_claim_limit": "IMPLEMENTED",
    "downstream_consumer": "POST-SUBTASK-095",
  ...
  "critical_path": false,
  "definition_of_done": [
    "The atomic scope in POST-SUBTASK-094 is completed without absorbing sibling work or weakening any protected requirement, control, split, judging rule, private-research publication boundary, or security boundary.",
    ...
    "The output set `artifacts/bas/bas_protected_scorecard.json` is demonstrably consumable by POST-SUBTASK-095 without manual reconstruction or undocumented state."
  ],
  "dependencies": [
    "POST-SUBTASK-093",
    "POST-SUBTASK-102"
  ...
  "gap_ids": [],
  "generated_markdown": "jira/issues/subtasks/POST-SUBTASK-094_evaluate_3_7_14_21_calibration_discrimination_reliability_uncertainty_and_nation.md",
  ...
  "local_id": "POST-SUBTASK-094",
  "maturity_before": "FUNCTIONAL_STARTER",
  "objective": "Evaluate ≥3/7/14/21 calibration, discrimination, reliability, uncertainty, and national/A&M/peer/regime scorecards on sealed predictions",
  "operational_jira": {
    "assignee": "",
    "jira_issue_id": "24584",
    "jira_updated_at": "2026-08-09T00:03:58.007-0500",
  ...
  "required_tests": [
    {
      ...
      "expectation": "Run as a regression check after completing POST-SUBTASK-094; retain command, exit code, and relevant output.",
    ...
    },
    {
      ...
      "path": "artifacts/bas/bas_protected_scorecard.json",
  ...
  "risk_failure_conditions": [
    "The work would be invalid if any prerequisite artifact, source/data/code/config identity, or declared maturity differs from the pinned issue contract for POST-SUBTASK-094.",
    ...
    "Acceptance failure: the evidence cannot demonstrate that the declared output `artifacts/bas/bas_protected_scorecard.json` is produced with deterministic identity, provenance, and validation metadata appropriate to this work.",
  ...
  "risk_ids": [],
  "schema_version": 2,
  "scope": "Execute the atomic 1 of 3 step in Story POST-STORY-032 (Protected calibration, stability, scientific decision, and product semantics): Evaluate ≥3/7/14/21 calibration, discrimination, reliability, uncertainty, and national/A&M/peer/regime scorecards on sealed predictions. Consume only verified prerequisite outputs from `POST-SUBTASK-093`, `POST-SUBTASK-102`. Produce `artifacts/bas/bas_protected_scorecard.json`; evaluate every issue-specific acceptance condition; preserve negative results; and hand the pinned output to POST-SUBTASK-095.",
  "source_ids": [
    "GAP-009",
    "HANDOFF-009"
  ],
  ...
  "specificity_fingerprint": "b5795a60d59836ae945f14f60e2e0919b75c65ebd8af8ce3160a5d816a13e7af",
  "stop_conditions": [
  ...
  "title": "[POST-SUBTASK-094] Evaluate ≥3/7/14/21 calibration, discrimination, reliability, uncertainty, and national/A&M/peer/regime scorecards on sealed predictions",
  ...
  "work_packet_path": "jira/ai/work_packets/POST-SUBTASK-094.md",
...
1. The atomic scope in POST-SUBTASK-094 is completed without absorbing sibling work or weakening any protected requirement, control, split, judging rule, private-research publication boundary, or security boundary.
...
7. The output set `artifacts/bas/bas_protected_scorecard.json` is demonstrably consumable by POST-SUBTASK-095 without manual reconstruction or undocumented state.
...
Validate that `artifacts/bas/bas_protected_scorecard.json` can be parsed and consumed by `POST-SUBTASK-095` using only documented identities and interfaces; the consumer must reject missing, stale, schema-incompatible, technically or quality-ineligible, or provenance-incomplete input without manual repair.
