...
def main() -> int:
    parser = argparse.ArgumentParser(description="Validate immutable 1997-expanded union successor.")
    ...
    mutations = [
        ...
        expect_rejection(
            ...
            lambda: _validate(_mutated_gate(gate, counts={**gate["counts"], "official_1997_rejected": 0})),
        ),
    ]
