<!-- GENERATED VIEW. Canonical record: jira/records/issues/tasks/TASK-165_implement_small_pytorch_tabular_challenger_only_if_admitted.json -->
# TASK-165 — [TASK-165] Implement small PyTorch tabular challenger only if admitted
...
```json
{
  ...
  "acceptance_criteria": [
    "Stable ID TASK-165, parent EPIC-029, owner wave W18+, and original status PLANNED are preserved.",
  ...
  "allowed_modification_paths": [
    "optional tabular neural challenger"
  ],
  "blocked_reason": "",
  "blocks": [
    "TASK-168"
  ],
  "canonical_record": "jira/records/issues/tasks/TASK-165_implement_small_pytorch_tabular_challenger_only_if_admitted.json",
  ...
  "gap_ids": [],
  "generated_markdown": "jira/issues/tasks/TASK-165_implement_small_pytorch_tabular_challenger_only_if_admitted.md",
  ...
  "operational_jira": {
    "assignee": "",
    "jira_issue_id": "24412",
    "jira_updated_at": "2026-08-09T00:05:14.297-0500",
  ...
  "required_evidence": [
    "Authoritative WBS row TASK-165",
    "Existing artifact `optional tabular neural challenger`"
  ],
  "required_tests": [
    {
  ...
  "specificity_fingerprint": "58f70d684cb4bed4ae1e69800eb6d8462b4b846fb99ae9f2286c5e6f35c4f7f2",
  "stop_conditions": [
  ...
  "title": "[TASK-165] Implement small PyTorch tabular challenger only if admitted",
...
Implement small PyTorch tabular challenger only if admitted
...
1. Stable ID TASK-165, parent EPIC-029, owner wave W18+, and original status PLANNED are preserved.
