<!-- GENERATED VIEW. Canonical record: jira/records/issues/tasks/TASK-183_produce_final_implementation_priority_and_first_72_hour_queue.json -->
# TASK-183 — [TASK-183] Produce final implementation priority and first-72-hour queue
...
```json
{
  ...
  "acceptance_criteria": [
    "Stable ID TASK-183, parent EPIC-032, owner wave W25, and original status DONE are preserved.",
  ...
  "canonical_record": "jira/records/issues/tasks/TASK-183_produce_final_implementation_priority_and_first_72_hour_queue.json",
  ...
  "gap_ids": [],
  "generated_markdown": "jira/issues/tasks/TASK-183_produce_final_implementation_priority_and_first_72_hour_queue.md",
  ...
  "operational_jira": {
    "assignee": "",
    "jira_issue_id": "24448",
    "jira_updated_at": "2026-08-09T00:40:49.008-0500",
  ...
  "phase": "PHASE-5",
  "prerequisites": [
    "Historical dependency TASK-181",
    "Historical dependency TASK-182"
  ],
  "primary_source_refs": [
    "SRCREF-00216",
    "SRCREF-02116",
  ...
  "required_evidence": [
    "Authoritative WBS row TASK-183",
    "Existing artifact `docs/final/FINAL_IMPLEMENTATION_PRIORITY.md`",
    "Existing artifact `first-72-hour queue`"
  ],
  "required_tests": [
    {
  ...
  "risk_ids": [],
  "schema_version": 2,
  "scope": "Original task type HANDOFF with mutation scope: as defined by its source documents.",
  "source_ids": [
    "TASK-183"
  ],
  "source_refs": [
  ...
  "specificity_fingerprint": "db840e890b6e755795295befed1ee9a549f08427f37945a55fb3b2ebef79d778",
  "stop_conditions": [
  ...
  "title": "[TASK-183] Produce final implementation priority and first-72-hour queue",
...
Produce final implementation priority and first-72-hour queue
...
Original task type HANDOFF with mutation scope: as defined by its source documents.
...
1. Stable ID TASK-183, parent EPIC-032, owner wave W25, and original status DONE are preserved.
