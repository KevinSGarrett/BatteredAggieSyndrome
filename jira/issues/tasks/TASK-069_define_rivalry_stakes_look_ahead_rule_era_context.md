<!-- GENERATED VIEW. Canonical record: jira/records/issues/tasks/TASK-069_define_rivalry_stakes_look_ahead_rule_era_context.json -->
# TASK-069 — [TASK-069] Define rivalry/stakes/look-ahead/rule-era context
...
```json
{
  ...
  "acceptance_criteria": [
    "Stable ID TASK-069, parent EPIC-012, owner wave W13, and original status DONE are preserved.",
  ...
  "canonical_record": "jira/records/issues/tasks/TASK-069_define_rivalry_stakes_look_ahead_rule_era_context.json",
  ...
  "gap_ids": [],
  "generated_markdown": "jira/issues/tasks/TASK-069_define_rivalry_stakes_look_ahead_rule_era_context.md",
  ...
  "objective": "Define rivalry/stakes/look-ahead/rule-era context",
  "operational_jira": {
    "assignee": "",
    "jira_issue_id": "24312",
    "jira_updated_at": "2026-08-09T00:40:28.867-0500",
  ...
  "required_evidence": [
    "Authoritative WBS row TASK-069",
    "Existing artifact `game-context effective-dated feature contracts`"
  ],
  "required_tests": [
    {
  ...
  "specificity_fingerprint": "9695d6e14bc116711cfe4253cd5223524c6b8537e3a91a20b622b1c34a3aa082",
  "stop_conditions": [
  ...
  "title": "[TASK-069] Define rivalry/stakes/look-ahead/rule-era context",
...
Define rivalry/stakes/look-ahead/rule-era context
...
1. Stable ID TASK-069, parent EPIC-012, owner wave W13, and original status DONE are preserved.
