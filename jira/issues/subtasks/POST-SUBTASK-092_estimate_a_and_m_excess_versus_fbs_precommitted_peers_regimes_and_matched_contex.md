...
```json
{
  ...
  "critical_path": false,
  "definition_of_done": [
    "The atomic scope in POST-SUBTASK-092 is completed without absorbing sibling work or weakening any protected requirement, control, split, judging rule, rights decision, or security boundary.",
  ...
  "end_to_end_validation": "Validate that `artifacts/bas/aggie_excess_components.json` can be parsed and consumed by `POST-SUBTASK-093` using only documented identities and interfaces; the consumer must reject missing, stale, schema-incompatible, rights-blocked, or provenance-incomplete input without manual repair.",
  ...
  "operational_jira": {
    "assignee": "",
    "jira_issue_id": "24582",
    "jira_updated_at": "2026-08-09T00:03:54.907-0500",
  ...
  "specificity_fingerprint": "68d579e4a59450db34e4ca60232c3c93dd8d1823c0dcbd58e1ebc8b4f44daea2",
  "stop_conditions": [
...
1. The atomic scope in POST-SUBTASK-092 is completed without absorbing sibling work or weakening any protected requirement, control, split, judging rule, rights decision, or security boundary.
