...
class Official1996BoxscoreTests(unittest.TestCase):
    @classmethod
    ...
    def test_gate_reconstructs(self) -> None:
        ...
        self.assertEqual(int(self.gate["counts"]["target_games_total"]), 11)
        self.assertEqual(int(self.gate["counts"]["normalized_games"]), 11)
