# AI Work Packet — POST-SUBTASK-129
...
1. `jira/records/issues/subtasks/POST-SUBTASK-129_run_outage_schema_stale_forecast_disk_corrupt_artifact_model_security_and_govern.json`
2. `jira/sources/issue_source_manifests/POST-SUBTASK-129.json`
3. `jira/index/ISSUE_GOVERNANCE_CONTEXT.csv` row for `POST-SUBTASK-129`.
