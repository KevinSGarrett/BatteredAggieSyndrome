...
1. `jira/records/issues/stories/POST-STORY-039_read_only_forecast_repository_and_versioned_api.json`
2. `jira/sources/issue_source_manifests/POST-STORY-039.json`
3. `jira/index/ISSUE_GOVERNANCE_CONTEXT.csv` row for `POST-STORY-039`.
