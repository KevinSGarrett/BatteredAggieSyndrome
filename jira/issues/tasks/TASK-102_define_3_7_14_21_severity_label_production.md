<!-- GENERATED VIEW. Canonical record: jira/records/issues/tasks/TASK-102_define_3_7_14_21_severity_label_production.json -->
# TASK-102 — [TASK-102] Define ≥3/7/14/21 severity label production
...
```json
{
  ...
  "acceptance_criteria": [
    "Stable ID TASK-102, parent EPIC-018, owner wave W15, and original status DONE are preserved.",
  ...
  "canonical_record": "jira/records/issues/tasks/TASK-102_define_3_7_14_21_severity_label_production.json",
  ...
  "gap_ids": [],
  "generated_markdown": "jira/issues/tasks/TASK-102_define_3_7_14_21_severity_label_production.md",
  ...
  "objective": "Define ≥3/7/14/21 severity label production",
  "operational_jira": {
    "assignee": "",
    "jira_issue_id": "24345",
    "jira_updated_at": "2026-08-09T00:40:35.488-0500",
  ...
  "required_evidence": [
    "Authoritative WBS row TASK-102",
    "Existing artifact `BAS severity label interface`"
  ],
  "required_tests": [
    {
  ...
  "specificity_fingerprint": "a04bb599a4f8ae77a79f0eea8508a20b13d715a19e6a3b0a619c896d620ee0e7",
  "stop_conditions": [
  ...
  "title": "[TASK-102] Define ≥3/7/14/21 severity label production",
...
Define ≥3/7/14/21 severity label production
...
1. Stable ID TASK-102, parent EPIC-018, owner wave W15, and original status DONE are preserved.
