...
```json
{
  ...
  "critical_path": false,
  "definition_of_done": [
    "The atomic scope in POST-SUBTASK-082 is completed without absorbing sibling work or weakening any protected requirement, control, split, judging rule, private-research publication boundary, or security boundary.",
  ...
  "end_to_end_validation": "Validate that `artifacts/tamu/peer_regime_analog_registry.json` can be parsed and consumed by `POST-SUBTASK-083` using only documented identities and interfaces; the consumer must reject missing, stale, schema-incompatible, technically or quality-ineligible, or provenance-incomplete input without manual repair.",
  ...
  "operational_jira": {
    "assignee": "",
    "jira_issue_id": "24572",
    "jira_updated_at": "2026-08-09T23:24:07.826-0500",
  ...
  "specificity_fingerprint": "283ee92fe6f4b745d516a5ab546bc8a1026372e55d5f35fb605c96b7df7bc0cd",
  "stop_conditions": [
...
1. The atomic scope in POST-SUBTASK-082 is completed without absorbing sibling work or weakening any protected requirement, control, split, judging rule, private-research publication boundary, or security boundary.
...
Validate that `artifacts/tamu/peer_regime_analog_registry.json` can be parsed and consumed by `POST-SUBTASK-083` using only documented identities and interfaces; the consumer must reject missing, stale, schema-incompatible, technically or quality-ineligible, or provenance-incomplete input without manual repair.
