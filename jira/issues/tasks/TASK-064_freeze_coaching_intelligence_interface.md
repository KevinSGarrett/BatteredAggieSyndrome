<!-- GENERATED VIEW. Canonical record: jira/records/issues/tasks/TASK-064_freeze_coaching_intelligence_interface.json -->
# TASK-064 — [TASK-064] Freeze coaching intelligence interface
...
```json
{
  ...
  "acceptance_criteria": [
    "Stable ID TASK-064, parent EPIC-011, owner wave W13, and original status DONE are preserved.",
  ...
  "canonical_record": "jira/records/issues/tasks/TASK-064_freeze_coaching_intelligence_interface.json",
  ...
  "gap_ids": [],
  "generated_markdown": "jira/issues/tasks/TASK-064_freeze_coaching_intelligence_interface.md",
  ...
  "objective": "Freeze coaching intelligence interface",
  "operational_jira": {
    "assignee": "",
    "jira_issue_id": "24307",
    "jira_updated_at": "2026-08-09T00:40:27.775-0500",
  ...
  "phase": "PHASE-2",
  "prerequisites": [
    "Historical dependency TASK-063"
  ],
  "primary_source_refs": [
    "SRCREF-00097",
    "SRCREF-02116",
  ...
  "required_evidence": [
    "Authoritative WBS row TASK-064",
    "Existing artifact `coaching interface baseline`"
  ],
  "required_tests": [
    {
  ...
  "specificity_fingerprint": "1bd9f8daba43adb10dc7d947991e5cdcd2d51ed49f87aba4d506570ebf9e5a3e",
  "stop_conditions": [
  ...
  "title": "[TASK-064] Freeze coaching intelligence interface",
...
Freeze coaching intelligence interface
...
1. Stable ID TASK-064, parent EPIC-011, owner wave W13, and original status DONE are preserved.
