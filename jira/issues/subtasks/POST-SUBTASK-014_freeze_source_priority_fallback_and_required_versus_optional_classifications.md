<!-- GENERATED VIEW. Canonical record: jira/records/issues/subtasks/POST-SUBTASK-014_freeze_source_priority_fallback_and_required_versus_optional_classifications.json -->
# POST-SUBTASK-014 — [POST-SUBTASK-014] Freeze source priority, fallback, and required-versus-optional classifications
...
```json
{
  ...
  "ai_context_notes": [
    ...
    "Read the exact source sections in `jira/sources/issue_source_manifests/POST-SUBTASK-014.json`; inspect only the listed implementation files and prerequisite outputs.",
  ...
  "canonical_record": "jira/records/issues/subtasks/POST-SUBTASK-014_freeze_source_priority_fallback_and_required_versus_optional_classifications.json",
  "canonical_source_role": "AUTHORITATIVE_LOCAL_SPECIFICATION",
  "completion_evidence_contract": {
    "acceptance_matrix_required": true,
    "artifact_hashes_required": true,
    "completion_claim_limit": "IMPLEMENTED",
    "downstream_consumer": "POST-SUBTASK-015",
  ...
  "gap_ids": [],
  "generated_markdown": "jira/issues/subtasks/POST-SUBTASK-014_freeze_source_priority_fallback_and_required_versus_optional_classifications.md",
  ...
  "operational_jira": {
    "assignee": "",
    "jira_issue_id": "24504",
    "jira_updated_at": "2026-08-09T07:20:14.078-0500",
    "last_synced_at": "2026-08-09T12:21:01.490479+00:00",
    "source_export": "C:\\BatteredAggieSyndrome.data\\runtime\\BAT-364\\BAT-364-live-row.csv",
    "sprint": "",
    "status_raw": "Done"
  },
  "out_of_scope": [
  ...
  "risk_failure_conditions": [
    "The work would be invalid if any prerequisite artifact, source/data/code/config identity, or declared maturity differs from the pinned issue contract for POST-SUBTASK-014.",
  ...
  "title": "[POST-SUBTASK-014] Freeze source priority, fallback, and required-versus-optional classifications",
  ...
  "work_packet_path": "jira/ai/work_packets/POST-SUBTASK-014.md",
  "workflow_state": "DONE"
}
```
