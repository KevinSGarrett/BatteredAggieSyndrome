<!-- GENERATED VIEW. Canonical record: jira/records/issues/tasks/TASK-123_define_ood_model_disagreement_detection_candidates.json -->
# TASK-123 — [TASK-123] Define OOD/model-disagreement detection candidates
...
```json
{
  ...
  "acceptance_criteria": [
    "Stable ID TASK-123, parent EPIC-022, owner wave W16, and original status DONE are preserved.",
  ...
  "canonical_record": "jira/records/issues/tasks/TASK-123_define_ood_model_disagreement_detection_candidates.json",
  ...
  "gap_ids": [],
  "generated_markdown": "jira/issues/tasks/TASK-123_define_ood_model_disagreement_detection_candidates.md",
  ...
  "objective": "Define OOD/model-disagreement detection candidates",
  "operational_jira": {
    "assignee": "",
    "jira_issue_id": "24366",
    "jira_updated_at": "2026-08-09T00:40:39.462-0500",
  ...
  "phase": "PHASE-4",
  "prerequisites": [
    "Historical dependency TASK-122"
  ],
  "primary_source_refs": [
    "SRCREF-00156",
    "SRCREF-02116",
  ...
  "required_evidence": [
    "Authoritative WBS row TASK-123",
    "Existing artifact `OOD/disagreement candidate registry`"
  ],
  "required_tests": [
    {
  ...
  "specificity_fingerprint": "12ae7f1a597f14da34dc541ea871956710fe611bf855277a78a72d81ab0329c6",
  "stop_conditions": [
  ...
  "title": "[TASK-123] Define OOD/model-disagreement detection candidates",
...
Define OOD/model-disagreement detection candidates
...
1. Stable ID TASK-123, parent EPIC-022, owner wave W16, and original status DONE are preserved.
