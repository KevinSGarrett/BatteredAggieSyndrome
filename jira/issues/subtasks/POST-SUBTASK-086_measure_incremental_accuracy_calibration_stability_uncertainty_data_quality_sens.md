<!-- GENERATED VIEW. Canonical record: jira/records/issues/subtasks/POST-SUBTASK-086_measure_incremental_accuracy_calibration_stability_uncertainty_data_quality_sens.json -->
# POST-SUBTASK-086 — [POST-SUBTASK-086] Measure incremental accuracy, calibration, stability, uncertainty, data-quality sensitivity, and multiple-comparison context
...
```json
{
  ...
  "ai_context_notes": [
    ...
    "Read the exact source sections in `jira/sources/issue_source_manifests/POST-SUBTASK-086.json`; inspect only the listed implementation files and prerequisite outputs.",
  ...
  "blocked_reason": "UNSATISFIED_HARD_DEPENDENCIES: POST-SUBTASK-084;POST-SUBTASK-085;POST-SUBTASK-102",
  "blocks": [
    "POST-SUBTASK-087"
  ],
  "canonical_record": "jira/records/issues/subtasks/POST-SUBTASK-086_measure_incremental_accuracy_calibration_stability_uncertainty_data_quality_sens.json",
  "canonical_source_role": "AUTHORITATIVE_LOCAL_SPECIFICATION",
  "completion_evidence_contract": {
    "acceptance_matrix_required": true,
    "artifact_hashes_required": true,
    "completion_claim_limit": "EMPIRICALLY_VALIDATED",
    "downstream_consumer": "POST-SUBTASK-087",
  ...
  "critical_path": false,
  "definition_of_done": [
    "The atomic scope in POST-SUBTASK-086 is completed without absorbing sibling work or weakening any protected requirement, control, split, judging rule, private-research publication boundary, or security boundary.",
    ...
    "The output set `artifacts/tamu/tamu_protected_evaluation.json` is demonstrably consumable by POST-SUBTASK-087 without manual reconstruction or undocumented state."
  ],
  "dependencies": [
    "POST-SUBTASK-084",
    "POST-SUBTASK-085",
  ...
  "end_to_end_validation": "Validate that `artifacts/tamu/tamu_protected_evaluation.json` can be parsed and consumed by `POST-SUBTASK-087` using only documented identities and interfaces; the consumer must reject missing, stale, schema-incompatible, technically or quality-ineligible, or provenance-incomplete input without manual repair.",
  "epic_id": "POST-EPIC-009",
  "evidence_manifest_path": "artifacts/jira_evidence/POST-SUBTASK-086.json",
  ...
  "gap_ids": [],
  "generated_markdown": "jira/issues/subtasks/POST-SUBTASK-086_measure_incremental_accuracy_calibration_stability_uncertainty_data_quality_sens.md",
  ...
  "local_id": "POST-SUBTASK-086",
  "maturity_before": "FUNCTIONAL_STARTER",
  "objective": "Measure incremental accuracy, calibration, stability, uncertainty, data-quality sensitivity, and multiple-comparison context",
  "operational_jira": {
    "assignee": "",
    "jira_issue_id": "24576",
    "jira_updated_at": "2026-08-09T23:24:08.359-0500",
  ...
  "required_tests": [
    {
      ...
      "expectation": "Run as a regression check after completing POST-SUBTASK-086; retain command, exit code, and relevant output.",
    ...
    },
    {
      ...
      "path": "artifacts/tamu/tamu_protected_evaluation.json",
  ...
  "risk_failure_conditions": [
    "The work would be invalid if any prerequisite artifact, source/data/code/config identity, or declared maturity differs from the pinned issue contract for POST-SUBTASK-086.",
    ...
    "Acceptance failure: the evidence cannot demonstrate that the declared output `artifacts/tamu/tamu_protected_evaluation.json` is produced with deterministic identity, provenance, and validation metadata appropriate to this work.",
  ...
  "specificity_fingerprint": "3c4167260d0346c7e41b38e55d0af0d85da18ac448aeb8ae1f2ef5e208e0c9ac",
  "stop_conditions": [
  ...
  "title": "[POST-SUBTASK-086] Measure incremental accuracy, calibration, stability, uncertainty, data-quality sensitivity, and multiple-comparison context",
  ...
  "work_packet_path": "jira/ai/work_packets/POST-SUBTASK-086.md",
...
1. The atomic scope in POST-SUBTASK-086 is completed without absorbing sibling work or weakening any protected requirement, control, split, judging rule, private-research publication boundary, or security boundary.
...
7. The output set `artifacts/tamu/tamu_protected_evaluation.json` is demonstrably consumable by POST-SUBTASK-087 without manual reconstruction or undocumented state.
...
Validate that `artifacts/tamu/tamu_protected_evaluation.json` can be parsed and consumed by `POST-SUBTASK-087` using only documented identities and interfaces; the consumer must reject missing, stale, schema-incompatible, technically or quality-ineligible, or provenance-incomplete input without manual repair.
