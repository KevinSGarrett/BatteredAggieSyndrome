...
1. `jira/records/issues/epics/POST-EPIC-011_protected_chronological_evaluation_calibration_and_champion_promotion.json`
2. `jira/sources/issue_source_manifests/POST-EPIC-011.json`
3. `jira/index/ISSUE_GOVERNANCE_CONTEXT.csv` row for `POST-EPIC-011`.
