...
def main() -> int:
    parser = argparse.ArgumentParser(description="Independently validate the expanded official gamebook union.")
    ...
    if not args.validate_only:
        ...
        if gate.get("prior_union_identity") != PRIOR_UNION_IDENTITY:
            raise AssertionError("committed gate lost the preserved Cycle #9 union identity")
