...
```json
{
  ...
  "critical_path": true,
  "definition_of_done": [
    "The atomic scope in POST-SUBTASK-007 is completed without absorbing sibling work or weakening any protected requirement, control, split, judging rule, private-research publication boundary, or security boundary.",
  ...
  "end_to_end_validation": "Validate that `artifacts/benchmarks/ac038_input_manifest.json` can be parsed and consumed by `POST-SUBTASK-008` using only documented identities and interfaces; the consumer must reject missing, stale, schema-incompatible, technically or quality-ineligible, or provenance-incomplete input without manual repair.",
  ...
  "operational_jira": {
    "assignee": "",
    "jira_issue_id": "24497",
    "jira_updated_at": "2026-08-09T05:48:09.631-0500",
    "last_synced_at": "2026-08-09T10:48:09.631000+00:00",
  ...
  "specificity_fingerprint": "622f577db6d9bdaf39bb5af10141b7c9ec0240d3390aa83559d93a73c44f32ce",
  "stop_conditions": [
...
1. The atomic scope in POST-SUBTASK-007 is completed without absorbing sibling work or weakening any protected requirement, control, split, judging rule, private-research publication boundary, or security boundary.
...
- **EXISTING_AUTOMATED_TEST** / `REGRESSION` — `artifacts/benchmarks/ac038_input_manifest.json` — Run as a regression check after completing POST-SUBTASK-007; retain command, exit code, and relevant output.
...
Validate that `artifacts/benchmarks/ac038_input_manifest.json` can be parsed and consumed by `POST-SUBTASK-008` using only documented identities and interfaces; the consumer must reject missing, stale, schema-incompatible, technically or quality-ineligible, or provenance-incomplete input without manual repair.
