<!-- GENERATED VIEW. Canonical record: jira/records/issues/tasks/TASK-077_define_opponent_adjusted_efficiency_framework.json -->
# TASK-077 — [TASK-077] Define opponent-adjusted efficiency framework
...
```json
{
  ...
  "acceptance_criteria": [
    "Stable ID TASK-077, parent EPIC-014, owner wave W13, and original status DONE are preserved.",
  ...
  "canonical_record": "jira/records/issues/tasks/TASK-077_define_opponent_adjusted_efficiency_framework.json",
  ...
  "gap_ids": [],
  "generated_markdown": "jira/issues/tasks/TASK-077_define_opponent_adjusted_efficiency_framework.md",
  ...
  "objective": "Define opponent-adjusted efficiency framework",
  "operational_jira": {
    "assignee": "",
    "jira_issue_id": "24320",
    "jira_updated_at": "2026-08-09T00:40:30.431-0500",
  ...
  "required_evidence": [
    "Authoritative WBS row TASK-077",
    "Existing artifact `opponent adjustment candidates`"
  ],
  "required_tests": [
    {
  ...
  "specificity_fingerprint": "43b0042129e91c5ea0b9d63c5c7e8108a433a784f0b4a3e43106be4ca414029d",
  "stop_conditions": [
  ...
  "title": "[TASK-077] Define opponent-adjusted efficiency framework",
...
Define opponent-adjusted efficiency framework
...
1. Stable ID TASK-077, parent EPIC-014, owner wave W13, and original status DONE are preserved.
