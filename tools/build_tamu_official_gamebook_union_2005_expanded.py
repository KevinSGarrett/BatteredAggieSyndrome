...
from aggie_analytics.data.tamu_official_gamebook_union_2005_expanded import materialize_union  # noqa: E402


def main() -> int:
    parser = argparse.ArgumentParser(description="Materialize the 2005-expanded official gamebook union.")
