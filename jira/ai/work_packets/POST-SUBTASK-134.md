# AI Work Packet — POST-SUBTASK-134
...
1. `jira/records/issues/subtasks/POST-SUBTASK-134_audit_every_component_maturity_and_completion_claim_against_actual_repository_ru.json`
2. `jira/sources/issue_source_manifests/POST-SUBTASK-134.json`
3. `jira/index/ISSUE_GOVERNANCE_CONTEXT.csv` row for `POST-SUBTASK-134`.
