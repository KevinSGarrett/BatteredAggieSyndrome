...
```json
{
  ...
  "critical_path": false,
  "definition_of_done": [
    "The atomic scope in POST-SUBTASK-115 is completed without absorbing sibling work or weakening any protected requirement, control, split, judging rule, rights decision, or security boundary.",
  ...
  "end_to_end_validation": "Validate that `artifacts/product/snapshot_repository_test.json` can be parsed and consumed by `POST-SUBTASK-116` using only documented identities and interfaces; the consumer must reject missing, stale, schema-incompatible, rights-blocked, or provenance-incomplete input without manual repair.",
  ...
  "specificity_fingerprint": "2f01e1182cef368841b12d606824c3aa304745cb38f425334921d832edd046e0",
  "stop_conditions": [
...
1. The atomic scope in POST-SUBTASK-115 is completed without absorbing sibling work or weakening any protected requirement, control, split, judging rule, rights decision, or security boundary.
