<!-- GENERATED VIEW. Canonical record: jira/records/issues/tasks/TASK-045_create_synthetic_end_to_end_foundation_fixture.json -->
# TASK-045 — [TASK-045] Create synthetic end-to-end foundation fixture
...
```json
{
  ...
  "acceptance_criteria": [
    "Stable ID TASK-045, parent EPIC-008, owner wave W19, and original status DONE are preserved.",
  ...
  "canonical_record": "jira/records/issues/tasks/TASK-045_create_synthetic_end_to_end_foundation_fixture.json",
  ...
  "gap_ids": [],
  "generated_markdown": "jira/issues/tasks/TASK-045_create_synthetic_end_to_end_foundation_fixture.md",
  ...
  "objective": "Create synthetic end-to-end foundation fixture",
  "operational_jira": {
    "assignee": "",
    "jira_issue_id": "24288",
    "jira_updated_at": "2026-08-09T00:40:24.177-0500",
  ...
  "phase": "PHASE-1",
  "prerequisites": [
    "Historical dependency TASK-044"
  ],
  "primary_source_refs": [
    "SRCREF-00078",
    "SRCREF-02116",
  ...
  "required_evidence": [
    "Authoritative WBS row TASK-045",
    "Existing artifact `synthetic source→PIT→feature replay fixture`"
  ],
  "required_tests": [
    {
  ...
  "specificity_fingerprint": "011b9b3828cef949a8131f8b369d27bf5a8c4981d0e2caf68c6829d0757e9f28",
  "stop_conditions": [
  ...
  "title": "[TASK-045] Create synthetic end-to-end foundation fixture",
...
Create synthetic end-to-end foundation fixture
...
1. Stable ID TASK-045, parent EPIC-008, owner wave W19, and original status DONE are preserved.
