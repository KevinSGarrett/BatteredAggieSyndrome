<!-- GENERATED VIEW. Canonical record: jira/records/issues/subtasks/POST-SUBTASK-026_normalize_and_reconcile_core_game_event_records_while_preserving_immutable_sourc.json -->
# POST-SUBTASK-026 — [POST-SUBTASK-026] Normalize and reconcile core/game-event records while preserving immutable source evidence
...
```json
{
  ...
  "ai_context_notes": [
    ...
    "Read the exact source sections in `jira/sources/issue_source_manifests/POST-SUBTASK-026.json`; inspect only the listed implementation files and prerequisite outputs.",
  ...
  "blocked_reason": "UNSATISFIED_HARD_DEPENDENCIES: POST-SUBTASK-006;POST-SUBTASK-018;POST-SUBTASK-021;POST-SUBTASK-022;POST-SUBTASK-025",
  "blocks": [
    "POST-SUBTASK-027"
  ],
  "canonical_record": "jira/records/issues/subtasks/POST-SUBTASK-026_normalize_and_reconcile_core_game_event_records_while_preserving_immutable_sourc.json",
  "canonical_source_role": "AUTHORITATIVE_LOCAL_SPECIFICATION",
  "completion_evidence_contract": {
    "acceptance_matrix_required": true,
    "artifact_hashes_required": true,
    "completion_claim_limit": "EMPIRICALLY_VALIDATED",
    "downstream_consumer": "POST-SUBTASK-027",
  ...
  "gap_ids": [],
  "generated_markdown": "jira/issues/subtasks/POST-SUBTASK-026_normalize_and_reconcile_core_game_event_records_while_preserving_immutable_sourc.md",
  ...
  "local_id": "POST-SUBTASK-026",
  "maturity_before": "SCAFFOLD",
  "objective": "Normalize and reconcile core/game-event records while preserving immutable source evidence",
  "operational_jira": {
    "assignee": "",
    "jira_issue_id": "24516",
    "jira_updated_at": "2026-08-09T00:03:28.637-0500",
  ...
  "risk_failure_conditions": [
    "The work would be invalid if any prerequisite artifact, source/data/code/config identity, or declared maturity differs from the pinned issue contract for POST-SUBTASK-026.",
    ...
    "Acceptance failure: the evidence cannot demonstrate that the declared output `artifacts/data_lake/core_normalization_report.json` is produced with deterministic identity, provenance, and validation metadata appropriate to this work.",
  ...
  "title": "[POST-SUBTASK-026] Normalize and reconcile core/game-event records while preserving immutable source evidence",
  ...
  "work_packet_path": "jira/ai/work_packets/POST-SUBTASK-026.md",
