<!-- GENERATED VIEW. Canonical record: jira/records/issues/tasks/TASK-117_compare_joint_score_margin_statistical_families.json -->
# TASK-117 — [TASK-117] Compare joint-score/margin statistical families
...
```json
{
  ...
  "acceptance_criteria": [
    "Stable ID TASK-117, parent EPIC-021, owner wave W16, and original status DONE are preserved.",
  ...
  "canonical_record": "jira/records/issues/tasks/TASK-117_compare_joint_score_margin_statistical_families.json",
  ...
  "gap_ids": [],
  "generated_markdown": "jira/issues/tasks/TASK-117_compare_joint_score_margin_statistical_families.md",
  ...
  "objective": "Compare joint-score/margin statistical families",
  "operational_jira": {
    "assignee": "",
    "jira_issue_id": "24360",
    "jira_updated_at": "2026-08-09T00:40:38.599-0500",
  ...
  "phase": "PHASE-4",
  "prerequisites": [
    "Historical dependency TASK-116"
  ],
  "primary_source_refs": [
    "SRCREF-00150",
    "SRCREF-02116",
  ...
  "required_evidence": [
    "Authoritative WBS row TASK-117",
    "Existing artifact `joint-distribution candidate report`"
  ],
  "required_tests": [
    {
  ...
  "specificity_fingerprint": "eacaf6ea246a6824ab0f6291d17c0c03c54ed0fcfd75b927eb4ab63fbfca5cd0",
  "stop_conditions": [
  ...
  "title": "[TASK-117] Compare joint-score/margin statistical families",
...
Compare joint-score/margin statistical families
...
1. Stable ID TASK-117, parent EPIC-021, owner wave W16, and original status DONE are preserved.
