...
1. `jira/records/issues/epics/POST-EPIC-005_point_in_time_historical_state_and_protected_replay.json`
2. `jira/sources/issue_source_manifests/POST-EPIC-005.json`
3. `jira/index/ISSUE_GOVERNANCE_CONTEXT.csv` row for `POST-EPIC-005`.
