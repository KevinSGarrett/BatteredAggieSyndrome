<!-- GENERATED VIEW. Canonical record: jira/records/issues/tasks/TASK-093_freeze_a_and_m_state_interface.json -->
# TASK-093 — [TASK-093] Freeze A&M state interface
...
```json
{
  ...
  "acceptance_criteria": [
    "Stable ID TASK-093, parent EPIC-016, owner wave W14, and original status DONE are preserved.",
  ...
  "canonical_record": "jira/records/issues/tasks/TASK-093_freeze_a_and_m_state_interface.json",
  ...
  "gap_ids": [],
  "generated_markdown": "jira/issues/tasks/TASK-093_freeze_a_and_m_state_interface.md",
  ...
  "objective": "Freeze A&M state interface",
  "operational_jira": {
    "assignee": "",
    "jira_issue_id": "24336",
    "jira_updated_at": "2026-08-09T00:40:33.670-0500",
  ...
  "phase": "PHASE-3",
  "prerequisites": [
    "Historical dependency TASK-089",
    "Historical dependency TASK-090",
    "Historical dependency TASK-091",
  ...
  "required_evidence": [
    "Authoritative WBS row TASK-093",
    "Existing artifact `A&M team-state baseline`"
  ],
  "required_tests": [
    {
  ...
  "specificity_fingerprint": "c0894547daad58d97f74317d3a7b0454d599099011fb60ac01cb23e80e5cdf37",
  "stop_conditions": [
  ...
  "title": "[TASK-093] Freeze A&M state interface",
...
1. Stable ID TASK-093, parent EPIC-016, owner wave W14, and original status DONE are preserved.
