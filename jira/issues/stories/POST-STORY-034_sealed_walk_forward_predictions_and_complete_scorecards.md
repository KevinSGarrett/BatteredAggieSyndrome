<!-- GENERATED VIEW. Canonical record: jira/records/issues/stories/POST-STORY-034_sealed_walk_forward_predictions_and_complete_scorecards.json -->
# POST-STORY-034 — [POST-STORY-034] Sealed walk-forward predictions and complete scorecards
...
```json
{
  ...
  "blocked_reason": "",
  "blocks": [],
  "canonical_record": "jira/records/issues/stories/POST-STORY-034_sealed_walk_forward_predictions_and_complete_scorecards.json",
  "canonical_source_role": "AUTHORITATIVE_LOCAL_SPECIFICATION",
  "completion_evidence_contract": {
    "all_child_evidence_required": true,
    "child_gate": "POST-SUBTASK-102",
  ...
  "critical_path": true,
  "definition_of_done": [
    "All child subtasks POST-SUBTASK-100, POST-SUBTASK-101, POST-SUBTASK-102 have verified evidence or an explicit accepted-risk/deferred/cancelled disposition consistent with the Story contract.",
    "The final gate `POST-SUBTASK-102` completes and proves the Story end-to-end requirement; closing implementation children alone is insufficient.",
  ...
  "end_to_end_validation": "Sealed immutable predictions generate complete scorecards that a separate process can reproduce without reopening tuning.",
  "epic_id": "POST-EPIC-011",
  "evidence_manifest_path": "artifacts/jira_evidence/POST-STORY-034.json",
  ...
  "gap_ids": [],
  "generated_markdown": "jira/issues/stories/POST-STORY-034_sealed_walk_forward_predictions_and_complete_scorecards.md",
  ...
  "local_id": "POST-STORY-034",
  "maturity_before": "FUNCTIONAL_STARTER",
  "objective": "Generate immutable protected predictions and independently reproducible evaluation evidence.",
  "operational_jira": {
    "assignee": "",
    "jira_issue_id": "24224",
    "jira_updated_at": "2026-08-09T00:03:56.595-0500",
  ...
  "phase": "PHASE-4",
  "prerequisites": [
    "Hard dependency POST-SUBTASK-099"
  ],
  "primary_source_refs": [
    "SRCREF-02071",
    "SRCREF-02072",
  ...
  "required_tests": [
    ...
    },
    {
      ...
      "expectation": "The final child gate `POST-SUBTASK-102` must prove the integrated Story outcome and downstream-consumable output.",
  ...
  "specificity_fingerprint": "c1acb16f0238d9f35babd3d16b2d06066cb7aeb4ecf313d0e4d963798ad776ad",
  "stop_conditions": [
  ...
  "title": "[POST-STORY-034] Sealed walk-forward predictions and complete scorecards",
  ...
  "work_packet_path": "jira/ai/work_packets/POST-STORY-034.md",
...
1. All child subtasks POST-SUBTASK-100, POST-SUBTASK-101, POST-SUBTASK-102 have verified evidence or an explicit accepted-risk/deferred/cancelled disposition consistent with the Story contract.
2. The final gate `POST-SUBTASK-102` completes and proves the Story end-to-end requirement; closing implementation children alone is insufficient.
