...
from aggie_analytics.data.tamu_official_1998_season_index import materialize  # noqa: E402  # pylint: disable=import-error


def main() -> int:
    parser = argparse.ArgumentParser(
        description="Capture the official 1998 SRC-014 season index and discover box URLs."
    )
    parser.add_argument(
