<!-- GENERATED VIEW. Canonical record: jira/records/issues/subtasks/POST-SUBTASK-127_instrument_run_stage_source_snapshot_entity_matrix_feature_model_product_identif.json -->
# POST-SUBTASK-127 — [POST-SUBTASK-127] Instrument run/stage/source/snapshot/entity/matrix/feature/model/product identifiers, metrics, structured events, health, and redaction
...
```json
{
  ...
  "ai_context_notes": [
    ...
    "Read the exact source sections in `jira/sources/issue_source_manifests/POST-SUBTASK-127.json`; inspect only the listed implementation files and prerequisite outputs.",
  ...
  "canonical_record": "jira/records/issues/subtasks/POST-SUBTASK-127_instrument_run_stage_source_snapshot_entity_matrix_feature_model_product_identif.json",
  "canonical_source_role": "AUTHORITATIVE_LOCAL_SPECIFICATION",
  "completion_evidence_contract": {
    "acceptance_matrix_required": true,
    "artifact_hashes_required": true,
    "completion_claim_limit": "IMPLEMENTED",
    "downstream_consumer": "POST-SUBTASK-128",
  ...
  "critical_path": false,
  "definition_of_done": [
    "The atomic scope in POST-SUBTASK-127 is completed without absorbing sibling work or weakening any protected requirement, control, split, judging rule, rights decision, or security boundary.",
    ...
    "The output set `artifacts/operations/observability_contract_test.json` is demonstrably consumable by POST-SUBTASK-128 without manual reconstruction or undocumented state."
  ],
  "dependencies": [
    "POST-SUBTASK-024",
    "POST-SUBTASK-126"
  ...
  "end_to_end_validation": "Validate that `artifacts/operations/observability_contract_test.json` can be parsed and consumed by `POST-SUBTASK-128` using only documented identities and interfaces; the consumer must reject missing, stale, schema-incompatible, rights-blocked, or provenance-incomplete input without manual repair.",
  ...
  "gap_ids": [],
  "generated_markdown": "jira/issues/subtasks/POST-SUBTASK-127_instrument_run_stage_source_snapshot_entity_matrix_feature_model_product_identif.md",
  ...
  "local_id": "POST-SUBTASK-127",
  "maturity_before": "FUNCTIONAL_STARTER",
  "objective": "Instrument run/stage/source/snapshot/entity/matrix/feature/model/product identifiers, metrics, structured events, health, and redaction",
  "operational_jira": {
    "assignee": "",
    "jira_issue_id": "24617",
    "jira_updated_at": "2026-08-09T00:04:06.635-0500",
  ...
  "required_tests": [
    {
      ...
      "expectation": "Run as a regression check after completing POST-SUBTASK-127; retain command, exit code, and relevant output.",
    ...
    },
    {
      ...
      "path": "artifacts/operations/observability_contract_test.json",
    ...
    },
    {
      ...
      "path": "NEW_TEST_REQUIRED::POST-SUBTASK-127",
      "validation_class": "NEW_AUTOMATED_TEST_REQUIRED"
    }
  ],
  "requirement_ids": [],
  "risk_failure_conditions": [
    "The work would be invalid if any prerequisite artifact, source/data/code/config identity, or declared maturity differs from the pinned issue contract for POST-SUBTASK-127.",
    ...
    "Acceptance failure: the evidence cannot demonstrate that the declared output `artifacts/operations/observability_contract_test.json` is produced with deterministic identity, provenance, and validation metadata appropriate to this work.",
  ...
  "risk_ids": [],
  "schema_version": 2,
  "scope": "Execute the atomic 1 of 3 step in Story POST-STORY-043 (Structured observability, alerts, drift, and incident response): Instrument run/stage/source/snapshot/entity/matrix/feature/model/product identifiers, metrics, structured events, health, and redaction. Consume only verified prerequisite outputs from `POST-SUBTASK-024`, `POST-SUBTASK-126`. Produce `artifacts/operations/observability_contract_test.json`; evaluate every issue-specific acceptance condition; preserve negative results; and hand the pinned output to POST-SUBTASK-128.",
  "source_ids": [
    "HANDOFF-012"
  ],
  "source_refs": [
  ...
  "specificity_fingerprint": "7eacd6c51664213dfc5a2dd4b4bd69599bc130b3bf5ea4d9ccb9cf52b8e7aa13",
  "stop_conditions": [
  ...
  "title": "[POST-SUBTASK-127] Instrument run/stage/source/snapshot/entity/matrix/feature/model/product identifiers, metrics, structured events, health, and redaction",
...
1. The atomic scope in POST-SUBTASK-127 is completed without absorbing sibling work or weakening any protected requirement, control, split, judging rule, rights decision, or security boundary.
...
7. The output set `artifacts/operations/observability_contract_test.json` is demonstrably consumable by POST-SUBTASK-128 without manual reconstruction or undocumented state.
...
Validate that `artifacts/operations/observability_contract_test.json` can be parsed and consumed by `POST-SUBTASK-128` using only documented identities and interfaces; the consumer must reject missing, stale, schema-incompatible, rights-blocked, or provenance-incomplete input without manual repair.
