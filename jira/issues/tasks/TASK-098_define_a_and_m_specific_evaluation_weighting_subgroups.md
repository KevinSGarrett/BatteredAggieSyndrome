<!-- GENERATED VIEW. Canonical record: jira/records/issues/tasks/TASK-098_define_a_and_m_specific_evaluation_weighting_subgroups.json -->
# TASK-098 — [TASK-098] Define A&M-specific evaluation weighting/subgroups
...
```json
{
  ...
  "acceptance_criteria": [
    "Stable ID TASK-098, parent EPIC-017, owner wave W14, and original status DONE are preserved.",
  ...
  "canonical_record": "jira/records/issues/tasks/TASK-098_define_a_and_m_specific_evaluation_weighting_subgroups.json",
  ...
  "gap_ids": [],
  "generated_markdown": "jira/issues/tasks/TASK-098_define_a_and_m_specific_evaluation_weighting_subgroups.md",
  ...
  "objective": "Define A&M-specific evaluation weighting/subgroups",
  "operational_jira": {
    "assignee": "",
    "jira_issue_id": "24341",
    "jira_updated_at": "2026-08-09T00:40:34.745-0500",
  ...
  "required_evidence": [
    "Authoritative WBS row TASK-098",
    "Existing artifact `A&M evaluation slice contract`"
  ],
  "required_tests": [
    {
  ...
  "specificity_fingerprint": "997c60acc07278cbf9f768e242a031df0ea0dabcf58ed262a9425ecb7f794d2b",
  "stop_conditions": [
  ...
  "title": "[TASK-098] Define A&M-specific evaluation weighting/subgroups",
...
Define A&M-specific evaluation weighting/subgroups
...
1. Stable ID TASK-098, parent EPIC-017, owner wave W14, and original status DONE are preserved.
