...
1. `jira/records/issues/stories/POST-STORY-025_simple_rating_linear_tree_market_and_coherent_joint_score_candidates.json`
2. `jira/sources/issue_source_manifests/POST-STORY-025.json`
3. `jira/index/ISSUE_GOVERNANCE_CONTEXT.csv` row for `POST-STORY-025`.
