<!-- GENERATED VIEW. Canonical record: jira/records/issues/subtasks/POST-SUBTASK-085_generate_sealed_global_only_and_a_and_m_candidate_predictions_inside_identical_p.json -->
# POST-SUBTASK-085 — [POST-SUBTASK-085] Generate sealed global-only and A&M candidate predictions inside identical protected chronological replay
...
```json
{
  ...
  "ai_context_notes": [
    ...
    "Read the exact source sections in `jira/sources/issue_source_manifests/POST-SUBTASK-085.json`; inspect only the listed implementation files and prerequisite outputs.",
  ...
  "blocked_reason": "UNSATISFIED_HARD_DEPENDENCIES: POST-SUBTASK-084;POST-SUBTASK-102",
  "blocks": [
    "POST-SUBTASK-086",
    "POST-SUBTASK-087"
  ],
  "canonical_record": "jira/records/issues/subtasks/POST-SUBTASK-085_generate_sealed_global_only_and_a_and_m_candidate_predictions_inside_identical_p.json",
  "canonical_source_role": "AUTHORITATIVE_LOCAL_SPECIFICATION",
  "completion_evidence_contract": {
    "acceptance_matrix_required": true,
    "artifact_hashes_required": true,
    "completion_claim_limit": "IMPLEMENTED",
    "downstream_consumer": "POST-SUBTASK-086",
  ...
  "critical_path": false,
  "definition_of_done": [
    "The atomic scope in POST-SUBTASK-085 is completed without absorbing sibling work or weakening any protected requirement, control, split, judging rule, private-research publication boundary, or security boundary.",
    ...
    "The output set `artifacts/tamu/tamu_protected_predictions.parquet` is demonstrably consumable by POST-SUBTASK-086 without manual reconstruction or undocumented state."
  ],
  "dependencies": [
    "POST-SUBTASK-084",
    "POST-SUBTASK-102"
  ...
  "end_to_end_validation": "Validate that `artifacts/tamu/tamu_protected_predictions.parquet` can be parsed and consumed by `POST-SUBTASK-086` using only documented identities and interfaces; the consumer must reject missing, stale, schema-incompatible, technically or quality-ineligible, or provenance-incomplete input without manual repair.",
  "epic_id": "POST-EPIC-009",
  "evidence_manifest_path": "artifacts/jira_evidence/POST-SUBTASK-085.json",
  ...
  "gap_ids": [],
  "generated_markdown": "jira/issues/subtasks/POST-SUBTASK-085_generate_sealed_global_only_and_a_and_m_candidate_predictions_inside_identical_p.md",
  ...
  "local_id": "POST-SUBTASK-085",
  "maturity_before": "FUNCTIONAL_STARTER",
  "objective": "Generate sealed global-only and A&M candidate predictions inside identical protected chronological replay",
  "operational_jira": {
    "assignee": "",
    "jira_issue_id": "24575",
    "jira_updated_at": "2026-08-09T23:24:08.100-0500",
  ...
  "required_tests": [
    {
      ...
      "expectation": "Run as a regression check after completing POST-SUBTASK-085; retain command, exit code, and relevant output.",
    ...
    },
    {
      ...
      "path": "artifacts/tamu/tamu_protected_predictions.parquet",
    ...
    },
    {
      ...
      "path": "NEW_TEST_REQUIRED::POST-SUBTASK-085",
      "validation_class": "NEW_AUTOMATED_TEST_REQUIRED"
    }
  ],
  "requirement_ids": [],
  "risk_failure_conditions": [
    "The work would be invalid if any prerequisite artifact, source/data/code/config identity, or declared maturity differs from the pinned issue contract for POST-SUBTASK-085.",
    ...
    "Acceptance failure: the evidence cannot demonstrate that the declared output `artifacts/tamu/tamu_protected_predictions.parquet` is produced with deterministic identity, provenance, and validation metadata appropriate to this work.",
  ...
  "specificity_fingerprint": "375210630f7dc2988767683ee9f62bc36ecdb73c5d993714de56266f14657aeb",
  "stop_conditions": [
  ...
  "title": "[POST-SUBTASK-085] Generate sealed global-only and A&M candidate predictions inside identical protected chronological replay",
  ...
  "work_packet_path": "jira/ai/work_packets/POST-SUBTASK-085.md",
...
1. The atomic scope in POST-SUBTASK-085 is completed without absorbing sibling work or weakening any protected requirement, control, split, judging rule, private-research publication boundary, or security boundary.
...
7. The output set `artifacts/tamu/tamu_protected_predictions.parquet` is demonstrably consumable by POST-SUBTASK-086 without manual reconstruction or undocumented state.
...
Validate that `artifacts/tamu/tamu_protected_predictions.parquet` can be parsed and consumed by `POST-SUBTASK-086` using only documented identities and interfaces; the consumer must reject missing, stale, schema-incompatible, technically or quality-ineligible, or provenance-incomplete input without manual repair.
