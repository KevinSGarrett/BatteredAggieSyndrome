<!-- GENERATED VIEW. Canonical record: jira/records/issues/subtasks/POST-SUBTASK-063_validate_player_state_coverage_uncertainty_double_counting_controls_and_producti.json -->
# POST-SUBTASK-063 — [POST-SUBTASK-063] Validate player-state coverage, uncertainty, double-counting controls, and production eligibility
...
```json
{
  ...
  "ai_context_notes": [
    ...
    "Read the exact source sections in `jira/sources/issue_source_manifests/POST-SUBTASK-063.json`; inspect only the listed implementation files and prerequisite outputs.",
  ...
  "canonical_record": "jira/records/issues/subtasks/POST-SUBTASK-063_validate_player_state_coverage_uncertainty_double_counting_controls_and_producti.json",
  "canonical_source_role": "AUTHORITATIVE_LOCAL_SPECIFICATION",
  "completion_evidence_contract": {
    "acceptance_matrix_required": true,
    "artifact_hashes_required": true,
    "completion_claim_limit": "PRODUCTION_READY",
    "downstream_consumer": "POST-STORY-021",
  ...
  "critical_path": false,
  "definition_of_done": [
    "The atomic scope in POST-SUBTASK-063 is completed without absorbing sibling work or weakening any protected requirement, control, split, judging rule, private-research publication boundary, or security boundary.",
    ...
    "The Story gate consumes the complete prerequisite evidence set and issues an explicit downstream approval/block/reject/defer decision for POST-STORY-021."
  ],
  "dependencies": [
    "POST-SUBTASK-030",
    "POST-SUBTASK-048",
  ...
  "gap_ids": [],
  "generated_markdown": "jira/issues/subtasks/POST-SUBTASK-063_validate_player_state_coverage_uncertainty_double_counting_controls_and_producti.md",
  ...
  "local_id": "POST-SUBTASK-063",
  "maturity_before": "FUNCTIONAL_STARTER",
  "objective": "Validate player-state coverage, uncertainty, double-counting controls, and production eligibility",
  "operational_jira": {
    "assignee": "",
    "jira_issue_id": "24553",
    "jira_updated_at": "2026-08-09T23:24:05.696-0500",
  ...
  "prerequisites": [
    ...
    "Dependency POST-SUBTASK-062 complete at required maturity"
  ],
  "primary_source_refs": [
    "SRCREF-02041",
    "SRCREF-02042",
  ...
  "required_tests": [
    {
      ...
      "expectation": "Run as a regression check after completing POST-SUBTASK-063; retain command, exit code, and relevant output.",
    ...
    },
    {
      ...
      "path": "artifacts/player_intelligence/player_intelligence_gate.json",
  ...
  "risk_failure_conditions": [
    "The work would be invalid if any prerequisite artifact, source/data/code/config identity, or declared maturity differs from the pinned issue contract for POST-SUBTASK-063.",
    ...
    "Acceptance failure: the evidence cannot demonstrate that coverage is measured by season/team/position/source and missing reports are uncertainty—not healthy/absent certainty; unsupported periods remain conditional.",
  ...
  "specificity_fingerprint": "70daef2ec506f03c9872ebe0b53c4333c4cdd6b976f317fd882b781b025cd075",
  "stop_conditions": [
  ...
  "title": "[POST-SUBTASK-063] Validate player-state coverage, uncertainty, double-counting controls, and production eligibility",
  ...
  "work_packet_path": "jira/ai/work_packets/POST-SUBTASK-063.md",
...
1. The atomic scope in POST-SUBTASK-063 is completed without absorbing sibling work or weakening any protected requirement, control, split, judging rule, private-research publication boundary, or security boundary.
...
7. The Story gate consumes the complete prerequisite evidence set and issues an explicit downstream approval/block/reject/defer decision for POST-STORY-021.
