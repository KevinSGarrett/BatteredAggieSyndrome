...
1. `jira/records/issues/stories/POST-STORY-036_production_weekly_acquisition_to_prediction_chain.json`
2. `jira/sources/issue_source_manifests/POST-STORY-036.json`
3. `jira/index/ISSUE_GOVERNANCE_CONTEXT.csv` row for `POST-STORY-036`.
