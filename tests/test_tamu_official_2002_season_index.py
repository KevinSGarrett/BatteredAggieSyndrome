...
from aggie_analytics.data.tamu_official_2002_season_index import (  # noqa: E402
    AuthorityViolation,
    GATE_RELATIVE,
...
OFFICIAL_2002_URL = "https://files.12thman.com/history/football/years/2002.html"
...
FIXTURE_HTML = (
    ...
    "<td><a href='../stats/2002-2003/ta01-asu.html'>Box Score</a></td></tr>"
    "<tr><td>Sep 6</td><td>Utah</td><td>College Station</td><td>W, 28-26</td>"
    "<td><a href='../stats/2002-2003/ta02-utah.html'>Box Score</a></td></tr>"
    "</table></body></html>"
).encode("utf-8")
...
AMBIGUOUS_HTML = (
    ...
    "<td><a href='../stats/2002-2003/ta03-unk.html'>Box Score</a></td></tr>"
    "</table></body></html>"
).encode("utf-8")
...
class Official2002UrlAndFixtureTests(unittest.TestCase):
    ...
    def test_fixture_discovers_source_ordered_rows_and_box_urls(self) -> None:
        with tempfile.TemporaryDirectory() as tmp:
            stored = persist_capture(
                Path(tmp),
                {
                    **_capture(OFFICIAL_2002_URL, FIXTURE_HTML),
            ...
            self.assertEqual(
                ...
                [
                    "https://files.12thman.com/history/football/stats/2002-2003/ta01-asu.html",
                    "https://files.12thman.com/history/football/stats/2002-2003/ta02-utah.html",
                ],
            )
            ...
            self.assertEqual(objects["gate"]["season"], 2002)
            self.assertEqual(objects["gate"]["jira_key"], "BAT-613")

    def test_missing_box_link_is_counted_not_invented(self) -> None:
        parsed = parse_season_game_rows(
            body=MISSING_BOX_HTML,
            page_url=OFFICIAL_2002_URL,
...
class Compact2002GateTests(unittest.TestCase):
    def setUp(self) -> None:
        path = REPO_ROOT / GATE_RELATIVE
        if not path.is_file():
            self.skipTest("2002 gate not materialized yet")
    ...
    def test_ci_path_validates_without_external_history_index(self) -> None:
        ...
        self.assertEqual(self.gate["official_index_url"], OFFICIAL_2002_URL)
...
@unittest.skipUnless(LAKE_READY, "external BAT-613 2002 capture is not mounted")
class Official2002CaptureTests(unittest.TestCase):
