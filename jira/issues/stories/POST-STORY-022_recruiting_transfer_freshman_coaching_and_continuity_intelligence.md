<!-- GENERATED VIEW. Canonical record: jira/records/issues/stories/POST-STORY-022_recruiting_transfer_freshman_coaching_and_continuity_intelligence.json -->
# POST-STORY-022 — [POST-STORY-022] Recruiting, transfer, freshman, coaching, and continuity intelligence
...
```json
{
  ...
  "blocked_reason": "",
  "blocks": [],
  "canonical_record": "jira/records/issues/stories/POST-STORY-022_recruiting_transfer_freshman_coaching_and_continuity_intelligence.json",
  "canonical_source_role": "AUTHORITATIVE_LOCAL_SPECIFICATION",
  "completion_evidence_contract": {
    "all_child_evidence_required": true,
    "child_gate": "POST-SUBTASK-066",
  ...
  "critical_path": false,
  "definition_of_done": [
    "All child subtasks POST-SUBTASK-064, POST-SUBTASK-065, POST-SUBTASK-066 have verified evidence or an explicit accepted-risk/deferred/cancelled disposition consistent with the Story contract.",
    "The final gate `POST-SUBTASK-066` completes and proves the Story end-to-end requirement; closing implementation children alone is insufficient.",
  ...
  "end_to_end_validation": "Recruiting, portal, freshman, coaching, coordinator, and continuity state is reproducible at each cutoff without current-season hindsight.",
  "epic_id": "POST-EPIC-007",
  "evidence_manifest_path": "artifacts/jira_evidence/POST-STORY-022.json",
  ...
  "gap_ids": [],
  "generated_markdown": "jira/issues/stories/POST-STORY-022_recruiting_transfer_freshman_coaching_and_continuity_intelligence.md",
  ...
  "local_id": "POST-STORY-022",
  "maturity_before": "FUNCTIONAL_STARTER",
  "objective": "Represent program talent inflows/outflows and staff/system continuity without hindsight or unsupported narrative labels.",
  "operational_jira": {
    "assignee": "",
    "jira_issue_id": "24212",
    "jira_updated_at": "2026-08-09T23:23:56.319-0500",
  ...
  "required_tests": [
    ...
    },
    {
      ...
      "expectation": "The final child gate `POST-SUBTASK-066` must prove the integrated Story outcome and downstream-consumable output.",
  ...
  "risk_ids": [],
  "schema_version": 2,
  "scope": "Deliver Story POST-STORY-022 (Recruiting, transfer, freshman, coaching, and continuity intelligence) as one coherent, gated capability inside Epic POST-EPIC-007. Execute child subtasks POST-SUBTASK-064, POST-SUBTASK-065, POST-SUBTASK-066 in dependency order, reconcile their pinned outputs, and require the final gate `POST-SUBTASK-066` to issue an evidence-backed approve/block/reject/defer decision before any downstream use.",
  "source_ids": [
    "GAP-006",
    "HANDOFF-008"
  ],
  ...
  "specificity_fingerprint": "e13af9308f0d48a84a4635fd472264b8403b53895559362db58c13f1724d4ee3",
  "stop_conditions": [
  ...
  "title": "[POST-STORY-022] Recruiting, transfer, freshman, coaching, and continuity intelligence",
  ...
  "work_packet_path": "jira/ai/work_packets/POST-STORY-022.md",
...
1. All child subtasks POST-SUBTASK-064, POST-SUBTASK-065, POST-SUBTASK-066 have verified evidence or an explicit accepted-risk/deferred/cancelled disposition consistent with the Story contract.
2. The final gate `POST-SUBTASK-066` completes and proves the Story end-to-end requirement; closing implementation children alone is insufficient.
