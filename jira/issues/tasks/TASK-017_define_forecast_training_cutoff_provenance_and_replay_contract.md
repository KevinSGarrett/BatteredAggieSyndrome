<!-- GENERATED VIEW. Canonical record: jira/records/issues/tasks/TASK-017_define_forecast_training_cutoff_provenance_and_replay_contract.json -->
# TASK-017 — [TASK-017] Define forecast/training cutoff provenance and replay contract
...
```json
{
  ...
  "acceptance_criteria": [
    "Stable ID TASK-017, parent EPIC-003, owner wave W08, and original status DONE are preserved.",
  ...
  "canonical_record": "jira/records/issues/tasks/TASK-017_define_forecast_training_cutoff_provenance_and_replay_contract.json",
  ...
  "gap_ids": [],
  "generated_markdown": "jira/issues/tasks/TASK-017_define_forecast_training_cutoff_provenance_and_replay_contract.md",
  ...
  "objective": "Define forecast/training cutoff provenance and replay contract",
  "operational_jira": {
    "assignee": "",
    "jira_issue_id": "24260",
    "jira_updated_at": "2026-08-09T00:40:18.637-0500",
  ...
  "required_evidence": [
    "Authoritative WBS row TASK-017",
    "Existing artifact `cutoff lineage/replay contract`"
  ],
  "required_tests": [
    {
  ...
  "specificity_fingerprint": "4a71cdba270e5431ca53760c63a08ff27187415f38d1a8ba804d948f45bf2951",
  "stop_conditions": [
  ...
  "title": "[TASK-017] Define forecast/training cutoff provenance and replay contract",
...
Define forecast/training cutoff provenance and replay contract
...
1. Stable ID TASK-017, parent EPIC-003, owner wave W08, and original status DONE are preserved.
