<!-- GENERATED VIEW. Canonical record: jira/records/issues/subtasks/POST-SUBTASK-128_implement_source_api_terms_schema_entity_feature_data_model_concept_freshness_se.json -->
# POST-SUBTASK-128 — [POST-SUBTASK-128] Implement source/API/terms/schema/entity/feature/data/model/concept/freshness/security/governance drift detectors plus alert severity/dedup/ack/escalation
...
```json
{
  ...
  "ai_context_notes": [
    ...
    "Read the exact source sections in `jira/sources/issue_source_manifests/POST-SUBTASK-128.json`; inspect only the listed implementation files and prerequisite outputs.",
  ...
  "blocked_reason": "UNSATISFIED_HARD_DEPENDENCIES: POST-SUBTASK-024;POST-SUBTASK-126;POST-SUBTASK-127",
  "blocks": [
    "POST-SUBTASK-129"
  ],
  "canonical_record": "jira/records/issues/subtasks/POST-SUBTASK-128_implement_source_api_terms_schema_entity_feature_data_model_concept_freshness_se.json",
  ...
  "critical_path": false,
  "definition_of_done": [
    "The atomic scope in POST-SUBTASK-128 is completed without absorbing sibling work or weakening any protected requirement, control, split, judging rule, rights decision, or security boundary.",
    ...
    "The output set `artifacts/operations/drift_alert_validation.json` is demonstrably consumable by POST-SUBTASK-129 without manual reconstruction or undocumented state."
  ],
  "dependencies": [
    "POST-SUBTASK-024",
    "POST-SUBTASK-126",
  ...
  "end_to_end_validation": "Validate that `artifacts/operations/drift_alert_validation.json` can be parsed and consumed by `POST-SUBTASK-129` using only documented identities and interfaces; the consumer must reject missing, stale, schema-incompatible, rights-blocked, or provenance-incomplete input without manual repair.",
  ...
  "gap_ids": [],
  "generated_markdown": "jira/issues/subtasks/POST-SUBTASK-128_implement_source_api_terms_schema_entity_feature_data_model_concept_freshness_se.md",
  ...
  "objective": "Implement source/API/terms/schema/entity/feature/data/model/concept/freshness/security/governance drift detectors plus alert severity/dedup/ack/escalation",
  "operational_jira": {
    "assignee": "",
    "jira_issue_id": "24618",
    "jira_updated_at": "2026-08-09T00:04:06.745-0500",
  ...
  "risk_failure_conditions": [
    "The work would be invalid if any prerequisite artifact, source/data/code/config identity, or declared maturity differs from the pinned issue contract for POST-SUBTASK-128.",
    ...
    "Acceptance failure: the evidence cannot demonstrate that the declared output `artifacts/operations/drift_alert_validation.json` is produced with deterministic identity, provenance, and validation metadata appropriate to this work.",
  ...
  "specificity_fingerprint": "2534864f2f163f748cfda5bef4577bb6c02bc1fc8481d8a0a636b476c3d82111",
  "stop_conditions": [
  ...
  "title": "[POST-SUBTASK-128] Implement source/API/terms/schema/entity/feature/data/model/concept/freshness/security/governance drift detectors plus alert severity/dedup/ack/escalation",
...
1. The atomic scope in POST-SUBTASK-128 is completed without absorbing sibling work or weakening any protected requirement, control, split, judging rule, rights decision, or security boundary.
...
7. The output set `artifacts/operations/drift_alert_validation.json` is demonstrably consumable by POST-SUBTASK-129 without manual reconstruction or undocumented state.
