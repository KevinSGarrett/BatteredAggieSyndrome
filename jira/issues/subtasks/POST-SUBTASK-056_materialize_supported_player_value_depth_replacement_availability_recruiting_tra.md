<!-- GENERATED VIEW. Canonical record: jira/records/issues/subtasks/POST-SUBTASK-056_materialize_supported_player_value_depth_replacement_availability_recruiting_tra.json -->
# POST-SUBTASK-056 — [POST-SUBTASK-056] Materialize supported player value/depth/replacement/availability, recruiting/transfer, coaching, weather, market, resource, officiating, and game-mechanics candidates
...
```json
{
  ...
  "acceptance_criteria": [
    ...
    "The declared output `artifacts/features/advanced_feature_manifest.json` is produced with deterministic identity, provenance, and validation metadata appropriate to this work.",
  ...
  "ai_context_notes": [
    ...
    "Read the exact source sections in `jira/sources/issue_source_manifests/POST-SUBTASK-056.json`; inspect only the listed implementation files and prerequisite outputs.",
  ...
  "blocked_reason": "UNSATISFIED_HARD_DEPENDENCIES: POST-SUBTASK-051;POST-SUBTASK-054;POST-SUBTASK-055",
  "blocks": [
    "POST-SUBTASK-057"
  ],
  "canonical_record": "jira/records/issues/subtasks/POST-SUBTASK-056_materialize_supported_player_value_depth_replacement_availability_recruiting_tra.json",
  "canonical_source_role": "AUTHORITATIVE_LOCAL_SPECIFICATION",
  "completion_evidence_contract": {
    "acceptance_matrix_required": true,
    "artifact_hashes_required": true,
    "completion_claim_limit": "EMPIRICALLY_VALIDATED",
    "downstream_consumer": "POST-SUBTASK-057",
  ...
  "critical_path": false,
  "definition_of_done": [
    "The atomic scope in POST-SUBTASK-056 is completed without absorbing sibling work or weakening any protected requirement, control, split, judging rule, rights decision, or security boundary.",
    ...
    "The output set `artifacts/features/advanced_feature_manifest.json` is demonstrably consumable by POST-SUBTASK-057 without manual reconstruction or undocumented state."
  ],
  "dependencies": [
    "POST-SUBTASK-051",
    "POST-SUBTASK-054",
  ...
  "end_to_end_validation": "Validate that `artifacts/features/advanced_feature_manifest.json` can be parsed and consumed by `POST-SUBTASK-057` using only documented identities and interfaces; the consumer must reject missing, stale, schema-incompatible, rights-blocked, or provenance-incomplete input without manual repair.",
  "epic_id": "POST-EPIC-006",
  "evidence_manifest_path": "artifacts/jira_evidence/POST-SUBTASK-056.json",
  ...
  "gap_ids": [],
  "generated_markdown": "jira/issues/subtasks/POST-SUBTASK-056_materialize_supported_player_value_depth_replacement_availability_recruiting_tra.md",
  ...
  "local_id": "POST-SUBTASK-056",
  "maturity_before": "FUNCTIONAL_STARTER",
  "objective": "Materialize supported player value/depth/replacement/availability, recruiting/transfer, coaching, weather, market, resource, officiating, and game-mechanics candidates",
  "operational_jira": {
    "assignee": "",
    "jira_issue_id": "24546",
    "jira_updated_at": "2026-08-09T00:03:41.793-0500",
  ...
  "required_tests": [
    {
      ...
      "expectation": "Run as a regression check after completing POST-SUBTASK-056; retain command, exit code, and relevant output.",
    ...
    },
    {
      ...
      "path": "artifacts/features/advanced_feature_manifest.json",
    ...
    },
    {
      ...
      "path": "NEW_TEST_REQUIRED::POST-SUBTASK-056",
      "validation_class": "NEW_AUTOMATED_TEST_REQUIRED"
    }
  ],
  "requirement_ids": [],
  "risk_failure_conditions": [
    "The work would be invalid if any prerequisite artifact, source/data/code/config identity, or declared maturity differs from the pinned issue contract for POST-SUBTASK-056.",
    ...
    "Acceptance failure: the evidence cannot demonstrate that the declared output `artifacts/features/advanced_feature_manifest.json` is produced with deterministic identity, provenance, and validation metadata appropriate to this work.",
  ...
  "specificity_fingerprint": "2d0f90b350a8ff9f1d09bc3b02f7a634ae27f43bab64a3ef25829a50ddc28e5b",
  "stop_conditions": [
  ...
  "title": "[POST-SUBTASK-056] Materialize supported player value/depth/replacement/availability, recruiting/transfer, coaching, weather, market, resource, officiating, and game-mechanics candidates",
  ...
  "work_packet_path": "jira/ai/work_packets/POST-SUBTASK-056.md",
...
1. The atomic scope in POST-SUBTASK-056 is completed without absorbing sibling work or weakening any protected requirement, control, split, judging rule, rights decision, or security boundary.
...
7. The output set `artifacts/features/advanced_feature_manifest.json` is demonstrably consumable by POST-SUBTASK-057 without manual reconstruction or undocumented state.
...
Validate that `artifacts/features/advanced_feature_manifest.json` can be parsed and consumed by `POST-SUBTASK-057` using only documented identities and interfaces; the consumer must reject missing, stale, schema-incompatible, rights-blocked, or provenance-incomplete input without manual repair.
