<!-- GENERATED VIEW. Canonical record: jira/records/issues/subtasks/POST-SUBTASK-145_implement_the_admitted_neural_bayesian_graph_sequence_challenger_against_pinned_.json -->
# POST-SUBTASK-145 — [POST-SUBTASK-145] Implement the admitted neural/Bayesian/graph/sequence challenger against pinned matrices/splits within fixed scope and compute
...
```json
{
  ...
  "acceptance_criteria": [
    ...
    "The declared output `artifacts/advanced/challenger_build_manifest.json` is produced with deterministic identity, provenance, and validation metadata appropriate to this work.",
  ...
  "ai_context_notes": [
    ...
    "Read the exact source sections in `jira/sources/issue_source_manifests/POST-SUBTASK-145.json`; inspect only the listed implementation files and prerequisite outputs.",
  ...
  "canonical_record": "jira/records/issues/subtasks/POST-SUBTASK-145_implement_the_admitted_neural_bayesian_graph_sequence_challenger_against_pinned_.json",
  "canonical_source_role": "AUTHORITATIVE_LOCAL_SPECIFICATION",
  "completion_evidence_contract": {
    "acceptance_matrix_required": true,
    "artifact_hashes_required": true,
    "completion_claim_limit": "IMPLEMENTED",
    "downstream_consumer": "POST-SUBTASK-146",
  ...
  "critical_path": false,
  "definition_of_done": [
    "The atomic scope in POST-SUBTASK-145 is completed without absorbing sibling work or weakening any protected requirement, control, split, judging rule, rights decision, or security boundary.",
    ...
    "The output set `artifacts/advanced/challenger_build_manifest.json` is demonstrably consumable by POST-SUBTASK-146 without manual reconstruction or undocumented state."
  ],
  "dependencies": [
    "POST-SUBTASK-144"
  ],
  ...
  "end_to_end_validation": "Validate that `artifacts/advanced/challenger_build_manifest.json` can be parsed and consumed by `POST-SUBTASK-146` using only documented identities and interfaces; the consumer must reject missing, stale, schema-incompatible, rights-blocked, or provenance-incomplete input without manual repair.",
  "epic_id": "POST-EPIC-016",
  "evidence_manifest_path": "artifacts/jira_evidence/POST-SUBTASK-145.json",
  ...
  "gap_ids": [],
  "generated_markdown": "jira/issues/subtasks/POST-SUBTASK-145_implement_the_admitted_neural_bayesian_graph_sequence_challenger_against_pinned_.md",
  ...
  "local_id": "POST-SUBTASK-145",
  "maturity_before": "CONDITIONAL",
  "objective": "Implement the admitted neural/Bayesian/graph/sequence challenger against pinned matrices/splits within fixed scope and compute",
  "operational_jira": {
    "assignee": "",
    "jira_issue_id": "24635",
    "jira_updated_at": "2026-08-09T00:04:12.167-0500",
  ...
  "required_tests": [
    {
      ...
      "expectation": "Run as a regression check after completing POST-SUBTASK-145; retain command, exit code, and relevant output.",
    ...
    },
    {
      ...
      "path": "artifacts/advanced/challenger_build_manifest.json",
    ...
    },
    {
      ...
      "path": "NEW_TEST_REQUIRED::POST-SUBTASK-145",
      "validation_class": "NEW_AUTOMATED_TEST_REQUIRED"
    }
  ],
  "requirement_ids": [],
  "risk_failure_conditions": [
    "The work would be invalid if any prerequisite artifact, source/data/code/config identity, or declared maturity differs from the pinned issue contract for POST-SUBTASK-145.",
    ...
    "Acceptance failure: the evidence cannot demonstrate that the declared output `artifacts/advanced/challenger_build_manifest.json` is produced with deterministic identity, provenance, and validation metadata appropriate to this work.",
  ...
  "specificity_fingerprint": "8aa6938c8148474c7cb832a455964277012df6bd10013f866b33a58eba8b1266",
  "stop_conditions": [
  ...
  "title": "[POST-SUBTASK-145] Implement the admitted neural/Bayesian/graph/sequence challenger against pinned matrices/splits within fixed scope and compute",
  ...
  "work_packet_path": "jira/ai/work_packets/POST-SUBTASK-145.md",
...
1. The atomic scope in POST-SUBTASK-145 is completed without absorbing sibling work or weakening any protected requirement, control, split, judging rule, rights decision, or security boundary.
...
7. The output set `artifacts/advanced/challenger_build_manifest.json` is demonstrably consumable by POST-SUBTASK-146 without manual reconstruction or undocumented state.
...
Validate that `artifacts/advanced/challenger_build_manifest.json` can be parsed and consumed by `POST-SUBTASK-146` using only documented identities and interfaces; the consumer must reject missing, stale, schema-incompatible, rights-blocked, or provenance-incomplete input without manual repair.
