<!-- GENERATED VIEW. Canonical record: jira/records/issues/tasks/TASK-151_pass_weekly_pipeline_idempotency_resume_gate.json -->
# TASK-151 — [TASK-151] Pass weekly pipeline idempotency/resume gate
...
```json
{
  ...
  "acceptance_criteria": [
    "Stable ID TASK-151, parent EPIC-026, owner wave W21, and original status DONE are preserved.",
  ...
  "allowed_modification_paths": [
    "end-to-end resumability evidence"
  ],
  "blocked_reason": "",
  "blocks": [
    "TASK-152",
  ...
  "canonical_record": "jira/records/issues/tasks/TASK-151_pass_weekly_pipeline_idempotency_resume_gate.json",
  ...
  "gap_ids": [],
  "generated_markdown": "jira/issues/tasks/TASK-151_pass_weekly_pipeline_idempotency_resume_gate.md",
  ...
  "objective": "Pass weekly pipeline idempotency/resume gate",
  "operational_jira": {
    "assignee": "",
    "jira_issue_id": "24394",
    "jira_updated_at": "2026-08-09T00:40:44.739-0500",
  ...
  "phase": "PHASE-4",
  "prerequisites": [
    "Historical dependency TASK-147",
    "Historical dependency TASK-150"
  ],
  "primary_source_refs": [
    "SRCREF-00184",
    "SRCREF-02116",
  ...
  "required_evidence": [
    "Authoritative WBS row TASK-151",
    "Existing artifact `end-to-end resumability evidence`"
  ],
  "required_tests": [
    {
  ...
  "specificity_fingerprint": "f5a7ae8f5ba55f13d65bcb0ddd055480a7faa1da437948583a93d2608719a840",
  "stop_conditions": [
  ...
  "title": "[TASK-151] Pass weekly pipeline idempotency/resume gate",
...
Pass weekly pipeline idempotency/resume gate
...
- Inherited from: None
- Resolution: `DIRECT`
- Effective counts: `{"acceptance_control_ids": 10, "adr_ids": 0, "gap_ids": 0, "requirement_ids": 6, "risk_ids": 0}`

## Acceptance Criteria

1. Stable ID TASK-151, parent EPIC-026, owner wave W21, and original status DONE are preserved.
