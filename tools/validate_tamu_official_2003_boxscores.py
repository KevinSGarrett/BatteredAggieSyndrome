...
def main() -> int:
    parser = argparse.ArgumentParser(description="Independently validate official 2003 box-score acquisition.")
    ...
    if not args.validate_only:
        ...
        upstream3["bat609_gate_identity"] = "0" * 64
        mutations.append(expect_rejection("bat609_rewrite", lambda: _validate(_mutated_gate(gate, upstream_identities=upstream3))))
