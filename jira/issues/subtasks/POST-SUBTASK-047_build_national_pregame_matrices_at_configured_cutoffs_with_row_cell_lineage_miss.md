...
```json
{
  ...
  "critical_path": true,
  "definition_of_done": [
    "The atomic scope in POST-SUBTASK-047 is completed without absorbing sibling work or weakening any protected requirement, control, split, judging rule, private-research publication boundary, or security boundary.",
  ...
  "end_to_end_validation": "Validate that `artifacts/pit/pregame_matrix_manifest.json` can be parsed and consumed by `POST-SUBTASK-048` using only documented identities and interfaces; the consumer must reject missing, stale, schema-incompatible, technically or quality-ineligible, or provenance-incomplete input without manual repair.",
  ...
  "operational_jira": {
    "assignee": "",
    "jira_issue_id": "24537",
    "jira_updated_at": "2026-08-10T05:59:28.002-0500",
    "last_synced_at": "2026-08-10T11:01:05.967750+00:00",
    "source_export": "C:\\BatteredAggieSyndrome.data\\runtime\\BAT-397\\BAT-397-claim-live-row.csv",
    "sprint": "",
  ...
  "specificity_fingerprint": "9ed9e134ce1e635cbd8dbcf5d00c71b7682e8936fa790e612f287048d8c9170f",
  "stop_conditions": [
...
1. The atomic scope in POST-SUBTASK-047 is completed without absorbing sibling work or weakening any protected requirement, control, split, judging rule, private-research publication boundary, or security boundary.
