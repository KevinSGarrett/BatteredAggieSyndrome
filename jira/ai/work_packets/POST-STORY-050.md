...
1. `jira/records/issues/stories/POST-STORY-050_protected_comparison_and_production_disposition.json`
2. `jira/sources/issue_source_manifests/POST-STORY-050.json`
3. `jira/index/ISSUE_GOVERNANCE_CONTEXT.csv` row for `POST-STORY-050`.
