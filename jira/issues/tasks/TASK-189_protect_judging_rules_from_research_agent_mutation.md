<!-- GENERATED VIEW. Canonical record: jira/records/issues/tasks/TASK-189_protect_judging_rules_from_research_agent_mutation.json -->
# TASK-189 — [TASK-189] Protect judging rules from research-agent mutation
...
```json
{
  ...
  "acceptance_criteria": [
    "Stable ID TASK-189, parent EPIC-033, owner wave W06-W25, and original status DONE are preserved.",
  ...
  "allowed_modification_paths": [
    "protected governance boundary evidence"
  ],
  "blocked_reason": "",
  "blocks": [],
  "canonical_record": "jira/records/issues/tasks/TASK-189_protect_judging_rules_from_research_agent_mutation.json",
  ...
  "gap_ids": [],
  "generated_markdown": "jira/issues/tasks/TASK-189_protect_judging_rules_from_research_agent_mutation.md",
  ...
  "objective": "Protect judging rules from research-agent mutation",
  "operational_jira": {
    "assignee": "",
    "jira_issue_id": "24460",
    "jira_updated_at": "2026-08-09T00:40:50.316-0500",
  ...
  "phase": "PHASE-4",
  "prerequisites": [
    "Historical dependency TASK-187"
  ],
  "primary_source_refs": [
    "SRCREF-00222",
    "SRCREF-02116",
  ...
  "required_evidence": [
    "Authoritative WBS row TASK-189",
    "Existing artifact `protected governance boundary evidence`"
  ],
  "required_tests": [
    {
  ...
  "specificity_fingerprint": "b8736cfbea8c4c32a8f89da38d5b1c121e4418ef246ce6bc2018914e7809f125",
  "stop_conditions": [
  ...
  "title": "[TASK-189] Protect judging rules from research-agent mutation",
...
Protect judging rules from research-agent mutation
...
1. Stable ID TASK-189, parent EPIC-033, owner wave W06-W25, and original status DONE are preserved.
