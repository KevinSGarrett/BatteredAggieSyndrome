<!-- GENERATED VIEW. Canonical record: jira/records/issues/tasks/TASK-124_define_pure_football_forecast_lane.json -->
# TASK-124 — [TASK-124] Define pure-football forecast lane
...
```json
{
  ...
  "acceptance_criteria": [
    "Stable ID TASK-124, parent EPIC-022, owner wave W16, and original status DONE are preserved.",
  ...
  "canonical_record": "jira/records/issues/tasks/TASK-124_define_pure_football_forecast_lane.json",
  ...
  "gap_ids": [],
  "generated_markdown": "jira/issues/tasks/TASK-124_define_pure_football_forecast_lane.md",
  ...
  "objective": "Define pure-football forecast lane",
  "operational_jira": {
    "assignee": "",
    "jira_issue_id": "24367",
    "jira_updated_at": "2026-08-09T00:40:39.387-0500",
  ...
  "required_evidence": [
    "Authoritative WBS row TASK-124",
    "Existing artifact `market-independent prediction path`"
  ],
  "required_tests": [
    {
  ...
  "specificity_fingerprint": "a2cd68b0489c1f7dedcbca62182933b467cf138064c367d0e72ff789e0f626df",
  "stop_conditions": [
  ...
  "title": "[TASK-124] Define pure-football forecast lane",
...
Define pure-football forecast lane
...
1. Stable ID TASK-124, parent EPIC-022, owner wave W16, and original status DONE are preserved.
