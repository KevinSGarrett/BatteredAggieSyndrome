<!-- GENERATED VIEW. Canonical record: jira/records/issues/tasks/TASK-111_implement_a_and_m_high_resolution_state_adapter_starter.json -->
# TASK-111 — [TASK-111] Implement A&M high-resolution state adapter starter
...
```json
{
  ...
  "acceptance_criteria": [
    "Stable ID TASK-111, parent EPIC-020, owner wave W20, and original status DONE are preserved.",
  ...
  "canonical_record": "jira/records/issues/tasks/TASK-111_implement_a_and_m_high_resolution_state_adapter_starter.json",
  ...
  "gap_ids": [],
  "generated_markdown": "jira/issues/tasks/TASK-111_implement_a_and_m_high_resolution_state_adapter_starter.md",
  ...
  "objective": "Implement A&M high-resolution state adapter starter",
  "operational_jira": {
    "assignee": "",
    "jira_issue_id": "24354",
    "jira_updated_at": "2026-08-09T00:40:37.079-0500",
  ...
  "required_evidence": [
    "Authoritative WBS row TASK-111",
    "Existing artifact `A&M state adapter`"
  ],
  "required_tests": [
    {
  ...
  "specificity_fingerprint": "43e6e50233c98a687c696f0e4c7f1025273cc629409ae9799e068147be2b0695",
  "stop_conditions": [
  ...
  "title": "[TASK-111] Implement A&M high-resolution state adapter starter",
...
Implement A&M high-resolution state adapter starter
...
1. Stable ID TASK-111, parent EPIC-020, owner wave W20, and original status DONE are preserved.
