"""Materialize the Cycle #24 executable binding for the five frozen candidates.

The producer refits the two fitted families on the allowed training partition
only, binds the frozen hyperparameters and development evidence, and decides per
candidate and oriented Week 1 row whether execution is permitted at all. It does
not emit a forecast and performs no network access.
"""
