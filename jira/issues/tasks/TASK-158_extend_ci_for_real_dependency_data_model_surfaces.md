<!-- GENERATED VIEW. Canonical record: jira/records/issues/tasks/TASK-158_extend_ci_for_real_dependency_data_model_surfaces.json -->
# TASK-158 — [TASK-158] Extend CI for real dependency/data/model surfaces
...
```json
{
  ...
  "acceptance_criteria": [
    "Stable ID TASK-158, parent EPIC-028, owner wave W23, and original status DONE are preserved.",
  ...
  "ai_context_notes": [
    ...
    "W23 CI implemented/tested locally; GitHub-hosted execution pending repository push."
  ],
  ...
  "canonical_record": "jira/records/issues/tasks/TASK-158_extend_ci_for_real_dependency_data_model_surfaces.json",
  ...
  "gap_ids": [],
  "generated_markdown": "jira/issues/tasks/TASK-158_extend_ci_for_real_dependency_data_model_surfaces.md",
  ...
  "objective": "Extend CI for real dependency/data/model surfaces",
  "operational_jira": {
    "assignee": "",
    "jira_issue_id": "24401",
    "jira_updated_at": "2026-08-09T00:40:46.232-0500",
  ...
  "required_evidence": [
    "Authoritative WBS row TASK-158",
    "Existing artifact `expanded cross-platform core/product CI + runtime manifest artifacts`"
  ],
  "required_tests": [
    {
  ...
  "specificity_fingerprint": "5a5a961e7b4c2763c5adc99f9aa255dbe977fae6d41e455b4074ba3cc413e1d9",
  "stop_conditions": [
  ...
  "title": "[TASK-158] Extend CI for real dependency/data/model surfaces",
...
Extend CI for real dependency/data/model surfaces
...
1. Stable ID TASK-158, parent EPIC-028, owner wave W23, and original status DONE are preserved.
