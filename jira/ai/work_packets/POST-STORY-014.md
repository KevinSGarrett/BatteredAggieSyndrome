...
1. `jira/records/issues/stories/POST-STORY-014_population_resolution_review_workflow_transitions_and_entity_gate.json`
2. `jira/sources/issue_source_manifests/POST-STORY-014.json`
3. `jira/index/ISSUE_GOVERNANCE_CONTEXT.csv` row for `POST-STORY-014`.
