...
def main() -> int:
    parser = argparse.ArgumentParser(description="Independently validate official 2006 box-score acquisition.")
    ...
    if not args.validate_only:
        ...
        mutations.append(expect_rejection("bat589_rewrite", lambda: _validate(_mutated_gate(gate, upstream_identities=upstream))))
        mutations.append(
            expect_rejection(
