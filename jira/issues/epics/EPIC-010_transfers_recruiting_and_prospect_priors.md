<!-- GENERATED VIEW. Canonical record: jira/records/issues/epics/EPIC-010_transfers_recruiting_and_prospect_priors.json -->
# EPIC-010 — [EPIC-010] Transfers, recruiting and prospect priors
...
```json
{
  ...
  "acceptance_criteria": [
    "The epic retains stable ID EPIC-010, owner wave W12, phase PHASE-2, and all authoritative WBS children.",
  ...
  "blocked_reason": "",
  "blocks": [],
  "canonical_record": "jira/records/issues/epics/EPIC-010_transfers_recruiting_and_prospect_priors.json",
  ...
  "expected_outputs": [
    "consensus/development candidate contracts",
    "position-aware translation experiment plan",
    "recruiting and freshman prior schema",
    "transfer episode schema",
    "transfer/recruiting source provenance decision",
    "transfer/recruiting/prospect interface baseline",
    "translation uncertainty/usage outputs"
  ],
  ...
  "gap_ids": [],
  "generated_markdown": "jira/issues/epics/EPIC-010_transfers_recruiting_and_prospect_priors.md",
  ...
  "objective": "Translate incoming talent/production across competitive context without hard-coded conference penalties.",
  "operational_jira": {
    "assignee": "",
    "jira_issue_id": "24150",
    "jira_updated_at": "2026-08-09T00:40:11.607-0500",
  ...
  "specificity_fingerprint": "57ab29d7e98fe3c818e984030ec41fb2fd8364249c622600e1780ebe75c4ba0d",
  "stop_conditions": [
    "Stop if a proposed update renumbers the historical epic or rewrites its original wave provenance."
  ],
  "supporting_source_refs": [],
  "title": "[EPIC-010] Transfers, recruiting and prospect priors",
...
Translate incoming talent/production across competitive context without hard-coded conference penalties.
...
1. The epic retains stable ID EPIC-010, owner wave W12, phase PHASE-2, and all authoritative WBS children.
