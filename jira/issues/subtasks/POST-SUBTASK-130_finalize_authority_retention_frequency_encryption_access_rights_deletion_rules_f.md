<!-- GENERATED VIEW. Canonical record: jira/records/issues/subtasks/POST-SUBTASK-130_finalize_authority_retention_frequency_encryption_access_rights_deletion_rules_f.json -->
# POST-SUBTASK-130 — [POST-SUBTASK-130] Finalize authority/retention/frequency/encryption/access/rights/deletion rules for raw, curated, model, forecast, log, evidence, and Jira metadata
...
```json
{
  ...
  "ai_context_notes": [
    ...
    "Read the exact source sections in `jira/sources/issue_source_manifests/POST-SUBTASK-130.json`; inspect only the listed implementation files and prerequisite outputs.",
    "May modify only the files explicitly listed in `files_expected_to_be_touched`, declared new outputs, and the Jira/evidence records required by the completion protocol. An empty file list does not authorize arbitrary repository edits.",
    "Return exact commands, exit codes, artifacts, hashes, input identities, acceptance-matrix results, negative findings, and remaining blockers; narrative completion is insufficient."
  ],
  "allowed_modification_paths": [
    "configs/backup_retention_policy.json",
    "artifacts/jira_evidence/POST-SUBTASK-130.json"
  ],
  "blocked_reason": "",
  "blocks": [
    "POST-SUBTASK-131",
  ...
  "canonical_record": "jira/records/issues/subtasks/POST-SUBTASK-130_finalize_authority_retention_frequency_encryption_access_rights_deletion_rules_f.json",
  "canonical_source_role": "AUTHORITATIVE_LOCAL_SPECIFICATION",
  "completion_evidence_contract": {
    "acceptance_matrix_required": true,
    "artifact_hashes_required": true,
    "completion_claim_limit": "IMPLEMENTED",
    "downstream_consumer": "POST-SUBTASK-131",
  ...
  "gap_ids": [],
  "generated_markdown": "jira/issues/subtasks/POST-SUBTASK-130_finalize_authority_retention_frequency_encryption_access_rights_deletion_rules_f.md",
  ...
  "operational_jira": {
    "assignee": "",
    "jira_issue_id": "24620",
    "jira_updated_at": "2026-08-16T20:32:33.558-0500",
    "last_synced_at": "2026-08-17T01:33:00.547548+00:00",
  ...
  "required_tests": [
    {
      ...
      "expectation": "Run as a regression check after completing POST-SUBTASK-130; retain command, exit code, and relevant output.",
  ...
  "risk_ids": [],
  "schema_version": 2,
  "scope": "Execute the atomic 1 of 3 step in Story POST-STORY-044 (Rights-aware backup, restore, retention, and disaster recovery): Finalize authority/retention/frequency/encryption/access/rights/deletion rules for raw, curated, model, forecast, log, evidence, and Jira metadata. Consume only verified prerequisite outputs from `POST-SUBTASK-129`. Produce `configs/backup_retention_policy.json`; evaluate every issue-specific acceptance condition; preserve negative results; and hand the pinned output to POST-SUBTASK-131.",
  "source_ids": [
    "HANDOFF-012"
  ],
  "source_refs": [
  ...
  "title": "[POST-SUBTASK-130] Finalize authority/retention/frequency/encryption/access/rights/deletion rules for raw, curated, model, forecast, log, evidence, and Jira metadata",
  ...
  "work_packet_path": "jira/ai/work_packets/POST-SUBTASK-130.md",
...
Execute the atomic 1 of 3 step in Story POST-STORY-044 (Rights-aware backup, restore, retention, and disaster recovery): Finalize authority/retention/frequency/encryption/access/rights/deletion rules for raw, curated, model, forecast, log, evidence, and Jira metadata. Consume only verified prerequisite outputs from `POST-SUBTASK-129`. Produce `configs/backup_retention_policy.json`; evaluate every issue-specific acceptance condition; preserve negative results; and hand the pinned output to POST-SUBTASK-131.
