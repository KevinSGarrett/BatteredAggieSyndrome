<!-- GENERATED VIEW. Canonical record: jira/records/issues/subtasks/POST-SUBTASK-114_approve_or_retain_blocked_the_autonomous_weekly_operating_maturity_decision.json -->
# POST-SUBTASK-114 — [POST-SUBTASK-114] Approve or retain-blocked the autonomous weekly operating maturity decision
...
```json
{
  ...
  "ai_context_notes": [
    ...
    "Read the exact source sections in `jira/sources/issue_source_manifests/POST-SUBTASK-114.json`; inspect only the listed implementation files and prerequisite outputs.",
  ...
  "blocked_reason": "UNSATISFIED_HARD_DEPENDENCIES: POST-SUBTASK-111;POST-SUBTASK-112;POST-SUBTASK-113",
  "blocks": [
    "POST-EPIC-015",
    "POST-STORY-045",
    "POST-SUBTASK-133",
  ...
  "canonical_record": "jira/records/issues/subtasks/POST-SUBTASK-114_approve_or_retain_blocked_the_autonomous_weekly_operating_maturity_decision.json",
  "canonical_source_role": "AUTHORITATIVE_LOCAL_SPECIFICATION",
  "completion_evidence_contract": {
    "acceptance_matrix_required": true,
    "artifact_hashes_required": true,
    "completion_claim_limit": "PRODUCTION_READY",
    "downstream_consumer": "POST-STORY-038",
  ...
  "critical_path": false,
  "definition_of_done": [
    "The atomic scope in POST-SUBTASK-114 is completed without absorbing sibling work or weakening any protected requirement, control, split, judging rule, private-research publication boundary, or security boundary.",
    ...
    "The Story gate consumes the complete prerequisite evidence set and issues an explicit downstream approval/block/reject/defer decision for POST-STORY-038."
  ],
  "dependencies": [
    "POST-SUBTASK-111",
    "POST-SUBTASK-112",
  ...
  "end_to_end_validation": "Repeated real weekly runs publish immutable forecasts, survive representative failures, and produce measured evidence for or against autonomous operation. The gate decision must explicitly reevaluate downstream issues: POST-EPIC-015, POST-STORY-045, POST-SUBTASK-133, POST-SUBTASK-134, POST-SUBTASK-135.",
  "epic_id": "POST-EPIC-012",
  "evidence_manifest_path": "artifacts/jira_evidence/POST-SUBTASK-114.json",
  ...
  "gap_ids": [],
  "generated_markdown": "jira/issues/subtasks/POST-SUBTASK-114_approve_or_retain_blocked_the_autonomous_weekly_operating_maturity_decision.md",
  ...
  "local_id": "POST-SUBTASK-114",
  "maturity_before": "FUNCTIONAL_STARTER",
  "objective": "Approve or retain-blocked the autonomous weekly operating maturity decision",
  "operational_jira": {
    "assignee": "",
    "jira_issue_id": "24604",
    "jira_updated_at": "2026-08-09T23:24:11.165-0500",
  ...
  "prerequisites": [
    ...
    "Dependency POST-SUBTASK-113 complete at required maturity"
  ],
  "primary_source_refs": [
    "SRCREF-02079",
    "SRCREF-02080",
  ...
  "required_tests": [
    {
      ...
      "expectation": "Run as a regression check after completing POST-SUBTASK-114; retain command, exit code, and relevant output.",
    ...
    },
    {
      ...
      "path": "artifacts/mlops/weekly_operating_readiness.json",
  ...
  "risk_failure_conditions": [
    "The work would be invalid if any prerequisite artifact, source/data/code/config identity, or declared maturity differs from the pinned issue contract for POST-SUBTASK-114.",
    ...
    "Acceptance failure: the evidence cannot demonstrate that oPERATING requires repeated successful real evidence plus freshness/recovery/resource/security/operator proof and documents residual manual gates; GAP-012 stays open otherwise.",
  ...
  "specificity_fingerprint": "551a680c1efe0a7294042a819a205f6e415138a1464fac162f43d33f70985749",
  "stop_conditions": [
  ...
  "title": "[POST-SUBTASK-114] Approve or retain-blocked the autonomous weekly operating maturity decision",
  ...
  "work_packet_path": "jira/ai/work_packets/POST-SUBTASK-114.md",
...
1. The atomic scope in POST-SUBTASK-114 is completed without absorbing sibling work or weakening any protected requirement, control, split, judging rule, private-research publication boundary, or security boundary.
...
7. The Story gate consumes the complete prerequisite evidence set and issues an explicit downstream approval/block/reject/defer decision for POST-STORY-038.
