<!-- GENERATED VIEW. Canonical record: jira/records/issues/subtasks/POST-SUBTASK-075_validate_artifacts_tuning_predictions_orientation_distribution_tails_score_margi.json -->
# POST-SUBTASK-075 — [POST-SUBTASK-075] Validate artifacts, tuning predictions, orientation, distribution tails, score-margin-win coherence, runtime, and candidate admission
...
```json
{
  ...
  "ai_context_notes": [
    ...
    "Read the exact source sections in `jira/sources/issue_source_manifests/POST-SUBTASK-075.json`; inspect only the listed implementation files and prerequisite outputs.",
  ...
  "blocked_reason": "UNSATISFIED_HARD_DEPENDENCIES: POST-SUBTASK-072;POST-SUBTASK-073;POST-SUBTASK-074",
  "blocks": [
    "POST-STORY-026",
    "POST-SUBTASK-076",
    "POST-SUBTASK-077",
  ...
  "canonical_record": "jira/records/issues/subtasks/POST-SUBTASK-075_validate_artifacts_tuning_predictions_orientation_distribution_tails_score_margi.json",
  "canonical_source_role": "AUTHORITATIVE_LOCAL_SPECIFICATION",
  "completion_evidence_contract": {
    "acceptance_matrix_required": true,
    "artifact_hashes_required": true,
    "completion_claim_limit": "PRODUCTION_READY",
    "downstream_consumer": "POST-STORY-025",
  ...
  "critical_path": false,
  "definition_of_done": [
    "The atomic scope in POST-SUBTASK-075 is completed without absorbing sibling work or weakening any protected requirement, control, split, judging rule, private-research publication boundary, or security boundary.",
    ...
    "The Story gate consumes the complete prerequisite evidence set and issues an explicit downstream approval/block/reject/defer decision for POST-STORY-025."
  ],
  "dependencies": [
    "POST-SUBTASK-072",
    "POST-SUBTASK-073",
  ...
  "end_to_end_validation": "Pinned real datasets train simple and coherent distributional candidates that reproduce all outputs and remain honest about failures and compute. The gate decision must explicitly reevaluate downstream issues: POST-STORY-026, POST-SUBTASK-076, POST-SUBTASK-077, POST-SUBTASK-078.",
  "epic_id": "POST-EPIC-008",
  "evidence_manifest_path": "artifacts/jira_evidence/POST-SUBTASK-075.json",
  ...
  "gap_ids": [],
  "generated_markdown": "jira/issues/subtasks/POST-SUBTASK-075_validate_artifacts_tuning_predictions_orientation_distribution_tails_score_margi.md",
  ...
  "local_id": "POST-SUBTASK-075",
  "maturity_before": "FUNCTIONAL_STARTER",
  "objective": "Validate artifacts, tuning predictions, orientation, distribution tails, score-margin-win coherence, runtime, and candidate admission",
  "operational_jira": {
    "assignee": "",
    "jira_issue_id": "24565",
    "jira_updated_at": "2026-08-09T23:24:07.016-0500",
  ...
  "prerequisites": [
    ...
    "Dependency POST-SUBTASK-074 complete at required maturity"
  ],
  "primary_source_refs": [
    "SRCREF-02049",
    "SRCREF-02050",
  ...
  "required_tests": [
    {
      ...
      "expectation": "Run as a regression check after completing POST-SUBTASK-075; retain command, exit code, and relevant output.",
    ...
    },
    {
      ...
      "path": "artifacts/modeling/baseline_joint_gate.json",
  ...
  "risk_failure_conditions": [
    "The work would be invalid if any prerequisite artifact, source/data/code/config identity, or declared maturity differs from the pinned issue contract for POST-SUBTASK-075.",
    "A command may exit successfully while producing stale, partial, synthetic-only, leakage-contaminated, non-reproducible, or legally unusable evidence.",
    "Acceptance failure: the evidence cannot demonstrate that every run pins data/config/code/seed/runtime, fits recency/home-field/shrinkage only on permitted history, separates market lanes/cutoffs, and retains failed or negative trials.",
    ...
    "Acceptance failure: the evidence cannot demonstrate that candidates regenerate identical predictions within declared numerical limits and no model enters protected replay with reproducibility, range, orientation, coherence, or resource failures.",
  ...
  "specificity_fingerprint": "921d0ddf4b96a55ea902be930ebb0b883582197ab775187962b461525fdd7f7d",
  "stop_conditions": [
  ...
  "title": "[POST-SUBTASK-075] Validate artifacts, tuning predictions, orientation, distribution tails, score-margin-win coherence, runtime, and candidate admission",
  ...
  "work_packet_path": "jira/ai/work_packets/POST-SUBTASK-075.md",
...
1. The atomic scope in POST-SUBTASK-075 is completed without absorbing sibling work or weakening any protected requirement, control, split, judging rule, private-research publication boundary, or security boundary.
...
7. The Story gate consumes the complete prerequisite evidence set and issues an explicit downstream approval/block/reject/defer decision for POST-STORY-025.
