# AI Work Packet — POST-SUBTASK-137
...
1. `jira/records/issues/subtasks/POST-SUBTASK-137_execute_approved_source_acquisition_through_immutable_raw_entities_pit_features_.json`
2. `jira/sources/issue_source_manifests/POST-SUBTASK-137.json`
3. `jira/index/ISSUE_GOVERNANCE_CONTEXT.csv` row for `POST-SUBTASK-137`.
