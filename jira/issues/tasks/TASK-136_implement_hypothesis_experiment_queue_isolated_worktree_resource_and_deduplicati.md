<!-- GENERATED VIEW. Canonical record: jira/records/issues/tasks/TASK-136_implement_hypothesis_experiment_queue_isolated_worktree_resource_and_deduplicati.json -->
# TASK-136 — [TASK-136] Implement hypothesis/experiment queue, isolated worktree, resource and deduplication contracts
...
```json
{
  ...
  "acceptance_criteria": [
    "Stable ID TASK-136, parent EPIC-024, owner wave W18, and original status DONE are preserved.",
  ...
  "ai_context_notes": [
    ...
    "Corrected W18: explicit hypothesis lifecycle, duplicate prevention, failure typing, protected mutation scope and resource authorization."
  ],
  "allowed_modification_paths": [
    "hypothesis lifecycle + experiment queue + worktree/resource execution reference"
  ],
  "blocked_reason": "",
  "blocks": [
    "TASK-137"
  ],
  "canonical_record": "jira/records/issues/tasks/TASK-136_implement_hypothesis_experiment_queue_isolated_worktree_resource_and_deduplicati.json",
  ...
  "gap_ids": [],
  "generated_markdown": "jira/issues/tasks/TASK-136_implement_hypothesis_experiment_queue_isolated_worktree_resource_and_deduplicati.md",
  ...
  "operational_jira": {
    "assignee": "",
    "jira_issue_id": "24379",
    "jira_updated_at": "2026-08-09T00:40:41.745-0500",
  ...
  "prerequisites": [
    ...
    "Historical dependency TASK-135"
  ],
  "primary_source_refs": [
    "SRCREF-00169",
    "SRCREF-02116",
  ...
  "required_evidence": [
    "Authoritative WBS row TASK-136",
    "Existing artifact `hypothesis lifecycle + experiment queue + worktree/resource execution reference`"
  ],
  "required_tests": [
    {
  ...
  "specificity_fingerprint": "8ba0f432c50347ee29d5accf5b17b22e778cc12a5e8b144eba0c3bad01019743",
  "stop_conditions": [
  ...
  "title": "[TASK-136] Implement hypothesis/experiment queue, isolated worktree, resource and deduplication contracts",
...
Implement hypothesis/experiment queue, isolated worktree, resource and deduplication contracts
...
- Inherited from: None
- Resolution: `DIRECT`
- Effective counts: `{"acceptance_control_ids": 5, "adr_ids": 0, "gap_ids": 0, "requirement_ids": 10, "risk_ids": 0}`

## Acceptance Criteria

1. Stable ID TASK-136, parent EPIC-024, owner wave W18, and original status DONE are preserved.
