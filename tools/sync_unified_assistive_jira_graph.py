...
def specs() -> list[dict[str, Any]]:
    ...
    cursor["ai_context_notes"].append(
        "The user authorized a separate nontransferable USD 200 hard limit on 2026-08-12; only USD 20 is initially released. Both serial pilots executed candidate-only on 2026-08-13, settled a cumulative USD 0.65240990, and passed only with Codex review edits; the remaining real-unit campaign, bounded concurrency, utilization, and sustained-operation gates are pending, so Cursor is not operational."
    )
