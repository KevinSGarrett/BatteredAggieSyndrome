<!-- GENERATED VIEW. Canonical record: jira/records/issues/tasks/TASK-063_design_hierarchical_pooling_and_confound_controls.json -->
# TASK-063 — [TASK-063] Design hierarchical pooling and confound controls
...
```json
{
  ...
  "acceptance_criteria": [
    "Stable ID TASK-063, parent EPIC-011, owner wave W13, and original status DONE are preserved.",
  ...
  "allowed_modification_paths": [
    "coach-effect evaluation specification"
  ],
  "blocked_reason": "",
  "blocks": [
    "TASK-064"
  ],
  "canonical_record": "jira/records/issues/tasks/TASK-063_design_hierarchical_pooling_and_confound_controls.json",
  ...
  "gap_ids": [],
  "generated_markdown": "jira/issues/tasks/TASK-063_design_hierarchical_pooling_and_confound_controls.md",
  ...
  "objective": "Design hierarchical pooling and confound controls",
  "operational_jira": {
    "assignee": "",
    "jira_issue_id": "24306",
    "jira_updated_at": "2026-08-09T00:40:27.877-0500",
  ...
  "phase": "PHASE-2",
  "prerequisites": [
    "Historical dependency TASK-060",
    "Historical dependency TASK-062"
  ],
  "primary_source_refs": [
    "SRCREF-00096",
    "SRCREF-02116",
  ...
  "required_evidence": [
    "Authoritative WBS row TASK-063",
    "Existing artifact `coach-effect evaluation specification`"
  ],
  "required_tests": [
    {
  ...
  "specificity_fingerprint": "946730afc7f7e76402d8fbb4681eb8cac2235581ba0156621eaa437f8f80c9a2",
  "stop_conditions": [
  ...
  "title": "[TASK-063] Design hierarchical pooling and confound controls",
...
Design hierarchical pooling and confound controls
...
1. Stable ID TASK-063, parent EPIC-011, owner wave W13, and original status DONE are preserved.
