<!-- GENERATED VIEW. Canonical record: jira/records/issues/tasks/TASK-103_build_anti_circularity_leakage_tests_for_bas_labels.json -->
# TASK-103 — [TASK-103] Build anti-circularity/leakage tests for BAS labels
...
```json
{
  ...
  "acceptance_criteria": [
    "Stable ID TASK-103, parent EPIC-018, owner wave W15, and original status DONE are preserved.",
  ...
  "allowed_modification_paths": [
    "BAS protected test battery"
  ],
  "blocked_reason": "",
  "blocks": [
    "TASK-104"
  ],
  "canonical_record": "jira/records/issues/tasks/TASK-103_build_anti_circularity_leakage_tests_for_bas_labels.json",
  ...
  "gap_ids": [],
  "generated_markdown": "jira/issues/tasks/TASK-103_build_anti_circularity_leakage_tests_for_bas_labels.md",
  ...
  "objective": "Build anti-circularity/leakage tests for BAS labels",
  "operational_jira": {
    "assignee": "",
    "jira_issue_id": "24346",
    "jira_updated_at": "2026-08-09T00:40:35.549-0500",
  ...
  "phase": "PHASE-3",
  "prerequisites": [
    "Historical dependency TASK-101",
    "Historical dependency TASK-102"
  ],
  "primary_source_refs": [
    "SRCREF-00136",
    "SRCREF-02116",
  ...
  "required_evidence": [
    "Authoritative WBS row TASK-103",
    "Existing artifact `BAS protected test battery`"
  ],
  "required_tests": [
    {
  ...
  "specificity_fingerprint": "19fc768ad2fcb03f664f5cb47ff004bc4dda464cba071c89d7f146ea6438e6ee",
  "stop_conditions": [
  ...
  "title": "[TASK-103] Build anti-circularity/leakage tests for BAS labels",
...
Build anti-circularity/leakage tests for BAS labels
...
1. Stable ID TASK-103, parent EPIC-018, owner wave W15, and original status DONE are preserved.
