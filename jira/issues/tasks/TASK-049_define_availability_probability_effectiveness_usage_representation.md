<!-- GENERATED VIEW. Canonical record: jira/records/issues/tasks/TASK-049_define_availability_probability_effectiveness_usage_representation.json -->
# TASK-049 — [TASK-049] Define availability probability/effectiveness/usage representation
...
```json
{
  ...
  "acceptance_criteria": [
    "Stable ID TASK-049, parent EPIC-009, owner wave W12, and original status DONE are preserved.",
  ...
  "canonical_record": "jira/records/issues/tasks/TASK-049_define_availability_probability_effectiveness_usage_representation.json",
  ...
  "gap_ids": [],
  "generated_markdown": "jira/issues/tasks/TASK-049_define_availability_probability_effectiveness_usage_representation.md",
  ...
  "objective": "Define availability probability/effectiveness/usage representation",
  "operational_jira": {
    "assignee": "",
    "jira_issue_id": "24292",
    "jira_updated_at": "2026-08-09T00:40:24.977-0500",
  ...
  "phase": "PHASE-2",
  "prerequisites": [
    "Historical dependency TASK-047"
  ],
  "primary_source_refs": [
    "SRCREF-00082",
    "SRCREF-02116",
  ...
  "required_evidence": [
    "Authoritative WBS row TASK-049",
    "Existing artifact `availability state contract`"
  ],
  "required_tests": [
    {
  ...
  "specificity_fingerprint": "1795132f20147a980400cb567f399b49e5685bed576b302bc18a4bd69dc0bf33",
  "stop_conditions": [
  ...
  "title": "[TASK-049] Define availability probability/effectiveness/usage representation",
...
Define availability probability/effectiveness/usage representation
...
1. Stable ID TASK-049, parent EPIC-009, owner wave W12, and original status DONE are preserved.
