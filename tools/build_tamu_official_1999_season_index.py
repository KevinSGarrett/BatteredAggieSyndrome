...
from aggie_analytics.data.tamu_official_1999_season_index import materialize  # noqa: E402


def main() -> int:
    parser = argparse.ArgumentParser(
        description="Capture the official 1999 SRC-014 season index and discover box URLs."
    )
    parser.add_argument(
