...
class StatCrewLakeTests(unittest.TestCase):
    def test_committed_gate_reconstructs(self) -> None:
        ...
        self.assertEqual(result["payload_identity"], "c7e061fcafa480f260b8f614ae6481747502ba5d933a786f584da442039fc338")
        gate = json.loads((REPO_ROOT / GATE_RELATIVE).read_text(encoding="utf-8-sig"))
        self.assertEqual(gate["gate_identity"], "ed2ce7b95bd046a282116cf50aff84fec1e585f8dee848cc4451bec63bdf668c")
