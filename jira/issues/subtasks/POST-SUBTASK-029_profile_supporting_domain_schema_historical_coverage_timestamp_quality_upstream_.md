...
# POST-SUBTASK-029 — [POST-SUBTASK-029] Profile supporting-domain schema, historical coverage, timestamp quality, upstream lineage, and nonblocking source-policy metadata
...
```json
{
  ...
  "ai_context_notes": [
    ...
    "Read the exact source sections in `jira/sources/issue_source_manifests/POST-SUBTASK-029.json`; inspect only the listed implementation files and prerequisite outputs.",
  ...
  "completion_evidence_contract": {
    ...
    "downstream_consumer": "POST-SUBTASK-030",
  ...
  "critical_path": true,
  "definition_of_done": [
    "The atomic scope in POST-SUBTASK-029 is completed without absorbing sibling work or weakening any protected requirement, control, split, judging rule, private-research publication boundary, or security boundary.",
  ...
  "end_to_end_validation": "Validate that `artifacts/data_lake/context_population_profile.json` can be parsed and consumed by `POST-SUBTASK-030` using only documented identities and interfaces; the consumer must reject missing, stale, schema-incompatible, technically or quality-ineligible, or provenance-incomplete input without manual repair.",
  ...
  "gap_ids": [],
  "generated_markdown": "jira/issues/subtasks/POST-SUBTASK-029_profile_supporting_domain_schema_historical_coverage_timestamp_quality_upstream_.md",
  "governance_review_required": false,
  "governance_traceability_gate": "POST-SUBTASK-033",
  "historical_classification": "ACTIONABLE_POST_WAVE",
  "import_id": 100333,
  "in_scope": [
    "Perform the exact action: Profile supporting-domain schema, historical coverage, timestamp quality, upstream lineage, and nonblocking source-policy metadata.",
  ...
  "objective": "Profile supporting-domain schema, historical coverage, timestamp quality, upstream lineage, and nonblocking source-policy metadata",
  "operational_jira": {
    "assignee": "",
    "jira_issue_id": "24519",
    "jira_updated_at": "2026-08-09T16:44:41.563-0500",
    "last_synced_at": "2026-08-09T21:46:00.291835+00:00",
    "source_export": "C:\\BatteredAggieSyndrome.data\\runtime\\BAT-379\\BAT-379-live-row.csv",
    "sprint": "",
    "status_raw": "Done"
  },
  "out_of_scope": [
    ...
    "Work assigned to sibling subtasks: Expand immutable national core and supporting-domain history to the maximum quality-supported seasons; Gate domain-by-domain production, experimental, conditional, rejected, or unavailable eligibility.",
  ...
  "required_tests": [
    {
      ...
      "expectation": "Run as a regression check after completing POST-SUBTASK-029; retain command, exit code, and relevant output.",
  ...
  "risk_ids": [],
  "schema_version": 2,
  "scope": "Execute the atomic 2 of 3 step in Story POST-STORY-010 (Historical expansion across core and supporting domains): Profile supporting-domain schema, historical coverage, timestamp quality, upstream lineage, and nonblocking source-policy metadata. Consume only verified prerequisite outputs from `POST-SUBTASK-027`, `POST-SUBTASK-028`. Produce `artifacts/data_lake/context_population_profile.json`; evaluate every issue-specific acceptance condition; preserve negative results; and hand the pinned output to POST-SUBTASK-030.",
  "source_ids": [
    "GAP-002",
    "GAP-006",
    "GAP-010",
  ...
  "specificity_fingerprint": "6c8fb17a1e870cd8aa0fa395692cfe77b4cf3af2ee534f21879693477deb5f6d",
  "stop_conditions": [
  ...
  "title": "[POST-SUBTASK-029] Profile supporting-domain schema, historical coverage, timestamp quality, upstream lineage, and nonblocking source-policy metadata",
...
Execute the atomic 2 of 3 step in Story POST-STORY-010 (Historical expansion across core and supporting domains): Profile supporting-domain schema, historical coverage, timestamp quality, upstream lineage, and nonblocking source-policy metadata. Consume only verified prerequisite outputs from `POST-SUBTASK-027`, `POST-SUBTASK-028`. Produce `artifacts/data_lake/context_population_profile.json`; evaluate every issue-specific acceptance condition; preserve negative results; and hand the pinned output to POST-SUBTASK-030.
...
1. The atomic scope in POST-SUBTASK-029 is completed without absorbing sibling work or weakening any protected requirement, control, split, judging rule, private-research publication boundary, or security boundary.
