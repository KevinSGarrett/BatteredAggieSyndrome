<!-- GENERATED VIEW. Canonical record: jira/records/issues/tasks/TASK-137_implement_immutable_judging_rule_boundary.json -->
# TASK-137 — [TASK-137] Implement immutable judging-rule boundary
...
```json
{
  ...
  "acceptance_criteria": [
    "Stable ID TASK-137, parent EPIC-024, owner wave W18, and original status DONE are preserved.",
  ...
  "ai_context_notes": [
    ...
    "Corrected W18: protected judging rules remain immutable inputs to all experiment/tournament execution."
  ],
  ...
  "canonical_record": "jira/records/issues/tasks/TASK-137_implement_immutable_judging_rule_boundary.json",
  ...
  "gap_ids": [],
  "generated_markdown": "jira/issues/tasks/TASK-137_implement_immutable_judging_rule_boundary.md",
  ...
  "objective": "Implement immutable judging-rule boundary",
  "operational_jira": {
    "assignee": "",
    "jira_issue_id": "24380",
    "jira_updated_at": "2026-08-09T00:40:42.291-0500",
  ...
  "phase": "PHASE-4",
  "prerequisites": [
    "Historical dependency TASK-136",
  ...
  "required_evidence": [
    "Authoritative WBS row TASK-137",
    "Existing artifact `protected evaluator separation tests + W17 hash-seal verification CLI`"
  ],
  "required_tests": [
    {
  ...
  "specificity_fingerprint": "925f2d1a87a2e1c991bbdf3be24ef839eb11b0ebfae65143d0bbb15f99c59e6a",
  "stop_conditions": [
  ...
  "title": "[TASK-137] Implement immutable judging-rule boundary",
...
Implement immutable judging-rule boundary
...
1. Stable ID TASK-137, parent EPIC-024, owner wave W18, and original status DONE are preserved.
