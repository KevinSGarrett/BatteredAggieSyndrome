<!-- GENERATED VIEW. Canonical record: jira/records/issues/epics/EPIC-009_player_roster_depth_and_availability_state.json -->
# EPIC-009 — [EPIC-009] Player, roster, depth and availability state
...
```json
{
  ...
  "acceptance_criteria": [
    "The epic retains stable ID EPIC-009, owner wave W12, phase PHASE-2, and all authoritative WBS children.",
  ...
  "blocked_reason": "",
  "blocks": [],
  "canonical_record": "jira/records/issues/epics/EPIC-009_player_roster_depth_and_availability_state.json",
  ...
  "gap_ids": [],
  "generated_markdown": "jira/issues/epics/EPIC-009_player_roster_depth_and_availability_state.md",
  ...
  "operational_jira": {
    "assignee": "",
    "jira_issue_id": "24149",
    "jira_updated_at": "2026-08-09T00:40:11.243-0500",
  ...
  "specificity_fingerprint": "fba22de87b689a31ce9a3a555e8b69147b8075130b91a290178fe2f1e6d2eea4",
  "stop_conditions": [
    "Stop if a proposed update renumbers the historical epic or rewrites its original wave provenance."
  ],
  "supporting_source_refs": [],
  "title": "[EPIC-009] Player, roster, depth and availability state",
...
Represent player value, depth, availability, usage, replacement and uncertainty at prediction time.
...
1. The epic retains stable ID EPIC-009, owner wave W12, phase PHASE-2, and all authoritative WBS children.
