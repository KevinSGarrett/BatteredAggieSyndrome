...
```json
{
  ...
  "critical_path": false,
  "definition_of_done": [
    "The atomic scope in POST-SUBTASK-119 is completed without absorbing sibling work or weakening any protected requirement, control, split, judging rule, rights decision, or security boundary.",
  ...
  "end_to_end_validation": "Validate that `artifacts/product/bas_presentation_validation.json` can be parsed and consumed by `POST-SUBTASK-120` using only documented identities and interfaces; the consumer must reject missing, stale, schema-incompatible, rights-blocked, or provenance-incomplete input without manual repair.",
  ...
  "operational_jira": {
    "assignee": "",
    "jira_issue_id": "24609",
    "jira_updated_at": "2026-08-09T00:04:04.206-0500",
  ...
  "specificity_fingerprint": "af2c78c7eea09bc2409302248e4b7557842435e35bc4f62ed98c2315b3d42233",
  "stop_conditions": [
...
1. The atomic scope in POST-SUBTASK-119 is completed without absorbing sibling work or weakening any protected requirement, control, split, judging rule, rights decision, or security boundary.
