<!-- GENERATED VIEW. Canonical record: jira/records/issues/tasks/TASK-002_execute_multi_pass_domain_and_source_discovery.json -->
# TASK-002 — [TASK-002] Execute multi-pass domain and source discovery
...
```json
{
  ...
  "acceptance_criteria": [
    "Stable ID TASK-002, parent EPIC-001, owner wave W06, and original status DONE are preserved.",
  ...
  "canonical_record": "jira/records/issues/tasks/TASK-002_execute_multi_pass_domain_and_source_discovery.json",
  ...
  "gap_ids": [],
  "generated_markdown": "jira/issues/tasks/TASK-002_execute_multi_pass_domain_and_source_discovery.md",
  ...
  "operational_jira": {
    "assignee": "",
    "jira_issue_id": "24245",
    "jira_updated_at": "2026-08-09T00:40:15.871-0500",
  ...
  "phase": "PHASE-1",
  "prerequisites": [
    "Historical dependency TASK-001"
  ],
  "primary_source_refs": [
    "SRCREF-00035",
    "SRCREF-02116",
  ...
  "required_evidence": [
    "Authoritative WBS row TASK-002",
    "Existing artifact `docs/data_research/w06/DATA_DOMAIN_COVERAGE_MATRIX.csv`",
    "Existing artifact `docs/data_research/w06/DATA_UNIVERSE_MASTER.csv`"
  ],
  "required_tests": [
    {
  ...
  "specificity_fingerprint": "adfb68f64ac47c762f337f860230dc82822172830a01171528064b343b90b08a",
  "stop_conditions": [
  ...
  "title": "[TASK-002] Execute multi-pass domain and source discovery",
...
Execute multi-pass domain and source discovery
...
1. Stable ID TASK-002, parent EPIC-001, owner wave W06, and original status DONE are preserved.
