...
```json
{
  ...
  "critical_path": true,
  "definition_of_done": [
    "The atomic scope in POST-SUBTASK-021 is completed without absorbing sibling work or weakening any protected requirement, control, split, judging rule, private-research publication boundary, or security boundary.",
  ...
  "risk_failure_conditions": [
    ...
    "Acceptance failure: the evidence cannot demonstrate that every source is READY, TECHNICAL_VALIDATION_PENDING, TECHNICAL_CREDENTIAL_UNAVAILABLE, or quality-quarantined with a concrete reason.",
    "Acceptance failure: the evidence cannot demonstrate that downstream materialization tasks consume this readiness file.",
    "Acceptance failure: the evidence cannot demonstrate that no source is blocked by licensing, redistribution, scraping, terms, provider preference, or upstream-authorization uncertainty."
  ],
  "risk_ids": [],
  "schema_version": 2,
  ...
  "specificity_fingerprint": "797fbd74a6582eea7e865cfc9176ab1a17da60712f9edb935f40eafad247cdbb",
  "stop_conditions": [
...
1. The atomic scope in POST-SUBTASK-021 is completed without absorbing sibling work or weakening any protected requirement, control, split, judging rule, private-research publication boundary, or security boundary.
