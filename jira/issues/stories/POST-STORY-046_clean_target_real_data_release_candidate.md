<!-- GENERATED VIEW. Canonical record: jira/records/issues/stories/POST-STORY-046_clean_target_real_data_release_candidate.json -->
# POST-STORY-046 — [POST-STORY-046] Clean-target real-data release candidate
...
```json
{
  ...
  "allowed_modification_paths": [
    "artifacts/jira_evidence/POST-STORY-046.json"
  ],
  "blocked_reason": "",
  "blocks": [],
  "canonical_record": "jira/records/issues/stories/POST-STORY-046_clean_target_real_data_release_candidate.json",
  "canonical_source_role": "AUTHORITATIVE_LOCAL_SPECIFICATION",
  "completion_evidence_contract": {
    "all_child_evidence_required": true,
    "child_gate": "POST-SUBTASK-138",
  ...
  "critical_path": false,
  "definition_of_done": [
    "All child subtasks POST-SUBTASK-136, POST-SUBTASK-137, POST-SUBTASK-138 have verified evidence or an explicit accepted-risk/deferred/cancelled disposition consistent with the Story contract.",
    "The final gate `POST-SUBTASK-138` completes and proves the Story end-to-end requirement; closing implementation children alone is insufficient.",
  ...
  "end_to_end_validation": "A clean authoritative target host runs the signed real-data product from acquisition to dashboard and proves reproducibility, rollback, resource, security, and scientific integrity.",
  "epic_id": "POST-EPIC-015",
  "evidence_manifest_path": "artifacts/jira_evidence/POST-STORY-046.json",
  ...
  "gap_ids": [],
  "generated_markdown": "jira/issues/stories/POST-STORY-046_clean_target_real_data_release_candidate.md",
  ...
  "local_id": "POST-STORY-046",
  "maturity_before": "DESIGN_ONLY",
  "objective": "Execute the complete production chain and product consumption from a clean target-machine checkout.",
  "operational_jira": {
    "assignee": "",
    "jira_issue_id": "24236",
    "jira_updated_at": "2026-08-09T23:23:58.809-0500",
  ...
  "phase": "PHASE-5",
  "prerequisites": [
    "Hard dependency POST-SUBTASK-135",
  ...
  "related_to": [],
  "required_evidence": [
    "Verified child completion/evidence manifests for POST-SUBTASK-136, POST-SUBTASK-137, POST-SUBTASK-138.",
    "Final gate decision from `POST-SUBTASK-138` with criterion-by-criterion PASS/FAIL/BLOCKED outcomes and output hashes.",
  ...
  "required_tests": [
    ...
    },
    {
      ...
      "expectation": "The final child gate `POST-SUBTASK-138` must prove the integrated Story outcome and downstream-consumable output.",
  ...
  "risk_ids": [],
  "schema_version": 2,
  "scope": "Deliver Story POST-STORY-046 (Clean-target real-data release candidate) as one coherent, gated capability inside Epic POST-EPIC-015. Execute child subtasks POST-SUBTASK-136, POST-SUBTASK-137, POST-SUBTASK-138 in dependency order, reconcile their pinned outputs, and require the final gate `POST-SUBTASK-138` to issue an evidence-backed approve/block/reject/defer decision before any downstream use.",
  "source_ids": [
    "AC-038",
    "GAP-001",
    "GAP-012",
  ...
  "specificity_fingerprint": "2c4af8cf9c5575d974fd77ca0feca01f455980585c0850a312690f7ba91fb1e8",
  "stop_conditions": [
  ...
  "title": "[POST-STORY-046] Clean-target real-data release candidate",
  ...
  "work_packet_path": "jira/ai/work_packets/POST-STORY-046.md",
...
Execute the complete production chain and product consumption from a clean target-machine checkout.
...
Deliver Story POST-STORY-046 (Clean-target real-data release candidate) as one coherent, gated capability inside Epic POST-EPIC-015. Execute child subtasks POST-SUBTASK-136, POST-SUBTASK-137, POST-SUBTASK-138 in dependency order, reconcile their pinned outputs, and require the final gate `POST-SUBTASK-138` to issue an evidence-backed approve/block/reject/defer decision before any downstream use.
...
1. All child subtasks POST-SUBTASK-136, POST-SUBTASK-137, POST-SUBTASK-138 have verified evidence or an explicit accepted-risk/deferred/cancelled disposition consistent with the Story contract.
2. The final gate `POST-SUBTASK-138` completes and proves the Story end-to-end requirement; closing implementation children alone is insufficient.
...
- **END_TO_END** / `END_TO_END` — `POST-SUBTASK-138` — The final child gate `POST-SUBTASK-138` must prove the integrated Story outcome and downstream-consumable output.
...
A clean authoritative target host runs the signed real-data product from acquisition to dashboard and proves reproducibility, rollback, resource, security, and scientific integrity.
