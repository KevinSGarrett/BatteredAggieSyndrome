<!-- GENERATED VIEW. Canonical record: jira/records/issues/epics/POST-EPIC-001_target_environment_reproducibility_and_ac_038_hardware_evidence.json -->
# POST-EPIC-001 — [POST-EPIC-001] Target environment, reproducibility, and AC-038 hardware evidence
...
```json
{
  ...
  "blocked_reason": "",
  "blocks": [],
  "canonical_record": "jira/records/issues/epics/POST-EPIC-001_target_environment_reproducibility_and_ac_038_hardware_evidence.json",
  ...
  "critical_path": true,
  "definition_of_done": [
    "Every child Story POST-STORY-001, POST-STORY-002, POST-STORY-003, POST-STORY-004 is completed through its explicit end-to-end gate or has an explicit accepted-risk/deferred/cancelled disposition consistent with release governance.",
  ...
  "end_to_end_validation": "Exercise all child Story gates for Target environment, reproducibility, and AC-038 hardware evidence and prove the integrated capability is safe and consumable by its downstream Epic/release path.",
  "epic_id": "",
  "evidence_manifest_path": "artifacts/jira_evidence/POST-EPIC-001.json",
  ...
  "gap_ids": [],
  "generated_markdown": "jira/issues/epics/POST-EPIC-001_target_environment_reproducibility_and_ac_038_hardware_evidence.md",
  ...
  "local_id": "POST-EPIC-001",
  "maturity_before": "FUNCTIONAL_STARTER",
  "objective": "Establish an authoritative, reproducible local execution environment and evidence-backed resource envelope on the declared target Windows hardware.",
  "operational_jira": {
    "assignee": "",
    "jira_issue_id": "24174",
    "jira_updated_at": "2026-08-08T23:36:53.758-0500",
  ...
  "required_tests": [
    {
      ...
      "expectation": "Story gate `POST-SUBTASK-003` must complete with verified evidence before Epic completion.",
      "path": "POST-SUBTASK-003",
      "validation_class": "END_TO_END"
    },
    {
      "classification": "END_TO_END",
      "expectation": "Story gate `POST-SUBTASK-006` must complete with verified evidence before Epic completion.",
      "path": "POST-SUBTASK-006",
      "validation_class": "END_TO_END"
    },
    {
      "classification": "END_TO_END",
      "expectation": "Story gate `POST-SUBTASK-009` must complete with verified evidence before Epic completion.",
      "path": "POST-SUBTASK-009",
      "validation_class": "END_TO_END"
    },
    {
      "classification": "END_TO_END",
      "expectation": "Story gate `POST-SUBTASK-012` must complete with verified evidence before Epic completion.",
  ...
  "risk_ids": [],
  "schema_version": 2,
  "scope": "All Stories and Subtasks under this Epic for the environment domain, including its explicit integrated completion gate.",
  "source_ids": [
    "GAP-001",
    "HANDOFF-001"
  ],
  ...
  "specificity_fingerprint": "cb9e1318e3fe1cae67729b4f2459df05c0790f563a40128807e07e9cf5f83fb6",
  "stop_conditions": [
  ...
  "title": "[POST-EPIC-001] Target environment, reproducibility, and AC-038 hardware evidence",
  ...
  "work_packet_path": "jira/ai/work_packets/POST-EPIC-001.md",
...
1. Every child Story POST-STORY-001, POST-STORY-002, POST-STORY-003, POST-STORY-004 is completed through its explicit end-to-end gate or has an explicit accepted-risk/deferred/cancelled disposition consistent with release governance.
...
Exercise all child Story gates for Target environment, reproducibility, and AC-038 hardware evidence and prove the integrated capability is safe and consumable by its downstream Epic/release path.
