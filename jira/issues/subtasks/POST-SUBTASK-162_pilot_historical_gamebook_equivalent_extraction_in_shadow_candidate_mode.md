<!-- GENERATED VIEW. Canonical record: jira/records/issues/subtasks/POST-SUBTASK-162_pilot_historical_gamebook_equivalent_extraction_in_shadow_candidate_mode.json -->
# POST-SUBTASK-162 — [POST-SUBTASK-162] Pilot historical gamebook-equivalent extraction in shadow candidate mode
...
```json
{
  ...
  "acceptance_criteria": [
    "A pinned human/deterministic gold sample covers drives, plays, box scores, roster/starter facts, venue, officials, weather, attendance, and source metadata with exact evidence locators.",
    "Terra capable reference is compared with Luna; only empirically validated routine formats may be proposed for Luna Batch and only ambiguous residue may reach Terra/Sol.",
    "Accepted candidates retain exact source/capture evidence and pass deterministic schema, provenance, identity, PIT, leakage, and domain validation with zero unsupported facts."
  ],
  "adr_ids": [],
  "ai_context_notes": [
    "Canonical contract source is `SRCREF-02119`. Read `jira/sources/issue_source_manifests/POST-SUBTASK-162.json` before execution.",
  ...
  "allowed_modification_paths": [
    ...
    "artifacts/openai_assist/gamebook_pilot.json",
  ...
  "canonical_record": "jira/records/issues/subtasks/POST-SUBTASK-162_pilot_historical_gamebook_equivalent_extraction_in_shadow_candidate_mode.json",
  ...
  "gap_ids": [],
  "generated_markdown": "jira/issues/subtasks/POST-SUBTASK-162_pilot_historical_gamebook_equivalent_extraction_in_shadow_candidate_mode.md",
  "governance_review_required": false,
  "governance_traceability_gate": "POST-SUBTASK-162",
  "historical_classification": "ACTIONABLE_POST_WAVE",
  "import_id": 100470,
  "in_scope": [
    "Perform the exact action: Pilot historical gamebook-equivalent extraction in shadow candidate mode.",
  ...
  "operational_jira": {
    "assignee": "",
    "jira_issue_id": "24658",
    "jira_updated_at": "2026-08-11T01:07:02.372-0500",
  ...
  "record_revision": "2.0",
  "required_evidence": [
    "`artifacts/jira_evidence/POST-SUBTASK-162.json` with one evidence row per acceptance criterion and exact artifact hashes.",
  ...
  "required_tests": [
    ...
    },
    {
      ...
      "expectation": "Extract a bounded real historical gamebook sample through the controller, validate every fact against exact source evidence, and measure accepted records, review time, quarantines, cost, and unsupported-fact rate without canonical mutation.",
      "path": "artifacts/jira_evidence/POST-SUBTASK-162.json",
  ...
  "risk_ids": [],
  "schema_version": 2,
  "scope": "Execute POST-SUBTASK-162 within the optional OpenAI assistive plane. Consume `POST-SUBTASK-161`, `POST-SUBTASK-028`; produce `artifacts/openai_assist/gamebook_pilot.json`, `artifacts/jira_evidence/POST-SUBTASK-162.json`; preserve the deterministic forecast path and candidate-only authority boundary.",
  "source_ids": [
    "OPENAI-ASSIST-PLAN"
  ],
  "source_refs": [
...
Pilot historical gamebook-equivalent extraction in shadow candidate mode
...
Execute POST-SUBTASK-162 within the optional OpenAI assistive plane. Consume `POST-SUBTASK-161`, `POST-SUBTASK-028`; produce `artifacts/openai_assist/gamebook_pilot.json`, `artifacts/jira_evidence/POST-SUBTASK-162.json`; preserve the deterministic forecast path and candidate-only authority boundary.
...
1. A pinned human/deterministic gold sample covers drives, plays, box scores, roster/starter facts, venue, officials, weather, attendance, and source metadata with exact evidence locators.
2. Terra capable reference is compared with Luna; only empirically validated routine formats may be proposed for Luna Batch and only ambiguous residue may reach Terra/Sol.
3. Accepted candidates retain exact source/capture evidence and pass deterministic schema, provenance, identity, PIT, leakage, and domain validation with zero unsupported facts.
...
- **END_TO_END** / `END_TO_END` — `artifacts/jira_evidence/POST-SUBTASK-162.json` — Extract a bounded real historical gamebook sample through the controller, validate every fact against exact source evidence, and measure accepted records, review time, quarantines, cost, and unsupported-fact rate without canonical mutation.
...
Extract a bounded real historical gamebook sample through the controller, validate every fact against exact source evidence, and measure accepted records, review time, quarantines, cost, and unsupported-fact rate without canonical mutation.
