<!-- GENERATED VIEW. Canonical record: jira/records/issues/epics/EPIC-025_model_calibration_and_forecast_starter_implementation.json -->
# EPIC-025 — [EPIC-025] Model, calibration and forecast starter implementation
...
```json
{
  ...
  "acceptance_criteria": [
    "The epic retains stable ID EPIC-025, owner wave W20, phase PHASE-4, and all authoritative WBS children.",
  ...
  "blocked_reason": "",
  "blocks": [],
  "canonical_record": "jira/records/issues/epics/EPIC-025_model_calibration_and_forecast_starter_implementation.json",
  ...
  "gap_ids": [],
  "generated_markdown": "jira/issues/epics/EPIC-025_model_calibration_and_forecast_starter_implementation.md",
  ...
  "objective": "Implement selected baseline/boosting/score/calibration/ensemble/uncertainty interfaces without fabricated performance.",
  "operational_jira": {
    "assignee": "",
    "jira_issue_id": "24165",
    "jira_updated_at": "2026-08-09T00:40:14.519-0500",
  ...
  "specificity_fingerprint": "6eb3188c6fc344615c49a1c8063ecb810de16c91ec312d8f83904b67ea62b74d",
  "stop_conditions": [
    "Stop if a proposed update renumbers the historical epic or rewrites its original wave provenance."
  ],
  "supporting_source_refs": [],
  "title": "[EPIC-025] Model, calibration and forecast starter implementation",
...
Implement selected baseline/boosting/score/calibration/ensemble/uncertainty interfaces without fabricated performance.
...
1. The epic retains stable ID EPIC-025, owner wave W20, phase PHASE-4, and all authoritative WBS children.
