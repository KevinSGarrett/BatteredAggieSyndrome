<!-- GENERATED VIEW. Canonical record: jira/records/issues/subtasks/POST-SUBTASK-106_wire_approved_adapters_through_immutable_raw_capture_normalization_entities_pit_.json -->
# POST-SUBTASK-106 — [POST-SUBTASK-106] Wire approved adapters through immutable raw capture, normalization, entities, PIT state, features, approved model, calibration, and prediction
...
```json
{
  ...
  "ai_context_notes": [
    ...
    "Read the exact source sections in `jira/sources/issue_source_manifests/POST-SUBTASK-106.json`; inspect only the listed implementation files and prerequisite outputs.",
  ...
  "blocked_reason": "UNSATISFIED_HARD_DEPENDENCIES: POST-SUBTASK-024;POST-SUBTASK-105",
  "blocks": [
    "POST-SUBTASK-107",
    "POST-SUBTASK-108"
  ],
  "canonical_record": "jira/records/issues/subtasks/POST-SUBTASK-106_wire_approved_adapters_through_immutable_raw_capture_normalization_entities_pit_.json",
  "canonical_source_role": "AUTHORITATIVE_LOCAL_SPECIFICATION",
  "completion_evidence_contract": {
    "acceptance_matrix_required": true,
    "artifact_hashes_required": true,
    "completion_claim_limit": "IMPLEMENTED",
    "downstream_consumer": "POST-SUBTASK-107",
  ...
  "critical_path": false,
  "definition_of_done": [
    "The atomic scope in POST-SUBTASK-106 is completed without absorbing sibling work or weakening any protected requirement, control, split, judging rule, private-research publication boundary, or security boundary.",
    ...
    "The output set `artifacts/mlops/weekly_pipeline_integration.json` is demonstrably consumable by POST-SUBTASK-107 without manual reconstruction or undocumented state."
  ],
  "dependencies": [
    "POST-SUBTASK-024",
    "POST-SUBTASK-105"
  ...
  "end_to_end_validation": "Validate that `artifacts/mlops/weekly_pipeline_integration.json` can be parsed and consumed by `POST-SUBTASK-107` using only documented identities and interfaces; the consumer must reject missing, stale, schema-incompatible, technically or quality-ineligible, or provenance-incomplete input without manual repair.",
  "epic_id": "POST-EPIC-012",
  "evidence_manifest_path": "artifacts/jira_evidence/POST-SUBTASK-106.json",
  ...
  "gap_ids": [],
  "generated_markdown": "jira/issues/subtasks/POST-SUBTASK-106_wire_approved_adapters_through_immutable_raw_capture_normalization_entities_pit_.md",
  ...
  "local_id": "POST-SUBTASK-106",
  "maturity_before": "FUNCTIONAL_STARTER",
  "objective": "Wire approved adapters through immutable raw capture, normalization, entities, PIT state, features, approved model, calibration, and prediction",
  "operational_jira": {
    "assignee": "",
    "jira_issue_id": "24596",
    "jira_updated_at": "2026-08-09T23:24:10.381-0500",
  ...
  "required_tests": [
    {
      ...
      "expectation": "Run as a regression check after completing POST-SUBTASK-106; retain command, exit code, and relevant output.",
    ...
    },
    {
      ...
      "path": "artifacts/mlops/weekly_pipeline_integration.json",
  ...
  "risk_failure_conditions": [
    "The work would be invalid if any prerequisite artifact, source/data/code/config identity, or declared maturity differs from the pinned issue contract for POST-SUBTASK-106.",
    ...
    "Acceptance failure: the evidence cannot demonstrate that the declared output `artifacts/mlops/weekly_pipeline_integration.json` is produced with deterministic identity, provenance, and validation metadata appropriate to this work.",
  ...
  "specificity_fingerprint": "844fb9391ea76422a5df2c32a67d802df3f8b907cf3dbaa29945d8ba49f38632",
  "stop_conditions": [
  ...
  "title": "[POST-SUBTASK-106] Wire approved adapters through immutable raw capture, normalization, entities, PIT state, features, approved model, calibration, and prediction",
  ...
  "work_packet_path": "jira/ai/work_packets/POST-SUBTASK-106.md",
...
1. The atomic scope in POST-SUBTASK-106 is completed without absorbing sibling work or weakening any protected requirement, control, split, judging rule, private-research publication boundary, or security boundary.
...
7. The output set `artifacts/mlops/weekly_pipeline_integration.json` is demonstrably consumable by POST-SUBTASK-107 without manual reconstruction or undocumented state.
...
Validate that `artifacts/mlops/weekly_pipeline_integration.json` can be parsed and consumed by `POST-SUBTASK-107` using only documented identities and interfaces; the consumer must reject missing, stale, schema-incompatible, technically or quality-ineligible, or provenance-incomplete input without manual repair.
