# AI Work Packet — POST-SUBTASK-099
...
1. `jira/records/issues/subtasks/POST-SUBTASK-099_authorize_or_block_the_exact_sealed_protected_evaluation_run.json`
2. `jira/sources/issue_source_manifests/POST-SUBTASK-099.json`
3. `jira/index/ISSUE_GOVERNANCE_CONTEXT.csv` row for `POST-SUBTASK-099`.
