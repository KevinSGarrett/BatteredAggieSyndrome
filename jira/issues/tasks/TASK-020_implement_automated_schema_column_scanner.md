<!-- GENERATED VIEW. Canonical record: jira/records/issues/tasks/TASK-020_implement_automated_schema_column_scanner.json -->
# TASK-020 — [TASK-020] Implement automated schema/column scanner
...
```json
{
  ...
  "acceptance_criteria": [
    "Stable ID TASK-020, parent EPIC-004, owner wave W09, and original status DONE are preserved.",
  ...
  "canonical_record": "jira/records/issues/tasks/TASK-020_implement_automated_schema_column_scanner.json",
  ...
  "gap_ids": [],
  "generated_markdown": "jira/issues/tasks/TASK-020_implement_automated_schema_column_scanner.md",
  ...
  "phase": "PHASE-1",
  "prerequisites": [
    "Historical dependency TASK-019"
  ],
  "primary_source_refs": [
    "SRCREF-00053",
    "SRCREF-02116",
  ...
  "required_evidence": [
    "Authoritative WBS row TASK-020",
    "Existing artifact `field inventory generator`",
    "Existing artifact `schema scanner`"
  ],
  "required_tests": [
    {
  ...
  "specificity_fingerprint": "c3e2c50e00f0435ad9579bfb35026a0ae9d2276599907ac1078553a08ad635ed",
  "stop_conditions": [
  ...
  "title": "[TASK-020] Implement automated schema/column scanner",
...
Implement automated schema/column scanner
...
1. Stable ID TASK-020, parent EPIC-004, owner wave W09, and original status DONE are preserved.
