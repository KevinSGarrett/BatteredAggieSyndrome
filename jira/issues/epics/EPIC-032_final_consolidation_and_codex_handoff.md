<!-- GENERATED VIEW. Canonical record: jira/records/issues/epics/EPIC-032_final_consolidation_and_codex_handoff.json -->
# EPIC-032 — [EPIC-032] Final consolidation and Codex handoff
...
```json
{
  ...
  "acceptance_criteria": [
    "The epic retains stable ID EPIC-032, owner wave W25, phase PHASE-5, and all authoritative WBS children.",
  ...
  "blocked_reason": "",
  "blocks": [],
  "canonical_record": "jira/records/issues/epics/EPIC-032_final_consolidation_and_codex_handoff.json",
  ...
  "gap_ids": [],
  "generated_markdown": "jira/issues/epics/EPIC-032_final_consolidation_and_codex_handoff.md",
  ...
  "objective": "Audit all requirements/ADRs/data/PIT/features/models/acceptance and deliver the final canonical repository and implementation priority.",
  "operational_jira": {
    "assignee": "",
    "jira_issue_id": "24172",
    "jira_updated_at": "2026-08-09T00:40:15.488-0500",
  ...
  "specificity_fingerprint": "b13aaf2c6884b7ee0b53851a8260e305dcafe376e957bff3513117502ecfd824",
  "stop_conditions": [
    "Stop if a proposed update renumbers the historical epic or rewrites its original wave provenance."
  ],
  "supporting_source_refs": [],
  "title": "[EPIC-032] Final consolidation and Codex handoff",
...
Audit all requirements/ADRs/data/PIT/features/models/acceptance and deliver the final canonical repository and implementation priority.
...
1. The epic retains stable ID EPIC-032, owner wave W25, phase PHASE-5, and all authoritative WBS children.
