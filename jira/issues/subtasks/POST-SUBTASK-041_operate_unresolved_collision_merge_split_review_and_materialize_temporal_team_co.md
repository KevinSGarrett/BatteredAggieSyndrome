...
```json
{
  ...
  "critical_path": true,
  "definition_of_done": [
    "The atomic scope in POST-SUBTASK-041 is completed without absorbing sibling work or weakening any protected requirement, control, split, judging rule, rights decision, or security boundary.",
  ...
  "end_to_end_validation": "Validate that `artifacts/entities/entity_decision_and_transition_log.jsonl` can be parsed and consumed by `POST-SUBTASK-042` using only documented identities and interfaces; the consumer must reject missing, stale, schema-incompatible, rights-blocked, or provenance-incomplete input without manual repair.",
  ...
  "operational_jira": {
    "assignee": "",
    "jira_issue_id": "24531",
    "jira_updated_at": "2026-08-09T00:03:34.454-0500",
  ...
  "specificity_fingerprint": "f6e850ce1ba8f2a2b7be29dca6d3e6e513f9f13725d0d543d574ee97ad970fe9",
  "stop_conditions": [
...
1. The atomic scope in POST-SUBTASK-041 is completed without absorbing sibling work or weakening any protected requirement, control, split, judging rule, rights decision, or security boundary.
...
Validate that `artifacts/entities/entity_decision_and_transition_log.jsonl` can be parsed and consumed by `POST-SUBTASK-042` using only documented identities and interfaces; the consumer must reject missing, stale, schema-incompatible, rights-blocked, or provenance-incomplete input without manual repair.
