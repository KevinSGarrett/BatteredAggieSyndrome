...
1. `jira/records/issues/stories/POST-STORY-029_protected_a_and_m_lift_calibration_stability_and_integration_decision.json`
2. `jira/sources/issue_source_manifests/POST-STORY-029.json`
3. `jira/index/ISSUE_GOVERNANCE_CONTEXT.csv` row for `POST-STORY-029`.
