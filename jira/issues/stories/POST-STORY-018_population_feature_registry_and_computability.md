<!-- GENERATED VIEW. Canonical record: jira/records/issues/stories/POST-STORY-018_population_feature_registry_and_computability.json -->
# POST-STORY-018 — [POST-STORY-018] Population feature registry and computability
...
```json
{
  ...
  "blocked_reason": "",
  "blocks": [],
  "canonical_record": "jira/records/issues/stories/POST-STORY-018_population_feature_registry_and_computability.json",
  "canonical_source_role": "AUTHORITATIVE_LOCAL_SPECIFICATION",
  "completion_evidence_contract": {
    "all_child_evidence_required": true,
    "child_gate": "POST-SUBTASK-054",
  ...
  "critical_path": false,
  "definition_of_done": [
    "All child subtasks POST-SUBTASK-052, POST-SUBTASK-053, POST-SUBTASK-054 have verified evidence or an explicit accepted-risk/deferred/cancelled disposition consistent with the Story contract.",
    "The final gate `POST-SUBTASK-054` completes and proves the Story end-to-end requirement; closing implementation children alone is insufficient.",
  ...
  "end_to_end_validation": "The full feature universe receives evidence-backed eligibility and a reproducible registry without hand-selecting attractive football variables.",
  "epic_id": "POST-EPIC-006",
  "evidence_manifest_path": "artifacts/jira_evidence/POST-STORY-018.json",
  ...
  "gap_ids": [],
  "generated_markdown": "jira/issues/stories/POST-STORY-018_population_feature_registry_and_computability.md",
  ...
  "local_id": "POST-STORY-018",
  "maturity_before": "FUNCTIONAL_STARTER",
  "objective": "Reconcile raw columns and 900+ candidate features against real coverage, PIT rules, implementations, and lifecycle state.",
  "operational_jira": {
    "assignee": "",
    "jira_issue_id": "24208",
    "jira_updated_at": "2026-08-09T23:23:55.820-0500",
  ...
  "required_tests": [
    ...
    },
    {
      ...
      "expectation": "The final child gate `POST-SUBTASK-054` must prove the integrated Story outcome and downstream-consumable output.",
  ...
  "risk_ids": [],
  "schema_version": 2,
  "scope": "Deliver Story POST-STORY-018 (Population feature registry and computability) as one coherent, gated capability inside Epic POST-EPIC-006. Execute child subtasks POST-SUBTASK-052, POST-SUBTASK-053, POST-SUBTASK-054 in dependency order, reconcile their pinned outputs, and require the final gate `POST-SUBTASK-054` to issue an evidence-backed approve/block/reject/defer decision before any downstream use.",
  "source_ids": [
    "GAP-007",
    "HANDOFF-005"
  ],
  ...
  "specificity_fingerprint": "9849d4b1e844a5736f4b148fc3e05024b618250cdd6bf7326ec3da37561f98ac",
  "stop_conditions": [
  ...
  "title": "[POST-STORY-018] Population feature registry and computability",
  ...
  "work_packet_path": "jira/ai/work_packets/POST-STORY-018.md",
...
4. Computability distinguishes not-known, source-missing, resolver-missing, structural, and implementation failure, and recent/A&M coverage cannot conceal national historical sparsity.
5. The declared output `artifacts/features/feature_computability_profile.json` is produced with deterministic identity, provenance, and validation metadata appropriate to this work.
6. Every experiment-eligible feature passes identity, PIT, lineage, implementation, and computability checks and the registry hash is pinned in downstream runs.
7. All prerequisite evidence is linked and unresolved blockers remain explicit; file creation alone cannot pass this gate.

## Definition of Done

1. All child subtasks POST-SUBTASK-052, POST-SUBTASK-053, POST-SUBTASK-054 have verified evidence or an explicit accepted-risk/deferred/cancelled disposition consistent with the Story contract.
2. The final gate `POST-SUBTASK-054` completes and proves the Story end-to-end requirement; closing implementation children alone is insufficient.
