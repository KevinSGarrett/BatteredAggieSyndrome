<!-- GENERATED VIEW. Canonical record: jira/records/issues/epics/POST-EPIC-017_deferred_live_and_in_game_modeling.json -->
# POST-EPIC-017 — [POST-EPIC-017] Deferred live and in-game modeling
...
```json
{
  ...
  "blocks": [],
  "canonical_record": "jira/records/issues/epics/POST-EPIC-017_deferred_live_and_in_game_modeling.json",
  ...
  "critical_path": false,
  "definition_of_done": [
    "Every child Story POST-STORY-051, POST-STORY-052, POST-STORY-053 is completed through its explicit end-to-end gate or has an explicit accepted-risk/deferred/cancelled disposition consistent with release governance.",
  ...
  "gap_ids": [],
  "generated_markdown": "jira/issues/epics/POST-EPIC-017_deferred_live_and_in_game_modeling.md",
  ...
  "operational_jira": {
    "assignee": "",
    "jira_issue_id": "24190",
    "jira_updated_at": "2026-08-09T23:23:54.279-0500",
  ...
  "required_tests": [
    {
      ...
      "expectation": "Story gate `POST-SUBTASK-153` must complete with verified evidence before Epic completion.",
      "path": "POST-SUBTASK-153",
      "validation_class": "END_TO_END"
    },
    {
      "classification": "END_TO_END",
      "expectation": "Story gate `POST-SUBTASK-156` must complete with verified evidence before Epic completion.",
      "path": "POST-SUBTASK-156",
      "validation_class": "END_TO_END"
    },
    {
      "classification": "END_TO_END",
      "expectation": "Story gate `POST-SUBTASK-159` must complete with verified evidence before Epic completion.",
  ...
  "risk_ids": [],
  "schema_version": 2,
  "scope": "All Stories and Subtasks under this Epic for the live domain, including its explicit integrated completion gate.",
  "source_ids": [
    "GAP-014",
    "HANDOFF-014",
    "TASK-169",
  ...
  "title": "[POST-EPIC-017] Deferred live and in-game modeling",
  ...
  "work_packet_path": "jira/ai/work_packets/POST-EPIC-017.md",
...
1. Every child Story POST-STORY-051, POST-STORY-052, POST-STORY-053 is completed through its explicit end-to-end gate or has an explicit accepted-risk/deferred/cancelled disposition consistent with release governance.
