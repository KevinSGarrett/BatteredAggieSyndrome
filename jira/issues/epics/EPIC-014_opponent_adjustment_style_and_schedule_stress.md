<!-- GENERATED VIEW. Canonical record: jira/records/issues/epics/EPIC-014_opponent_adjustment_style_and_schedule_stress.json -->
# EPIC-014 — [EPIC-014] Opponent adjustment, style and schedule stress
...
```json
{
  ...
  "acceptance_criteria": [
    "The epic retains stable ID EPIC-014, owner wave W13, phase PHASE-2, and all authoritative WBS children.",
  ...
  "blocked_reason": "",
  "blocks": [],
  "canonical_record": "jira/records/issues/epics/EPIC-014_opponent_adjustment_style_and_schedule_stress.json",
  ...
  "gap_ids": [],
  "generated_markdown": "jira/issues/epics/EPIC-014_opponent_adjustment_style_and_schedule_stress.md",
  ...
  "objective": "Normalize performance by opponent quality and represent matchup/style/workload context.",
  "operational_jira": {
    "assignee": "",
    "jira_issue_id": "24154",
    "jira_updated_at": "2026-08-09T00:40:12.230-0500",
  ...
  "specificity_fingerprint": "5d49e8656596e13f95d055178bcb075650e31664ca01f3738a491c3d5b75a51d",
  "stop_conditions": [
    "Stop if a proposed update renumbers the historical epic or rewrites its original wave provenance."
  ],
  "supporting_source_refs": [],
  "title": "[EPIC-014] Opponent adjustment, style and schedule stress",
...
Normalize performance by opponent quality and represent matchup/style/workload context.
...
1. The epic retains stable ID EPIC-014, owner wave W13, phase PHASE-2, and all authoritative WBS children.
