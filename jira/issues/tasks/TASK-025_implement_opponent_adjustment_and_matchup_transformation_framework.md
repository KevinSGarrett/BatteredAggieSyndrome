<!-- GENERATED VIEW. Canonical record: jira/records/issues/tasks/TASK-025_implement_opponent_adjustment_and_matchup_transformation_framework.json -->
# TASK-025 — [TASK-025] Implement opponent-adjustment and matchup transformation framework
...
```json
{
  ...
  "acceptance_criteria": [
    "Stable ID TASK-025, parent EPIC-005, owner wave W10, and original status DONE are preserved.",
  ...
  "canonical_record": "jira/records/issues/tasks/TASK-025_implement_opponent_adjustment_and_matchup_transformation_framework.json",
  ...
  "gap_ids": [],
  "generated_markdown": "jira/issues/tasks/TASK-025_implement_opponent_adjustment_and_matchup_transformation_framework.md",
  ...
  "objective": "Implement opponent-adjustment and matchup transformation framework",
  "operational_jira": {
    "assignee": "",
    "jira_issue_id": "24268",
    "jira_updated_at": "2026-08-09T00:40:20.150-0500",
  ...
  "required_evidence": [
    "Authoritative WBS row TASK-025",
    "Existing artifact `opponent/matchup transform interfaces`"
  ],
  "required_tests": [
    {
  ...
  "specificity_fingerprint": "c0bbab81386110086937daff0ab3b7e21387a665bcb3c7f1490fbcd37176385f",
  "stop_conditions": [
  ...
  "title": "[TASK-025] Implement opponent-adjustment and matchup transformation framework",
...
Implement opponent-adjustment and matchup transformation framework
...
1. Stable ID TASK-025, parent EPIC-005, owner wave W10, and original status DONE are preserved.
