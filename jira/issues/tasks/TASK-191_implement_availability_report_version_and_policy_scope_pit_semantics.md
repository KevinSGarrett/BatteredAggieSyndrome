<!-- GENERATED VIEW. Canonical record: jira/records/issues/tasks/TASK-191_implement_availability_report_version_and_policy_scope_pit_semantics.json -->
# TASK-191 — [TASK-191] Implement availability report version and policy-scope PIT semantics
...
```json
{
  ...
  "acceptance_criteria": [
    "Stable ID TASK-191, parent EPIC-003, owner wave W08, and original status DONE are preserved.",
  ...
  "gap_ids": [],
  "generated_markdown": "jira/issues/tasks/TASK-191_implement_availability_report_version_and_policy_scope_pit_semantics.md",
  ...
  "operational_jira": {
    "assignee": "",
    "jira_issue_id": "24464",
    "jira_updated_at": "2026-08-11T07:09:31.691-0500",
  ...
  "required_evidence": [
    "Authoritative WBS row TASK-191",
    "Existing artifact `availability report PIT contract + fixtures`"
  ],
  "required_tests": [
    {
  ...
  "risk_ids": [],
  "schema_version": 2,
  "scope": "Original task type TEMPORAL_DESIGN with mutation scope: PIT availability semantics.",
  "source_ids": [
    "TASK-191"
  ],
  "source_refs": [
  ...
  "specificity_fingerprint": "16f13d1072e67651528c70b1566a2c2d43e549459ccf8f53036f0cf4c73efe23",
  "stop_conditions": [
  ...
  "title": "[TASK-191] Implement availability report version and policy-scope PIT semantics",
...
Implement availability report version and policy-scope PIT semantics
...
Original task type TEMPORAL_DESIGN with mutation scope: PIT availability semantics.
...
1. Stable ID TASK-191, parent EPIC-003, owner wave W08, and original status DONE are preserved.
