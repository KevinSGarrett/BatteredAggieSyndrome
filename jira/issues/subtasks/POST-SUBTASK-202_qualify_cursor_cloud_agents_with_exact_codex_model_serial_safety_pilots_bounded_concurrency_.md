<!-- GENERATED VIEW. Canonical record: jira/records/issues/subtasks/POST-SUBTASK-202_qualify_cursor_cloud_agents_with_exact_codex_model_serial_safety_pilots_bounded_concurrency_.json -->
# POST-SUBTASK-202 — [POST-SUBTASK-202] Qualify Cursor Cloud Agents with exact Codex model, serial safety pilots, bounded concurrency, and reviewed candidate integration
...
```json
{
  ...
  "blocked_reason": "PAID_CURSOR_BUDGET_NOT_AUTHORIZED",
  "blocks": [
    "POST-SUBTASK-205"
  ],
  "canonical_record": "jira/records/issues/subtasks/POST-SUBTASK-202_qualify_cursor_cloud_agents_with_exact_codex_model_serial_safety_pilots_bounded_concurrency_.json",
  ...
  "evidence_manifest_path": "artifacts/jira_evidence/POST-SUBTASK-202.json",
  ...
  "gap_ids": [],
  "generated_markdown": "jira/issues/subtasks/POST-SUBTASK-202_qualify_cursor_cloud_agents_with_exact_codex_model_serial_safety_pilots_bounded_concurrency_.md",
  "governance_review_required": false,
  "governance_traceability_gate": "POST-SUBTASK-202",
  ...
  "operational_jira": {
    "assignee": "",
    "jira_issue_id": "24954",
    "jira_updated_at": "2026-08-12T12:49:19.538-0500",
  ...
  "risk_ids": [],
  "schema_version": 2,
  "scope": "Execute 10 nontrivial isolated repository units using exact live `gpt-5.3-codex`, low/medium reasoning, Fast disabled, no direct branch/PR/merge authority, and full Codex review.",
  "source_ids": [
  ...
  "unblock_condition": "User explicitly authorizes a positive Cursor-only envelope and POST-SUBTASK-201 integrates.",
  "validation_classes": [
    "END_TO_END",
    "REPRODUCIBILITY",
    "SECURITY"
