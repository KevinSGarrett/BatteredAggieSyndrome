<!-- GENERATED VIEW. Canonical record: jira/records/issues/epics/EPIC-022_uncertainty_ood_and_market_lanes.json -->
# EPIC-022 — [EPIC-022] Uncertainty, OOD and market lanes
...
```json
{
  ...
  "acceptance_criteria": [
    "The epic retains stable ID EPIC-022, owner wave W16-W17, phase PHASE-4, and all authoritative WBS children.",
  ...
  "blocked_reason": "",
  "blocks": [],
  "canonical_record": "jira/records/issues/epics/EPIC-022_uncertainty_ood_and_market_lanes.json",
  ...
  "expected_outputs": [
    "OOD/disagreement candidate registry",
    "market source comparison + PIT fixture plan",
    "market-augmented path with observation cutoffs",
    "market-independent prediction path",
  ...
  "gap_ids": [],
  "generated_markdown": "jira/issues/epics/EPIC-022_uncertainty_ood_and_market_lanes.md",
  ...
  "objective": "Separate pure-football and timestamp-safe market-augmented forecasts and expose uncertainty without unsupported directional claims.",
  "operational_jira": {
    "assignee": "",
    "jira_issue_id": "24162",
    "jira_updated_at": "2026-08-09T00:40:13.798-0500",
  ...
  "specificity_fingerprint": "766a43f95a97807c37d939f7bd25c64b459407d73ec472a7636ad753501ce4f3",
  "stop_conditions": [
    "Stop if a proposed update renumbers the historical epic or rewrites its original wave provenance."
  ],
  "supporting_source_refs": [],
  "title": "[EPIC-022] Uncertainty, OOD and market lanes",
...
Separate pure-football and timestamp-safe market-augmented forecasts and expose uncertainty without unsupported directional claims.
...
1. The epic retains stable ID EPIC-022, owner wave W16-W17, phase PHASE-4, and all authoritative WBS children.
