<!-- GENERATED VIEW. Canonical record: jira/records/issues/epics/EPIC-021_model_targets_joint_score_and_simulation.json -->
# EPIC-021 — [EPIC-021] Model targets, joint score and simulation
...
```json
{
  ...
  "acceptance_criteria": [
    "The epic retains stable ID EPIC-021, owner wave W16, phase PHASE-4, and all authoritative WBS children.",
  ...
  "blocked_reason": "",
  "blocks": [],
  "canonical_record": "jira/records/issues/epics/EPIC-021_model_targets_joint_score_and_simulation.json",
  ...
  "expected_outputs": [
    "forecast distribution interface",
    "joint-distribution candidate report",
  ...
  "gap_ids": [],
  "generated_markdown": "jira/issues/epics/EPIC-021_model_targets_joint_score_and_simulation.md",
  ...
  "objective": "Build coherent outcome-distribution architecture for win/loss/score/margin/BAS rather than disconnected point predictions.",
  "operational_jira": {
    "assignee": "",
    "jira_issue_id": "24161",
    "jira_updated_at": "2026-08-09T00:40:13.685-0500",
  ...
  "specificity_fingerprint": "d4bb5a42f85657e5e93fedbe8eabb4d034e62f6610886076588101f26c8d8aed",
  "stop_conditions": [
    "Stop if a proposed update renumbers the historical epic or rewrites its original wave provenance."
  ],
  "supporting_source_refs": [],
  "title": "[EPIC-021] Model targets, joint score and simulation",
...
Build coherent outcome-distribution architecture for win/loss/score/margin/BAS rather than disconnected point predictions.
...
1. The epic retains stable ID EPIC-021, owner wave W16, phase PHASE-4, and all authoritative WBS children.
