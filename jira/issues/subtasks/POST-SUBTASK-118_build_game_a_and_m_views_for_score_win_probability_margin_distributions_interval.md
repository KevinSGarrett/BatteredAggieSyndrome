<!-- GENERATED VIEW. Canonical record: jira/records/issues/subtasks/POST-SUBTASK-118_build_game_a_and_m_views_for_score_win_probability_margin_distributions_interval.json -->
# POST-SUBTASK-118 — [POST-SUBTASK-118] Build game/A&M views for score, win probability, margin, distributions, intervals, scenarios, cutoff, freshness, and model identity
...
```json
{
  ...
  "acceptance_criteria": [
    ...
    "The declared output `artifacts/product/dashboard_contract_test.json` is produced with deterministic identity, provenance, and validation metadata appropriate to this work.",
  ...
  "ai_context_notes": [
    ...
    "Read the exact source sections in `jira/sources/issue_source_manifests/POST-SUBTASK-118.json`; inspect only the listed implementation files and prerequisite outputs.",
  ...
  "blocked_reason": "UNSATISFIED_HARD_DEPENDENCIES: POST-SUBTASK-117",
  "blocks": [
    "POST-SUBTASK-119",
    "POST-SUBTASK-120"
  ],
  "canonical_record": "jira/records/issues/subtasks/POST-SUBTASK-118_build_game_a_and_m_views_for_score_win_probability_margin_distributions_interval.json",
  "canonical_source_role": "AUTHORITATIVE_LOCAL_SPECIFICATION",
  "completion_evidence_contract": {
    "acceptance_matrix_required": true,
    "artifact_hashes_required": true,
    "completion_claim_limit": "IMPLEMENTED",
    "downstream_consumer": "POST-SUBTASK-119",
  ...
  "critical_path": false,
  "definition_of_done": [
    "The atomic scope in POST-SUBTASK-118 is completed without absorbing sibling work or weakening any protected requirement, control, split, judging rule, private-research publication boundary, or security boundary.",
    ...
    "The output set `artifacts/product/dashboard_contract_test.json` is demonstrably consumable by POST-SUBTASK-119 without manual reconstruction or undocumented state."
  ],
  "dependencies": [
    "POST-SUBTASK-117"
  ],
  ...
  "end_to_end_validation": "Validate that `artifacts/product/dashboard_contract_test.json` can be parsed and consumed by `POST-SUBTASK-119` using only documented identities and interfaces; the consumer must reject missing, stale, schema-incompatible, technically or quality-ineligible, or provenance-incomplete input without manual repair.",
  "epic_id": "POST-EPIC-013",
  "evidence_manifest_path": "artifacts/jira_evidence/POST-SUBTASK-118.json",
  ...
  "gap_ids": [],
  "generated_markdown": "jira/issues/subtasks/POST-SUBTASK-118_build_game_a_and_m_views_for_score_win_probability_margin_distributions_interval.md",
  ...
  "local_id": "POST-SUBTASK-118",
  "maturity_before": "FUNCTIONAL_STARTER",
  "objective": "Build game/A&M views for score, win probability, margin, distributions, intervals, scenarios, cutoff, freshness, and model identity",
  "operational_jira": {
    "assignee": "",
    "jira_issue_id": "24608",
    "jira_updated_at": "2026-08-09T23:24:11.584-0500",
  ...
  "required_tests": [
    {
      ...
      "expectation": "Run as a regression check after completing POST-SUBTASK-118; retain command, exit code, and relevant output.",
    ...
    },
    {
      ...
      "path": "artifacts/product/dashboard_contract_test.json",
    ...
    },
    {
      ...
      "path": "NEW_TEST_REQUIRED::POST-SUBTASK-118",
      "validation_class": "NEW_AUTOMATED_TEST_REQUIRED"
    }
  ],
  "requirement_ids": [],
  "risk_failure_conditions": [
    "The work would be invalid if any prerequisite artifact, source/data/code/config identity, or declared maturity differs from the pinned issue contract for POST-SUBTASK-118.",
    ...
    "Acceptance failure: the evidence cannot demonstrate that the declared output `artifacts/product/dashboard_contract_test.json` is produced with deterministic identity, provenance, and validation metadata appropriate to this work.",
  ...
  "specificity_fingerprint": "af74b08b88fc776b77c487bbed25c7a78eb61ce594036d57d726dc48962f66b9",
  "stop_conditions": [
  ...
  "title": "[POST-SUBTASK-118] Build game/A&M views for score, win probability, margin, distributions, intervals, scenarios, cutoff, freshness, and model identity",
  ...
  "work_packet_path": "jira/ai/work_packets/POST-SUBTASK-118.md",
...
1. The atomic scope in POST-SUBTASK-118 is completed without absorbing sibling work or weakening any protected requirement, control, split, judging rule, private-research publication boundary, or security boundary.
...
7. The output set `artifacts/product/dashboard_contract_test.json` is demonstrably consumable by POST-SUBTASK-119 without manual reconstruction or undocumented state.
...
Validate that `artifacts/product/dashboard_contract_test.json` can be parsed and consumed by `POST-SUBTASK-119` using only documented identities and interfaces; the consumer must reject missing, stale, schema-incompatible, technically or quality-ineligible, or provenance-incomplete input without manual repair.
