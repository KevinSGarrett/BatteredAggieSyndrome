<!-- GENERATED VIEW. Canonical record: jira/records/issues/subtasks/POST-SUBTASK-066_validate_identity_timing_source_scale_compatibility_sparse_history_shrinkage_and.json -->
# POST-SUBTASK-066 — [POST-SUBTASK-066] Validate identity, timing, source-scale compatibility, sparse-history shrinkage, and experimental eligibility
...
```json
{
  ...
  "ai_context_notes": [
    ...
    "Read the exact source sections in `jira/sources/issue_source_manifests/POST-SUBTASK-066.json`; inspect only the listed implementation files and prerequisite outputs.",
  ...
  "blocked_reason": "UNSATISFIED_HARD_DEPENDENCIES: POST-SUBTASK-063;POST-SUBTASK-064;POST-SUBTASK-065",
  "blocks": [
    "POST-STORY-027",
    "POST-SUBTASK-079",
    "POST-SUBTASK-080",
  ...
  "canonical_record": "jira/records/issues/subtasks/POST-SUBTASK-066_validate_identity_timing_source_scale_compatibility_sparse_history_shrinkage_and.json",
  "canonical_source_role": "AUTHORITATIVE_LOCAL_SPECIFICATION",
  "completion_evidence_contract": {
    "acceptance_matrix_required": true,
    "artifact_hashes_required": true,
    "completion_claim_limit": "PRODUCTION_READY",
    "downstream_consumer": "POST-STORY-022",
  ...
  "critical_path": false,
  "definition_of_done": [
    "The atomic scope in POST-SUBTASK-066 is completed without absorbing sibling work or weakening any protected requirement, control, split, judging rule, private-research publication boundary, or security boundary.",
    ...
    "The Story gate consumes the complete prerequisite evidence set and issues an explicit downstream approval/block/reject/defer decision for POST-STORY-022."
  ],
  "dependencies": [
    "POST-SUBTASK-063",
    "POST-SUBTASK-064",
  ...
  "end_to_end_validation": "Recruiting, portal, freshman, coaching, coordinator, and continuity state is reproducible at each cutoff without current-season hindsight. The gate decision must explicitly reevaluate downstream issues: POST-STORY-027, POST-SUBTASK-079, POST-SUBTASK-080, POST-SUBTASK-081.",
  "epic_id": "POST-EPIC-007",
  "evidence_manifest_path": "artifacts/jira_evidence/POST-SUBTASK-066.json",
  ...
  "gap_ids": [],
  "generated_markdown": "jira/issues/subtasks/POST-SUBTASK-066_validate_identity_timing_source_scale_compatibility_sparse_history_shrinkage_and.md",
  ...
  "local_id": "POST-SUBTASK-066",
  "maturity_before": "FUNCTIONAL_STARTER",
  "objective": "Validate identity, timing, source-scale compatibility, sparse-history shrinkage, and experimental eligibility",
  "operational_jira": {
    "assignee": "",
    "jira_issue_id": "24556",
    "jira_updated_at": "2026-08-09T23:24:06.111-0500",
  ...
  "prerequisites": [
    ...
    "Dependency POST-SUBTASK-065 complete at required maturity"
  ],
  "primary_source_refs": [
    "SRCREF-02041",
    "SRCREF-02042",
  ...
  "required_tests": [
    {
      ...
      "expectation": "Run as a regression check after completing POST-SUBTASK-066; retain command, exit code, and relevant output.",
    ...
    },
    {
      ...
      "path": "artifacts/context_intelligence/program_intelligence_gate.json",
  ...
  "risk_failure_conditions": [
    "The work would be invalid if any prerequisite artifact, source/data/code/config identity, or declared maturity differs from the pinned issue contract for POST-SUBTASK-066.",
    ...
    "Acceptance failure: the evidence cannot demonstrate that temporal perturbation, coverage, and scale tests pass; sparse/unsupported candidates remain experimental or rejected and are not assumed predictive.",
  ...
  "specificity_fingerprint": "69dfd77c66601a7fd7eefc4e28c7eac0cc0b4ea5e06debf4d286c27fc34860e3",
  "stop_conditions": [
  ...
  "title": "[POST-SUBTASK-066] Validate identity, timing, source-scale compatibility, sparse-history shrinkage, and experimental eligibility",
  ...
  "work_packet_path": "jira/ai/work_packets/POST-SUBTASK-066.md",
...
1. The atomic scope in POST-SUBTASK-066 is completed without absorbing sibling work or weakening any protected requirement, control, split, judging rule, private-research publication boundary, or security boundary.
...
7. The Story gate consumes the complete prerequisite evidence set and issues an explicit downstream approval/block/reject/defer decision for POST-STORY-022.
