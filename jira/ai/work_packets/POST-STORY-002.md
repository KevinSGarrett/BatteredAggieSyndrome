...
1. `jira/records/issues/stories/POST-STORY-002_local_data_artifact_and_secret_boundary_bootstrap.json`
2. `jira/sources/issue_source_manifests/POST-STORY-002.json`
3. `jira/index/ISSUE_GOVERNANCE_CONTEXT.csv` row for `POST-STORY-002`.
