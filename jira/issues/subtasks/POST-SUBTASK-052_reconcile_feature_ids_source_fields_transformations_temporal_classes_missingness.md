<!-- GENERATED VIEW. Canonical record: jira/records/issues/subtasks/POST-SUBTASK-052_reconcile_feature_ids_source_fields_transformations_temporal_classes_missingness.json -->
# POST-SUBTASK-052 — [POST-SUBTASK-052] Reconcile feature IDs, source fields, transformations, temporal classes, missingness, code paths, aliases, duplicates, and lifecycle states
...
```json
{
  ...
  "acceptance_criteria": [
    ...
    "The declared output `artifacts/features/production_feature_inventory.csv` is produced with deterministic identity, provenance, and validation metadata appropriate to this work.",
  ...
  "ai_context_notes": [
    ...
    "Read the exact source sections in `jira/sources/issue_source_manifests/POST-SUBTASK-052.json`; inspect only the listed implementation files and prerequisite outputs.",
  ...
  "canonical_record": "jira/records/issues/subtasks/POST-SUBTASK-052_reconcile_feature_ids_source_fields_transformations_temporal_classes_missingness.json",
  "canonical_source_role": "AUTHORITATIVE_LOCAL_SPECIFICATION",
  "completion_evidence_contract": {
    "acceptance_matrix_required": true,
    "artifact_hashes_required": true,
    "completion_claim_limit": "IMPLEMENTED",
    "downstream_consumer": "POST-SUBTASK-053",
  ...
  "critical_path": false,
  "definition_of_done": [
    "The atomic scope in POST-SUBTASK-052 is completed without absorbing sibling work or weakening any protected requirement, control, split, judging rule, private-research publication boundary, or security boundary.",
    ...
    "The output set `artifacts/features/production_feature_inventory.csv` is demonstrably consumable by POST-SUBTASK-053 without manual reconstruction or undocumented state."
  ],
  "dependencies": [
    "POST-SUBTASK-048"
  ],
  ...
  "end_to_end_validation": "Validate that `artifacts/features/production_feature_inventory.csv` can be parsed and consumed by `POST-SUBTASK-053` using only documented identities and interfaces; the consumer must reject missing, stale, schema-incompatible, technically or quality-ineligible, or provenance-incomplete input without manual repair.",
  "epic_id": "POST-EPIC-006",
  "evidence_manifest_path": "artifacts/jira_evidence/POST-SUBTASK-052.json",
  ...
  "gap_ids": [],
  "generated_markdown": "jira/issues/subtasks/POST-SUBTASK-052_reconcile_feature_ids_source_fields_transformations_temporal_classes_missingness.md",
  ...
  "local_id": "POST-SUBTASK-052",
  "maturity_before": "FUNCTIONAL_STARTER",
  "objective": "Reconcile feature IDs, source fields, transformations, temporal classes, missingness, code paths, aliases, duplicates, and lifecycle states",
  "operational_jira": {
    "assignee": "",
    "jira_issue_id": "24542",
    "jira_updated_at": "2026-08-09T23:24:04.612-0500",
  ...
  "required_tests": [
    {
      ...
      "expectation": "Run as a regression check after completing POST-SUBTASK-052; retain command, exit code, and relevant output.",
    ...
    },
    {
      ...
      "path": "artifacts/features/production_feature_inventory.csv",
  ...
  "risk_failure_conditions": [
    "The work would be invalid if any prerequisite artifact, source/data/code/config identity, or declared maturity differs from the pinned issue contract for POST-SUBTASK-052.",
    ...
    "Acceptance failure: the evidence cannot demonstrate that the declared output `artifacts/features/production_feature_inventory.csv` is produced with deterministic identity, provenance, and validation metadata appropriate to this work.",
  ...
  "specificity_fingerprint": "68fd5834481e552d2b110101e4ff588f4de5909110231eba3cb6e5466b87c868",
  "stop_conditions": [
  ...
  "title": "[POST-SUBTASK-052] Reconcile feature IDs, source fields, transformations, temporal classes, missingness, code paths, aliases, duplicates, and lifecycle states",
  ...
  "work_packet_path": "jira/ai/work_packets/POST-SUBTASK-052.md",
...
1. The atomic scope in POST-SUBTASK-052 is completed without absorbing sibling work or weakening any protected requirement, control, split, judging rule, private-research publication boundary, or security boundary.
...
7. The output set `artifacts/features/production_feature_inventory.csv` is demonstrably consumable by POST-SUBTASK-053 without manual reconstruction or undocumented state.
...
Validate that `artifacts/features/production_feature_inventory.csv` can be parsed and consumed by `POST-SUBTASK-053` using only documented identities and interfaces; the consumer must reject missing, stale, schema-incompatible, technically or quality-ineligible, or provenance-incomplete input without manual repair.
