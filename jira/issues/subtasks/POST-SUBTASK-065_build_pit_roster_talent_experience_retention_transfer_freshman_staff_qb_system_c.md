<!-- GENERATED VIEW. Canonical record: jira/records/issues/subtasks/POST-SUBTASK-065_build_pit_roster_talent_experience_retention_transfer_freshman_staff_qb_system_c.json -->
# POST-SUBTASK-065 — [POST-SUBTASK-065] Build PIT roster-talent, experience, retention, transfer/freshman, staff/QB/system continuity, prior-performance, and bounded scheme-proxy candidates
...
```json
{
  ...
  "acceptance_criteria": [
    ...
    "The declared output `artifacts/context_intelligence/program_feature_manifest.json` is produced with deterministic identity, provenance, and validation metadata appropriate to this work.",
    "The work does not fabricate source availability, empirical results, thresholds, model performance, operational readiness, or completion evidence."
  ],
  "adr_ids": [],
  "ai_context_notes": [
    "Canonical parent Story: POST-STORY-022. Governance traceability gate: POST-SUBTASK-069. Inherited traceability is resolved through `jira/index/ISSUE_GOVERNANCE_CONTEXT.csv`.",
    "Read the exact source sections in `jira/sources/issue_source_manifests/POST-SUBTASK-065.json`; inspect only the listed implementation files and prerequisite outputs.",
  ...
  "blocked_reason": "UNSATISFIED_HARD_DEPENDENCIES: POST-SUBTASK-063;POST-SUBTASK-064",
  "blocks": [
    "POST-SUBTASK-066"
  ],
  "canonical_record": "jira/records/issues/subtasks/POST-SUBTASK-065_build_pit_roster_talent_experience_retention_transfer_freshman_staff_qb_system_c.json",
  "canonical_source_role": "AUTHORITATIVE_LOCAL_SPECIFICATION",
  "completion_evidence_contract": {
    "acceptance_matrix_required": true,
    "artifact_hashes_required": true,
    "completion_claim_limit": "EMPIRICALLY_VALIDATED",
    "downstream_consumer": "POST-SUBTASK-066",
  ...
  "critical_path": false,
  "definition_of_done": [
    "The atomic scope in POST-SUBTASK-065 is completed without absorbing sibling work or weakening any protected requirement, control, split, judging rule, rights decision, or security boundary.",
    ...
    "The output set `artifacts/context_intelligence/program_feature_manifest.json` is demonstrably consumable by POST-SUBTASK-066 without manual reconstruction or undocumented state."
  ],
  "dependencies": [
    "POST-SUBTASK-063",
    "POST-SUBTASK-064"
  ...
  "end_to_end_validation": "Validate that `artifacts/context_intelligence/program_feature_manifest.json` can be parsed and consumed by `POST-SUBTASK-066` using only documented identities and interfaces; the consumer must reject missing, stale, schema-incompatible, rights-blocked, or provenance-incomplete input without manual repair.",
  "epic_id": "POST-EPIC-007",
  "evidence_manifest_path": "artifacts/jira_evidence/POST-SUBTASK-065.json",
  ...
  "gap_ids": [],
  "generated_markdown": "jira/issues/subtasks/POST-SUBTASK-065_build_pit_roster_talent_experience_retention_transfer_freshman_staff_qb_system_c.md",
  ...
  "local_id": "POST-SUBTASK-065",
  "maturity_before": "FUNCTIONAL_STARTER",
  "objective": "Build PIT roster-talent, experience, retention, transfer/freshman, staff/QB/system continuity, prior-performance, and bounded scheme-proxy candidates",
  "operational_jira": {
    "assignee": "",
    "jira_issue_id": "24555",
    "jira_updated_at": "2026-08-09T00:03:45.047-0500",
  ...
  "owner_wave": "POST_W25",
  "parent_id": "POST-STORY-022",
  "phase": "PHASE-2",
  "prerequisites": [
    "Dependency POST-SUBTASK-063 complete at required maturity",
    "Dependency POST-SUBTASK-064 complete at required maturity"
  ],
  "primary_source_refs": [
    "SRCREF-02041",
    "SRCREF-02042",
  ...
  "required_tests": [
    {
      ...
      "expectation": "Run as a regression check after completing POST-SUBTASK-065; retain command, exit code, and relevant output.",
    ...
    },
    {
      ...
      "path": "artifacts/context_intelligence/program_feature_manifest.json",
    ...
    },
    {
      ...
      "path": "NEW_TEST_REQUIRED::POST-SUBTASK-065",
      "validation_class": "NEW_AUTOMATED_TEST_REQUIRED"
    }
  ],
  "requirement_ids": [],
  "risk_failure_conditions": [
    "The work would be invalid if any prerequisite artifact, source/data/code/config identity, or declared maturity differs from the pinned issue contract for POST-SUBTASK-065.",
    "A command may exit successfully while producing stale, partial, synthetic-only, leakage-contaminated, non-reproducible, or legally unusable evidence.",
    "Acceptance failure: the evidence cannot demonstrate that aggregates use only prior eligible state, distinguish returning production/recruits/transfers, expose early-season uncertainty, and do not encode culture/clutch/collapse without measurable definitions.",
    "Acceptance failure: the evidence cannot demonstrate that the declared output `artifacts/context_intelligence/program_feature_manifest.json` is produced with deterministic identity, provenance, and validation metadata appropriate to this work.",
  ...
  "specificity_fingerprint": "9eae15c4cb0aa34d46ffa48010324fc5fcc2dc46e78fff42ea1d121ce03524ed",
  "stop_conditions": [
  ...
  "title": "[POST-SUBTASK-065] Build PIT roster-talent, experience, retention, transfer/freshman, staff/QB/system continuity, prior-performance, and bounded scheme-proxy candidates",
  ...
  "why_this_exists": "This is an independently executable and verifiable work unit required by Story POST-STORY-022: Recruiting, transfer, freshman, coaching, and continuity intelligence.",
  "work_packet_path": "jira/ai/work_packets/POST-SUBTASK-065.md",
...
1. The atomic scope in POST-SUBTASK-065 is completed without absorbing sibling work or weakening any protected requirement, control, split, judging rule, rights decision, or security boundary.
...
7. The output set `artifacts/context_intelligence/program_feature_manifest.json` is demonstrably consumable by POST-SUBTASK-066 without manual reconstruction or undocumented state.
...
Validate that `artifacts/context_intelligence/program_feature_manifest.json` can be parsed and consumed by `POST-SUBTASK-066` using only documented identities and interfaces; the consumer must reject missing, stale, schema-incompatible, rights-blocked, or provenance-incomplete input without manual repair.
