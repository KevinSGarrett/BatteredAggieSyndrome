<!-- GENERATED VIEW. Canonical record: jira/records/issues/epics/EPIC-024_experimentation_and_autonomous_research_system.json -->
# EPIC-024 — [EPIC-024] Experimentation and autonomous research system
...
```json
{
  ...
  "acceptance_criteria": [
    "The epic retains stable ID EPIC-024, owner wave W18, phase PHASE-4, and all authoritative WBS children.",
  ...
  "blocked_reason": "",
  "blocks": [],
  "canonical_record": "jira/records/issues/epics/EPIC-024_experimentation_and_autonomous_research_system.json",
  ...
  "expected_outputs": [
    ...
    "protected evaluator separation tests + W17 hash-seal verification CLI"
  ],
  ...
  "gap_ids": [],
  "generated_markdown": "jira/issues/epics/EPIC-024_experimentation_and_autonomous_research_system.md",
  ...
  "objective": "Build a governed experiment queue that can propose/run challengers without changing its own judging rules.",
  "operational_jira": {
    "assignee": "",
    "jira_issue_id": "24164",
    "jira_updated_at": "2026-08-09T00:40:14.337-0500",
  ...
  "specificity_fingerprint": "e49a1d910d18f9850b454ed6e433a9fd4249855cdbf1f8bcd2ef38e51e6545f0",
  "stop_conditions": [
    "Stop if a proposed update renumbers the historical epic or rewrites its original wave provenance."
  ],
  "supporting_source_refs": [],
  "title": "[EPIC-024] Experimentation and autonomous research system",
...
Build a governed experiment queue that can propose/run challengers without changing its own judging rules.
...
1. The epic retains stable ID EPIC-024, owner wave W18, phase PHASE-4, and all authoritative WBS children.
