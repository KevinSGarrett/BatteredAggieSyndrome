...
```json
{
  ...
  "critical_path": true,
  "definition_of_done": [
    "The atomic scope in POST-SUBTASK-035 is completed without absorbing sibling work or weakening any protected requirement, control, split, judging rule, rights decision, or security boundary.",
  ...
  "end_to_end_validation": "Validate that `artifacts/entities/schema_reconciliation.csv` can be parsed and consumed by `POST-SUBTASK-036` using only documented identities and interfaces; the consumer must reject missing, stale, schema-incompatible, rights-blocked, or provenance-incomplete input without manual repair.",
  ...
  "specificity_fingerprint": "67fa8762a3011bb7af34fd980aaa500775018d20d833cc5be22ddb87c94007a8",
  "stop_conditions": [
...
1. The atomic scope in POST-SUBTASK-035 is completed without absorbing sibling work or weakening any protected requirement, control, split, judging rule, rights decision, or security boundary.
