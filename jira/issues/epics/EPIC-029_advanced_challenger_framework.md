<!-- GENERATED VIEW. Canonical record: jira/records/issues/epics/EPIC-029_advanced_challenger_framework.json -->
# EPIC-029 — [EPIC-029] Advanced challenger framework
...
```json
{
  ...
  "acceptance_criteria": [
    "The epic retains stable ID EPIC-029, owner wave W18+, phase PHASE-5, and all authoritative WBS children.",
  ...
  "blocked_reason": "",
  "blocks": [],
  "canonical_record": "jira/records/issues/epics/EPIC-029_advanced_challenger_framework.json",
  ...
  "gap_ids": [],
  "generated_markdown": "jira/issues/epics/EPIC-029_advanced_challenger_framework.md",
  ...
  "operational_jira": {
    "assignee": "",
    "jira_issue_id": "24169",
    "jira_updated_at": "2026-08-09T00:04:54.392-0500",
  ...
  "specificity_fingerprint": "82895359b80ddebf55362b310ee8baf27bb1b7bd1bc4eebda6b28ce8f2c7d067",
  "stop_conditions": [
    "Stop if a proposed update renumbers the historical epic or rewrites its original wave provenance."
  ],
  "supporting_source_refs": [],
  "title": "[EPIC-029] Advanced challenger framework",
...
Allow neural/sequence/graph/other challengers only after strong baselines and protected evaluation exist.
...
1. The epic retains stable ID EPIC-029, owner wave W18+, phase PHASE-5, and all authoritative WBS children.
