...
1. `jira/records/issues/stories/POST-STORY-046_clean_target_real_data_release_candidate.json`
2. `jira/sources/issue_source_manifests/POST-STORY-046.json`
3. `jira/index/ISSUE_GOVERNANCE_CONTEXT.csv` row for `POST-STORY-046`.
