<!-- GENERATED VIEW. Canonical record: jira/records/issues/subtasks/POST-SUBTASK-110_build_immutable_forecast_snapshots_containing_coherent_scores_probabilities_unce.json -->
# POST-SUBTASK-110 — [POST-SUBTASK-110] Build immutable forecast snapshots containing coherent scores/probabilities/uncertainty/A&M/BAS outputs plus exact state/run/model identities
...
```json
{
  ...
  "ai_context_notes": [
    ...
    "Read the exact source sections in `jira/sources/issue_source_manifests/POST-SUBTASK-110.json`; inspect only the listed implementation files and prerequisite outputs.",
  ...
  "blocked_reason": "UNSATISFIED_HARD_DEPENDENCIES: POST-SUBTASK-108;POST-SUBTASK-109",
  "blocks": [
    "POST-SUBTASK-111"
  ],
  "canonical_record": "jira/records/issues/subtasks/POST-SUBTASK-110_build_immutable_forecast_snapshots_containing_coherent_scores_probabilities_unce.json",
  "canonical_source_role": "AUTHORITATIVE_LOCAL_SPECIFICATION",
  "completion_evidence_contract": {
    "acceptance_matrix_required": true,
    "artifact_hashes_required": true,
    "completion_claim_limit": "EMPIRICALLY_VALIDATED",
    "downstream_consumer": "POST-SUBTASK-111",
  ...
  "critical_path": false,
  "definition_of_done": [
    "The atomic scope in POST-SUBTASK-110 is completed without absorbing sibling work or weakening any protected requirement, control, split, judging rule, rights decision, or security boundary.",
    ...
    "The output set `artifacts/forecasts/forecast_snapshot_manifest.json` is demonstrably consumable by POST-SUBTASK-111 without manual reconstruction or undocumented state."
  ],
  "dependencies": [
    "POST-SUBTASK-108",
    "POST-SUBTASK-109"
  ...
  "end_to_end_validation": "Validate that `artifacts/forecasts/forecast_snapshot_manifest.json` can be parsed and consumed by `POST-SUBTASK-111` using only documented identities and interfaces; the consumer must reject missing, stale, schema-incompatible, rights-blocked, or provenance-incomplete input without manual repair.",
  "epic_id": "POST-EPIC-012",
  "evidence_manifest_path": "artifacts/jira_evidence/POST-SUBTASK-110.json",
  ...
  "gap_ids": [],
  "generated_markdown": "jira/issues/subtasks/POST-SUBTASK-110_build_immutable_forecast_snapshots_containing_coherent_scores_probabilities_unce.md",
  ...
  "local_id": "POST-SUBTASK-110",
  "maturity_before": "FUNCTIONAL_STARTER",
  "objective": "Build immutable forecast snapshots containing coherent scores/probabilities/uncertainty/A&M/BAS outputs plus exact state/run/model identities",
  "operational_jira": {
    "assignee": "",
    "jira_issue_id": "24600",
    "jira_updated_at": "2026-08-09T00:04:01.056-0500",
  ...
  "required_tests": [
    {
      ...
      "expectation": "Run as a regression check after completing POST-SUBTASK-110; retain command, exit code, and relevant output.",
    ...
    },
    {
      ...
      "path": "artifacts/forecasts/forecast_snapshot_manifest.json",
    ...
    },
    {
      ...
      "path": "NEW_TEST_REQUIRED::POST-SUBTASK-110",
      "validation_class": "NEW_AUTOMATED_TEST_REQUIRED"
    }
  ],
  "requirement_ids": [],
  "risk_failure_conditions": [
    "The work would be invalid if any prerequisite artifact, source/data/code/config identity, or declared maturity differs from the pinned issue contract for POST-SUBTASK-110.",
    ...
    "Acceptance failure: the evidence cannot demonstrate that the declared output `artifacts/forecasts/forecast_snapshot_manifest.json` is produced with deterministic identity, provenance, and validation metadata appropriate to this work.",
  ...
  "specificity_fingerprint": "56e9a4563a2b2638aab14df1c3edcac9181082b13ef5449075af32dcb28f5e19",
  "stop_conditions": [
  ...
  "title": "[POST-SUBTASK-110] Build immutable forecast snapshots containing coherent scores/probabilities/uncertainty/A&M/BAS outputs plus exact state/run/model identities",
  ...
  "work_packet_path": "jira/ai/work_packets/POST-SUBTASK-110.md",
...
1. The atomic scope in POST-SUBTASK-110 is completed without absorbing sibling work or weakening any protected requirement, control, split, judging rule, rights decision, or security boundary.
...
7. The output set `artifacts/forecasts/forecast_snapshot_manifest.json` is demonstrably consumable by POST-SUBTASK-111 without manual reconstruction or undocumented state.
...
Validate that `artifacts/forecasts/forecast_snapshot_manifest.json` can be parsed and consumed by `POST-SUBTASK-111` using only documented identities and interfaces; the consumer must reject missing, stale, schema-incompatible, rights-blocked, or provenance-incomplete input without manual repair.
