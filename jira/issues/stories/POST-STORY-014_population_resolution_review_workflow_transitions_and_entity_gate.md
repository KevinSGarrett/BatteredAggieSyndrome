<!-- GENERATED VIEW. Canonical record: jira/records/issues/stories/POST-STORY-014_population_resolution_review_workflow_transitions_and_entity_gate.json -->
# POST-STORY-014 — [POST-STORY-014] Population resolution, review workflow, transitions, and entity gate
...
```json
{
  ...
  "allowed_modification_paths": [
    "artifacts/jira_evidence/POST-STORY-014.json"
  ],
  "blocked_reason": "",
  "blocks": [],
  "canonical_record": "jira/records/issues/stories/POST-STORY-014_population_resolution_review_workflow_transitions_and_entity_gate.json",
  "canonical_source_role": "AUTHORITATIVE_LOCAL_SPECIFICATION",
  "completion_evidence_contract": {
    "all_child_evidence_required": true,
    "child_gate": "POST-SUBTASK-042",
  ...
  "critical_path": true,
  "definition_of_done": [
    "All child subtasks POST-SUBTASK-040, POST-SUBTASK-041, POST-SUBTASK-042 have verified evidence or an explicit accepted-risk/deferred/cancelled disposition consistent with the Story contract.",
    "The final gate `POST-SUBTASK-042` completes and proves the Story end-to-end requirement; closing implementation children alone is insufficient.",
  ...
  "end_to_end_validation": "Pinned source/schema inputs resolve through auditable canonical identities and temporal transitions into a reproducible entity snapshot with no silent merges or orphans.",
  "epic_id": "POST-EPIC-004",
  "evidence_manifest_path": "artifacts/jira_evidence/POST-STORY-014.json",
  ...
  "gap_ids": [],
  "generated_markdown": "jira/issues/stories/POST-STORY-014_population_resolution_review_workflow_transitions_and_entity_gate.md",
  "governance_review_required": false,
  "governance_traceability_gate": "POST-SUBTASK-042",
  "historical_classification": "ACTIONABLE_POST_WAVE",
  "import_id": 100064,
  "in_scope": [
    "Complete and verify child `POST-SUBTASK-040` — Run exact, alias, contextual, and bounded probabilistic resolution over the full population with evidence per decision.",
    "Complete and verify child `POST-SUBTASK-041` — Operate unresolved/collision/merge/split review and materialize temporal team, conference, staff, roster, and player transitions.",
    "Complete and verify child `POST-SUBTASK-042` — Publish the canonical entity snapshot and approve or block downstream PIT consumption.",
    "Integrate the child outputs and execute final gate `POST-SUBTASK-042`.",
  ...
  "operational_jira": {
    "assignee": "",
    "jira_issue_id": "24204",
    "jira_updated_at": "2026-08-09T23:23:55.433-0500",
  ...
  "phase": "PHASE-1",
  "prerequisites": [
    "Hard dependency POST-SUBTASK-039"
  ],
  "primary_source_refs": [
    "SRCREF-02019",
    "SRCREF-02020",
  ...
  "related_to": [],
  "required_evidence": [
    "Verified child completion/evidence manifests for POST-SUBTASK-040, POST-SUBTASK-041, POST-SUBTASK-042.",
    "Final gate decision from `POST-SUBTASK-042` with criterion-by-criterion PASS/FAIL/BLOCKED outcomes and output hashes.",
  ...
  "required_tests": [
    ...
    },
    {
      ...
      "expectation": "The final child gate `POST-SUBTASK-042` must prove the integrated Story outcome and downstream-consumable output.",
  ...
  "risk_ids": [],
  "schema_version": 2,
  "scope": "Deliver Story POST-STORY-014 (Population resolution, review workflow, transitions, and entity gate) as one coherent, gated capability inside Epic POST-EPIC-004. Execute child subtasks POST-SUBTASK-040, POST-SUBTASK-041, POST-SUBTASK-042 in dependency order, reconcile their pinned outputs, and require the final gate `POST-SUBTASK-042` to issue an evidence-backed approve/block/reject/defer decision before any downstream use.",
  "source_ids": [
    "GAP-003",
    "GAP-004"
  ],
  ...
  "title": "[POST-STORY-014] Population resolution, review workflow, transitions, and entity gate",
  ...
  "work_packet_path": "jira/ai/work_packets/POST-STORY-014.md",
...
Resolve the full population deterministically and publish a pinned entity snapshot for PIT use.
...
Deliver Story POST-STORY-014 (Population resolution, review workflow, transitions, and entity gate) as one coherent, gated capability inside Epic POST-EPIC-004. Execute child subtasks POST-SUBTASK-040, POST-SUBTASK-041, POST-SUBTASK-042 in dependency order, reconcile their pinned outputs, and require the final gate `POST-SUBTASK-042` to issue an evidence-backed approve/block/reject/defer decision before any downstream use.
...
1. All child subtasks POST-SUBTASK-040, POST-SUBTASK-041, POST-SUBTASK-042 have verified evidence or an explicit accepted-risk/deferred/cancelled disposition consistent with the Story contract.
2. The final gate `POST-SUBTASK-042` completes and proves the Story end-to-end requirement; closing implementation children alone is insufficient.
...
- **END_TO_END** / `END_TO_END` — `POST-SUBTASK-042` — The final child gate `POST-SUBTASK-042` must prove the integrated Story outcome and downstream-consumable output.
...
Pinned source/schema inputs resolve through auditable canonical identities and temporal transitions into a reproducible entity snapshot with no silent merges or orphans.
