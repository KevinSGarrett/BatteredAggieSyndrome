<!-- GENERATED VIEW. Canonical record: jira/records/issues/tasks/TASK-092_define_a_and_m_peer_cohort_analog_evidence_interface.json -->
# TASK-092 — [TASK-092] Define A&M peer cohort/analog evidence interface
...
```json
{
  ...
  "acceptance_criteria": [
    "Stable ID TASK-092, parent EPIC-016, owner wave W14, and original status DONE are preserved.",
  ...
  "canonical_record": "jira/records/issues/tasks/TASK-092_define_a_and_m_peer_cohort_analog_evidence_interface.json",
  ...
  "gap_ids": [],
  "generated_markdown": "jira/issues/tasks/TASK-092_define_a_and_m_peer_cohort_analog_evidence_interface.md",
  ...
  "objective": "Define A&M peer cohort/analog evidence interface",
  "operational_jira": {
    "assignee": "",
    "jira_issue_id": "24335",
    "jira_updated_at": "2026-08-09T00:40:33.241-0500",
  ...
  "required_evidence": [
    "Authoritative WBS row TASK-092",
    "Existing artifact `peer/analog contract`"
  ],
  "required_tests": [
    {
  ...
  "specificity_fingerprint": "cd0a54cc2a17be0c8ed5dd6b33d983c22c07c77bd7fedba3b24572710b9a946f",
  "stop_conditions": [
  ...
  "title": "[TASK-092] Define A&M peer cohort/analog evidence interface",
...
Define A&M peer cohort/analog evidence interface
...
1. Stable ID TASK-092, parent EPIC-016, owner wave W14, and original status DONE are preserved.
