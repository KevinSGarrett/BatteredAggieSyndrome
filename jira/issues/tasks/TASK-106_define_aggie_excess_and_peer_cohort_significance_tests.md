<!-- GENERATED VIEW. Canonical record: jira/records/issues/tasks/TASK-106_define_aggie_excess_and_peer_cohort_significance_tests.json -->
# TASK-106 — [TASK-106] Define Aggie Excess and peer-cohort significance tests
...
```json
{
  ...
  "acceptance_criteria": [
    "Stable ID TASK-106, parent EPIC-019, owner wave W15, and original status DONE are preserved.",
  ...
  "allowed_modification_paths": [
    "Aggie Excess test plan"
  ],
  "blocked_reason": "",
  "blocks": [
    "TASK-108"
  ],
  "canonical_record": "jira/records/issues/tasks/TASK-106_define_aggie_excess_and_peer_cohort_significance_tests.json",
  ...
  "gap_ids": [],
  "generated_markdown": "jira/issues/tasks/TASK-106_define_aggie_excess_and_peer_cohort_significance_tests.md",
  ...
  "objective": "Define Aggie Excess and peer-cohort significance tests",
  "operational_jira": {
    "assignee": "",
    "jira_issue_id": "24349",
    "jira_updated_at": "2026-08-09T00:40:36.295-0500",
  ...
  "phase": "PHASE-3",
  "prerequisites": [
    "Historical dependency TASK-105",
    "Historical dependency TASK-092"
  ],
  "primary_source_refs": [
    "SRCREF-00139",
    "SRCREF-02116",
  ...
  "required_evidence": [
    "Authoritative WBS row TASK-106",
    "Existing artifact `Aggie Excess test plan`"
  ],
  "required_tests": [
    {
  ...
  "specificity_fingerprint": "2ca2dda46b781fd3f6fa442899f173f3997d2b5da48ca1685bc4d3c830071f6f",
  "stop_conditions": [
  ...
  "title": "[TASK-106] Define Aggie Excess and peer-cohort significance tests",
...
Define Aggie Excess and peer-cohort significance tests
...
- Inherited from: None
- Resolution: `DIRECT`
- Effective counts: `{"acceptance_control_ids": 7, "adr_ids": 0, "gap_ids": 0, "requirement_ids": 8, "risk_ids": 0}`

## Acceptance Criteria

1. Stable ID TASK-106, parent EPIC-019, owner wave W15, and original status DONE are preserved.
