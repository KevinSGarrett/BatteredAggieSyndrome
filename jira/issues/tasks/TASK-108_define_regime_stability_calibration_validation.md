<!-- GENERATED VIEW. Canonical record: jira/records/issues/tasks/TASK-108_define_regime_stability_calibration_validation.json -->
# TASK-108 — [TASK-108] Define regime/stability/calibration validation
...
```json
{
  ...
  "acceptance_criteria": [
    "Stable ID TASK-108, parent EPIC-019, owner wave W15, and original status DONE are preserved.",
  ...
  "allowed_modification_paths": [
    "BAS stability/calibration plan"
  ],
  "blocked_reason": "",
  "blocks": [
    "TASK-109"
  ],
  "canonical_record": "jira/records/issues/tasks/TASK-108_define_regime_stability_calibration_validation.json",
  ...
  "gap_ids": [],
  "generated_markdown": "jira/issues/tasks/TASK-108_define_regime_stability_calibration_validation.md",
  ...
  "objective": "Define regime/stability/calibration validation",
  "operational_jira": {
    "assignee": "",
    "jira_issue_id": "24351",
  ...
  "phase": "PHASE-3",
  "prerequisites": [
    "Historical dependency TASK-106",
    "Historical dependency TASK-107"
  ],
  "primary_source_refs": [
    "SRCREF-00141",
    "SRCREF-02116",
  ...
  "required_evidence": [
    "Authoritative WBS row TASK-108",
    "Existing artifact `BAS stability/calibration plan`"
  ],
  "required_tests": [
    {
  ...
  "specificity_fingerprint": "6e12f1eb41015afda2cc9f2d252c2fafaeb92ae7eb7014dba1f89795cbb5ba44",
  "stop_conditions": [
  ...
  "title": "[TASK-108] Define regime/stability/calibration validation",
...
Define regime/stability/calibration validation
...
1. Stable ID TASK-108, parent EPIC-019, owner wave W15, and original status DONE are preserved.
