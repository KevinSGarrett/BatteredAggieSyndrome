<!-- GENERATED VIEW. Canonical record: jira/records/issues/epics/EPIC-007_foundation_baseline_model_capability.json -->
# EPIC-007 — [EPIC-007] Foundation baseline model capability
...
```json
{
  ...
  "acceptance_criteria": [
    "The epic retains stable ID EPIC-007, owner wave W16-W17, phase PHASE-1, and all authoritative WBS children.",
  ...
  "blocked_reason": "",
  "blocks": [],
  "canonical_record": "jira/records/issues/epics/EPIC-007_foundation_baseline_model_capability.json",
  ...
  "gap_ids": [],
  "generated_markdown": "jira/issues/epics/EPIC-007_foundation_baseline_model_capability.md",
  ...
  "operational_jira": {
    "assignee": "",
    "jira_issue_id": "24147",
    "jira_updated_at": "2026-08-09T00:40:10.610-0500",
  ...
  "specificity_fingerprint": "b2ec8a1ba587d179cfcdac843a74140f66805925d64d30f48e7ad813dc868a46",
  "stop_conditions": [
    "Stop if a proposed update renumbers the historical epic or rewrites its original wave provenance."
  ],
  "supporting_source_refs": [],
  "title": "[EPIC-007] Foundation baseline model capability",
...
Establish simple and boosted national baselines, calibration and walk-forward benchmarks before complex challengers.
...
1. The epic retains stable ID EPIC-007, owner wave W16-W17, phase PHASE-1, and all authoritative WBS children.
