<!-- GENERATED VIEW. Canonical record: jira/records/issues/tasks/TASK-099_freeze_specialization_candidates_for_w16_w17_comparison.json -->
# TASK-099 — [TASK-099] Freeze specialization candidates for W16/W17 comparison
...
```json
{
  ...
  "acceptance_criteria": [
    "Stable ID TASK-099, parent EPIC-017, owner wave W14, and original status DONE are preserved.",
  ...
  "canonical_record": "jira/records/issues/tasks/TASK-099_freeze_specialization_candidates_for_w16_w17_comparison.json",
  ...
  "gap_ids": [],
  "generated_markdown": "jira/issues/tasks/TASK-099_freeze_specialization_candidates_for_w16_w17_comparison.md",
  ...
  "objective": "Freeze specialization candidates for W16/W17 comparison",
  "operational_jira": {
    "assignee": "",
    "jira_issue_id": "24342",
    "jira_updated_at": "2026-08-09T00:40:34.760-0500",
  ...
  "phase": "PHASE-3",
  "prerequisites": [
    "Historical dependency TASK-097",
    "Historical dependency TASK-098"
  ],
  "primary_source_refs": [
    "SRCREF-00132",
    "SRCREF-02116",
  ...
  "required_evidence": [
    "Authoritative WBS row TASK-099",
    "Existing artifact `specialization candidate baseline`"
  ],
  "required_tests": [
    {
  ...
  "specificity_fingerprint": "a77e588fd06b99cd9457962263eeb1400dcce743fd3c3dee79d888963f715b88",
  "stop_conditions": [
  ...
  "title": "[TASK-099] Freeze specialization candidates for W16/W17 comparison",
...
Freeze specialization candidates for W16/W17 comparison
...
- Inherited from: None
- Resolution: `DIRECT`
- Effective counts: `{"acceptance_control_ids": 5, "adr_ids": 0, "gap_ids": 0, "requirement_ids": 19, "risk_ids": 0}`

## Acceptance Criteria

1. Stable ID TASK-099, parent EPIC-017, owner wave W14, and original status DONE are preserved.
