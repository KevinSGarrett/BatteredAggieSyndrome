<!-- GENERATED VIEW. Canonical record: jira/records/issues/tasks/TASK-035_freeze_team_state_early_season_interface_for_downstream_intelligence.json -->
# TASK-035 — [TASK-035] Freeze team-state/early-season interface for downstream intelligence
...
```json
{
  ...
  "acceptance_criteria": [
    "Stable ID TASK-035, parent EPIC-006, owner wave W11, and original status DONE are preserved.",
  ...
  "canonical_record": "jira/records/issues/tasks/TASK-035_freeze_team_state_early_season_interface_for_downstream_intelligence.json",
  ...
  "gap_ids": [],
  "generated_markdown": "jira/issues/tasks/TASK-035_freeze_team_state_early_season_interface_for_downstream_intelligence.md",
  ...
  "objective": "Freeze team-state/early-season interface for downstream intelligence",
  "operational_jira": {
    "assignee": "",
    "jira_issue_id": "24278",
    "jira_updated_at": "2026-08-09T00:40:22.471-0500",
  ...
  "phase": "PHASE-1",
  "prerequisites": [
    "Historical dependency TASK-034"
  ],
  "primary_source_refs": [
    "SRCREF-00068",
    "SRCREF-02116",
  ...
  "required_evidence": [
    "Authoritative WBS row TASK-035",
    "Existing artifact `team-state baseline contract`"
  ],
  "required_tests": [
    {
  ...
  "specificity_fingerprint": "6ec9d64fe974a81272e778ca7e9ee8e18c70abee15f0bd7438a9457b31b458e3",
  "stop_conditions": [
  ...
  "title": "[TASK-035] Freeze team-state/early-season interface for downstream intelligence",
...
Freeze team-state/early-season interface for downstream intelligence
...
1. Stable ID TASK-035, parent EPIC-006, owner wave W11, and original status DONE are preserved.
