<!-- GENERATED VIEW. Canonical record: jira/records/issues/epics/EPIC-030_future_live_in_game_research_lane.json -->
# EPIC-030 — [EPIC-030] Future live/in-game research lane
...
```json
{
  ...
  "acceptance_criteria": [
    "The epic retains stable ID EPIC-030, owner wave W24+, phase PHASE-5, and all authoritative WBS children.",
  ...
  "blocked_reason": "",
  "blocks": [],
  "canonical_record": "jira/records/issues/epics/EPIC-030_future_live_in_game_research_lane.json",
  ...
  "expected_outputs": [
    ...
    "live source feasibility update",
  ...
  "gap_ids": [],
  "generated_markdown": "jira/issues/epics/EPIC-030_future_live_in_game_research_lane.md",
  ...
  "objective": "Research chronological live replay without allowing live state into the same game pregame feature row.",
  "operational_jira": {
    "assignee": "",
    "jira_issue_id": "24170",
    "jira_updated_at": "2026-08-09T00:04:54.429-0500",
  ...
  "required_tests": [
    {
      ...
      "expectation": "Create and execute the smallest deterministic validation or end-to-end gate that proves this issue without fabricating unavailable evidence.",
      "path": "NEW TEST REQUIRED"
    }
  ],
  "requirement_ids": [],
  ...
  "specificity_fingerprint": "f489bbd2b869bb438badd9edd8c4f2b84fd08348115fac641e0bc892adad4439",
  "stop_conditions": [
    "Stop if a proposed update renumbers the historical epic or rewrites its original wave provenance."
  ],
  "supporting_source_refs": [],
  "title": "[EPIC-030] Future live/in-game research lane",
...
Research chronological live replay without allowing live state into the same game pregame feature row.
...
1. The epic retains stable ID EPIC-030, owner wave W24+, phase PHASE-5, and all authoritative WBS children.
...
- **NEW_AUTOMATED_TEST_REQUIRED** / `NEW_AUTOMATED_TEST_REQUIRED` — `NEW TEST REQUIRED` — Create and execute the smallest deterministic validation or end-to-end gate that proves this issue without fabricating unavailable evidence.
