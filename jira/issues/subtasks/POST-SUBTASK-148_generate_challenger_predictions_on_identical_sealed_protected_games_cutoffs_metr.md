...
```json
{
  ...
  "critical_path": false,
  "definition_of_done": [
    "The atomic scope in POST-SUBTASK-148 is completed without absorbing sibling work or weakening any protected requirement, control, split, judging rule, private-research publication boundary, or security boundary.",
  ...
  "end_to_end_validation": "Validate that `artifacts/advanced/challenger_protected_scorecard.json` can be parsed and consumed by `POST-SUBTASK-149` using only documented identities and interfaces; the consumer must reject missing, stale, schema-incompatible, technically or quality-ineligible, or provenance-incomplete input without manual repair.",
  ...
  "operational_jira": {
    "assignee": "",
    "jira_issue_id": "24638",
    "jira_updated_at": "2026-08-09T23:24:14.622-0500",
  ...
  "specificity_fingerprint": "7213aed45b033bc8b2cafb8427c6eb99116160000677b0902d77d36248b3dc5f",
  "stop_conditions": [
...
1. The atomic scope in POST-SUBTASK-148 is completed without absorbing sibling work or weakening any protected requirement, control, split, judging rule, private-research publication boundary, or security boundary.
...
Validate that `artifacts/advanced/challenger_protected_scorecard.json` can be parsed and consumed by `POST-SUBTASK-149` using only documented identities and interfaces; the consumer must reject missing, stale, schema-incompatible, technically or quality-ineligible, or provenance-incomplete input without manual repair.
