...
def main() -> int:
    parser = argparse.ArgumentParser(description="Independently validate the official 2003 season-index capture.")
    ...
    if not args.validate_only:
        ...
        mutations.append(
            expect_rejection(
                "invented_season_url",
                lambda: _validate(
                    _mutated_gate(gate, official_index_url="https://files.12thman.com/history/football/years/2004.html")
                ),
            )
        )
        ...
        invented = list(gate["box_score_urls"]) + [
            "https://files.12thman.com/history/football/stats/2003-2004/invented.html"
        ]
