# AI Work Packet — POST-SUBTASK-144
...
1. `jira/records/issues/subtasks/POST-SUBTASK-144_apply_the_existing_advanced_challenger_admission_gate_and_retain_rejection_no_ad.json`
2. `jira/sources/issue_source_manifests/POST-SUBTASK-144.json`
3. `jira/index/ISSUE_GOVERNANCE_CONTEXT.csv` row for `POST-SUBTASK-144`.
