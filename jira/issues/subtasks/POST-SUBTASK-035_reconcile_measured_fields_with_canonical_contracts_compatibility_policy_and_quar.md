<!-- GENERATED VIEW. Canonical record: jira/records/issues/subtasks/POST-SUBTASK-035_reconcile_measured_fields_with_canonical_contracts_compatibility_policy_and_quar.json -->
# POST-SUBTASK-035 — [POST-SUBTASK-035] Reconcile measured fields with canonical contracts, compatibility policy, and quarantine/rejection decisions
...
```json
{
  ...
  "acceptance_criteria": [
    ...
    "The declared output `artifacts/entities/schema_reconciliation.csv` is produced with deterministic identity, provenance, and validation metadata appropriate to this work.",
  ...
  "ai_context_notes": [
    ...
    "Read the exact source sections in `jira/sources/issue_source_manifests/POST-SUBTASK-035.json`; inspect only the listed implementation files and prerequisite outputs.",
  ...
  "canonical_record": "jira/records/issues/subtasks/POST-SUBTASK-035_reconcile_measured_fields_with_canonical_contracts_compatibility_policy_and_quar.json",
  "canonical_source_role": "AUTHORITATIVE_LOCAL_SPECIFICATION",
  "completion_evidence_contract": {
    "acceptance_matrix_required": true,
    "artifact_hashes_required": true,
    "completion_claim_limit": "EMPIRICALLY_VALIDATED",
    "downstream_consumer": "POST-SUBTASK-036",
  ...
  "critical_path": true,
  "definition_of_done": [
    "The atomic scope in POST-SUBTASK-035 is completed without absorbing sibling work or weakening any protected requirement, control, split, judging rule, private-research publication boundary, or security boundary.",
    ...
    "The output set `artifacts/entities/schema_reconciliation.csv` is demonstrably consumable by POST-SUBTASK-036 without manual reconstruction or undocumented state."
  ],
  "dependencies": [
    "POST-SUBTASK-033",
    "POST-SUBTASK-034"
  ...
  "end_to_end_validation": "Validate that `artifacts/entities/schema_reconciliation.csv` can be parsed and consumed by `POST-SUBTASK-036` using only documented identities and interfaces; the consumer must reject missing, stale, schema-incompatible, technically or quality-ineligible, or provenance-incomplete input without manual repair.",
  "epic_id": "POST-EPIC-004",
  "evidence_manifest_path": "artifacts/jira_evidence/POST-SUBTASK-035.json",
  ...
  "gap_ids": [],
  "generated_markdown": "jira/issues/subtasks/POST-SUBTASK-035_reconcile_measured_fields_with_canonical_contracts_compatibility_policy_and_quar.md",
  ...
  "local_id": "POST-SUBTASK-035",
  "maturity_before": "FUNCTIONAL_STARTER",
  "objective": "Reconcile measured fields with canonical contracts, compatibility policy, and quarantine/rejection decisions",
  "operational_jira": {
    "assignee": "",
    "jira_issue_id": "24525",
    "jira_updated_at": "2026-08-09T18:34:22.383-0500",
    "last_synced_at": "2026-08-09T23:35:05.017597+00:00",
    "source_export": "C:\\BatteredAggieSyndrome.data\\runtime\\BAT-385\\BAT-385-live-row.csv",
    "sprint": "",
    "status_raw": "Done"
  },
  "out_of_scope": [
  ...
  "required_tests": [
    {
      ...
      "expectation": "Run as a regression check after completing POST-SUBTASK-035; retain command, exit code, and relevant output.",
    ...
    },
    {
      ...
      "path": "artifacts/entities/schema_reconciliation.csv",
  ...
  "risk_failure_conditions": [
    "The work would be invalid if any prerequisite artifact, source/data/code/config identity, or declared maturity differs from the pinned issue contract for POST-SUBTASK-035.",
    ...
    "Acceptance failure: the evidence cannot demonstrate that the declared output `artifacts/entities/schema_reconciliation.csv` is produced with deterministic identity, provenance, and validation metadata appropriate to this work.",
  ...
  "specificity_fingerprint": "93de14a1299e4794cdc390f7fd5d1f4a4ee135e7f318c870289c7ecf73bde3b5",
  "stop_conditions": [
  ...
  "title": "[POST-SUBTASK-035] Reconcile measured fields with canonical contracts, compatibility policy, and quarantine/rejection decisions",
  ...
  "work_packet_path": "jira/ai/work_packets/POST-SUBTASK-035.md",
  "workflow_state": "DONE"
}
```
...
1. The atomic scope in POST-SUBTASK-035 is completed without absorbing sibling work or weakening any protected requirement, control, split, judging rule, private-research publication boundary, or security boundary.
...
7. The output set `artifacts/entities/schema_reconciliation.csv` is demonstrably consumable by POST-SUBTASK-036 without manual reconstruction or undocumented state.
...
Validate that `artifacts/entities/schema_reconciliation.csv` can be parsed and consumed by `POST-SUBTASK-036` using only documented identities and interfaces; the consumer must reject missing, stale, schema-incompatible, technically or quality-ineligible, or provenance-incomplete input without manual repair.
