<!-- GENERATED VIEW. Canonical record: jira/records/issues/subtasks/POST-SUBTASK-198_implement_the_non_billable_provider_neutral_openrouter_foundation_usd_0_hard_stop_privacy_co.json -->
# POST-SUBTASK-198 — [POST-SUBTASK-198] Implement the non-billable provider-neutral OpenRouter foundation, USD 0 hard stop, privacy controls, storage, schemas, and worker isolation
...
```json
{
  ...
  "canonical_record": "jira/records/issues/subtasks/POST-SUBTASK-198_implement_the_non_billable_provider_neutral_openrouter_foundation_usd_0_hard_stop_privacy_co.json",
  ...
  "evidence_manifest_path": "artifacts/jira_evidence/POST-SUBTASK-198.json",
  ...
  "gap_ids": [],
  "generated_markdown": "jira/issues/subtasks/POST-SUBTASK-198_implement_the_non_billable_provider_neutral_openrouter_foundation_usd_0_hard_stop_privacy_co.md",
  ...
  "local_id": "POST-SUBTASK-198",
  "maturity_before": "NOT_STARTED",
  "objective": "Implement the non-billable provider-neutral OpenRouter foundation, USD 0 hard stop, privacy controls, storage, schemas, and worker isolation",
  "operational_jira": {
    "assignee": "",
    "jira_issue_id": "24949",
    "jira_updated_at": "2026-08-12T11:49:52.892-0500",
    "last_synced_at": "2026-08-12T16:50:14.033730+00:00",
  ...
  "risk_ids": [],
  "schema_version": 2,
  "scope": "Implement and integrate the governed foundation and public capability evidence. Paid inference is out of scope and must be rejected locally before network dispatch.",
  "source_ids": [
  ...
  "title": "[POST-SUBTASK-198] Implement the non-billable provider-neutral OpenRouter foundation, USD 0 hard stop, privacy controls, storage, schemas, and worker isolation",
  ...
  "work_packet_path": "jira/ai/work_packets/POST-SUBTASK-198.md",
  "workflow_state": "DONE"
}
```
