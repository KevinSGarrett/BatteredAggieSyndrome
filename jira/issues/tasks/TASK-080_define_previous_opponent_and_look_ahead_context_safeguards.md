<!-- GENERATED VIEW. Canonical record: jira/records/issues/tasks/TASK-080_define_previous_opponent_and_look_ahead_context_safeguards.json -->
# TASK-080 — [TASK-080] Define previous-opponent and look-ahead context safeguards
...
```json
{
  ...
  "acceptance_criteria": [
    "Stable ID TASK-080, parent EPIC-014, owner wave W13, and original status DONE are preserved.",
  ...
  "allowed_modification_paths": [
    "chronological schedule context rules"
  ],
  "blocked_reason": "",
  "blocks": [
    "TASK-082"
  ],
  "canonical_record": "jira/records/issues/tasks/TASK-080_define_previous_opponent_and_look_ahead_context_safeguards.json",
  ...
  "gap_ids": [],
  "generated_markdown": "jira/issues/tasks/TASK-080_define_previous_opponent_and_look_ahead_context_safeguards.md",
  ...
  "objective": "Define previous-opponent and look-ahead context safeguards",
  "operational_jira": {
    "assignee": "",
    "jira_issue_id": "24323",
    "jira_updated_at": "2026-08-09T00:40:30.984-0500",
  ...
  "phase": "PHASE-2",
  "prerequisites": [
    "Historical dependency TASK-079",
  ...
  "required_evidence": [
    "Authoritative WBS row TASK-080",
    "Existing artifact `chronological schedule context rules`"
  ],
  "required_tests": [
    {
  ...
  "specificity_fingerprint": "e89a86bdcffd31dc2ed420d00bd038bc2cb6188561d4e2e76487f07f4ffaaa0b",
  "stop_conditions": [
  ...
  "title": "[TASK-080] Define previous-opponent and look-ahead context safeguards",
...
Define previous-opponent and look-ahead context safeguards
...
1. Stable ID TASK-080, parent EPIC-014, owner wave W13, and original status DONE are preserved.
