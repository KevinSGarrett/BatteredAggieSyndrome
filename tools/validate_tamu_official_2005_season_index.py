...
def main() -> int:
    parser = argparse.ArgumentParser(description="Independently validate the official 2005 season-index capture.")
    ...
    if not args.validate_only:
        ...
        mutations.append(
            expect_rejection(
                "guessed_url",
                lambda: _validate(
                    _mutated_gate(gate, official_index_url="https://files.12thman.com/history/football/years/2006.html")
                ),
            )
        )
        ...
        invented = list(gate["box_score_urls"]) + [
            "https://files.12thman.com/history/football/stats/2005-2006/invented.html"
        ]
        ...
        upstream["bat594_gate_identity"] = "0" * 64
        mutations.append(
            expect_rejection(
                "bat594_identity_rewrite",
