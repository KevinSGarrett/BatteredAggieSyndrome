<!-- GENERATED VIEW. Canonical record: jira/records/issues/subtasks/POST-SUBTASK-097_verify_protected_split_judging_rule_threshold_feature_model_a_and_m_bas_peer_and.json -->
# POST-SUBTASK-097 — [POST-SUBTASK-097] Verify protected split, judging-rule, threshold, feature, model, A&M, BAS, peer, and candidate seal hashes
...
```json
{
  ...
  "ai_context_notes": [
    ...
    "Read the exact source sections in `jira/sources/issue_source_manifests/POST-SUBTASK-097.json`; inspect only the listed implementation files and prerequisite outputs.",
  ...
  "blocked_reason": "UNSATISFIED_HARD_DEPENDENCIES: POST-SUBTASK-078;POST-SUBTASK-084;POST-SUBTASK-090",
  "blocks": [
    "POST-SUBTASK-098",
    "POST-SUBTASK-099"
  ],
  "canonical_record": "jira/records/issues/subtasks/POST-SUBTASK-097_verify_protected_split_judging_rule_threshold_feature_model_a_and_m_bas_peer_and.json",
  "canonical_source_role": "AUTHORITATIVE_LOCAL_SPECIFICATION",
  "completion_evidence_contract": {
    "acceptance_matrix_required": true,
    "artifact_hashes_required": true,
    "completion_claim_limit": "IMPLEMENTED",
    "downstream_consumer": "POST-SUBTASK-098",
  ...
  "critical_path": true,
  "definition_of_done": [
    "The atomic scope in POST-SUBTASK-097 is completed without absorbing sibling work or weakening any protected requirement, control, split, judging rule, private-research publication boundary, or security boundary.",
    ...
    "The output set `artifacts/validation/protected_seal_verification.json` is demonstrably consumable by POST-SUBTASK-098 without manual reconstruction or undocumented state."
  ],
  "dependencies": [
    "POST-SUBTASK-078",
    "POST-SUBTASK-084",
  ...
  "end_to_end_validation": "Validate that `artifacts/validation/protected_seal_verification.json` can be parsed and consumed by `POST-SUBTASK-098` using only documented identities and interfaces; the consumer must reject missing, stale, schema-incompatible, technically or quality-ineligible, or provenance-incomplete input without manual repair.",
  "epic_id": "POST-EPIC-011",
  "evidence_manifest_path": "artifacts/jira_evidence/POST-SUBTASK-097.json",
  ...
  "gap_ids": [],
  "generated_markdown": "jira/issues/subtasks/POST-SUBTASK-097_verify_protected_split_judging_rule_threshold_feature_model_a_and_m_bas_peer_and.md",
  ...
  "operational_jira": {
    "assignee": "",
    "jira_issue_id": "24587",
    "jira_updated_at": "2026-08-09T23:24:09.423-0500",
  ...
  "required_tests": [
    {
      ...
      "expectation": "Run as a regression check after completing POST-SUBTASK-097; retain command, exit code, and relevant output.",
    ...
    },
    {
      ...
      "path": "artifacts/validation/protected_seal_verification.json",
  ...
  "risk_failure_conditions": [
    "The work would be invalid if any prerequisite artifact, source/data/code/config identity, or declared maturity differs from the pinned issue contract for POST-SUBTASK-097.",
    ...
    "Acceptance failure: the evidence cannot demonstrate that the declared output `artifacts/validation/protected_seal_verification.json` is produced with deterministic identity, provenance, and validation metadata appropriate to this work.",
  ...
  "risk_ids": [],
  "schema_version": 2,
  "scope": "Execute the atomic 1 of 3 step in Story POST-STORY-033 (Protected split, judging rule, threshold, candidate, and access seal): Verify protected split, judging-rule, threshold, feature, model, A&M, BAS, peer, and candidate seal hashes. Consume only verified prerequisite outputs from `POST-SUBTASK-078`, `POST-SUBTASK-084`, `POST-SUBTASK-090`. Produce `artifacts/validation/protected_seal_verification.json`; evaluate every issue-specific acceptance condition; preserve negative results; and hand the pinned output to POST-SUBTASK-098.",
  "source_ids": [
    "AC-013",
    "AC-015",
    "AC-017",
  ...
  "specificity_fingerprint": "84cc5b928c38df3b27e72bd1f599cc7e21a19a079e49fa15ffc3747183a2decf",
  "stop_conditions": [
  ...
  "title": "[POST-SUBTASK-097] Verify protected split, judging-rule, threshold, feature, model, A&M, BAS, peer, and candidate seal hashes",
  ...
  "work_packet_path": "jira/ai/work_packets/POST-SUBTASK-097.md",
...
1. The atomic scope in POST-SUBTASK-097 is completed without absorbing sibling work or weakening any protected requirement, control, split, judging rule, private-research publication boundary, or security boundary.
...
7. The output set `artifacts/validation/protected_seal_verification.json` is demonstrably consumable by POST-SUBTASK-098 without manual reconstruction or undocumented state.
...
Validate that `artifacts/validation/protected_seal_verification.json` can be parsed and consumed by `POST-SUBTASK-098` using only documented identities and interfaces; the consumer must reject missing, stale, schema-incompatible, technically or quality-ineligible, or provenance-incomplete input without manual repair.
