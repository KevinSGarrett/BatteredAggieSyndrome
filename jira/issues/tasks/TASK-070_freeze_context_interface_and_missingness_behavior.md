<!-- GENERATED VIEW. Canonical record: jira/records/issues/tasks/TASK-070_freeze_context_interface_and_missingness_behavior.json -->
# TASK-070 — [TASK-070] Freeze context interface and missingness behavior
...
```json
{
  ...
  "acceptance_criteria": [
    "Stable ID TASK-070, parent EPIC-012, owner wave W13, and original status DONE are preserved.",
  ...
  "canonical_record": "jira/records/issues/tasks/TASK-070_freeze_context_interface_and_missingness_behavior.json",
  ...
  "gap_ids": [],
  "generated_markdown": "jira/issues/tasks/TASK-070_freeze_context_interface_and_missingness_behavior.md",
  ...
  "objective": "Freeze context interface and missingness behavior",
  "operational_jira": {
    "assignee": "",
    "jira_issue_id": "24313",
    "jira_updated_at": "2026-08-09T00:40:29.292-0500",
  ...
  "prerequisites": [
    ...
    "Historical dependency TASK-068",
  ...
  "required_evidence": [
    "Authoritative WBS row TASK-070",
    "Existing artifact `context interface baseline`"
  ],
  "required_tests": [
    {
  ...
  "specificity_fingerprint": "3c59a5c7a34b7633c97cb3cd2dfce4763c47c6b25a3197981a6b57639d2ac868",
  "stop_conditions": [
  ...
  "title": "[TASK-070] Freeze context interface and missingness behavior",
...
Freeze context interface and missingness behavior
...
1. Stable ID TASK-070, parent EPIC-012, owner wave W13, and original status DONE are preserved.
