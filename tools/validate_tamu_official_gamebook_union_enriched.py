...
def main() -> int:
    parser = argparse.ArgumentParser(description="Independently validate the StatCrew-enriched union.")
    ...
    if not args.validate_only:
        ...
        if gate.get("prior_union_identity") != PRIOR_237_UNION_IDENTITY:
            raise AssertionError("committed gate lost the preserved BAT-590 237-game union identity")
