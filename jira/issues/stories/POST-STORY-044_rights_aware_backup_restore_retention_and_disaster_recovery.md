<!-- GENERATED VIEW. Canonical record: jira/records/issues/stories/POST-STORY-044_rights_aware_backup_restore_retention_and_disaster_recovery.json -->
# POST-STORY-044 — [POST-STORY-044] Rights-aware backup, restore, retention, and disaster recovery
...
```json
{
  ...
  "blocked_reason": "",
  "blocks": [],
  "canonical_record": "jira/records/issues/stories/POST-STORY-044_rights_aware_backup_restore_retention_and_disaster_recovery.json",
  "canonical_source_role": "AUTHORITATIVE_LOCAL_SPECIFICATION",
  "completion_evidence_contract": {
    "all_child_evidence_required": true,
    "child_gate": "POST-SUBTASK-132",
  ...
  "critical_path": false,
  "definition_of_done": [
    "All child subtasks POST-SUBTASK-130, POST-SUBTASK-131, POST-SUBTASK-132 have verified evidence or an explicit accepted-risk/deferred/cancelled disposition consistent with the Story contract.",
    "The final gate `POST-SUBTASK-132` completes and proves the Story end-to-end requirement; closing implementation children alone is insufficient.",
  ...
  "end_to_end_validation": "A verified backup can restore selected canonical lineage and Jira execution state into a clean location without rewriting history or violating data rights.",
  "epic_id": "POST-EPIC-014",
  "evidence_manifest_path": "artifacts/jira_evidence/POST-STORY-044.json",
  ...
  "gap_ids": [],
  "generated_markdown": "jira/issues/stories/POST-STORY-044_rights_aware_backup_restore_retention_and_disaster_recovery.md",
  ...
  "local_id": "POST-STORY-044",
  "maturity_before": "FUNCTIONAL_STARTER",
  "objective": "Prove canonical data/model/forecast/Jira state can be recovered to a verified point.",
  "operational_jira": {
    "assignee": "",
    "jira_issue_id": "24234",
    "jira_updated_at": "2026-08-09T23:23:58.700-0500",
  ...
  "phase": "PHASE-4",
  "prerequisites": [
    "Hard dependency POST-SUBTASK-129"
  ],
  "primary_source_refs": [
    "SRCREF-02092",
    "SRCREF-02093",
  ...
  "required_tests": [
    ...
    },
    {
      ...
      "expectation": "The final child gate `POST-SUBTASK-132` must prove the integrated Story outcome and downstream-consumable output.",
      "path": "POST-SUBTASK-132",
  ...
  "risk_ids": [],
  "schema_version": 2,
  "scope": "Deliver Story POST-STORY-044 (Rights-aware backup, restore, retention, and disaster recovery) as one coherent, gated capability inside Epic POST-EPIC-014. Execute child subtasks POST-SUBTASK-130, POST-SUBTASK-131, POST-SUBTASK-132 in dependency order, reconcile their pinned outputs, and require the final gate `POST-SUBTASK-132` to issue an evidence-backed approve/block/reject/defer decision before any downstream use.",
  "source_ids": [
    "HANDOFF-012"
  ],
  "source_refs": [
  ...
  "specificity_fingerprint": "9e5fbeafac8609639b9ec290c7469419ffe93df679f5120206b6b95b9ae208a3",
  "stop_conditions": [
  ...
  "title": "[POST-STORY-044] Rights-aware backup, restore, retention, and disaster recovery",
  ...
  "work_packet_path": "jira/ai/work_packets/POST-STORY-044.md",
...
4. Backups are independently readable/content-hashed/cataloged/permission-checked, partial/corrupt copies never replace good state, and Jira canonical records/key map/change log/indexes are included efficiently.
5. The declared output `artifacts/operations/backup_catalog_and_integrity.json` is produced with deterministic identity, provenance, and validation metadata appropriate to this work.
6. A clean restore passes hash/schema/reference/lineage validation, identifies external credentials/rights reconfiguration, measures recovery, and success is not inferred from backup creation alone.
7. All prerequisite evidence is linked and unresolved blockers remain explicit; file creation alone cannot pass this gate.

## Definition of Done

1. All child subtasks POST-SUBTASK-130, POST-SUBTASK-131, POST-SUBTASK-132 have verified evidence or an explicit accepted-risk/deferred/cancelled disposition consistent with the Story contract.
2. The final gate `POST-SUBTASK-132` completes and proves the Story end-to-end requirement; closing implementation children alone is insufficient.
