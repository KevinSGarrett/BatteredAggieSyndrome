<!-- GENERATED VIEW. Canonical record: jira/records/issues/tasks/TASK-031_build_week_1_priors_and_early_season_blending_candidates.json -->
# TASK-031 — [TASK-031] Build Week-1 priors and early-season blending candidates
...
```json
{
  ...
  "acceptance_criteria": [
    "Stable ID TASK-031, parent EPIC-006, owner wave W11, and original status DONE are preserved.",
  ...
  "canonical_record": "jira/records/issues/tasks/TASK-031_build_week_1_priors_and_early_season_blending_candidates.json",
  ...
  "gap_ids": [],
  "generated_markdown": "jira/issues/tasks/TASK-031_build_week_1_priors_and_early_season_blending_candidates.md",
  ...
  "objective": "Build Week-1 priors and early-season blending candidates",
  "operational_jira": {
    "assignee": "",
    "jira_issue_id": "24274",
    "jira_updated_at": "2026-08-09T00:40:21.709-0500",
  ...
  "required_evidence": [
    "Authoritative WBS row TASK-031",
    "Existing artifact `early-season prior/blending candidates`"
  ],
  "required_tests": [
    {
  ...
  "specificity_fingerprint": "0e757bc87171aef1bf931066412261badd74f9ec60e46fc8f2a86562e93973cb",
  "stop_conditions": [
  ...
  "title": "[TASK-031] Build Week-1 priors and early-season blending candidates",
...
Build Week-1 priors and early-season blending candidates
...
1. Stable ID TASK-031, parent EPIC-006, owner wave W11, and original status DONE are preserved.
