<!-- GENERATED VIEW. Canonical record: jira/records/issues/subtasks/POST-SUBTASK-077_implement_sparse_history_missingness_source_regime_shift_feature_pattern_ood_unc.json -->
# POST-SUBTASK-077 — [POST-SUBTASK-077] Implement sparse-history, missingness, source/regime shift, feature-pattern OOD, uncertainty, and abstention diagnostics
...
```json
{
  ...
  "adr_ids": [],
  "ai_context_notes": [
    "Canonical parent Story: POST-STORY-026. Governance traceability gate: POST-SUBTASK-078. Inherited traceability is resolved through `jira/index/ISSUE_GOVERNANCE_CONTEXT.csv`.",
    "Read the exact source sections in `jira/sources/issue_source_manifests/POST-SUBTASK-077.json`; inspect only the listed implementation files and prerequisite outputs.",
  ...
  "blocked_reason": "UNSATISFIED_HARD_DEPENDENCIES: POST-SUBTASK-075;POST-SUBTASK-076",
  "blocks": [
    "POST-SUBTASK-078"
  ],
  "canonical_record": "jira/records/issues/subtasks/POST-SUBTASK-077_implement_sparse_history_missingness_source_regime_shift_feature_pattern_ood_unc.json",
  "canonical_source_role": "AUTHORITATIVE_LOCAL_SPECIFICATION",
  "completion_evidence_contract": {
    "acceptance_matrix_required": true,
    "artifact_hashes_required": true,
    "completion_claim_limit": "EMPIRICALLY_VALIDATED",
    "downstream_consumer": "POST-SUBTASK-078",
  ...
  "critical_path": true,
  "definition_of_done": [
    "The atomic scope in POST-SUBTASK-077 is completed without absorbing sibling work or weakening any protected requirement, control, split, judging rule, private-research publication boundary, or security boundary.",
    ...
    "The output set `artifacts/modeling/ood_abstention_validation.json` is demonstrably consumable by POST-SUBTASK-078 without manual reconstruction or undocumented state."
  ],
  "dependencies": [
    "POST-SUBTASK-075",
    "POST-SUBTASK-076"
  ...
  "end_to_end_validation": "Validate that `artifacts/modeling/ood_abstention_validation.json` can be parsed and consumed by `POST-SUBTASK-078` using only documented identities and interfaces; the consumer must reject missing, stale, schema-incompatible, technically or quality-ineligible, or provenance-incomplete input without manual repair.",
  "epic_id": "POST-EPIC-008",
  "evidence_manifest_path": "artifacts/jira_evidence/POST-SUBTASK-077.json",
  ...
  "gap_ids": [],
  "generated_markdown": "jira/issues/subtasks/POST-SUBTASK-077_implement_sparse_history_missingness_source_regime_shift_feature_pattern_ood_unc.md",
  ...
  "local_id": "POST-SUBTASK-077",
  "maturity_before": "FUNCTIONAL_STARTER",
  "objective": "Implement sparse-history, missingness, source/regime shift, feature-pattern OOD, uncertainty, and abstention diagnostics",
  "operational_jira": {
    "assignee": "",
    "jira_issue_id": "24567",
    "jira_updated_at": "2026-08-09T23:24:07.318-0500",
  ...
  "owner_wave": "POST_W25",
  "parent_id": "POST-STORY-026",
  "phase": "PHASE-1",
  "prerequisites": [
    "Dependency POST-SUBTASK-075 complete at required maturity",
    "Dependency POST-SUBTASK-076 complete at required maturity"
  ],
  "primary_source_refs": [
    "SRCREF-02049",
    "SRCREF-02050",
  ...
  "required_tests": [
    {
      ...
      "expectation": "Run as a regression check after completing POST-SUBTASK-077; retain command, exit code, and relevant output.",
    ...
    },
    {
      ...
      "path": "artifacts/modeling/ood_abstention_validation.json",
    ...
    },
    {
      ...
      "path": "NEW_TEST_REQUIRED::POST-SUBTASK-077",
      "validation_class": "NEW_AUTOMATED_TEST_REQUIRED"
    }
  ],
  "requirement_ids": [],
  "risk_failure_conditions": [
    "The work would be invalid if any prerequisite artifact, source/data/code/config identity, or declared maturity differs from the pinned issue contract for POST-SUBTASK-077.",
    "A command may exit successfully while producing stale, partial, synthetic-only, leakage-contaminated, non-reproducible, or legally unusable evidence.",
    "Acceptance failure: the evidence cannot demonstrate that evidence-derived tuning thresholds identify unsupported conditions and return wider uncertainty/abstention reasons rather than confident defaults when required inputs are unavailable.",
    "Acceptance failure: the evidence cannot demonstrate that the declared output `artifacts/modeling/ood_abstention_validation.json` is produced with deterministic identity, provenance, and validation metadata appropriate to this work.",
  ...
  "specificity_fingerprint": "04b385c624e076a9c2d386feedf7b982e7fbb4fe9a2d51d2e26b90bb4f432d8d",
  "stop_conditions": [
  ...
  "title": "[POST-SUBTASK-077] Implement sparse-history, missingness, source/regime shift, feature-pattern OOD, uncertainty, and abstention diagnostics",
  ...
  "why_this_exists": "This is an independently executable and verifiable work unit required by Story POST-STORY-026: Calibration, ensembles, OOD, abstention, and candidate artifact registry.",
  "work_packet_path": "jira/ai/work_packets/POST-SUBTASK-077.md",
...
1. The atomic scope in POST-SUBTASK-077 is completed without absorbing sibling work or weakening any protected requirement, control, split, judging rule, private-research publication boundary, or security boundary.
...
7. The output set `artifacts/modeling/ood_abstention_validation.json` is demonstrably consumable by POST-SUBTASK-078 without manual reconstruction or undocumented state.
...
Validate that `artifacts/modeling/ood_abstention_validation.json` can be parsed and consumed by `POST-SUBTASK-078` using only documented identities and interfaces; the consumer must reject missing, stale, schema-incompatible, technically or quality-ineligible, or provenance-incomplete input without manual repair.
