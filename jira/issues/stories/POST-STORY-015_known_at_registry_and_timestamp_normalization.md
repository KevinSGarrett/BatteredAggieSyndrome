<!-- GENERATED VIEW. Canonical record: jira/records/issues/stories/POST-STORY-015_known_at_registry_and_timestamp_normalization.json -->
# POST-STORY-015 — [POST-STORY-015] Known-at registry and timestamp normalization
...
```json
{
  ...
  "allowed_modification_paths": [
    "artifacts/jira_evidence/POST-STORY-015.json"
  ],
  "blocked_reason": "",
  "blocks": [],
  "canonical_record": "jira/records/issues/stories/POST-STORY-015_known_at_registry_and_timestamp_normalization.json",
  "canonical_source_role": "AUTHORITATIVE_LOCAL_SPECIFICATION",
  "completion_evidence_contract": {
    "all_child_evidence_required": true,
    "child_gate": "POST-SUBTASK-045",
  ...
  "critical_path": true,
  "definition_of_done": [
    "All child subtasks POST-SUBTASK-043, POST-SUBTASK-044, POST-SUBTASK-045 have verified evidence or an explicit accepted-risk/deferred/cancelled disposition consistent with the Story contract.",
    "The final gate `POST-SUBTASK-045` completes and proves the Story end-to-end requirement; closing implementation children alone is insufficient.",
  ...
  "end_to_end_validation": "Every value in every pregame horizon has a conservative, testable known-at decision grounded in source timing evidence.",
  "epic_id": "POST-EPIC-005",
  "evidence_manifest_path": "artifacts/jira_evidence/POST-STORY-015.json",
  ...
  "gap_ids": [],
  "generated_markdown": "jira/issues/stories/POST-STORY-015_known_at_registry_and_timestamp_normalization.md",
  "governance_review_required": false,
  "governance_traceability_gate": "POST-SUBTASK-051",
  "historical_classification": "ACTIONABLE_POST_WAVE",
  "import_id": 100065,
  "in_scope": [
    "Complete and verify child `POST-SUBTASK-043` — Reconcile field temporal classes, source known-at rules, cutoffs, correction policies, and prohibited uses against real schemas.",
    "Complete and verify child `POST-SUBTASK-044` — Normalize observed, published, effective, retrieved, and corrected timestamps with source-specific precedence and timezone rules.",
    "Complete and verify child `POST-SUBTASK-045` — Validate fail-closed cutoff eligibility and deliberate future/same-game/postgame rejection.",
    "Integrate the child outputs and execute final gate `POST-SUBTASK-045`.",
  ...
  "operational_jira": {
    "assignee": "",
    "jira_issue_id": "24205",
    "jira_updated_at": "2026-08-09T00:03:34.556-0500",
  ...
  "phase": "PHASE-1",
  "prerequisites": [
    "Hard dependency POST-SUBTASK-042"
  ],
  "primary_source_refs": [
    "SRCREF-02025",
    "SRCREF-02026",
  ...
  "related_to": [],
  "required_evidence": [
    "Verified child completion/evidence manifests for POST-SUBTASK-043, POST-SUBTASK-044, POST-SUBTASK-045.",
    "Final gate decision from `POST-SUBTASK-045` with criterion-by-criterion PASS/FAIL/BLOCKED outcomes and output hashes.",
  ...
  "required_tests": [
    ...
    },
    {
      ...
      "expectation": "The final child gate `POST-SUBTASK-045` must prove the integrated Story outcome and downstream-consumable output.",
  ...
  "risk_ids": [],
  "schema_version": 2,
  "scope": "Deliver Story POST-STORY-015 (Known-at registry and timestamp normalization) as one coherent, gated capability inside Epic POST-EPIC-005. Execute child subtasks POST-SUBTASK-043, POST-SUBTASK-044, POST-SUBTASK-045 in dependency order, reconcile their pinned outputs, and require the final gate `POST-SUBTASK-045` to issue an evidence-backed approve/block/reject/defer decision before any downstream use.",
  "source_ids": [
    "AC-011",
    "AC-012",
    "GAP-005",
  ...
  "title": "[POST-STORY-015] Known-at registry and timestamp normalization",
  ...
  "why_this_exists": "This coherent capability closes a defined portion of Point-in-time historical state and protected replay and creates a verifiable output for the next dependency stage.",
  "work_packet_path": "jira/ai/work_packets/POST-STORY-015.md",
...
Define exactly when each source field may enter each pregame horizon.
...
Deliver Story POST-STORY-015 (Known-at registry and timestamp normalization) as one coherent, gated capability inside Epic POST-EPIC-005. Execute child subtasks POST-SUBTASK-043, POST-SUBTASK-044, POST-SUBTASK-045 in dependency order, reconcile their pinned outputs, and require the final gate `POST-SUBTASK-045` to issue an evidence-backed approve/block/reject/defer decision before any downstream use.
...
1. All child subtasks POST-SUBTASK-043, POST-SUBTASK-044, POST-SUBTASK-045 have verified evidence or an explicit accepted-risk/deferred/cancelled disposition consistent with the Story contract.
2. The final gate `POST-SUBTASK-045` completes and proves the Story end-to-end requirement; closing implementation children alone is insufficient.
...
- **END_TO_END** / `END_TO_END` — `POST-SUBTASK-045` — The final child gate `POST-SUBTASK-045` must prove the integrated Story outcome and downstream-consumable output.
...
Every value in every pregame horizon has a conservative, testable known-at decision grounded in source timing evidence.
