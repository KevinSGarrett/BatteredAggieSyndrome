<!-- GENERATED VIEW. Canonical record: jira/records/issues/tasks/TASK-143_implement_calibration_ensemble_uncertainty_starter.json -->
# TASK-143 — [TASK-143] Implement calibration/ensemble/uncertainty starter
...
```json
{
  ...
  "acceptance_criteria": [
    "Stable ID TASK-143, parent EPIC-025, owner wave W20, and original status DONE are preserved.",
  ...
  "allowed_modification_paths": [
    "calibration/ensemble/uncertainty adapters"
  ],
  "blocked_reason": "",
  "blocks": [
    "TASK-145"
  ],
  "canonical_record": "jira/records/issues/tasks/TASK-143_implement_calibration_ensemble_uncertainty_starter.json",
  ...
  "gap_ids": [],
  "generated_markdown": "jira/issues/tasks/TASK-143_implement_calibration_ensemble_uncertainty_starter.md",
  ...
  "objective": "Implement calibration/ensemble/uncertainty starter",
  "operational_jira": {
    "assignee": "",
    "jira_issue_id": "24386",
    "jira_updated_at": "2026-08-09T00:40:43.282-0500",
  ...
  "phase": "PHASE-4",
  "prerequisites": [
    "Historical dependency TASK-141",
    "Historical dependency TASK-142",
  ...
  "required_evidence": [
    "Authoritative WBS row TASK-143",
    "Existing artifact `calibration/ensemble/uncertainty adapters`"
  ],
  "required_tests": [
    {
  ...
  "specificity_fingerprint": "657bdf82fd192a218085b5959b3f0e140cf14a110479eef28f19813430374a37",
  "stop_conditions": [
  ...
  "title": "[TASK-143] Implement calibration/ensemble/uncertainty starter",
...
Implement calibration/ensemble/uncertainty starter
...
1. Stable ID TASK-143, parent EPIC-025, owner wave W20, and original status DONE are preserved.
