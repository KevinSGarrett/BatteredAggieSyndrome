# AI Work Packet — POST-SUBTASK-149
...
1. `jira/records/issues/subtasks/POST-SUBTASK-149_apply_champion_challenger_promotion_reproducibility_operational_compatibility_pu.json`
2. `jira/sources/issue_source_manifests/POST-SUBTASK-149.json`
3. `jira/index/ISSUE_GOVERNANCE_CONTEXT.csv` row for `POST-SUBTASK-149`.
