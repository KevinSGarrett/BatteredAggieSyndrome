<!-- GENERATED VIEW. Canonical record: jira/records/issues/tasks/TASK-142_implement_score_margin_joint_distribution_starter.json -->
# TASK-142 — [TASK-142] Implement score/margin/joint-distribution starter
...
```json
{
  ...
  "acceptance_criteria": [
    "Stable ID TASK-142, parent EPIC-025, owner wave W20, and original status DONE are preserved.",
  ...
  "allowed_modification_paths": [
    "joint forecast starter"
  ],
  "blocked_reason": "",
  "blocks": [
    "TASK-143"
  ],
  "canonical_record": "jira/records/issues/tasks/TASK-142_implement_score_margin_joint_distribution_starter.json",
  ...
  "gap_ids": [],
  "generated_markdown": "jira/issues/tasks/TASK-142_implement_score_margin_joint_distribution_starter.md",
  ...
  "objective": "Implement score/margin/joint-distribution starter",
  "operational_jira": {
    "assignee": "",
    "jira_issue_id": "24385",
    "jira_updated_at": "2026-08-09T00:40:43.256-0500",
  ...
  "required_evidence": [
    "Authoritative WBS row TASK-142",
    "Existing artifact `joint forecast starter`"
  ],
  "required_tests": [
    {
  ...
  "specificity_fingerprint": "08bd5f6247f7e79c2d6a09bb9be2958b708dd9cf09362a653638773910464aab",
  "stop_conditions": [
  ...
  "title": "[TASK-142] Implement score/margin/joint-distribution starter",
...
Implement score/margin/joint-distribution starter
...
1. Stable ID TASK-142, parent EPIC-025, owner wave W20, and original status DONE are preserved.
