# AI Work Packet — POST-SUBTASK-093
...
1. `jira/records/issues/subtasks/POST-SUBTASK-093_validate_peer_sensitivity_multiple_comparisons_component_coherence_uncertainty_c.json`
2. `jira/sources/issue_source_manifests/POST-SUBTASK-093.json`
3. `jira/index/ISSUE_GOVERNANCE_CONTEXT.csv` row for `POST-SUBTASK-093`.
