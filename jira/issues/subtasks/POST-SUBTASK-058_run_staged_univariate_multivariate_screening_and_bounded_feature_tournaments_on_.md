...
```json
{
  ...
  "critical_path": true,
  "definition_of_done": [
    "The atomic scope in POST-SUBTASK-058 is completed without absorbing sibling work or weakening any protected requirement, control, split, judging rule, rights decision, or security boundary.",
  ...
  "end_to_end_validation": "Validate that `artifacts/features/feature_screening_results.json` can be parsed and consumed by `POST-SUBTASK-059` using only documented identities and interfaces; the consumer must reject missing, stale, schema-incompatible, rights-blocked, or provenance-incomplete input without manual repair.",
  ...
  "operational_jira": {
    "assignee": "",
    "jira_issue_id": "24548",
    "jira_updated_at": "2026-08-09T00:03:42.532-0500",
  ...
  "specificity_fingerprint": "5c7b255443afbf901399e42aeb6c1caea3e44697b22c626caa380dbf481f1253",
  "stop_conditions": [
...
1. The atomic scope in POST-SUBTASK-058 is completed without absorbing sibling work or weakening any protected requirement, control, split, judging rule, rights decision, or security boundary.
...
Validate that `artifacts/features/feature_screening_results.json` can be parsed and consumed by `POST-SUBTASK-059` using only documented identities and interfaces; the consumer must reject missing, stale, schema-incompatible, rights-blocked, or provenance-incomplete input without manual repair.
