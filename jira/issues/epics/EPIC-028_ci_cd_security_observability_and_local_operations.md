<!-- GENERATED VIEW. Canonical record: jira/records/issues/epics/EPIC-028_ci_cd_security_observability_and_local_operations.json -->
# EPIC-028 — [EPIC-028] CI/CD, security, observability and local operations
...
```json
{
  ...
  "acceptance_criteria": [
    "The epic retains stable ID EPIC-028, owner wave W23, phase PHASE-4, and all authoritative WBS children.",
  ...
  "blocked_reason": "",
  "blocks": [],
  "canonical_record": "jira/records/issues/epics/EPIC-028_ci_cd_security_observability_and_local_operations.json",
  ...
  "expected_outputs": [
    ...
    "dependency pin/provenance/security gates + CodeQL/dependency-review workflows",
    "expanded cross-platform core/product CI + runtime manifest artifacts",
  ...
  "gap_ids": [],
  "generated_markdown": "jira/issues/epics/EPIC-028_ci_cd_security_observability_and_local_operations.md",
  ...
  "operational_jira": {
    "assignee": "",
    "jira_issue_id": "24168",
    "jira_updated_at": "2026-08-09T00:04:54.323-0500",
  ...
  "specificity_fingerprint": "cf48aae81c52ebcff6627ca0b7072be42f945ad1e8a2f2d9c24974e5c0b53d99",
  "stop_conditions": [
    "Stop if a proposed update renumbers the historical epic or rewrites its original wave provenance."
  ],
  "supporting_source_refs": [],
  "title": "[EPIC-028] CI/CD, security, observability and local operations",
...
Harden the local production path using measured operational needs rather than cargo-cult infrastructure.
...
1. The epic retains stable ID EPIC-028, owner wave W23, phase PHASE-4, and all authoritative WBS children.
