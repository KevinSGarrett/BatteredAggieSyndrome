<!-- GENERATED VIEW. Canonical record: jira/records/issues/tasks/TASK-032_build_recency_regime_change_point_candidate_framework.json -->
# TASK-032 — [TASK-032] Build recency/regime/change-point candidate framework
...
```json
{
  ...
  "acceptance_criteria": [
    "Stable ID TASK-032, parent EPIC-006, owner wave W11, and original status DONE are preserved.",
  ...
  "canonical_record": "jira/records/issues/tasks/TASK-032_build_recency_regime_change_point_candidate_framework.json",
  ...
  "gap_ids": [],
  "generated_markdown": "jira/issues/tasks/TASK-032_build_recency_regime_change_point_candidate_framework.md",
  ...
  "objective": "Build recency/regime/change-point candidate framework",
  "operational_jira": {
    "assignee": "",
    "jira_issue_id": "24275",
    "jira_updated_at": "2026-08-09T00:40:21.818-0500",
  ...
  "required_evidence": [
    "Authoritative WBS row TASK-032",
    "Existing artifact `historical weighting candidates`"
  ],
  "required_tests": [
    {
  ...
  "specificity_fingerprint": "e615a2af57b82dc42406cc15fc4e3cbd6765e4e6b35ff2ed31f2bc20ca8fd089",
  "stop_conditions": [
  ...
  "title": "[TASK-032] Build recency/regime/change-point candidate framework",
...
Build recency/regime/change-point candidate framework
...
1. Stable ID TASK-032, parent EPIC-006, owner wave W11, and original status DONE are preserved.
