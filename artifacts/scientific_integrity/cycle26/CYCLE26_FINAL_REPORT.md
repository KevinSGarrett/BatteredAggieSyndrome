...
| R26-08 | QUALIFIED |
| R26-09 | CONFIRMED_FIXED (stamp); remaining reconstruction enumerated, not COMPLETE |
...
| R26-22 | CONFIRMED_CONTAINED_NOT_FIXED (0 proven-PIT training rows) |
...
`BRANCH_WORKTREE_HYGIENE=VERIFIED`. Historical cleanup of 8 merged-PR local worktrees/branches is preserved with `refs/preserve/cycle26-hygiene/*`. Re-enumeration: 6 worktrees, 2 open PRs (#678 and Dependabot #654), 0 additional deletions, 0 remote deletions. Leftover local cycle branches without worktrees are retained (`PRESERVATION_RETAIN` / squash-merge unproven; no force-delete). Canonical main unchanged.
