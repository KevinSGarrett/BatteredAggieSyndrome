...
```json
{
  ...
  "critical_path": false,
  "definition_of_done": [
    "The atomic scope in POST-SUBTASK-113 is completed without absorbing sibling work or weakening any protected requirement, control, split, judging rule, rights decision, or security boundary.",
  ...
  "end_to_end_validation": "Validate that `artifacts/mlops/shadow_failure_drills.json` can be parsed and consumed by `POST-SUBTASK-114` using only documented identities and interfaces; the consumer must reject missing, stale, schema-incompatible, rights-blocked, or provenance-incomplete input without manual repair.",
  ...
  "operational_jira": {
    "assignee": "",
    "jira_issue_id": "24603",
    "jira_updated_at": "2026-08-09T00:04:02.529-0500",
  ...
  "specificity_fingerprint": "0b1c9e334208e597759af9cafa3a21a8ebe372cf855e7ded081045328675d582",
  "stop_conditions": [
...
1. The atomic scope in POST-SUBTASK-113 is completed without absorbing sibling work or weakening any protected requirement, control, split, judging rule, rights decision, or security boundary.
...
Validate that `artifacts/mlops/shadow_failure_drills.json` can be parsed and consumed by `POST-SUBTASK-114` using only documented identities and interfaces; the consumer must reject missing, stale, schema-incompatible, rights-blocked, or provenance-incomplete input without manual repair.
