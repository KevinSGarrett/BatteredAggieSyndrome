<!-- GENERATED VIEW. Canonical record: jira/records/issues/tasks/TASK-067_define_program_resource_public_private_asymmetric_lanes.json -->
# TASK-067 — [TASK-067] Define program-resource public/private asymmetric lanes
...
```json
{
  ...
  "acceptance_criteria": [
    "Stable ID TASK-067, parent EPIC-012, owner wave W13, and original status DONE are preserved.",
  ...
  "canonical_record": "jira/records/issues/tasks/TASK-067_define_program_resource_public_private_asymmetric_lanes.json",
  ...
  "gap_ids": [],
  "generated_markdown": "jira/issues/tasks/TASK-067_define_program_resource_public_private_asymmetric_lanes.md",
  ...
  "objective": "Define program-resource public/private asymmetric lanes",
  "operational_jira": {
    "assignee": "",
    "jira_issue_id": "24310",
    "jira_updated_at": "2026-08-09T00:40:28.584-0500",
  ...
  "required_evidence": [
    "Authoritative WBS row TASK-067",
    "Existing artifact `resource capacity evidence lanes and missingness policy`"
  ],
  "required_tests": [
    {
  ...
  "specificity_fingerprint": "c2d43e0d9a1b6de6cbb1664c3617e8f2858d2e64d47d92821f4b106b16053aa5",
  "stop_conditions": [
  ...
  "title": "[TASK-067] Define program-resource public/private asymmetric lanes",
...
Define program-resource public/private asymmetric lanes
...
1. Stable ID TASK-067, parent EPIC-012, owner wave W13, and original status DONE are preserved.
