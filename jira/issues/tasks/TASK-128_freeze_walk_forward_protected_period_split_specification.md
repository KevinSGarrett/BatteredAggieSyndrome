<!-- GENERATED VIEW. Canonical record: jira/records/issues/tasks/TASK-128_freeze_walk_forward_protected_period_split_specification.json -->
# TASK-128 — [TASK-128] Freeze walk-forward/protected-period split specification
...
```json
{
  ...
  "acceptance_criteria": [
    "Stable ID TASK-128, parent EPIC-023, owner wave W17, and original status DONE are preserved.",
  ...
  "canonical_record": "jira/records/issues/tasks/TASK-128_freeze_walk_forward_protected_period_split_specification.json",
  ...
  "gap_ids": [],
  "generated_markdown": "jira/issues/tasks/TASK-128_freeze_walk_forward_protected_period_split_specification.md",
  ...
  "objective": "Freeze walk-forward/protected-period split specification",
  "operational_jira": {
    "assignee": "",
    "jira_issue_id": "24371",
    "jira_updated_at": "2026-08-09T00:40:40.230-0500",
  ...
  "required_evidence": [
    "Authoritative WBS row TASK-128",
    "Existing artifact `2024-2025 holdout`",
    "Existing artifact `2026+ forward shadow`",
    "Existing artifact `sealed protected split registry`"
  ],
  "required_tests": [
    {
  ...
  "specificity_fingerprint": "0ed463ba99f3f2f726e4990359f0e9eccd5201c5d15465dd6ff28041cffa1f8c",
  "stop_conditions": [
  ...
  "title": "[TASK-128] Freeze walk-forward/protected-period split specification",
...
Freeze walk-forward/protected-period split specification
...
1. Stable ID TASK-128, parent EPIC-023, owner wave W17, and original status DONE are preserved.
