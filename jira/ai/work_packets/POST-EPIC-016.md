...
1. `jira/records/issues/epics/POST-EPIC-016_conditional_advanced_challenger_research_and_admission.json`
2. `jira/sources/issue_source_manifests/POST-EPIC-016.json`
3. `jira/index/ISSUE_GOVERNANCE_CONTEXT.csv` row for `POST-EPIC-016`.
