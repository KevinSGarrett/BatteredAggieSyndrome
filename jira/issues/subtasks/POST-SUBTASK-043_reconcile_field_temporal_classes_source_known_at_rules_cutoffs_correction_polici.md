<!-- GENERATED VIEW. Canonical record: jira/records/issues/subtasks/POST-SUBTASK-043_reconcile_field_temporal_classes_source_known_at_rules_cutoffs_correction_polici.json -->
# POST-SUBTASK-043 — [POST-SUBTASK-043] Reconcile field temporal classes, source known-at rules, cutoffs, correction policies, and prohibited uses against real schemas
...
```json
{
  ...
  "ai_context_notes": [
    ...
    "Read the exact source sections in `jira/sources/issue_source_manifests/POST-SUBTASK-043.json`; inspect only the listed implementation files and prerequisite outputs.",
  ...
  "blocked_reason": "UNSATISFIED_HARD_DEPENDENCIES: POST-SUBTASK-042",
  "blocks": [
    "POST-SUBTASK-044",
    "POST-SUBTASK-045"
  ],
  "canonical_record": "jira/records/issues/subtasks/POST-SUBTASK-043_reconcile_field_temporal_classes_source_known_at_rules_cutoffs_correction_polici.json",
  "canonical_source_role": "AUTHORITATIVE_LOCAL_SPECIFICATION",
  "completion_evidence_contract": {
    "acceptance_matrix_required": true,
    "artifact_hashes_required": true,
    "completion_claim_limit": "IMPLEMENTED",
    "downstream_consumer": "POST-SUBTASK-044",
  ...
  "critical_path": true,
  "definition_of_done": [
    "The atomic scope in POST-SUBTASK-043 is completed without absorbing sibling work or weakening any protected requirement, control, split, judging rule, rights decision, or security boundary.",
    ...
    "The output set `configs/known_at_registry.json` is demonstrably consumable by POST-SUBTASK-044 without manual reconstruction or undocumented state."
  ],
  "dependencies": [
    "POST-SUBTASK-042"
  ],
  ...
  "end_to_end_validation": "Validate that `configs/known_at_registry.json` can be parsed and consumed by `POST-SUBTASK-044` using only documented identities and interfaces; the consumer must reject missing, stale, schema-incompatible, rights-blocked, or provenance-incomplete input without manual repair.",
  ...
  "gap_ids": [],
  "generated_markdown": "jira/issues/subtasks/POST-SUBTASK-043_reconcile_field_temporal_classes_source_known_at_rules_cutoffs_correction_polici.md",
  ...
  "local_id": "POST-SUBTASK-043",
  "maturity_before": "FUNCTIONAL_STARTER",
  "objective": "Reconcile field temporal classes, source known-at rules, cutoffs, correction policies, and prohibited uses against real schemas",
  "operational_jira": {
    "assignee": "",
    "jira_issue_id": "24533",
    "jira_updated_at": "2026-08-09T00:03:35.164-0500",
  ...
  "required_tests": [
    {
      ...
      "expectation": "Run as a regression check after completing POST-SUBTASK-043; retain command, exit code, and relevant output.",
    ...
    },
    {
      ...
      "path": "configs/known_at_registry.json",
  ...
  "risk_failure_conditions": [
    "The work would be invalid if any prerequisite artifact, source/data/code/config identity, or declared maturity differs from the pinned issue contract for POST-SUBTASK-043.",
    ...
    "Acceptance failure: the evidence cannot demonstrate that the declared output `configs/known_at_registry.json` is produced with deterministic identity, provenance, and validation metadata appropriate to this work.",
  ...
  "specificity_fingerprint": "dfd8beafff64ff970a77e49bf2ae0ff4a0b53ce427493be13ebd99973e3194f3",
  "stop_conditions": [
  ...
  "title": "[POST-SUBTASK-043] Reconcile field temporal classes, source known-at rules, cutoffs, correction policies, and prohibited uses against real schemas",
...
1. The atomic scope in POST-SUBTASK-043 is completed without absorbing sibling work or weakening any protected requirement, control, split, judging rule, rights decision, or security boundary.
...
7. The output set `configs/known_at_registry.json` is demonstrably consumable by POST-SUBTASK-044 without manual reconstruction or undocumented state.
...
Validate that `configs/known_at_registry.json` can be parsed and consumed by `POST-SUBTASK-044` using only documented identities and interfaces; the consumer must reject missing, stale, schema-incompatible, rights-blocked, or provenance-incomplete input without manual repair.
