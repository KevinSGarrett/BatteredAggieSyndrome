<!-- GENERATED VIEW. Canonical record: jira/records/issues/tasks/TASK-060_define_role_conditioned_development_residual_framework.json -->
# TASK-060 — [TASK-060] Define role-conditioned development residual framework
...
```json
{
  ...
  "acceptance_criteria": [
    "Stable ID TASK-060, parent EPIC-011, owner wave W13, and original status DONE are preserved.",
  ...
  "allowed_modification_paths": [
    "coach development candidate model contract"
  ],
  "blocked_reason": "",
  "blocks": [
    "TASK-063"
  ],
  "canonical_record": "jira/records/issues/tasks/TASK-060_define_role_conditioned_development_residual_framework.json",
  ...
  "gap_ids": [],
  "generated_markdown": "jira/issues/tasks/TASK-060_define_role_conditioned_development_residual_framework.md",
  ...
  "objective": "Define role-conditioned development residual framework",
  "operational_jira": {
    "assignee": "",
    "jira_issue_id": "24303",
    "jira_updated_at": "2026-08-09T00:40:27.086-0500",
  ...
  "required_evidence": [
    "Authoritative WBS row TASK-060",
    "Existing artifact `coach development candidate model contract`"
  ],
  "required_tests": [
    {
  ...
  "specificity_fingerprint": "0486b8bb627c025289e04c33bbebdd03f5a777b2125f5c05d2036bceeb0b6f6a",
  "stop_conditions": [
  ...
  "title": "[TASK-060] Define role-conditioned development residual framework",
...
Define role-conditioned development residual framework
...
1. Stable ID TASK-060, parent EPIC-011, owner wave W13, and original status DONE are preserved.
