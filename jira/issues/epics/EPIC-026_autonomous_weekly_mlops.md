<!-- GENERATED VIEW. Canonical record: jira/records/issues/epics/EPIC-026_autonomous_weekly_mlops.json -->
# EPIC-026 — [EPIC-026] Autonomous weekly MLOps
...
```json
{
  ...
  "acceptance_criteria": [
    "The epic retains stable ID EPIC-026, owner wave W21, phase PHASE-4, and all authoritative WBS children.",
  ...
  "blocked_reason": "",
  "blocks": [],
  "canonical_record": "jira/records/issues/epics/EPIC-026_autonomous_weekly_mlops.json",
  ...
  "gap_ids": [],
  "generated_markdown": "jira/issues/epics/EPIC-026_autonomous_weekly_mlops.md",
  ...
  "operational_jira": {
    "assignee": "",
    "jira_issue_id": "24166",
    "jira_updated_at": "2026-08-09T00:40:14.621-0500",
  ...
  "specificity_fingerprint": "bf0f59be955eabf48f71830d9b7aeced1c0cb7d2364d0a69aa8ff6301eb36a52",
  "stop_conditions": [
    "Stop if a proposed update renumbers the historical epic or rewrites its original wave provenance."
  ],
  "supporting_source_refs": [],
  "title": "[EPIC-026] Autonomous weekly MLOps",
...
Create resumable ingestion→QA→state→features→train→evaluate→promote→forecast→postmortem workflows.
...
1. The epic retains stable ID EPIC-026, owner wave W21, phase PHASE-4, and all authoritative WBS children.
