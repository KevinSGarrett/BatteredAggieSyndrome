# AI Work Packet — POST-SUBTASK-100
...
1. `jira/records/issues/subtasks/POST-SUBTASK-100_execute_the_sealed_national_a_and_m_candidate_and_bas_support_chronological_repl.json`
2. `jira/sources/issue_source_manifests/POST-SUBTASK-100.json`
3. `jira/index/ISSUE_GOVERNANCE_CONTEXT.csv` row for `POST-SUBTASK-100`.
