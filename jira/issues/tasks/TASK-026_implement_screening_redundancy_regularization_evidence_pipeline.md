<!-- GENERATED VIEW. Canonical record: jira/records/issues/tasks/TASK-026_implement_screening_redundancy_regularization_evidence_pipeline.json -->
# TASK-026 — [TASK-026] Implement screening/redundancy/regularization evidence pipeline
...
```json
{
  ...
  "acceptance_criteria": [
    "Stable ID TASK-026, parent EPIC-005, owner wave W10, and original status DONE are preserved.",
  ...
  "canonical_record": "jira/records/issues/tasks/TASK-026_implement_screening_redundancy_regularization_evidence_pipeline.json",
  ...
  "gap_ids": [],
  "generated_markdown": "jira/issues/tasks/TASK-026_implement_screening_redundancy_regularization_evidence_pipeline.md",
  ...
  "objective": "Implement screening/redundancy/regularization evidence pipeline",
  "operational_jira": {
    "assignee": "",
    "jira_issue_id": "24269",
    "jira_updated_at": "2026-08-09T00:40:20.592-0500",
  ...
  "phase": "PHASE-1",
  "prerequisites": [
    "Historical dependency TASK-024"
  ],
  "primary_source_refs": [
    "SRCREF-00059",
    "SRCREF-02116",
  ...
  "required_evidence": [
    "Authoritative WBS row TASK-026",
    "Existing artifact `screening reports`",
    "Existing artifact `selection evidence`"
  ],
  "required_tests": [
    {
  ...
  "specificity_fingerprint": "97a326e1318cbe44aadf7faf34e0ee6f23255f09d397da0030b3af6615fe6cf5",
  "stop_conditions": [
  ...
  "title": "[TASK-026] Implement screening/redundancy/regularization evidence pipeline",
...
Implement screening/redundancy/regularization evidence pipeline
...
- Inherited from: None
- Resolution: `DIRECT`
- Effective counts: `{"acceptance_control_ids": 4, "adr_ids": 0, "gap_ids": 0, "requirement_ids": 10, "risk_ids": 0}`

## Acceptance Criteria

1. Stable ID TASK-026, parent EPIC-005, owner wave W10, and original status DONE are preserved.
