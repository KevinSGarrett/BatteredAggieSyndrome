<!-- GENERATED VIEW. Canonical record: jira/records/issues/tasks/TASK-024_implement_pit_safe_rolling_trend_recency_transformation_contracts.json -->
# TASK-024 — [TASK-024] Implement PIT-safe rolling/trend/recency transformation contracts
...
```json
{
  ...
  "acceptance_criteria": [
    "Stable ID TASK-024, parent EPIC-005, owner wave W10, and original status DONE are preserved.",
  ...
  "canonical_record": "jira/records/issues/tasks/TASK-024_implement_pit_safe_rolling_trend_recency_transformation_contracts.json",
  ...
  "gap_ids": [],
  "generated_markdown": "jira/issues/tasks/TASK-024_implement_pit_safe_rolling_trend_recency_transformation_contracts.md",
  ...
  "objective": "Implement PIT-safe rolling/trend/recency transformation contracts",
  "operational_jira": {
    "assignee": "",
    "jira_issue_id": "24267",
    "jira_updated_at": "2026-08-09T00:40:20.127-0500",
  ...
  "required_evidence": [
    "Authoritative WBS row TASK-024",
    "Existing artifact `feature transform library/contracts`"
  ],
  "required_tests": [
    {
  ...
  "specificity_fingerprint": "f5d6ec7a04484fd60ea3ce7fc32fef6a2eefe0c130082330500bc28844576889",
  "stop_conditions": [
  ...
  "title": "[TASK-024] Implement PIT-safe rolling/trend/recency transformation contracts",
...
Implement PIT-safe rolling/trend/recency transformation contracts
...
1. Stable ID TASK-024, parent EPIC-005, owner wave W10, and original status DONE are preserved.
