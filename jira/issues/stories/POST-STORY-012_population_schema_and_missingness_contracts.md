<!-- GENERATED VIEW. Canonical record: jira/records/issues/stories/POST-STORY-012_population_schema_and_missingness_contracts.json -->
# POST-STORY-012 — [POST-STORY-012] Population schema and missingness contracts
...
```json
{
  ...
  "blocked_reason": "",
  "blocks": [],
  "canonical_record": "jira/records/issues/stories/POST-STORY-012_population_schema_and_missingness_contracts.json",
  "canonical_source_role": "AUTHORITATIVE_LOCAL_SPECIFICATION",
  "completion_evidence_contract": {
    "all_child_evidence_required": true,
    "child_gate": "POST-SUBTASK-036",
  ...
  "critical_path": true,
  "definition_of_done": [
    "All child subtasks POST-SUBTASK-034, POST-SUBTASK-035, POST-SUBTASK-036 have verified evidence or an explicit accepted-risk/deferred/cancelled disposition consistent with the Story contract.",
    "The final gate `POST-SUBTASK-036` completes and proves the Story end-to-end requirement; closing implementation children alone is insufficient.",
  ...
  "end_to_end_validation": "Real raw populations produce versioned schema/missingness contracts and an explicit readiness decision for resolution.",
  "epic_id": "POST-EPIC-004",
  "evidence_manifest_path": "artifacts/jira_evidence/POST-STORY-012.json",
  ...
  "gap_ids": [],
  "generated_markdown": "jira/issues/stories/POST-STORY-012_population_schema_and_missingness_contracts.md",
  ...
  "local_id": "POST-STORY-012",
  "maturity_before": "FUNCTIONAL_STARTER",
  "objective": "Replace sample assumptions with measured population schemas before canonical resolution.",
  "operational_jira": {
    "assignee": "",
    "jira_issue_id": "24202",
    "jira_updated_at": "2026-08-09T00:03:32.198-0500",
  ...
  "required_tests": [
    ...
    },
    {
      ...
      "expectation": "The final child gate `POST-SUBTASK-036` must prove the integrated Story outcome and downstream-consumable output.",
  ...
  "specificity_fingerprint": "dd8f382ae957def3a3d29396693e54a88756761d9e77cd94ad26385722c6423f",
  "stop_conditions": [
  ...
  "title": "[POST-STORY-012] Population schema and missingness contracts",
  ...
  "work_packet_path": "jira/ai/work_packets/POST-STORY-012.md",
...
4. Every measured field is accepted, transformed, quarantined, deprecated, or rejected with reason; protected temporal/evidence fields are not weakened to accommodate dirty data.
5. The declared output `artifacts/entities/schema_reconciliation.csv` is produced with deterministic identity, provenance, and validation metadata appropriate to this work.
6. All entity-bearing domains have measured key quality and a declared resolution strategy; unusable partitions remain enumerated rather than silently dropped.
7. All prerequisite evidence is linked and unresolved blockers remain explicit; file creation alone cannot pass this gate.

## Definition of Done

1. All child subtasks POST-SUBTASK-034, POST-SUBTASK-035, POST-SUBTASK-036 have verified evidence or an explicit accepted-risk/deferred/cancelled disposition consistent with the Story contract.
2. The final gate `POST-SUBTASK-036` completes and proves the Story end-to-end requirement; closing implementation children alone is insufficient.
