...
from aggie_analytics.temporal.roster_membership_pit import materialize  # noqa: E402
...
def main() -> int:
    ...
    result = materialize(input_data_root=args.input_data_root.resolve(), output_data_root=(args.output_data_root or args.input_data_root).resolve(), repo_root=args.repo_root.resolve(), issued_at_utc=issued_at)
