"""Independently validate the Week Zero 2026 live shadow execution gate."""
...
def main() -> int:
    ...
    except LiveExecutionViolation as violation:
        print(f"FAIL: {violation}")
        return 1

    print(json.dumps(summary, indent=2, sort_keys=True))
    print("PASS: the Week Zero 2026 live shadow execution reproduces with no backfill")
    return 0
