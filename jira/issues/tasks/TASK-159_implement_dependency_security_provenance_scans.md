<!-- GENERATED VIEW. Canonical record: jira/records/issues/tasks/TASK-159_implement_dependency_security_provenance_scans.json -->
# TASK-159 — [TASK-159] Implement dependency/security/provenance scans
...
```json
{
  ...
  "acceptance_criteria": [
    "Stable ID TASK-159, parent EPIC-028, owner wave W23, and original status DONE are preserved.",
  ...
  "ai_context_notes": [
    ...
    "Dependency policy executable locally; hosted CodeQL/dependency-review run after push."
  ],
  ...
  "canonical_record": "jira/records/issues/tasks/TASK-159_implement_dependency_security_provenance_scans.json",
  ...
  "gap_ids": [],
  "generated_markdown": "jira/issues/tasks/TASK-159_implement_dependency_security_provenance_scans.md",
  ...
  "objective": "Implement dependency/security/provenance scans",
  "operational_jira": {
    "assignee": "",
    "jira_issue_id": "24402",
    "jira_updated_at": "2026-08-09T00:40:46.385-0500",
  ...
  "phase": "PHASE-4",
  "prerequisites": [
    "Historical dependency TASK-158"
  ],
  "primary_source_refs": [
    "SRCREF-00192",
    "SRCREF-02116",
  ...
  "required_evidence": [
    "Authoritative WBS row TASK-159",
    "Existing artifact `dependency pin/provenance/security gates + CodeQL/dependency-review workflows`"
  ],
  "required_tests": [
    {
  ...
  "specificity_fingerprint": "e42b3d7909ef52863b3ed42b5ce3036c73bc4934acb23cfc33247bb188e539f7",
  "stop_conditions": [
  ...
  "title": "[TASK-159] Implement dependency/security/provenance scans",
...
Implement dependency/security/provenance scans
...
- Inherited from: None
- Resolution: `DIRECT`
- Effective counts: `{"acceptance_control_ids": 6, "adr_ids": 0, "gap_ids": 0, "requirement_ids": 3, "risk_ids": 0}`

## Acceptance Criteria

1. Stable ID TASK-159, parent EPIC-028, owner wave W23, and original status DONE are preserved.
