<!-- GENERATED VIEW. Canonical record: jira/records/issues/subtasks/POST-SUBTASK-040_run_exact_alias_contextual_and_bounded_probabilistic_resolution_over_the_full_po.json -->
# POST-SUBTASK-040 — [POST-SUBTASK-040] Run exact, alias, contextual, and bounded probabilistic resolution over the full population with evidence per decision
...
```json
{
  ...
  "completion_evidence_contract": {
    ...
    "downstream_consumer": "POST-SUBTASK-041",
  ...
  "critical_path": true,
  "definition_of_done": [
    "The atomic scope in POST-SUBTASK-040 is completed without absorbing sibling work or weakening any protected requirement, control, split, judging rule, private-research publication boundary, or security boundary.",
    ...
    "The output set `artifacts/entities/resolution_results.parquet` is demonstrably consumable by POST-SUBTASK-041 without manual reconstruction or undocumented state."
  ],
  "dependencies": [
    "POST-SUBTASK-039"
  ],
  ...
  "end_to_end_validation": "Validate that `artifacts/entities/resolution_results.parquet` can be parsed and consumed by `POST-SUBTASK-041` using only documented identities and interfaces; the consumer must reject missing, stale, schema-incompatible, technically or quality-ineligible, or provenance-incomplete input without manual repair.",
  "epic_id": "POST-EPIC-004",
  "evidence_manifest_path": "artifacts/jira_evidence/POST-SUBTASK-040.json",
  ...
  "gap_ids": [],
  "generated_markdown": "jira/issues/subtasks/POST-SUBTASK-040_run_exact_alias_contextual_and_bounded_probabilistic_resolution_over_the_full_po.md",
  ...
  "local_id": "POST-SUBTASK-040",
  "maturity_before": "FUNCTIONAL_STARTER",
  "objective": "Run exact, alias, contextual, and bounded probabilistic resolution over the full population with evidence per decision",
  "operational_jira": {
    "assignee": "",
    "jira_issue_id": "24530",
    "jira_updated_at": "2026-08-09T22:23:00.657-0500",
    "last_synced_at": "2026-08-10T03:23:54.645183+00:00",
    "source_export": "C:\\BatteredAggieSyndrome.data\\runtime\\BAT-390\\BAT-390-live-row.csv",
    "sprint": "",
    "status_raw": "Done"
  },
  "out_of_scope": [
  ...
  "required_tests": [
    {
      ...
      "expectation": "Run as a regression check after completing POST-SUBTASK-040; retain command, exit code, and relevant output.",
    ...
    },
    {
      ...
      "path": "artifacts/entities/resolution_results.parquet",
    ...
    },
    {
      ...
      "path": "NEW_TEST_REQUIRED::POST-SUBTASK-040",
      "validation_class": "NEW_AUTOMATED_TEST_REQUIRED"
    }
  ],
  "requirement_ids": [],
  "risk_failure_conditions": [
    "The work would be invalid if any prerequisite artifact, source/data/code/config identity, or declared maturity differs from the pinned issue contract for POST-SUBTASK-040.",
    "A command may exit successfully while producing stale, partial, synthetic-only, leakage-contaminated, non-reproducible, or legally unusable evidence.",
    "Acceptance failure: the evidence cannot demonstrate that every resolution records resolver version, candidate set, evidence, confidence, decision rule, and deterministic replay; probability never substitutes for proof.",
    "Acceptance failure: the evidence cannot demonstrate that the declared output `artifacts/entities/resolution_results.parquet` is produced with deterministic identity, provenance, and validation metadata appropriate to this work.",
  ...
  "specificity_fingerprint": "edb4f9c6fe7c89c7ecf2a7415bb53502babddc3ea586bb9adbc617ef05a4e8e1",
  "stop_conditions": [
  ...
  "title": "[POST-SUBTASK-040] Run exact, alias, contextual, and bounded probabilistic resolution over the full population with evidence per decision",
  ...
  "work_packet_path": "jira/ai/work_packets/POST-SUBTASK-040.md",
  "workflow_state": "DONE"
}
```
...
1. The atomic scope in POST-SUBTASK-040 is completed without absorbing sibling work or weakening any protected requirement, control, split, judging rule, private-research publication boundary, or security boundary.
...
7. The output set `artifacts/entities/resolution_results.parquet` is demonstrably consumable by POST-SUBTASK-041 without manual reconstruction or undocumented state.
...
Validate that `artifacts/entities/resolution_results.parquet` can be parsed and consumed by `POST-SUBTASK-041` using only documented identities and interfaces; the consumer must reject missing, stale, schema-incompatible, technically or quality-ineligible, or provenance-incomplete input without manual repair.
