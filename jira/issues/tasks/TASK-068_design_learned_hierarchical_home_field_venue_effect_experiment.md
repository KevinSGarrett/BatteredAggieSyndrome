<!-- GENERATED VIEW. Canonical record: jira/records/issues/tasks/TASK-068_design_learned_hierarchical_home_field_venue_effect_experiment.json -->
# TASK-068 — [TASK-068] Design learned hierarchical home-field/venue effect experiment
...
```json
{
  ...
  "acceptance_criteria": [
    "Stable ID TASK-068, parent EPIC-012, owner wave W13, and original status DONE are preserved.",
  ...
  "canonical_record": "jira/records/issues/tasks/TASK-068_design_learned_hierarchical_home_field_venue_effect_experiment.json",
  ...
  "gap_ids": [],
  "generated_markdown": "jira/issues/tasks/TASK-068_design_learned_hierarchical_home_field_venue_effect_experiment.md",
  ...
  "objective": "Design learned hierarchical home-field/venue effect experiment",
  "operational_jira": {
    "assignee": "",
    "jira_issue_id": "24311",
    "jira_updated_at": "2026-08-09T00:40:28.637-0500",
  ...
  "required_evidence": [
    "Authoritative WBS row TASK-068",
    "Existing artifact `home-field residual experiment specification`"
  ],
  "required_tests": [
    {
  ...
  "specificity_fingerprint": "90fdd3d12b3040ad0a664e3a09d573cab5c721b030bb7f8805f87e7fd2b69b87",
  "stop_conditions": [
  ...
  "title": "[TASK-068] Design learned hierarchical home-field/venue effect experiment",
...
Design learned hierarchical home-field/venue effect experiment
...
1. Stable ID TASK-068, parent EPIC-012, owner wave W13, and original status DONE are preserved.
