...
from aggie_analytics.data.development_2023_outcomes import materialize  # noqa: E402


def main() -> int:
    parser = argparse.ArgumentParser(
        description="Materialize the verified 2023-only development outcome identity."
    )
