<!-- GENERATED VIEW. Canonical record: jira/records/issues/subtasks/POST-SUBTASK-068_materialize_supported_mechanics_officiating_resource_candidates_and_fcs_dii_diii.json -->
# POST-SUBTASK-068 — [POST-SUBTASK-068] Materialize supported mechanics/officiating/resource candidates and FCS/DII/DIII/NAIA decreasing-information opponent priors
...
```json
{
  ...
  "ai_context_notes": [
    ...
    "Read the exact source sections in `jira/sources/issue_source_manifests/POST-SUBTASK-068.json`; inspect only the listed implementation files and prerequisite outputs.",
  ...
  "canonical_record": "jira/records/issues/subtasks/POST-SUBTASK-068_materialize_supported_mechanics_officiating_resource_candidates_and_fcs_dii_diii.json",
  "canonical_source_role": "AUTHORITATIVE_LOCAL_SPECIFICATION",
  "completion_evidence_contract": {
    "acceptance_matrix_required": true,
    "artifact_hashes_required": true,
    "completion_claim_limit": "EMPIRICALLY_VALIDATED",
    "downstream_consumer": "POST-SUBTASK-069",
  ...
  "critical_path": false,
  "definition_of_done": [
    "The atomic scope in POST-SUBTASK-068 is completed without absorbing sibling work or weakening any protected requirement, control, split, judging rule, rights decision, or security boundary.",
    ...
    "The output set `artifacts/context_intelligence/mechanics_sparse_opponent_manifest.json` is demonstrably consumable by POST-SUBTASK-069 without manual reconstruction or undocumented state."
  ],
  "dependencies": [
    "POST-SUBTASK-030",
    "POST-SUBTASK-048",
  ...
  "end_to_end_validation": "Validate that `artifacts/context_intelligence/mechanics_sparse_opponent_manifest.json` can be parsed and consumed by `POST-SUBTASK-069` using only documented identities and interfaces; the consumer must reject missing, stale, schema-incompatible, rights-blocked, or provenance-incomplete input without manual repair.",
  "epic_id": "POST-EPIC-007",
  "evidence_manifest_path": "artifacts/jira_evidence/POST-SUBTASK-068.json",
  ...
  "gap_ids": [],
  "generated_markdown": "jira/issues/subtasks/POST-SUBTASK-068_materialize_supported_mechanics_officiating_resource_candidates_and_fcs_dii_diii.md",
  ...
  "local_id": "POST-SUBTASK-068",
  "maturity_before": "FUNCTIONAL_STARTER",
  "objective": "Materialize supported mechanics/officiating/resource candidates and FCS/DII/DIII/NAIA decreasing-information opponent priors",
  "operational_jira": {
    "assignee": "",
    "jira_issue_id": "24558",
    "jira_updated_at": "2026-08-09T00:03:45.752-0500",
  ...
  "required_tests": [
    {
      ...
      "expectation": "Run as a regression check after completing POST-SUBTASK-068; retain command, exit code, and relevant output.",
    ...
    },
    {
      ...
      "path": "artifacts/context_intelligence/mechanics_sparse_opponent_manifest.json",
    ...
    },
    {
      ...
      "path": "NEW_TEST_REQUIRED::POST-SUBTASK-068",
      "validation_class": "NEW_AUTOMATED_TEST_REQUIRED"
    }
  ],
  "requirement_ids": [],
  "risk_failure_conditions": [
    "The work would be invalid if any prerequisite artifact, source/data/code/config identity, or declared maturity differs from the pinned issue contract for POST-SUBTASK-068.",
    ...
    "Acceptance failure: the evidence cannot demonstrate that the declared output `artifacts/context_intelligence/mechanics_sparse_opponent_manifest.json` is produced with deterministic identity, provenance, and validation metadata appropriate to this work.",
  ...
  "specificity_fingerprint": "554fb236db59b0fc8abcdddf39ac774eefc255d78d64a35b1877086de8ac2aae",
  "stop_conditions": [
  ...
  "title": "[POST-SUBTASK-068] Materialize supported mechanics/officiating/resource candidates and FCS/DII/DIII/NAIA decreasing-information opponent priors",
  ...
  "work_packet_path": "jira/ai/work_packets/POST-SUBTASK-068.md",
...
1. The atomic scope in POST-SUBTASK-068 is completed without absorbing sibling work or weakening any protected requirement, control, split, judging rule, rights decision, or security boundary.
...
7. The output set `artifacts/context_intelligence/mechanics_sparse_opponent_manifest.json` is demonstrably consumable by POST-SUBTASK-069 without manual reconstruction or undocumented state.
...
Validate that `artifacts/context_intelligence/mechanics_sparse_opponent_manifest.json` can be parsed and consumed by `POST-SUBTASK-069` using only documented identities and interfaces; the consumer must reject missing, stale, schema-incompatible, rights-blocked, or provenance-incomplete input without manual repair.
