<!-- GENERATED VIEW. Canonical record: jira/records/issues/tasks/TASK-076_freeze_mechanics_feature_interfaces.json -->
# TASK-076 — [TASK-076] Freeze mechanics feature interfaces
...
```json
{
  ...
  "acceptance_criteria": [
    "Stable ID TASK-076, parent EPIC-013, owner wave W13, and original status DONE are preserved.",
  ...
  "canonical_record": "jira/records/issues/tasks/TASK-076_freeze_mechanics_feature_interfaces.json",
  ...
  "gap_ids": [],
  "generated_markdown": "jira/issues/tasks/TASK-076_freeze_mechanics_feature_interfaces.md",
  ...
  "objective": "Freeze mechanics feature interfaces",
  "operational_jira": {
    "assignee": "",
    "jira_issue_id": "24319",
    "jira_updated_at": "2026-08-09T00:40:30.248-0500",
  ...
  "phase": "PHASE-2",
  "prerequisites": [
    "Historical dependency TASK-073",
    "Historical dependency TASK-075"
  ],
  "primary_source_refs": [
    "SRCREF-00109",
    "SRCREF-02116",
  ...
  "required_evidence": [
    "Authoritative WBS row TASK-076",
    "Existing artifact `mechanics interface baseline`"
  ],
  "required_tests": [
    {
  ...
  "specificity_fingerprint": "7e13e8a9c780b8ca727b9d91295c3fbe2ff58de5ea8b1b4625353a663622c43d",
  "stop_conditions": [
  ...
  "title": "[TASK-076] Freeze mechanics feature interfaces",
...
Freeze mechanics feature interfaces
...
- Inherited from: None
- Resolution: `DIRECT`
- Effective counts: `{"acceptance_control_ids": 3, "adr_ids": 0, "gap_ids": 0, "requirement_ids": 12, "risk_ids": 0}`

## Acceptance Criteria

1. Stable ID TASK-076, parent EPIC-013, owner wave W13, and original status DONE are preserved.
