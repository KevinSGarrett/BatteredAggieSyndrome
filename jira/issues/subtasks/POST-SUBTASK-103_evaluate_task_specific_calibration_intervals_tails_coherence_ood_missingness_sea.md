<!-- GENERATED VIEW. Canonical record: jira/records/issues/subtasks/POST-SUBTASK-103_evaluate_task_specific_calibration_intervals_tails_coherence_ood_missingness_sea.json -->
# POST-SUBTASK-103 — [POST-SUBTASK-103] Evaluate task-specific calibration, intervals, tails, coherence, OOD, missingness, season/regime/source shift, market ablation, and resource robustness
...
```json
{
  ...
  "acceptance_criteria": [
    ...
    "The declared output `artifacts/validation/calibration_robustness_report.json` is produced with deterministic identity, provenance, and validation metadata appropriate to this work.",
  ...
  "ai_context_notes": [
    ...
    "Read the exact source sections in `jira/sources/issue_source_manifests/POST-SUBTASK-103.json`; inspect only the listed implementation files and prerequisite outputs.",
  ...
  "blocked_reason": "UNSATISFIED_HARD_DEPENDENCIES: POST-SUBTASK-087;POST-SUBTASK-096;POST-SUBTASK-102",
  "blocks": [
    "POST-SUBTASK-104",
    "POST-SUBTASK-105"
  ],
  "canonical_record": "jira/records/issues/subtasks/POST-SUBTASK-103_evaluate_task_specific_calibration_intervals_tails_coherence_ood_missingness_sea.json",
  "canonical_source_role": "AUTHORITATIVE_LOCAL_SPECIFICATION",
  "completion_evidence_contract": {
    "acceptance_matrix_required": true,
    "artifact_hashes_required": true,
    "completion_claim_limit": "IMPLEMENTED",
    "downstream_consumer": "POST-SUBTASK-104",
  ...
  "critical_path": true,
  "definition_of_done": [
    "The atomic scope in POST-SUBTASK-103 is completed without absorbing sibling work or weakening any protected requirement, control, split, judging rule, private-research publication boundary, or security boundary.",
    ...
    "The output set `artifacts/validation/calibration_robustness_report.json` is demonstrably consumable by POST-SUBTASK-104 without manual reconstruction or undocumented state."
  ],
  "dependencies": [
    "POST-SUBTASK-087",
    "POST-SUBTASK-096",
  ...
  "end_to_end_validation": "Validate that `artifacts/validation/calibration_robustness_report.json` can be parsed and consumed by `POST-SUBTASK-104` using only documented identities and interfaces; the consumer must reject missing, stale, schema-incompatible, technically or quality-ineligible, or provenance-incomplete input without manual repair.",
  "epic_id": "POST-EPIC-011",
  "evidence_manifest_path": "artifacts/jira_evidence/POST-SUBTASK-103.json",
  ...
  "gap_ids": [],
  "generated_markdown": "jira/issues/subtasks/POST-SUBTASK-103_evaluate_task_specific_calibration_intervals_tails_coherence_ood_missingness_sea.md",
  ...
  "local_id": "POST-SUBTASK-103",
  "maturity_before": "FUNCTIONAL_STARTER",
  "objective": "Evaluate task-specific calibration, intervals, tails, coherence, OOD, missingness, season/regime/source shift, market ablation, and resource robustness",
  "operational_jira": {
    "assignee": "",
    "jira_issue_id": "24593",
    "jira_updated_at": "2026-08-09T00:03:58.670-0500",
  ...
  "required_tests": [
    {
      ...
      "expectation": "Run as a regression check after completing POST-SUBTASK-103; retain command, exit code, and relevant output.",
    ...
    },
    {
      ...
      "path": "artifacts/validation/calibration_robustness_report.json",
  ...
  "risk_failure_conditions": [
    "The work would be invalid if any prerequisite artifact, source/data/code/config identity, or declared maturity differs from the pinned issue contract for POST-SUBTASK-103.",
    ...
    "Acceptance failure: the evidence cannot demonstrate that the declared output `artifacts/validation/calibration_robustness_report.json` is produced with deterministic identity, provenance, and validation metadata appropriate to this work.",
  ...
  "specificity_fingerprint": "0972a80a9e5e7cfa402b14984d8dbfbecd71d4da58e3114dfb77753c4be51330",
  "stop_conditions": [
  ...
  "title": "[POST-SUBTASK-103] Evaluate task-specific calibration, intervals, tails, coherence, OOD, missingness, season/regime/source shift, market ablation, and resource robustness",
  ...
  "work_packet_path": "jira/ai/work_packets/POST-SUBTASK-103.md",
...
1. The atomic scope in POST-SUBTASK-103 is completed without absorbing sibling work or weakening any protected requirement, control, split, judging rule, private-research publication boundary, or security boundary.
...
7. The output set `artifacts/validation/calibration_robustness_report.json` is demonstrably consumable by POST-SUBTASK-104 without manual reconstruction or undocumented state.
...
Validate that `artifacts/validation/calibration_robustness_report.json` can be parsed and consumed by `POST-SUBTASK-104` using only documented identities and interfaces; the consumer must reject missing, stale, schema-incompatible, technically or quality-ineligible, or provenance-incomplete input without manual repair.
