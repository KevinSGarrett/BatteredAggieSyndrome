<!-- GENERATED VIEW. Canonical record: jira/records/issues/tasks/TASK-152_freeze_snapshot_serving_api_contract.json -->
# TASK-152 — [TASK-152] Freeze snapshot-serving API contract
...
```json
{
  ...
  "acceptance_criteria": [
    "Stable ID TASK-152, parent EPIC-027, owner wave W22, and original status DONE are preserved.",
  ...
  "ai_context_notes": [
    ...
    "First READY W22 task after W21 MLOps gate.;Completed W22 functional snapshot-serving/product starter with executable tests"
  ],
  "allowed_modification_paths": [
    "read-only forecast API schema"
  ],
  "blocked_reason": "",
  "blocks": [
    "TASK-153",
  ...
  "canonical_record": "jira/records/issues/tasks/TASK-152_freeze_snapshot_serving_api_contract.json",
  ...
  "gap_ids": [],
  "generated_markdown": "jira/issues/tasks/TASK-152_freeze_snapshot_serving_api_contract.md",
  ...
  "operational_jira": {
    "assignee": "",
    "jira_issue_id": "24395",
    "jira_updated_at": "2026-08-09T00:40:45.149-0500",
  ...
  "required_evidence": [
    "Authoritative WBS row TASK-152",
    "Existing artifact `read-only forecast API schema`"
  ],
  "required_tests": [
    {
  ...
  "specificity_fingerprint": "03de632b54b57338195ffe50c640a56d2ed24212235463bc768555ed01769870",
  "stop_conditions": [
  ...
  "title": "[TASK-152] Freeze snapshot-serving API contract",
...
Freeze snapshot-serving API contract
...
- Inherited from: None
- Resolution: `DIRECT`
- Effective counts: `{"acceptance_control_ids": 8, "adr_ids": 0, "gap_ids": 0, "requirement_ids": 10, "risk_ids": 0}`

## Acceptance Criteria

1. Stable ID TASK-152, parent EPIC-027, owner wave W22, and original status DONE are preserved.
