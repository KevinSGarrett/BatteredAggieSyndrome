<!-- GENERATED VIEW. Canonical record: jira/records/issues/tasks/TASK-170_inventory_legitimate_historical_live_source_requirements.json -->
# TASK-170 — [TASK-170] Inventory legitimate historical/live source requirements
...
```json
{
  ...
  "acceptance_criteria": [
    "Stable ID TASK-170, parent EPIC-030, owner wave W24+, and original status PLANNED are preserved.",
  ...
  "canonical_record": "jira/records/issues/tasks/TASK-170_inventory_legitimate_historical_live_source_requirements.json",
  ...
  "gap_ids": [],
  "generated_markdown": "jira/issues/tasks/TASK-170_inventory_legitimate_historical_live_source_requirements.md",
  ...
  "objective": "Inventory legitimate historical/live source requirements",
  "operational_jira": {
    "assignee": "",
    "jira_issue_id": "24422",
    "jira_updated_at": "2026-08-09T00:05:14.774-0500",
  ...
  "phase": "PHASE-5",
  "prerequisites": [
    "Historical dependency TASK-169"
  ],
  "primary_source_refs": [
    "SRCREF-00203",
    "SRCREF-02116",
  ...
  "required_evidence": [
    "Authoritative WBS row TASK-170",
    "Existing artifact `live source feasibility update`"
  ],
  "required_tests": [
    {
  ...
  "specificity_fingerprint": "c81153265b0240caeeb9a44105bb7f3946d75ce4820839797ab51fa20c802163",
  "stop_conditions": [
  ...
  "title": "[TASK-170] Inventory legitimate historical/live source requirements",
...
Inventory legitimate historical/live source requirements
...
1. Stable ID TASK-170, parent EPIC-030, owner wave W24+, and original status PLANNED are preserved.
