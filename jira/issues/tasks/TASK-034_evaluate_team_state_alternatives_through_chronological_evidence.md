<!-- GENERATED VIEW. Canonical record: jira/records/issues/tasks/TASK-034_evaluate_team_state_alternatives_through_chronological_evidence.json -->
# TASK-034 — [TASK-034] Evaluate team-state alternatives through chronological evidence
...
```json
{
  ...
  "acceptance_criteria": [
    "Stable ID TASK-034, parent EPIC-006, owner wave W11, and original status DONE are preserved.",
  ...
  "canonical_record": "jira/records/issues/tasks/TASK-034_evaluate_team_state_alternatives_through_chronological_evidence.json",
  ...
  "gap_ids": [],
  "generated_markdown": "jira/issues/tasks/TASK-034_evaluate_team_state_alternatives_through_chronological_evidence.md",
  ...
  "objective": "Evaluate team-state alternatives through chronological evidence",
  "operational_jira": {
    "assignee": "",
    "jira_issue_id": "24277",
    "jira_updated_at": "2026-08-09T00:40:22.196-0500",
  ...
  "phase": "PHASE-1",
  "prerequisites": [
    "Historical dependency TASK-031",
    "Historical dependency TASK-032",
  ...
  "required_evidence": [
    "Authoritative WBS row TASK-034",
    "Existing artifact `team-state comparison report`"
  ],
  "required_tests": [
    {
  ...
  "risk_ids": [],
  "schema_version": 2,
  "scope": "Original task type VALIDATION with mutation scope: as defined by its source documents.",
  "source_ids": [
    "TASK-034"
  ],
  "source_refs": [
  ...
  "specificity_fingerprint": "7f76f6447f46c67863aca1a01d4fa4c76fd93d58cac38ef34bdf8fd93cb3b224",
  "stop_conditions": [
  ...
  "title": "[TASK-034] Evaluate team-state alternatives through chronological evidence",
...
Evaluate team-state alternatives through chronological evidence
...
Original task type VALIDATION with mutation scope: as defined by its source documents.
...
1. Stable ID TASK-034, parent EPIC-006, owner wave W11, and original status DONE are preserved.
