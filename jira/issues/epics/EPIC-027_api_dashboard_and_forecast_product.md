<!-- GENERATED VIEW. Canonical record: jira/records/issues/epics/EPIC-027_api_dashboard_and_forecast_product.json -->
# EPIC-027 — [EPIC-027] API, dashboard and forecast product
...
```json
{
  ...
  "acceptance_criteria": [
    "The epic retains stable ID EPIC-027, owner wave W22, phase PHASE-4, and all authoritative WBS children.",
  ...
  "blocked_reason": "",
  "blocks": [],
  "canonical_record": "jira/records/issues/epics/EPIC-027_api_dashboard_and_forecast_product.json",
  ...
  "gap_ids": [],
  "generated_markdown": "jira/issues/epics/EPIC-027_api_dashboard_and_forecast_product.md",
  ...
  "objective": "Serve immutable forecast snapshots with lineage, explanation, uncertainty, BAS and availability context.",
  "operational_jira": {
    "assignee": "",
    "jira_issue_id": "24167",
    "jira_updated_at": "2026-08-09T00:40:14.712-0500",
  ...
  "specificity_fingerprint": "96bbcd82e843a140c6a9395f58dc93133475f726f87e60596c26a4950e9f9561",
  "stop_conditions": [
    "Stop if a proposed update renumbers the historical epic or rewrites its original wave provenance."
  ],
  "supporting_source_refs": [],
  "title": "[EPIC-027] API, dashboard and forecast product",
...
Serve immutable forecast snapshots with lineage, explanation, uncertainty, BAS and availability context.
...
1. The epic retains stable ID EPIC-027, owner wave W22, phase PHASE-4, and all authoritative WBS children.
