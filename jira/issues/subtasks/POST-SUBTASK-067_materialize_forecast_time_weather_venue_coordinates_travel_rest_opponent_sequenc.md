<!-- GENERATED VIEW. Canonical record: jira/records/issues/subtasks/POST-SUBTASK-067_materialize_forecast_time_weather_venue_coordinates_travel_rest_opponent_sequenc.json -->
# POST-SUBTASK-067 — [POST-SUBTASK-067] Materialize forecast-time weather, venue, coordinates, travel, rest, opponent sequence, neutral-site, schedule-change, and local-time state
...
```json
{
  ...
  "adr_ids": [],
  "ai_context_notes": [
    "Canonical parent Story: POST-STORY-023. Governance traceability gate: POST-SUBTASK-069. Inherited traceability is resolved through `jira/index/ISSUE_GOVERNANCE_CONTEXT.csv`.",
    "Read the exact source sections in `jira/sources/issue_source_manifests/POST-SUBTASK-067.json`; inspect only the listed implementation files and prerequisite outputs.",
  ...
  "blocked_reason": "UNSATISFIED_HARD_DEPENDENCIES: POST-SUBTASK-030;POST-SUBTASK-048",
  "blocks": [
    "POST-SUBTASK-068",
    "POST-SUBTASK-069"
  ],
  "canonical_record": "jira/records/issues/subtasks/POST-SUBTASK-067_materialize_forecast_time_weather_venue_coordinates_travel_rest_opponent_sequenc.json",
  "canonical_source_role": "AUTHORITATIVE_LOCAL_SPECIFICATION",
  "completion_evidence_contract": {
    "acceptance_matrix_required": true,
    "artifact_hashes_required": true,
    "completion_claim_limit": "IMPLEMENTED",
    "downstream_consumer": "POST-SUBTASK-068",
  ...
  "critical_path": false,
  "definition_of_done": [
    "The atomic scope in POST-SUBTASK-067 is completed without absorbing sibling work or weakening any protected requirement, control, split, judging rule, private-research publication boundary, or security boundary.",
    ...
    "The output set `artifacts/context_intelligence/game_context_state_manifest.json` is demonstrably consumable by POST-SUBTASK-068 without manual reconstruction or undocumented state."
  ],
  "dependencies": [
    "POST-SUBTASK-030",
    "POST-SUBTASK-048"
  ...
  "end_to_end_validation": "Validate that `artifacts/context_intelligence/game_context_state_manifest.json` can be parsed and consumed by `POST-SUBTASK-068` using only documented identities and interfaces; the consumer must reject missing, stale, schema-incompatible, technically or quality-ineligible, or provenance-incomplete input without manual repair.",
  "epic_id": "POST-EPIC-007",
  "evidence_manifest_path": "artifacts/jira_evidence/POST-SUBTASK-067.json",
  ...
  "gap_ids": [],
  "generated_markdown": "jira/issues/subtasks/POST-SUBTASK-067_materialize_forecast_time_weather_venue_coordinates_travel_rest_opponent_sequenc.md",
  ...
  "local_id": "POST-SUBTASK-067",
  "maturity_before": "FUNCTIONAL_STARTER",
  "objective": "Materialize forecast-time weather, venue, coordinates, travel, rest, opponent sequence, neutral-site, schedule-change, and local-time state",
  "operational_jira": {
    "assignee": "",
    "jira_issue_id": "24557",
    "jira_updated_at": "2026-08-09T00:03:45.681-0500",
  ...
  "required_tests": [
    {
      ...
      "expectation": "Run as a regression check after completing POST-SUBTASK-067; retain command, exit code, and relevant output.",
    ...
    },
    {
      ...
      "path": "artifacts/context_intelligence/game_context_state_manifest.json",
    ...
    },
    {
      ...
      "path": "NEW_TEST_REQUIRED::POST-SUBTASK-067",
      "validation_class": "NEW_AUTOMATED_TEST_REQUIRED"
    }
  ],
  "requirement_ids": [],
  "risk_failure_conditions": [
    "The work would be invalid if any prerequisite artifact, source/data/code/config identity, or declared maturity differs from the pinned issue contract for POST-SUBTASK-067.",
    "A command may exit successfully while producing stale, partial, synthetic-only, leakage-contaminated, non-reproducible, or legally unusable evidence.",
    "Acceptance failure: the evidence cannot demonstrate that weather uses forecast snapshots available at each cutoff; travel/rest/sequence derive from canonical schedules/venues and update for postponements/neutral sites with unknown coordinates left uncertain.",
    "Acceptance failure: the evidence cannot demonstrate that the declared output `artifacts/context_intelligence/game_context_state_manifest.json` is produced with deterministic identity, provenance, and validation metadata appropriate to this work.",
  ...
  "specificity_fingerprint": "dd296f0874ab15dbed78f64ecf48057d6f9079555adec5698f849f74be2cb3bc",
  "stop_conditions": [
  ...
  "title": "[POST-SUBTASK-067] Materialize forecast-time weather, venue, coordinates, travel, rest, opponent sequence, neutral-site, schedule-change, and local-time state",
  ...
  "why_this_exists": "This is an independently executable and verifiable work unit required by Story POST-STORY-023: Weather, travel, rest, venue, schedule sequence, mechanics, officiating, and sparse-opponent priors.",
  "work_packet_path": "jira/ai/work_packets/POST-SUBTASK-067.md",
...
1. The atomic scope in POST-SUBTASK-067 is completed without absorbing sibling work or weakening any protected requirement, control, split, judging rule, private-research publication boundary, or security boundary.
...
7. The output set `artifacts/context_intelligence/game_context_state_manifest.json` is demonstrably consumable by POST-SUBTASK-068 without manual reconstruction or undocumented state.
...
Validate that `artifacts/context_intelligence/game_context_state_manifest.json` can be parsed and consumed by `POST-SUBTASK-068` using only documented identities and interfaces; the consumer must reject missing, stale, schema-incompatible, technically or quality-ineligible, or provenance-incomplete input without manual repair.
