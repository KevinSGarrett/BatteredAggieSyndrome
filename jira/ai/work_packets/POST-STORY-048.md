...
1. `jira/records/issues/stories/POST-STORY-048_advanced_challenger_proposal_feasibility_and_admission.json`
2. `jira/sources/issue_source_manifests/POST-STORY-048.json`
3. `jira/index/ISSUE_GOVERNANCE_CONTEXT.csv` row for `POST-STORY-048`.
