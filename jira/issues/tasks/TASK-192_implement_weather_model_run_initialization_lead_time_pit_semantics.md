<!-- GENERATED VIEW. Canonical record: jira/records/issues/tasks/TASK-192_implement_weather_model_run_initialization_lead_time_pit_semantics.json -->
# TASK-192 — [TASK-192] Implement weather model-run initialization/lead-time PIT semantics
...
```json
{
  ...
  "acceptance_criteria": [
    "Stable ID TASK-192, parent EPIC-003, owner wave W08, and original status DONE are preserved.",
  ...
  "ai_context_notes": [
    ...
    "W06-added after source research;Completed W08 contract + synthetic evidence"
  ],
  ...
  "blocked_reason": "",
  "blocks": [],
  "canonical_record": "jira/records/issues/tasks/TASK-192_implement_weather_model_run_initialization_lead_time_pit_semantics.json",
  ...
  "gap_ids": [],
  "generated_markdown": "jira/issues/tasks/TASK-192_implement_weather_model_run_initialization_lead_time_pit_semantics.md",
  ...
  "objective": "Implement weather model-run initialization/lead-time PIT semantics",
  "operational_jira": {
    "assignee": "",
    "jira_issue_id": "24465",
    "jira_updated_at": "2026-08-09T00:40:50.915-0500",
  ...
  "phase": "PHASE-1",
  "prerequisites": [
    "Historical dependency TASK-015"
  ],
  "primary_source_refs": [
    "SRCREF-00225",
    "SRCREF-02116",
  ...
  "required_evidence": [
    "Authoritative WBS row TASK-192",
    "Existing artifact `weather model-run PIT contract + fixtures`"
  ],
  "required_tests": [
    {
  ...
  "risk_ids": [],
  "schema_version": 2,
  "scope": "Original task type TEMPORAL_DESIGN with mutation scope: PIT weather semantics.",
  "source_ids": [
    "TASK-192"
  ],
  "source_refs": [
  ...
  "specificity_fingerprint": "d84bb3809b88d57d72c32c2b8c93191b334cfb737bf8e1c7b15054fac1c16018",
  "stop_conditions": [
  ...
  "title": "[TASK-192] Implement weather model-run initialization/lead-time PIT semantics",
...
Implement weather model-run initialization/lead-time PIT semantics
...
Original task type TEMPORAL_DESIGN with mutation scope: PIT weather semantics.
...
1. Stable ID TASK-192, parent EPIC-003, owner wave W08, and original status DONE are preserved.
