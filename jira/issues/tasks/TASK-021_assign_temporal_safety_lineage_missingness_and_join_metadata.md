<!-- GENERATED VIEW. Canonical record: jira/records/issues/tasks/TASK-021_assign_temporal_safety_lineage_missingness_and_join_metadata.json -->
# TASK-021 — [TASK-021] Assign temporal safety, lineage, missingness and join metadata
...
```json
{
  ...
  "acceptance_criteria": [
    "Stable ID TASK-021, parent EPIC-004, owner wave W09, and original status DONE are preserved.",
  ...
  "allowed_modification_paths": [
    "raw feature registry metadata"
  ],
  "blocked_reason": "",
  "blocks": [
    "TASK-022"
  ],
  "canonical_record": "jira/records/issues/tasks/TASK-021_assign_temporal_safety_lineage_missingness_and_join_metadata.json",
  ...
  "gap_ids": [],
  "generated_markdown": "jira/issues/tasks/TASK-021_assign_temporal_safety_lineage_missingness_and_join_metadata.md",
  ...
  "objective": "Assign temporal safety, lineage, missingness and join metadata",
  "operational_jira": {
    "assignee": "",
    "jira_issue_id": "24264",
    "jira_updated_at": "2026-08-09T00:40:19.381-0500",
  ...
  "phase": "PHASE-1",
  "prerequisites": [
    "Historical dependency TASK-020"
  ],
  "primary_source_refs": [
    "SRCREF-00054",
    "SRCREF-02116",
  ...
  "required_evidence": [
    "Authoritative WBS row TASK-021",
    "Existing artifact `raw feature registry metadata`"
  ],
  "required_tests": [
    {
  ...
  "specificity_fingerprint": "f31bd1dbf076cc67a5bf3736605cbcc3ebc78093bf527164e0597cc333c513bf",
  "stop_conditions": [
  ...
  "title": "[TASK-021] Assign temporal safety, lineage, missingness and join metadata",
...
Assign temporal safety, lineage, missingness and join metadata
...
- Inherited from: None
- Resolution: `DIRECT`
- Effective counts: `{"acceptance_control_ids": 6, "adr_ids": 0, "gap_ids": 0, "requirement_ids": 12, "risk_ids": 0}`

## Acceptance Criteria

1. Stable ID TASK-021, parent EPIC-004, owner wave W09, and original status DONE are preserved.
