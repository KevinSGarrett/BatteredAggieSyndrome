<!-- GENERATED VIEW. Canonical record: jira/records/issues/tasks/TASK-150_implement_result_scoring_postmortem_research_queue_workflow.json -->
# TASK-150 — [TASK-150] Implement result scoring/postmortem/research-queue workflow
...
```json
{
  ...
  "acceptance_criteria": [
    "Stable ID TASK-150, parent EPIC-026, owner wave W21, and original status DONE are preserved.",
  ...
  "canonical_record": "jira/records/issues/tasks/TASK-150_implement_result_scoring_postmortem_research_queue_workflow.json",
  ...
  "gap_ids": [],
  "generated_markdown": "jira/issues/tasks/TASK-150_implement_result_scoring_postmortem_research_queue_workflow.md",
  ...
  "objective": "Implement result scoring/postmortem/research-queue workflow",
  "operational_jira": {
    "assignee": "",
    "jira_issue_id": "24393",
    "jira_updated_at": "2026-08-09T00:40:44.773-0500",
  ...
  "phase": "PHASE-4",
  "prerequisites": [
    "Historical dependency TASK-149",
  ...
  "required_evidence": [
    "Authoritative WBS row TASK-150",
    "Existing artifact `postmortem/research loop`"
  ],
  "required_tests": [
    {
  ...
  "specificity_fingerprint": "805f09710d452761850961e7636570b864535613f610a7826feca1d36232e58a",
  "stop_conditions": [
  ...
  "title": "[TASK-150] Implement result scoring/postmortem/research-queue workflow",
...
Implement result scoring/postmortem/research-queue workflow
...
1. Stable ID TASK-150, parent EPIC-026, owner wave W21, and original status DONE are preserved.
