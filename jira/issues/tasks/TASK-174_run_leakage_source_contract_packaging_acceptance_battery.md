<!-- GENERATED VIEW. Canonical record: jira/records/issues/tasks/TASK-174_run_leakage_source_contract_packaging_acceptance_battery.json -->
# TASK-174 — [TASK-174] Run leakage/source-contract/packaging acceptance battery
...
```json
{
  ...
  "acceptance_criteria": [
    "Stable ID TASK-174, parent EPIC-031, owner wave W24, and original status DONE are preserved.",
  ...
  "ai_context_notes": [
    ...
    "Cross-layer leakage repair/battery plus source-contract and packaging validations."
  ],
  ...
  "canonical_record": "jira/records/issues/tasks/TASK-174_run_leakage_source_contract_packaging_acceptance_battery.json",
  ...
  "gap_ids": [],
  "generated_markdown": "jira/issues/tasks/TASK-174_run_leakage_source_contract_packaging_acceptance_battery.md",
  ...
  "operational_jira": {
    "assignee": "",
    "jira_issue_id": "24430",
    "jira_updated_at": "2026-08-09T00:40:47.390-0500",
  ...
  "required_evidence": [
    "Authoritative WBS row TASK-174",
    "Existing artifact `full acceptance battery`"
  ],
  "required_tests": [
    {
  ...
  "specificity_fingerprint": "3d3d0a702b61814b8db74e4a56ef92a65d062a61a61750980e8354f76d0e58b6",
  "stop_conditions": [
  ...
  "title": "[TASK-174] Run leakage/source-contract/packaging acceptance battery",
...
Run leakage/source-contract/packaging acceptance battery
...
1. Stable ID TASK-174, parent EPIC-031, owner wave W24, and original status DONE are preserved.
