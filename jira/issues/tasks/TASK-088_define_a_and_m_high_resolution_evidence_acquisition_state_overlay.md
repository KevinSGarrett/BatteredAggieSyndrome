<!-- GENERATED VIEW. Canonical record: jira/records/issues/tasks/TASK-088_define_a_and_m_high_resolution_evidence_acquisition_state_overlay.json -->
# TASK-088 — [TASK-088] Define A&M high-resolution evidence acquisition/state overlay
...
```json
{
  ...
  "acceptance_criteria": [
    "Stable ID TASK-088, parent EPIC-016, owner wave W14, and original status DONE are preserved.",
  ...
  "ai_context_notes": [
    ...
    "W13 adaptive repair: W14 architecture now depends on frozen W12/W13 contracts, not future W20 TASK-087 implementation gate. W14 contract/reference task complete; empirical/model selection remains W16/W17 where applicable."
  ],
  "allowed_modification_paths": [
    "A&M high-resolution state contract"
  ],
  "blocked_reason": "",
  "blocks": [
    "TASK-089",
  ...
  "canonical_record": "jira/records/issues/tasks/TASK-088_define_a_and_m_high_resolution_evidence_acquisition_state_overlay.json",
  ...
  "gap_ids": [],
  "generated_markdown": "jira/issues/tasks/TASK-088_define_a_and_m_high_resolution_evidence_acquisition_state_overlay.md",
  ...
  "operational_jira": {
    "assignee": "",
    "jira_issue_id": "24331",
    "jira_updated_at": "2026-08-09T00:40:32.463-0500",
  ...
  "phase": "PHASE-3",
  "prerequisites": [
    "Historical dependency TASK-058",
    "Historical dependency TASK-064",
    "Historical dependency TASK-070",
    "Historical dependency TASK-076",
    "Historical dependency TASK-082"
  ],
  "primary_source_refs": [
    "SRCREF-00121",
    "SRCREF-02116",
  ...
  "required_evidence": [
    "Authoritative WBS row TASK-088",
    "Existing artifact `A&M high-resolution state contract`"
  ],
  "required_tests": [
    {
  ...
  "specificity_fingerprint": "b3e45e9db7da076d8bdcae68c9a37b5de8cf6139381a58b176172ee1d65bc2dd",
  "stop_conditions": [
  ...
  "title": "[TASK-088] Define A&M high-resolution evidence acquisition/state overlay",
...
Define A&M high-resolution evidence acquisition/state overlay
...
1. Stable ID TASK-088, parent EPIC-016, owner wave W14, and original status DONE are preserved.
