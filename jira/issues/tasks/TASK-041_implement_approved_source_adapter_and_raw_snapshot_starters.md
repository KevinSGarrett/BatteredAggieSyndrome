<!-- GENERATED VIEW. Canonical record: jira/records/issues/tasks/TASK-041_implement_approved_source_adapter_and_raw_snapshot_starters.json -->
# TASK-041 — [TASK-041] Implement approved source-adapter and raw snapshot starters
...
```json
{
  ...
  "acceptance_criteria": [
    "Stable ID TASK-041, parent EPIC-008, owner wave W19, and original status DONE are preserved.",
  ...
  "ai_context_notes": [
    ...
    "First READY W19 task after W18 governance gate; owner-wave sequencing still applies. Completed W19 functional starter; no empirical model/feature claims."
  ],
  "allowed_modification_paths": [
    "raw snapshot writer",
    "source adapter starters"
  ],
  "blocked_reason": "",
  "blocks": [
    "TASK-042"
  ],
  "canonical_record": "jira/records/issues/tasks/TASK-041_implement_approved_source_adapter_and_raw_snapshot_starters.json",
  ...
  "gap_ids": [],
  "generated_markdown": "jira/issues/tasks/TASK-041_implement_approved_source_adapter_and_raw_snapshot_starters.md",
  ...
  "objective": "Implement approved source-adapter and raw snapshot starters",
  "operational_jira": {
    "assignee": "",
    "jira_issue_id": "24284",
    "jira_updated_at": "2026-08-09T00:40:23.416-0500",
  ...
  "required_evidence": [
    "Authoritative WBS row TASK-041",
    "Existing artifact `raw snapshot writer`",
    "Existing artifact `source adapter starters`"
  ],
  "required_tests": [
    {
  ...
  "specificity_fingerprint": "5aa9b2d8f57a5b0927d215bb8a237c88ae99f35fe493fda24a6ea75f5f869d64",
  "stop_conditions": [
  ...
  "title": "[TASK-041] Implement approved source-adapter and raw snapshot starters",
...
Implement approved source-adapter and raw snapshot starters
...
1. Stable ID TASK-041, parent EPIC-008, owner wave W19, and original status DONE are preserved.
