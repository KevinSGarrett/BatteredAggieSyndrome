<!-- GENERATED VIEW. Canonical record: jira/records/issues/tasks/TASK-058_freeze_advanced_player_input_contract.json -->
# TASK-058 — [TASK-058] Freeze advanced player-input contract
...
```json
{
  ...
  "acceptance_criteria": [
    "Stable ID TASK-058, parent EPIC-010, owner wave W12, and original status DONE are preserved.",
  ...
  "canonical_record": "jira/records/issues/tasks/TASK-058_freeze_advanced_player_input_contract.json",
  ...
  "gap_ids": [],
  "generated_markdown": "jira/issues/tasks/TASK-058_freeze_advanced_player_input_contract.md",
  ...
  "objective": "Freeze advanced player-input contract",
  "operational_jira": {
    "assignee": "",
    "jira_issue_id": "24301",
    "jira_updated_at": "2026-08-09T00:40:26.957-0500",
  ...
  "phase": "PHASE-2",
  "prerequisites": [
    "Historical dependency TASK-057",
  ...
  "required_evidence": [
    "Authoritative WBS row TASK-058",
    "Existing artifact `transfer/recruiting/prospect interface baseline`"
  ],
  "required_tests": [
    {
  ...
  "specificity_fingerprint": "498ee4e7ee7e9c457d48449ee195e056ed134666747a3395593f37ecd342e4e9",
  "stop_conditions": [
  ...
  "title": "[TASK-058] Freeze advanced player-input contract",
...
Freeze advanced player-input contract
...
- Inherited from: None
- Resolution: `DIRECT`
- Effective counts: `{"acceptance_control_ids": 9, "adr_ids": 0, "gap_ids": 0, "requirement_ids": 10, "risk_ids": 0}`

## Acceptance Criteria

1. Stable ID TASK-058, parent EPIC-010, owner wave W12, and original status DONE are preserved.
