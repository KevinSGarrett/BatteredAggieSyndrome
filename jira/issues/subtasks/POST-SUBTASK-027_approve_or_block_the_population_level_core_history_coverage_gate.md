...
```json
{
  ...
  "critical_path": true,
  "definition_of_done": [
    "The atomic scope in POST-SUBTASK-027 is completed without absorbing sibling work or weakening any protected requirement, control, split, judging rule, private-research publication boundary, or security boundary.",
  ...
  "operational_jira": {
    "assignee": "",
    "jira_issue_id": "24517",
    "jira_updated_at": "2026-08-09T23:24:01.866-0500",
  ...
  "out_of_scope": [
    ...
    "Work assigned to sibling subtasks: Acquire quality-supported national team, schedule, game, score, drive, play, box-score, and gamebook history; Normalize and reconcile core/game-event records while preserving immutable source evidence."
  ],
  "owner_wave": "POST_W25",
  ...
  "specificity_fingerprint": "0fa7f8083a11e70c60f4639ba580a3b6680f18e5c1625dfab47fb4f32326c00f",
  "stop_conditions": [
...
1. The atomic scope in POST-SUBTASK-027 is completed without absorbing sibling work or weakening any protected requirement, control, split, judging rule, private-research publication boundary, or security boundary.
...
- **EXISTING_AUTOMATED_TEST** / `REGRESSION` — `artifacts/data_lake/core_coverage_gate.json` — Run as a regression check after completing POST-SUBTASK-027; retain command, exit code, and relevant output.
