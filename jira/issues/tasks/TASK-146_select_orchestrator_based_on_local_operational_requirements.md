<!-- GENERATED VIEW. Canonical record: jira/records/issues/tasks/TASK-146_select_orchestrator_based_on_local_operational_requirements.json -->
# TASK-146 — [TASK-146] Select orchestrator based on local operational requirements
...
```json
{
  ...
  "acceptance_criteria": [
    "Stable ID TASK-146, parent EPIC-026, owner wave W21, and original status DONE are preserved.",
  ...
  "canonical_record": "jira/records/issues/tasks/TASK-146_select_orchestrator_based_on_local_operational_requirements.json",
  ...
  "gap_ids": [],
  "generated_markdown": "jira/issues/tasks/TASK-146_select_orchestrator_based_on_local_operational_requirements.md",
  ...
  "objective": "Select orchestrator based on local operational requirements",
  "operational_jira": {
    "assignee": "",
    "jira_issue_id": "24389",
    "jira_updated_at": "2026-08-09T00:40:43.990-0500",
  ...
  "required_evidence": [
    "Authoritative WBS row TASK-146",
    "Existing artifact `Prefect-or-approved choice`",
    "Existing artifact `orchestrator ADR`"
  ],
  "required_tests": [
    {
  ...
  "specificity_fingerprint": "ea7b9d9091008e4aeac0327cf16a1ab7aa2d92cfe658571d99b3e63ea709c9da",
  "stop_conditions": [
  ...
  "title": "[TASK-146] Select orchestrator based on local operational requirements",
...
Select orchestrator based on local operational requirements
...
1. Stable ID TASK-146, parent EPIC-026, owner wave W21, and original status DONE are preserved.
