<!-- GENERATED VIEW. Canonical record: jira/records/issues/tasks/TASK-122_define_epistemic_aleatoric_data_uncertainty_interface.json -->
# TASK-122 — [TASK-122] Define epistemic/aleatoric/data uncertainty interface
...
```json
{
  ...
  "acceptance_criteria": [
    "Stable ID TASK-122, parent EPIC-022, owner wave W16, and original status DONE are preserved.",
  ...
  "canonical_record": "jira/records/issues/tasks/TASK-122_define_epistemic_aleatoric_data_uncertainty_interface.json",
  ...
  "gap_ids": [],
  "generated_markdown": "jira/issues/tasks/TASK-122_define_epistemic_aleatoric_data_uncertainty_interface.md",
  ...
  "objective": "Define epistemic/aleatoric/data uncertainty interface",
  "operational_jira": {
    "assignee": "",
    "jira_issue_id": "24365",
    "jira_updated_at": "2026-08-09T00:40:39.349-0500",
  ...
  "required_evidence": [
    "Authoritative WBS row TASK-122",
    "Existing artifact `uncertainty contract`"
  ],
  "required_tests": [
    {
  ...
  "specificity_fingerprint": "e50ae308ffcc25fbde5f8bd55c2f45df86cdde1141eef28a6b8445f9324e5115",
  "stop_conditions": [
  ...
  "title": "[TASK-122] Define epistemic/aleatoric/data uncertainty interface",
...
Define epistemic/aleatoric/data uncertainty interface
...
1. Stable ID TASK-122, parent EPIC-022, owner wave W16, and original status DONE are preserved.
