<!-- GENERATED VIEW. Canonical record: jira/records/issues/epics/EPIC-015_advanced_intelligence_implementation_realization.json -->
# EPIC-015 — [EPIC-015] Advanced intelligence implementation realization
...
```json
{
  ...
  "acceptance_criteria": [
    "The epic retains stable ID EPIC-015, owner wave W19-W20, phase PHASE-2, and all authoritative WBS children.",
  ...
  "blocked_reason": "",
  "blocks": [],
  "canonical_record": "jira/records/issues/epics/EPIC-015_advanced_intelligence_implementation_realization.json",
  ...
  "expected_outputs": [
    ...
    "player/availability starter modules",
    "transfer/recruiting starter modules"
  ],
  ...
  "gap_ids": [],
  "generated_markdown": "jira/issues/epics/EPIC-015_advanced_intelligence_implementation_realization.md",
  ...
  "operational_jira": {
    "assignee": "",
    "jira_issue_id": "24155",
    "jira_updated_at": "2026-08-09T00:40:12.474-0500",
  ...
  "specificity_fingerprint": "d756061de5c2d4ce9992356dc9fdc0402924968b27190dc1c117120d263f01a1",
  "stop_conditions": [
    "Stop if a proposed update renumbers the historical epic or rewrites its original wave provenance."
  ],
  "supporting_source_refs": [],
  "title": "[EPIC-015] Advanced intelligence implementation realization",
...
Implement selected advanced state/feature components behind stable PIT-safe interfaces.
...
1. The epic retains stable ID EPIC-015, owner wave W19-W20, phase PHASE-2, and all authoritative WBS children.
