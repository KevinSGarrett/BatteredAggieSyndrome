<!-- GENERATED VIEW. Canonical record: jira/records/issues/stories/POST-STORY-024_model_ready_targets_splits_weights_and_datasets.json -->
# POST-STORY-024 — [POST-STORY-024] Model-ready targets, splits, weights, and datasets
...
```json
{
  ...
  "blocked_reason": "",
  "blocks": [],
  "canonical_record": "jira/records/issues/stories/POST-STORY-024_model_ready_targets_splits_weights_and_datasets.json",
  "canonical_source_role": "AUTHORITATIVE_LOCAL_SPECIFICATION",
  "completion_evidence_contract": {
    "all_child_evidence_required": true,
    "child_gate": "POST-SUBTASK-072",
  ...
  "critical_path": true,
  "definition_of_done": [
    "All child subtasks POST-SUBTASK-070, POST-SUBTASK-071, POST-SUBTASK-072 have verified evidence or an explicit accepted-risk/deferred/cancelled disposition consistent with the Story contract.",
    "The final gate `POST-SUBTASK-072` completes and proves the Story end-to-end requirement; closing implementation children alone is insufficient.",
  ...
  "end_to_end_validation": "The same pinned identities always produce the same model-ready rows, targets, weights, and chronological partitions without protected leakage.",
  "epic_id": "POST-EPIC-008",
  "evidence_manifest_path": "artifacts/jira_evidence/POST-STORY-024.json",
  ...
  "gap_ids": [],
  "generated_markdown": "jira/issues/stories/POST-STORY-024_model_ready_targets_splits_weights_and_datasets.md",
  ...
  "local_id": "POST-STORY-024",
  "maturity_before": "FUNCTIONAL_STARTER",
  "objective": "Freeze task definitions and model inputs before candidate training.",
  "operational_jira": {
    "assignee": "",
    "jira_issue_id": "24214",
    "jira_updated_at": "2026-08-09T00:03:42.932-0500",
  ...
  "phase": "PHASE-1",
  "prerequisites": [
    "Hard dependency POST-SUBTASK-060",
  ...
  "required_tests": [
    ...
    },
    {
      ...
      "expectation": "The final child gate `POST-SUBTASK-072` must prove the integrated Story outcome and downstream-consumable output.",
  ...
  "specificity_fingerprint": "50a366d19e9c36dc85765d2bc5ba3203848cd309d95edcc8da4d278cae08c8e7",
  "stop_conditions": [
  ...
  "title": "[POST-STORY-024] Model-ready targets, splits, weights, and datasets",
  ...
  "work_packet_path": "jira/ai/work_packets/POST-STORY-024.md",
...
1. All child subtasks POST-SUBTASK-070, POST-SUBTASK-071, POST-SUBTASK-072 have verified evidence or an explicit accepted-risk/deferred/cancelled disposition consistent with the Story contract.
2. The final gate `POST-SUBTASK-072` completes and proves the Story end-to-end requirement; closing implementation children alone is insufficient.
