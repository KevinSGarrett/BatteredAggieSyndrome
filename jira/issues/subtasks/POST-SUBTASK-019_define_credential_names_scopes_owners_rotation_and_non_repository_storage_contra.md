...
```json
{
  ...
  "critical_path": true,
  "definition_of_done": [
    "The atomic scope in POST-SUBTASK-019 is completed without absorbing sibling work or weakening any protected requirement, control, split, judging rule, private-research publication boundary, or security boundary.",
  ...
  "end_to_end_validation": "Validate that `docs/operations/SOURCE_CREDENTIAL_CONTRACT.md`, `artifacts/source_governance/credential_contract.redacted.json` can be parsed and consumed by `POST-SUBTASK-020` using only documented identities and interfaces; the consumer must reject missing, stale, schema-incompatible, technically or quality-ineligible, or provenance-incomplete input without manual repair.",
  ...
  "operational_jira": {
    "assignee": "",
    "jira_issue_id": "24509",
    "jira_updated_at": "2026-08-09T08:06:27.128-0500",
    "last_synced_at": "2026-08-09T13:07:09.957737+00:00",
    "source_export": "C:\\BatteredAggieSyndrome.data\\runtime\\BAT-369\\BAT-369-live-row.csv",
    "sprint": "",
    "status_raw": "Done"
  },
  "out_of_scope": [
  ...
  "specificity_fingerprint": "e16bdd7aa248f35772fea8aa345f910bb8b7eb91cf2058fc400bf35e7985a894",
  "stop_conditions": [
...
1. The atomic scope in POST-SUBTASK-019 is completed without absorbing sibling work or weakening any protected requirement, control, split, judging rule, private-research publication boundary, or security boundary.
...
- **EXISTING_AUTOMATED_TEST** / `REGRESSION` — `docs/operations/SOURCE_CREDENTIAL_CONTRACT.md` — Run as a regression check after completing POST-SUBTASK-019; retain command, exit code, and relevant output.
