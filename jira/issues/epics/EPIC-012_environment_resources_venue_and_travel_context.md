<!-- GENERATED VIEW. Canonical record: jira/records/issues/epics/EPIC-012_environment_resources_venue_and_travel_context.json -->
# EPIC-012 — [EPIC-012] Environment, resources, venue and travel context
...
```json
{
  ...
  "acceptance_criteria": [
    "The epic retains stable ID EPIC-012, owner wave W13, phase PHASE-2, and all authoritative WBS children.",
  ...
  "blocked_reason": "",
  "blocks": [],
  "canonical_record": "jira/records/issues/epics/EPIC-012_environment_resources_venue_and_travel_context.json",
  ...
  "expected_outputs": [
    "context interface baseline",
    "game-context effective-dated feature contracts",
    "home-field residual experiment specification",
    "private-resource proxy semantics/experiment",
    "regulatory environment contract",
    "resource capacity evidence lanes and missingness policy",
    "venue/travel context schema",
    "weather snapshot feature contract"
  ],
  ...
  "gap_ids": [],
  "generated_markdown": "jira/issues/epics/EPIC-012_environment_resources_venue_and_travel_context.md",
  ...
  "objective": "Represent environment and resource signals without inventing private-school values or hard-coded home bonuses.",
  "operational_jira": {
    "assignee": "",
    "jira_issue_id": "24152",
    "jira_updated_at": "2026-08-09T00:40:11.613-0500",
  ...
  "specificity_fingerprint": "36366b3544d7badaf788042a0a53008d4192069f34f852de0575af7e6d855ccc",
  "stop_conditions": [
    "Stop if a proposed update renumbers the historical epic or rewrites its original wave provenance."
  ],
  "supporting_source_refs": [],
  "title": "[EPIC-012] Environment, resources, venue and travel context",
...
Represent environment and resource signals without inventing private-school values or hard-coded home bonuses.
...
1. The epic retains stable ID EPIC-012, owner wave W13, phase PHASE-2, and all authoritative WBS children.
