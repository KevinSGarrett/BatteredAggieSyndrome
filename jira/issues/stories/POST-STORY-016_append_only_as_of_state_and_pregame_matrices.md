<!-- GENERATED VIEW. Canonical record: jira/records/issues/stories/POST-STORY-016_append_only_as_of_state_and_pregame_matrices.json -->
# POST-STORY-016 — [POST-STORY-016] Append-only as-of state and pregame matrices
...
```json
{
  ...
  "blocked_reason": "",
  "blocks": [],
  "canonical_record": "jira/records/issues/stories/POST-STORY-016_append_only_as_of_state_and_pregame_matrices.json",
  "canonical_source_role": "AUTHORITATIVE_LOCAL_SPECIFICATION",
  "completion_evidence_contract": {
    "all_child_evidence_required": true,
    "child_gate": "POST-SUBTASK-048",
  ...
  "critical_path": true,
  "definition_of_done": [
    "All child subtasks POST-SUBTASK-046, POST-SUBTASK-047, POST-SUBTASK-048 have verified evidence or an explicit accepted-risk/deferred/cancelled disposition consistent with the Story contract.",
    "The final gate `POST-SUBTASK-048` completes and proves the Story end-to-end requirement; closing implementation children alone is insufficient.",
  ...
  "end_to_end_validation": "A pinned cutoff reconstructs the exact state and matrix row that was legitimately knowable before a historical game.",
  "epic_id": "POST-EPIC-005",
  "evidence_manifest_path": "artifacts/jira_evidence/POST-STORY-016.json",
  ...
  "gap_ids": [],
  "generated_markdown": "jira/issues/stories/POST-STORY-016_append_only_as_of_state_and_pregame_matrices.md",
  ...
  "local_id": "POST-STORY-016",
  "maturity_before": "FUNCTIONAL_STARTER",
  "objective": "Reconstruct what was known for each game/cutoff and materialize row-level model inputs with complete lineage.",
  "operational_jira": {
    "assignee": "",
    "jira_issue_id": "24206",
    "jira_updated_at": "2026-08-09T23:23:55.797-0500",
  ...
  "phase": "PHASE-1",
  "prerequisites": [
    "Hard dependency POST-SUBTASK-045"
  ],
  "primary_source_refs": [
    "SRCREF-02025",
    "SRCREF-02026",
  ...
  "required_tests": [
    ...
    },
    {
      ...
      "expectation": "The final child gate `POST-SUBTASK-048` must prove the integrated Story outcome and downstream-consumable output.",
  ...
  "risk_ids": [],
  "schema_version": 2,
  "scope": "Deliver Story POST-STORY-016 (Append-only as-of state and pregame matrices) as one coherent, gated capability inside Epic POST-EPIC-005. Execute child subtasks POST-SUBTASK-046, POST-SUBTASK-047, POST-SUBTASK-048 in dependency order, reconcile their pinned outputs, and require the final gate `POST-SUBTASK-048` to issue an evidence-backed approve/block/reject/defer decision before any downstream use.",
  "source_ids": [
    "GAP-005",
    "GAP-006",
    "HANDOFF-004"
  ...
  "specificity_fingerprint": "68f8e98d50e9cec6952664b3fa411ff407798289d2b4d97b2bb61cc25ed91b0d",
  "stop_conditions": [
  ...
  "title": "[POST-STORY-016] Append-only as-of state and pregame matrices",
  ...
  "work_packet_path": "jira/ai/work_packets/POST-STORY-016.md",
...
4. Each game/cutoff row uses only eligible state, handles home/away/neutral/lower-division/cancellations deterministically, and separates structural/not-known/source/resolution/pipeline missingness.
5. The declared output `artifacts/pit/pregame_matrix_manifest.json` is produced with deterministic identity, provenance, and validation metadata appropriate to this work.
6. Approved matrices are content-hashed, split-blind, reproducible from pinned raw/entity/state versions, and cannot pass on successful file creation alone.
7. All prerequisite evidence is linked and unresolved blockers remain explicit; file creation alone cannot pass this gate.

## Definition of Done

1. All child subtasks POST-SUBTASK-046, POST-SUBTASK-047, POST-SUBTASK-048 have verified evidence or an explicit accepted-risk/deferred/cancelled disposition consistent with the Story contract.
2. The final gate `POST-SUBTASK-048` completes and proves the Story end-to-end requirement; closing implementation children alone is insufficient.
