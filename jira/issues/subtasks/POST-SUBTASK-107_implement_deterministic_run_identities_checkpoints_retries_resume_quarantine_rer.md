...
```json
{
  ...
  "critical_path": false,
  "definition_of_done": [
    "The atomic scope in POST-SUBTASK-107 is completed without absorbing sibling work or weakening any protected requirement, control, split, judging rule, private-research publication boundary, or security boundary.",
  ...
  "operational_jira": {
    "assignee": "",
    "jira_issue_id": "24597",
    "jira_updated_at": "2026-08-09T23:24:10.493-0500",
  ...
  "specificity_fingerprint": "f1209a7957cb57c246b79d432a24027bfb977a1467abdb0c23d2ea414d49bd0e",
  "stop_conditions": [
...
1. The atomic scope in POST-SUBTASK-107 is completed without absorbing sibling work or weakening any protected requirement, control, split, judging rule, private-research publication boundary, or security boundary.
...
Validate that `artifacts/mlops/checkpoint_resume_test.json` can be parsed and consumed by `POST-SUBTASK-108` using only documented identities and interfaces; the consumer must reject missing, stale, schema-incompatible, technically or quality-ineligible, or provenance-incomplete input without manual repair.
