<!-- GENERATED VIEW. Canonical record: jira/records/issues/subtasks/POST-SUBTASK-205_run_cross_plane_gold_comparison_three_scheduler_cycles_restart_and_outage_exercises_and_seve.json -->
# POST-SUBTASK-205 — [POST-SUBTASK-205] Run cross-plane gold comparison, three scheduler cycles, restart and outage exercises, and seven-day sustained assurance
...
```json
{
  ...
  "gap_ids": [],
  "generated_markdown": "jira/issues/subtasks/POST-SUBTASK-205_run_cross_plane_gold_comparison_three_scheduler_cycles_restart_and_outage_exercises_and_seve.md",
  ...
  "objective": "Run cross-plane gold comparison, three scheduler cycles, restart and outage exercises, and seven-day sustained assurance",
  "operational_jira": {
    "assignee": "",
    "jira_issue_id": "24957",
    "jira_updated_at": "2026-08-12T12:49:19.926-0500",
  ...
  "unblock_condition": "At least one separately keyed local route qualifies, paid Cursor/OpenRouter pilots pass their applicable gates, POST-SUBTASK-204 qualifies, and seven days plus three real scheduler cycles accrue from production-like eligible work.",
  "validation_classes": [
    "END_TO_END",
    "REPRODUCIBILITY",
    "SECURITY"
