<!-- GENERATED VIEW. Canonical record: jira/records/issues/subtasks/POST-SUBTASK-006_validate_target_storage_permissions_free_space_atomic_writes_and_quarantine_beha.json -->
# POST-SUBTASK-006 — [POST-SUBTASK-006] Validate target storage permissions, free space, atomic writes, and quarantine behavior
...
```json
{
  ...
  "ai_context_notes": [
    ...
    "Read the exact source sections in `jira/sources/issue_source_manifests/POST-SUBTASK-006.json`; inspect only the listed implementation files and prerequisite outputs.",
  ...
  "blocked_reason": "UNSATISFIED_HARD_DEPENDENCIES: POST-SUBTASK-001;POST-SUBTASK-004;POST-SUBTASK-005",
  "blocks": [
    "POST-STORY-003",
    "POST-STORY-009",
    "POST-SUBTASK-007",
  ...
  "canonical_record": "jira/records/issues/subtasks/POST-SUBTASK-006_validate_target_storage_permissions_free_space_atomic_writes_and_quarantine_beha.json",
  "canonical_source_role": "AUTHORITATIVE_LOCAL_SPECIFICATION",
  "completion_evidence_contract": {
    "acceptance_matrix_required": true,
    "artifact_hashes_required": true,
    "completion_claim_limit": "INTEGRATED",
    "downstream_consumer": "POST-STORY-002",
  ...
  "critical_path": false,
  "definition_of_done": [
    "The atomic scope in POST-SUBTASK-006 is completed without absorbing sibling work or weakening any protected requirement, control, split, judging rule, rights decision, or security boundary.",
    ...
    "The Story gate consumes the complete prerequisite evidence set and issues an explicit downstream approval/block/reject/defer decision for POST-STORY-002."
  ],
  "dependencies": [
    "POST-SUBTASK-001",
    "POST-SUBTASK-004",
  ...
  "gap_ids": [],
  "generated_markdown": "jira/issues/subtasks/POST-SUBTASK-006_validate_target_storage_permissions_free_space_atomic_writes_and_quarantine_beha.md",
  ...
  "local_id": "POST-SUBTASK-006",
  "maturity_before": "FUNCTIONAL_STARTER",
  "objective": "Validate target storage permissions, free space, atomic writes, and quarantine behavior",
  "operational_jira": {
    "assignee": "",
    "jira_issue_id": "24496",
    "jira_updated_at": "2026-08-09T00:03:19.651-0500",
  ...
  "prerequisites": [
    ...
    "Dependency POST-SUBTASK-005 complete at required maturity"
  ],
  "primary_source_refs": [
    "SRCREF-01994",
    "SRCREF-01995",
  ...
  "required_tests": [
    {
      ...
      "expectation": "Run as a regression check after completing POST-SUBTASK-006; retain command, exit code, and relevant output.",
    ...
    },
    {
      ...
      "path": "artifacts/implementation_preflight/storage_probe.json",
  ...
  "risk_failure_conditions": [
    "The work would be invalid if any prerequisite artifact, source/data/code/config identity, or declared maturity differs from the pinned issue contract for POST-SUBTASK-006.",
    "A command may exit successfully while producing stale, partial, synthetic-only, leakage-contaminated, non-reproducible, or legally unusable evidence.",
    "Acceptance failure: the evidence cannot demonstrate that the probe demonstrates atomic create/rename, fsync, readback hash verification, and quarantine moves on each configured root.",
    "Acceptance failure: the evidence cannot demonstrate that available capacity is recorded without inventing a minimum threshold.",
    "Acceptance failure: the evidence cannot demonstrate that insufficient permissions or capacity blocks downstream materialization."
  ],
  "risk_ids": [],
  "schema_version": 2,
  "scope": "Execute the atomic 3 of 3 step in Story POST-STORY-002 (Local data, artifact, and secret boundary bootstrap): Validate target storage permissions, free space, atomic writes, and quarantine behavior. Consume only verified prerequisite outputs from `POST-SUBTASK-001`, `POST-SUBTASK-004`, `POST-SUBTASK-005`. Produce `artifacts/implementation_preflight/storage_probe.json`; evaluate every issue-specific acceptance condition; preserve negative results; and hand the pinned output to the Story gate/downstream dependency graph.",
  "source_ids": [
    "GAP-001",
    "GAP-010",
    "HANDOFF-001",
  ...
  "specificity_fingerprint": "31bd729bb2ca63bcb6e98b7bb3215312a3d6a5b6b9b55e4e237f5f386ffb58c2",
  "stop_conditions": [
  ...
  "title": "[POST-SUBTASK-006] Validate target storage permissions, free space, atomic writes, and quarantine behavior",
...
1. The atomic scope in POST-SUBTASK-006 is completed without absorbing sibling work or weakening any protected requirement, control, split, judging rule, rights decision, or security boundary.
...
7. The Story gate consumes the complete prerequisite evidence set and issues an explicit downstream approval/block/reject/defer decision for POST-STORY-002.
