...
```json
{
  ...
  "critical_path": false,
  "definition_of_done": [
    "The atomic scope in POST-SUBTASK-133 is completed without absorbing sibling work or weakening any protected requirement, control, split, judging rule, rights decision, or security boundary.",
  ...
  "end_to_end_validation": "Validate that `artifacts/release/final_traceability_audit.json` can be parsed and consumed by `POST-SUBTASK-134` using only documented identities and interfaces; the consumer must reject missing, stale, schema-incompatible, rights-blocked, or provenance-incomplete input without manual repair.",
  ...
  "specificity_fingerprint": "03bac76ee5de7328e32f41e242b6e8fc005a2fa33c179534098deb83ad1426b6",
  "stop_conditions": [
...
1. The atomic scope in POST-SUBTASK-133 is completed without absorbing sibling work or weakening any protected requirement, control, split, judging rule, rights decision, or security boundary.
