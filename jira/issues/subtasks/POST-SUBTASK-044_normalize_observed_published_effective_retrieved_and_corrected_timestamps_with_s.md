...
```json
{
  ...
  "blocked_reason": "UNSATISFIED_HARD_DEPENDENCIES: POST-SUBTASK-042;POST-SUBTASK-043",
  "blocks": [
    "POST-SUBTASK-045"
  ],
  ...
  "critical_path": true,
  "definition_of_done": [
    "The atomic scope in POST-SUBTASK-044 is completed without absorbing sibling work or weakening any protected requirement, control, split, judging rule, rights decision, or security boundary.",
  ...
  "end_to_end_validation": "Validate that `artifacts/pit/timestamp_normalization_report.json` can be parsed and consumed by `POST-SUBTASK-045` using only documented identities and interfaces; the consumer must reject missing, stale, schema-incompatible, rights-blocked, or provenance-incomplete input without manual repair.",
  ...
  "operational_jira": {
    "assignee": "",
    "jira_issue_id": "24534",
    "jira_updated_at": "2026-08-09T00:03:35.350-0500",
  ...
  "specificity_fingerprint": "3842977acf9fcec0755ce4d3390726dd38d96e4fb61432dc764868a7b307531a",
  "stop_conditions": [
...
1. The atomic scope in POST-SUBTASK-044 is completed without absorbing sibling work or weakening any protected requirement, control, split, judging rule, rights decision, or security boundary.
