...
1. `jira/records/issues/stories/POST-STORY-027_official_a_and_m_evidence_and_high_resolution_pit_state.json`
2. `jira/sources/issue_source_manifests/POST-STORY-027.json`
3. `jira/index/ISSUE_GOVERNANCE_CONTEXT.csv` row for `POST-STORY-027`.
