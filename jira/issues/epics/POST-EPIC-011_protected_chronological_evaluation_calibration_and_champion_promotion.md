<!-- GENERATED VIEW. Canonical record: jira/records/issues/epics/POST-EPIC-011_protected_chronological_evaluation_calibration_and_champion_promotion.json -->
# POST-EPIC-011 — [POST-EPIC-011] Protected chronological evaluation, calibration, and champion promotion
...
```json
{
  ...
  "allowed_modification_paths": [
    "artifacts/jira_evidence/POST-EPIC-011.json"
  ],
  "blocked_reason": "",
  "blocks": [],
  "canonical_record": "jira/records/issues/epics/POST-EPIC-011_protected_chronological_evaluation_calibration_and_champion_promotion.json",
  ...
  "critical_path": true,
  "definition_of_done": [
    "Every child Story POST-STORY-033, POST-STORY-034, POST-STORY-035 is completed through its explicit end-to-end gate or has an explicit accepted-risk/deferred/cancelled disposition consistent with release governance.",
  ...
  "gap_ids": [],
  "generated_markdown": "jira/issues/epics/POST-EPIC-011_protected_chronological_evaluation_calibration_and_champion_promotion.md",
  ...
  "operational_jira": {
    "assignee": "",
    "jira_issue_id": "24184",
    "jira_updated_at": "2026-08-09T23:23:53.786-0500",
  ...
  "prerequisites": [
    ...
    "Completion of POST-SUBTASK-090"
  ],
  "primary_source_refs": [
    "SRCREF-02071",
    "SRCREF-02072",
  ...
  "related_to": [],
  "required_evidence": [
    "Verified Story gate decisions for POST-SUBTASK-099, POST-SUBTASK-102, POST-SUBTASK-105.",
  ...
  "required_tests": [
    {
      ...
      "expectation": "Story gate `POST-SUBTASK-099` must complete with verified evidence before Epic completion.",
      "path": "POST-SUBTASK-099",
      "validation_class": "END_TO_END"
    },
    {
      "classification": "END_TO_END",
      "expectation": "Story gate `POST-SUBTASK-102` must complete with verified evidence before Epic completion.",
      "path": "POST-SUBTASK-102",
      "validation_class": "END_TO_END"
    },
    {
      "classification": "END_TO_END",
      "expectation": "Story gate `POST-SUBTASK-105` must complete with verified evidence before Epic completion.",
  ...
  "risk_ids": [],
  "schema_version": 2,
  "scope": "All Stories and Subtasks under this Epic for the validation domain, including its explicit integrated completion gate.",
  "source_ids": [
    "GAP-008",
    "GAP-009",
    "HANDOFF-006"
  ...
  "title": "[POST-EPIC-011] Protected chronological evaluation, calibration, and champion promotion",
  ...
  "work_packet_path": "jira/ai/work_packets/POST-EPIC-011.md",
...
All Stories and Subtasks under this Epic for the validation domain, including its explicit integrated completion gate.
...
1. Every child Story POST-STORY-033, POST-STORY-034, POST-STORY-035 is completed through its explicit end-to-end gate or has an explicit accepted-risk/deferred/cancelled disposition consistent with release governance.
...
- **END_TO_END** / `END_TO_END` — `POST-SUBTASK-099` — Story gate `POST-SUBTASK-099` must complete with verified evidence before Epic completion.
- **END_TO_END** / `END_TO_END` — `POST-SUBTASK-102` — Story gate `POST-SUBTASK-102` must complete with verified evidence before Epic completion.
- **END_TO_END** / `END_TO_END` — `POST-SUBTASK-105` — Story gate `POST-SUBTASK-105` must complete with verified evidence before Epic completion.
