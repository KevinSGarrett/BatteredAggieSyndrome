<!-- GENERATED VIEW. Canonical record: jira/records/issues/subtasks/POST-SUBTASK-071_materialize_chronological_train_tune_protected_assignments_sample_weights_cold_s.json -->
# POST-SUBTASK-071 — [POST-SUBTASK-071] Materialize chronological train/tune/protected assignments, sample weights, cold-start rules, and feature/target separation
...
```json
{
  ...
  "acceptance_criteria": [
    ...
    "The declared output `artifacts/modeling/model_split_manifest.json` is produced with deterministic identity, provenance, and validation metadata appropriate to this work.",
  ...
  "ai_context_notes": [
    ...
    "Read the exact source sections in `jira/sources/issue_source_manifests/POST-SUBTASK-071.json`; inspect only the listed implementation files and prerequisite outputs.",
  ...
  "canonical_record": "jira/records/issues/subtasks/POST-SUBTASK-071_materialize_chronological_train_tune_protected_assignments_sample_weights_cold_s.json",
  "canonical_source_role": "AUTHORITATIVE_LOCAL_SPECIFICATION",
  "completion_evidence_contract": {
    "acceptance_matrix_required": true,
    "artifact_hashes_required": true,
    "completion_claim_limit": "EMPIRICALLY_VALIDATED",
    "downstream_consumer": "POST-SUBTASK-072",
  ...
  "critical_path": true,
  "definition_of_done": [
    "The atomic scope in POST-SUBTASK-071 is completed without absorbing sibling work or weakening any protected requirement, control, split, judging rule, rights decision, or security boundary.",
    ...
    "The output set `artifacts/modeling/model_split_manifest.json` is demonstrably consumable by POST-SUBTASK-072 without manual reconstruction or undocumented state."
  ],
  "dependencies": [
    "POST-SUBTASK-051",
    "POST-SUBTASK-060",
  ...
  "end_to_end_validation": "Validate that `artifacts/modeling/model_split_manifest.json` can be parsed and consumed by `POST-SUBTASK-072` using only documented identities and interfaces; the consumer must reject missing, stale, schema-incompatible, rights-blocked, or provenance-incomplete input without manual repair.",
  "epic_id": "POST-EPIC-008",
  "evidence_manifest_path": "artifacts/jira_evidence/POST-SUBTASK-071.json",
  ...
  "gap_ids": [],
  "generated_markdown": "jira/issues/subtasks/POST-SUBTASK-071_materialize_chronological_train_tune_protected_assignments_sample_weights_cold_s.md",
  ...
  "local_id": "POST-SUBTASK-071",
  "maturity_before": "FUNCTIONAL_STARTER",
  "objective": "Materialize chronological train/tune/protected assignments, sample weights, cold-start rules, and feature/target separation",
  "operational_jira": {
    "assignee": "",
    "jira_issue_id": "24561",
    "jira_updated_at": "2026-08-09T00:03:46.767-0500",
  ...
  "required_tests": [
    {
      ...
      "expectation": "Run as a regression check after completing POST-SUBTASK-071; retain command, exit code, and relevant output.",
    ...
    },
    {
      ...
      "path": "artifacts/modeling/model_split_manifest.json",
    ...
    },
    {
      ...
      "path": "NEW_TEST_REQUIRED::POST-SUBTASK-071",
      "validation_class": "NEW_AUTOMATED_TEST_REQUIRED"
    }
  ],
  "requirement_ids": [],
  "risk_failure_conditions": [
    "The work would be invalid if any prerequisite artifact, source/data/code/config identity, or declared maturity differs from the pinned issue contract for POST-SUBTASK-071.",
    "A command may exit successfully while producing stale, partial, synthetic-only, leakage-contaminated, non-reproducible, or legally unusable evidence.",
    "Acceptance failure: the evidence cannot demonstrate that split assignments match protected registries, prevent duplicate/rematch/season-fragment leakage, and precommit weights/shrinkage before candidate results.",
    "Acceptance failure: the evidence cannot demonstrate that the declared output `artifacts/modeling/model_split_manifest.json` is produced with deterministic identity, provenance, and validation metadata appropriate to this work.",
  ...
  "specificity_fingerprint": "ec8c30c4da39f050d9ce6770ed1f25627b175b5a49e3781be26bc4b1f38afcaa",
  "stop_conditions": [
  ...
  "title": "[POST-SUBTASK-071] Materialize chronological train/tune/protected assignments, sample weights, cold-start rules, and feature/target separation",
  ...
  "work_packet_path": "jira/ai/work_packets/POST-SUBTASK-071.md",
...
1. The atomic scope in POST-SUBTASK-071 is completed without absorbing sibling work or weakening any protected requirement, control, split, judging rule, rights decision, or security boundary.
...
7. The output set `artifacts/modeling/model_split_manifest.json` is demonstrably consumable by POST-SUBTASK-072 without manual reconstruction or undocumented state.
...
Validate that `artifacts/modeling/model_split_manifest.json` can be parsed and consumed by `POST-SUBTASK-072` using only documented identities and interfaces; the consumer must reject missing, stale, schema-incompatible, rights-blocked, or provenance-incomplete input without manual repair.
