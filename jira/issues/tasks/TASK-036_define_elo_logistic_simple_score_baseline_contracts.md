<!-- GENERATED VIEW. Canonical record: jira/records/issues/tasks/TASK-036_define_elo_logistic_simple_score_baseline_contracts.json -->
# TASK-036 — [TASK-036] Define Elo/logistic/simple score baseline contracts
...
```json
{
  ...
  "acceptance_criteria": [
    "Stable ID TASK-036, parent EPIC-007, owner wave W16, and original status DONE are preserved.",
  ...
  "ai_context_notes": [
    ...
    "W16 contract/reference only; actual trained implementation/results are not claimed."
  ],
  "allowed_modification_paths": [
    "baseline candidate contracts + reference formulas"
  ],
  "blocked_reason": "",
  "blocks": [
    "TASK-037",
  ...
  "canonical_record": "jira/records/issues/tasks/TASK-036_define_elo_logistic_simple_score_baseline_contracts.json",
  ...
  "gap_ids": [],
  "generated_markdown": "jira/issues/tasks/TASK-036_define_elo_logistic_simple_score_baseline_contracts.md",
  ...
  "objective": "Define Elo/logistic/simple score baseline contracts",
  "operational_jira": {
    "assignee": "",
    "jira_issue_id": "24279",
    "jira_updated_at": "2026-08-09T00:40:22.632-0500",
  ...
  "required_evidence": [
    "Authoritative WBS row TASK-036",
    "Existing artifact `baseline candidate contracts + reference formulas`"
  ],
  "required_tests": [
    {
  ...
  "specificity_fingerprint": "078cebd8e951928d2679e374ba6c7f1747b9de37dd20faedacbf5cbd6f89da1e",
  "stop_conditions": [
  ...
  "title": "[TASK-036] Define Elo/logistic/simple score baseline contracts",
...
Define Elo/logistic/simple score baseline contracts
...
1. Stable ID TASK-036, parent EPIC-007, owner wave W16, and original status DONE are preserved.
