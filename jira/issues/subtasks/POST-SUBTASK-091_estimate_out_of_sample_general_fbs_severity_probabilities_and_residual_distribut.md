<!-- GENERATED VIEW. Canonical record: jira/records/issues/subtasks/POST-SUBTASK-091_estimate_out_of_sample_general_fbs_severity_probabilities_and_residual_distribut.json -->
# POST-SUBTASK-091 — [POST-SUBTASK-091] Estimate out-of-sample general FBS severity probabilities and residual distributions across seasons/regimes/contexts
...
```json
{
  ...
  "acceptance_criteria": [
    ...
    "The declared output `artifacts/bas/general_fbs_baseline.json` is produced with deterministic identity, provenance, and validation metadata appropriate to this work.",
  ...
  "ai_context_notes": [
    ...
    "Read the exact source sections in `jira/sources/issue_source_manifests/POST-SUBTASK-091.json`; inspect only the listed implementation files and prerequisite outputs.",
  ...
  "allowed_modification_paths": [
    ...
    "artifacts/jira_evidence/POST-SUBTASK-091.json"
  ],
  "blocked_reason": "UNSATISFIED_HARD_DEPENDENCIES: POST-SUBTASK-084;POST-SUBTASK-090",
  "blocks": [
    "POST-SUBTASK-092",
    "POST-SUBTASK-093"
  ],
  "canonical_record": "jira/records/issues/subtasks/POST-SUBTASK-091_estimate_out_of_sample_general_fbs_severity_probabilities_and_residual_distribut.json",
  "canonical_source_role": "AUTHORITATIVE_LOCAL_SPECIFICATION",
  "completion_evidence_contract": {
    "acceptance_matrix_required": true,
    "artifact_hashes_required": true,
    "completion_claim_limit": "IMPLEMENTED",
    "downstream_consumer": "POST-SUBTASK-092",
  ...
  "gap_ids": [],
  "generated_markdown": "jira/issues/subtasks/POST-SUBTASK-091_estimate_out_of_sample_general_fbs_severity_probabilities_and_residual_distribut.md",
  "governance_review_required": false,
  "governance_traceability_gate": "POST-SUBTASK-096",
  "historical_classification": "ACTIONABLE_POST_WAVE",
  "import_id": 100395,
  "in_scope": [
    "Perform the exact action: Estimate out-of-sample general FBS severity probabilities and residual distributions across seasons/regimes/contexts.",
    "Consume only verified prerequisite outputs from `POST-SUBTASK-084`, `POST-SUBTASK-090`.",
    ...
    "Demonstrate with saved evidence: The declared output `artifacts/bas/general_fbs_baseline.json` is produced with deterministic identity, provenance, and validation metadata appropriate to this work.",
    "Demonstrate with saved evidence: The work does not fabricate source availability, empirical results, thresholds, model performance, operational readiness, or completion evidence.",
    "Produce, validate, content-hash, and register `artifacts/bas/general_fbs_baseline.json`.",
  ...
  "operational_jira": {
    "assignee": "",
    "jira_issue_id": "24581",
    "jira_updated_at": "2026-08-09T23:24:08.771-0500",
  ...
  "related_to": [],
  "required_evidence": [
    "`artifacts/bas/general_fbs_baseline.json` plus SHA-256/content identity, producer command/version, prerequisite artifact identities, creation time, and validation disposition.",
  ...
  "required_tests": [
    {
      ...
      "expectation": "Run as a regression check after completing POST-SUBTASK-091; retain command, exit code, and relevant output.",
    ...
    },
    {
      ...
      "path": "artifacts/bas/general_fbs_baseline.json",
  ...
  "risk_failure_conditions": [
    "The work would be invalid if any prerequisite artifact, source/data/code/config identity, or declared maturity differs from the pinned issue contract for POST-SUBTASK-091.",
    ...
    "Acceptance failure: the evidence cannot demonstrate that the declared output `artifacts/bas/general_fbs_baseline.json` is produced with deterministic identity, provenance, and validation metadata appropriate to this work.",
  ...
  "risk_ids": [],
  "schema_version": 2,
  "scope": "Execute the atomic 1 of 3 step in Story POST-STORY-031 (General FBS baseline, Aggie excess, and components): Estimate out-of-sample general FBS severity probabilities and residual distributions across seasons/regimes/contexts. Consume only verified prerequisite outputs from `POST-SUBTASK-084`, `POST-SUBTASK-090`. Produce `artifacts/bas/general_fbs_baseline.json`; evaluate every issue-specific acceptance condition; preserve negative results; and hand the pinned output to POST-SUBTASK-092.",
  "source_ids": [
    "GAP-009",
    "HANDOFF-009"
  ],
  ...
  "title": "[POST-SUBTASK-091] Estimate out-of-sample general FBS severity probabilities and residual distributions across seasons/regimes/contexts",
  ...
  "work_packet_path": "jira/ai/work_packets/POST-SUBTASK-091.md",
...
Execute the atomic 1 of 3 step in Story POST-STORY-031 (General FBS baseline, Aggie excess, and components): Estimate out-of-sample general FBS severity probabilities and residual distributions across seasons/regimes/contexts. Consume only verified prerequisite outputs from `POST-SUBTASK-084`, `POST-SUBTASK-090`. Produce `artifacts/bas/general_fbs_baseline.json`; evaluate every issue-specific acceptance condition; preserve negative results; and hand the pinned output to POST-SUBTASK-092.
...
- **EXISTING_AUTOMATED_TEST** / `REGRESSION` — `tests/test_bas_science_governance.py` — Run as a regression check after completing POST-SUBTASK-091; retain command, exit code, and relevant output.
- **EXISTING_AUTOMATED_TEST** / `REGRESSION` — `tests/test_w20_model_starter.py` — Run as a regression check after completing POST-SUBTASK-091; retain command, exit code, and relevant output.
- **EXISTING_AUTOMATED_TEST** / `REGRESSION` — `tools/validate_bas_science.py` — Run as a regression check after completing POST-SUBTASK-091; retain command, exit code, and relevant output.
- **SCIENTIFIC** / `SCIENTIFIC` — `artifacts/bas/general_fbs_baseline.json` — Evaluate the precommitted hypothesis/metric against pinned data and splits; preserve null, negative, unstable, and failed results.
- **CALIBRATION** / `CALIBRATION` — `artifacts/bas/general_fbs_baseline.json` — Report calibration/reliability evidence on the allowed evaluation lane with sample size and uncertainty.
- **STATIC_VALIDATION** / `STATIC_VALIDATION` — `artifacts/bas/general_fbs_baseline.json` — Validate schema, required fields, unique identifiers, cross-references, provenance, and explicit unresolved states.
