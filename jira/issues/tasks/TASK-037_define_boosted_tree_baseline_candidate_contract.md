<!-- GENERATED VIEW. Canonical record: jira/records/issues/tasks/TASK-037_define_boosted_tree_baseline_candidate_contract.json -->
# TASK-037 — [TASK-037] Define boosted-tree baseline candidate contract
...
```json
{
  ...
  "acceptance_criteria": [
    "Stable ID TASK-037, parent EPIC-007, owner wave W16, and original status DONE are preserved.",
  ...
  "ai_context_notes": [
    ...
    "No boosted-tree library or empirical winner selected in W16; W20 owns starter implementation."
  ],
  "allowed_modification_paths": [
    "boosted-tree candidate interface (XGBoost/LightGBM/CatBoost alternatives)"
  ],
  "blocked_reason": "",
  "blocks": [
    "TASK-039"
  ],
  "canonical_record": "jira/records/issues/tasks/TASK-037_define_boosted_tree_baseline_candidate_contract.json",
  ...
  "gap_ids": [],
  "generated_markdown": "jira/issues/tasks/TASK-037_define_boosted_tree_baseline_candidate_contract.md",
  ...
  "objective": "Define boosted-tree baseline candidate contract",
  "operational_jira": {
    "assignee": "",
    "jira_issue_id": "24280",
    "jira_updated_at": "2026-08-09T00:40:22.628-0500",
  ...
  "required_evidence": [
    "Authoritative WBS row TASK-037",
    "Existing artifact `boosted-tree candidate interface (XGBoost/LightGBM/CatBoost alternatives)`"
  ],
  "required_tests": [
    {
  ...
  "specificity_fingerprint": "07f3f9a4aae9907c547877e096fecf04b3f9ea8ef91fb7e52fb4e12ff52769d3",
  "stop_conditions": [
  ...
  "title": "[TASK-037] Define boosted-tree baseline candidate contract",
...
Define boosted-tree baseline candidate contract
...
1. Stable ID TASK-037, parent EPIC-007, owner wave W16, and original status DONE are preserved.
