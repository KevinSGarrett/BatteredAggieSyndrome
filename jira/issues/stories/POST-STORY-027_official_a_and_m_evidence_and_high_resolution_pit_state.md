<!-- GENERATED VIEW. Canonical record: jira/records/issues/stories/POST-STORY-027_official_a_and_m_evidence_and_high_resolution_pit_state.json -->
# POST-STORY-027 — [POST-STORY-027] Official A&M evidence and high-resolution PIT state
...
```json
{
  ...
  "acceptance_criteria": [
    ...
    "The declared output `artifacts/tamu/tamu_source_manifest.json` is produced with deterministic identity, provenance, and validation metadata appropriate to this work.",
  ...
  "allowed_modification_paths": [
    "artifacts/jira_evidence/POST-STORY-027.json"
  ],
  "blocked_reason": "",
  "blocks": [],
  "canonical_record": "jira/records/issues/stories/POST-STORY-027_official_a_and_m_evidence_and_high_resolution_pit_state.json",
  "canonical_source_role": "AUTHORITATIVE_LOCAL_SPECIFICATION",
  "completion_evidence_contract": {
    "all_child_evidence_required": true,
    "child_gate": "POST-SUBTASK-081",
  ...
  "critical_path": false,
  "definition_of_done": [
    "All child subtasks POST-SUBTASK-079, POST-SUBTASK-080, POST-SUBTASK-081 have verified evidence or an explicit accepted-risk/deferred/cancelled disposition consistent with the Story contract.",
    "The final gate `POST-SUBTASK-081` completes and proves the Story end-to-end requirement; closing implementation children alone is insufficient.",
  ...
  "end_to_end_validation": "Any A&M pregame cutoff reconstructs a richer but governance-compatible state with conflicts, missingness, and uncertainty preserved.",
  "epic_id": "POST-EPIC-009",
  "evidence_manifest_path": "artifacts/jira_evidence/POST-STORY-027.json",
  ...
  "gap_ids": [],
  "generated_markdown": "jira/issues/stories/POST-STORY-027_official_a_and_m_evidence_and_high_resolution_pit_state.md",
  ...
  "local_id": "POST-STORY-027",
  "maturity_before": "FUNCTIONAL_STARTER",
  "objective": "Materialize the highest supported A&M resolution without violating national PIT, identity, rights, or provenance contracts.",
  "operational_jira": {
    "assignee": "",
    "jira_issue_id": "24217",
    "jira_updated_at": "2026-08-18T01:00:27.669-0500",
  ...
  "phase": "PHASE-3",
  "prerequisites": [
    "Hard dependency POST-SUBTASK-063",
    "Hard dependency POST-SUBTASK-066",
    "Hard dependency POST-SUBTASK-069",
  ...
  "related_to": [],
  "required_evidence": [
    "Verified child completion/evidence manifests for POST-SUBTASK-079, POST-SUBTASK-080, POST-SUBTASK-081.",
    "Final gate decision from `POST-SUBTASK-081` with criterion-by-criterion PASS/FAIL/BLOCKED outcomes and output hashes.",
  ...
  "required_tests": [
    ...
    },
    {
      ...
      "expectation": "The final child gate `POST-SUBTASK-081` must prove the integrated Story outcome and downstream-consumable output.",
  ...
  "risk_ids": [],
  "schema_version": 2,
  "scope": "Deliver Story POST-STORY-027 (Official A&M evidence and high-resolution PIT state) as one coherent, gated capability inside Epic POST-EPIC-009. Execute child subtasks POST-SUBTASK-079, POST-SUBTASK-080, POST-SUBTASK-081 in dependency order, reconcile their pinned outputs, and require the final gate `POST-SUBTASK-081` to issue an evidence-backed approve/block/reject/defer decision before any downstream use.",
  "source_ids": [
    "GAP-006",
    "GAP-009",
    "HANDOFF-007",
  ...
  "specificity_fingerprint": "f083e213cd53b76b3549e34f85031b5165ef43ad6950667fd2d546f661d9a536",
  "stop_conditions": [
  ...
  "title": "[POST-STORY-027] Official A&M evidence and high-resolution PIT state",
  ...
  "work_packet_path": "jira/ai/work_packets/POST-STORY-027.md",
...
Materialize the highest supported A&M resolution without violating national PIT, identity, rights, or provenance contracts.
...
Deliver Story POST-STORY-027 (Official A&M evidence and high-resolution PIT state) as one coherent, gated capability inside Epic POST-EPIC-009. Execute child subtasks POST-SUBTASK-079, POST-SUBTASK-080, POST-SUBTASK-081 in dependency order, reconcile their pinned outputs, and require the final gate `POST-SUBTASK-081` to issue an evidence-backed approve/block/reject/defer decision before any downstream use.
...
1. All child subtasks POST-SUBTASK-079, POST-SUBTASK-080, POST-SUBTASK-081 have verified evidence or an explicit accepted-risk/deferred/cancelled disposition consistent with the Story contract.
2. The final gate `POST-SUBTASK-081` completes and proves the Story end-to-end requirement; closing implementation children alone is insufficient.
...
- **END_TO_END** / `END_TO_END` — `POST-SUBTASK-081` — The final child gate `POST-SUBTASK-081` must prove the integrated Story outcome and downstream-consumable output.
...
Any A&M pregame cutoff reconstructs a richer but governance-compatible state with conflicts, missingness, and uncertainty preserved.
