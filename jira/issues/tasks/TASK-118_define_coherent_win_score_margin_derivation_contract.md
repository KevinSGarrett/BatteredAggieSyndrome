<!-- GENERATED VIEW. Canonical record: jira/records/issues/tasks/TASK-118_define_coherent_win_score_margin_derivation_contract.json -->
# TASK-118 — [TASK-118] Define coherent win/score/margin derivation contract
...
```json
{
  ...
  "acceptance_criteria": [
    "Stable ID TASK-118, parent EPIC-021, owner wave W16, and original status DONE are preserved.",
  ...
  "canonical_record": "jira/records/issues/tasks/TASK-118_define_coherent_win_score_margin_derivation_contract.json",
  ...
  "gap_ids": [],
  "generated_markdown": "jira/issues/tasks/TASK-118_define_coherent_win_score_margin_derivation_contract.md",
  ...
  "operational_jira": {
    "assignee": "",
    "jira_issue_id": "24361",
    "jira_updated_at": "2026-08-09T00:40:38.667-0500",
  ...
  "phase": "PHASE-4",
  "prerequisites": [
    "Historical dependency TASK-117"
  ],
  "primary_source_refs": [
    "SRCREF-00151",
    "SRCREF-02116",
  ...
  "required_evidence": [
    "Authoritative WBS row TASK-118",
    "Existing artifact `forecast distribution interface`"
  ],
  "required_tests": [
    {
  ...
  "specificity_fingerprint": "20aa39fd9d4b83d6f710983a457e37919aab8c08ba2a0b53b1993582c978ad88",
  "stop_conditions": [
  ...
  "title": "[TASK-118] Define coherent win/score/margin derivation contract",
...
Define coherent win/score/margin derivation contract
...
1. Stable ID TASK-118, parent EPIC-021, owner wave W16, and original status DONE are preserved.
