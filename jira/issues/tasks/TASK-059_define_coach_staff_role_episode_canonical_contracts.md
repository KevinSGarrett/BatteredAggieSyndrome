<!-- GENERATED VIEW. Canonical record: jira/records/issues/tasks/TASK-059_define_coach_staff_role_episode_canonical_contracts.json -->
# TASK-059 — [TASK-059] Define coach/staff role-episode canonical contracts
...
```json
{
  ...
  "acceptance_criteria": [
    "Stable ID TASK-059, parent EPIC-011, owner wave W13, and original status DONE are preserved.",
  ...
  "ai_context_notes": [
    ...
    "W12 player/availability contract gate cleared; W13 may begin coach role-episode design. Completed W13 contract/reference scope; no empirical effect winner or numeric bonus implied."
  ],
  "allowed_modification_paths": [
    "effective-dated coach role schema"
  ],
  "blocked_reason": "",
  "blocks": [
    "TASK-060",
  ...
  "canonical_record": "jira/records/issues/tasks/TASK-059_define_coach_staff_role_episode_canonical_contracts.json",
  ...
  "gap_ids": [],
  "generated_markdown": "jira/issues/tasks/TASK-059_define_coach_staff_role_episode_canonical_contracts.md",
  ...
  "objective": "Define coach/staff role-episode canonical contracts",
  "operational_jira": {
    "assignee": "",
    "jira_issue_id": "24302",
    "jira_updated_at": "2026-08-09T00:40:27.057-0500",
  ...
  "required_evidence": [
    "Authoritative WBS row TASK-059",
    "Existing artifact `effective-dated coach role schema`"
  ],
  "required_tests": [
    {
  ...
  "specificity_fingerprint": "8e249683f949cdd4a0167cdb3b72f2dc322bba862f861225eec776f346942097",
  "stop_conditions": [
  ...
  "title": "[TASK-059] Define coach/staff role-episode canonical contracts",
...
Define coach/staff role-episode canonical contracts
...
1. Stable ID TASK-059, parent EPIC-011, owner wave W13, and original status DONE are preserved.
