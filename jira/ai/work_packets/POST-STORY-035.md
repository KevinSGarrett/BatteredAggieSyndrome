...
1. `jira/records/issues/stories/POST-STORY-035_calibration_robustness_gates_a_and_m_bas_decisions_and_champion_promotion.json`
2. `jira/sources/issue_source_manifests/POST-STORY-035.json`
3. `jira/index/ISSUE_GOVERNANCE_CONTEXT.csv` row for `POST-STORY-035`.
