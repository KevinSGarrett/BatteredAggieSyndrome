<!-- GENERATED VIEW. Canonical record: jira/records/issues/tasks/TASK-164_define_advanced_challenger_admission_criteria.json -->
# TASK-164 — [TASK-164] Define advanced challenger admission criteria
...
```json
{
  ...
  "acceptance_criteria": [
    "Stable ID TASK-164, parent EPIC-029, owner wave W18, and original status DONE are preserved.",
  ...
  "ai_context_notes": [
    ...
    "Completed W18 full-rebuild: advanced challenger admission gate implemented and tested; research-only admission, no empirical winner/promotion."
  ],
  "allowed_modification_paths": [
    "advanced challenger admission policy"
  ],
  "blocked_reason": "",
  "blocks": [
    "TASK-165",
  ...
  "canonical_record": "jira/records/issues/tasks/TASK-164_define_advanced_challenger_admission_criteria.json",
  ...
  "gap_ids": [],
  "generated_markdown": "jira/issues/tasks/TASK-164_define_advanced_challenger_admission_criteria.md",
  ...
  "objective": "Define advanced challenger admission criteria",
  "operational_jira": {
    "assignee": "",
    "jira_issue_id": "24410",
    "jira_updated_at": "2026-08-09T00:40:47.018-0500",
  ...
  "prerequisites": [
    ...
    "Historical dependency TASK-139"
  ],
  "primary_source_refs": [
    "SRCREF-00197",
    "SRCREF-02116",
  ...
  "required_evidence": [
    "Authoritative WBS row TASK-164",
    "Existing artifact `advanced challenger admission policy`"
  ],
  "required_tests": [
    {
  ...
  "risk_ids": [],
  "schema_version": 2,
  "scope": "Original task type RESEARCH_GOVERNANCE with mutation scope: as defined by its source documents.",
  "source_ids": [
    "TASK-164"
  ],
  "source_refs": [
  ...
  "specificity_fingerprint": "21698d22e0e5009bf9161e3133ae29f777107bbc7a471674aa629c02c5d9ee46",
  "stop_conditions": [
  ...
  "title": "[TASK-164] Define advanced challenger admission criteria",
...
Define advanced challenger admission criteria
...
Original task type RESEARCH_GOVERNANCE with mutation scope: as defined by its source documents.
...
- Inherited from: None
- Resolution: `DIRECT`
- Effective counts: `{"acceptance_control_ids": 4, "adr_ids": 0, "gap_ids": 0, "requirement_ids": 11, "risk_ids": 0}`

## Acceptance Criteria

1. Stable ID TASK-164, parent EPIC-029, owner wave W18, and original status DONE are preserved.
