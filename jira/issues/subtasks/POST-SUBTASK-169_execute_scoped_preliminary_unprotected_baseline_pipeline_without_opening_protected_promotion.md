...
```json
{
  ...
  "acceptance_criteria": [
    ...
    "The historical 2023/2024/2025 fit/tune/unprotected-evaluation chronology remains preserved as contaminated evidence and is not rewritten.",
    ...
    "Every 2024/2025 result published by this unit is classified HISTORICAL_PROTECTED_RESULT_EXPOSED_NO_SELECTION_OR_PROMOTION_AUTHORITY.",
    "No current contract may label a protected canonical season as DEVELOPMENT_TUNE, DEVELOPMENT_EVALUATION_UNPROTECTED, or an equivalent development role.",
    "Artifact labels cannot override sealed canonical-game membership in governance/PROTECTED_SPLIT_REGISTRY.csv.",
    "The successor development-safe contract uses 2010-2022 as historical development inputs, 2023 only for development fit/selection/calibration, and 2024-2025 as protected and inaccessible to tuning/evaluation code.",
    "The protected split registry is not altered and no replacement protected period is defined."
  ],
  "adr_ids": [],
  "ai_context_notes": [
  ...
  "definition_of_done": [
    ...
    "The protected-split contradiction is audited, historical 2024/2025 metrics retain no selection or promotion authority, and the successor development-safe contract is the current contract."
  ],
  "dependencies": [
    "POST-SUBTASK-048",
    "POST-SUBTASK-049"
  ...
  "end_to_end_validation": "Preserve the historical contaminated run identities, independently audit every 2024/2025 split assignment against governance/PROTECTED_SPLIT_REGISTRY.csv, prove labels cannot override protected membership, and verify the successor contract denies protected-season tuning, evaluation, selection, and promotion.",
  ...
  "expected_outputs": [
    ...
    "configs/preliminary_development_safe_baseline_contract.json",
    ...
    "artifacts/governance/protected_split_exposure_audit.json",
  ...
  "files_expected_to_be_touched": [
    ...
    "tools/audit_protected_split_exposure.py",
    "tests/test_protected_split_exposure.py",
    ...
    "jira/records/issues/subtasks/POST-SUBTASK-169_execute_scoped_preliminary_unprotected_baseline_pipeline_without_opening_protected_promotion.json"
  ],
  "files_to_inspect": [
    "artifacts/pit/historical_known_at_replay_gate.json",
    "configs/preliminary_unprotected_baseline_contract.json",
  ...
  "operational_jira": {
    "assignee": "",
    "jira_issue_id": "24666",
    "jira_updated_at": "2026-08-18T13:57:45.760-0500",
    "last_synced_at": "2026-08-18T19:22:06.437683+00:00",
  ...
  "required_evidence": [
    ...
    "Protected-split exposure audit recording every contradictory 2024/2025 assignment and every exposed metric without deleting historical results.",
    "Successor development-safe contract plus tests proving labels cannot override protected canonical-game membership."
  ],
  "required_tests": [
    {
    ...
    {
      "classification": "NEW_AUTOMATED_TEST_REQUIRED",
      "expectation": "Current contracts that assign development roles to protected canonical seasons are rejected; labels cannot override registry membership; historical contaminated evidence is preserved without authority.",
      "path": "tests/test_protected_split_exposure.py",
      "validation_class": "PROTECTED_SPLIT"
    },
    {
      "classification": "END_TO_END",
      "expectation": "The historical contaminated run identities remain preserved and the independent protected-split audit plus successor contract pass.",
  ...
  "risk_failure_conditions": [
    ...
    "Any later artifact label is treated as authority to tune, select, threshold, promote, or claim protected performance on 2024-2025 canonical games.",
...
Final expanded-history and protected-promotion gates must remain binding. The historical preliminary run is retained as contaminated evidence after its 2024/2025 unprotected labels contradicted the sealed protected-split registry.
...
3. The historical 2023/2024/2025 fit/tune/unprotected-evaluation chronology remains preserved as contaminated evidence and is not rewritten.
...
6. Every 2024/2025 result published by this unit is classified HISTORICAL_PROTECTED_RESULT_EXPOSED_NO_SELECTION_OR_PROMOTION_AUTHORITY.
7. No current contract may label a protected canonical season as DEVELOPMENT_TUNE, DEVELOPMENT_EVALUATION_UNPROTECTED, or an equivalent development role.
8. Artifact labels cannot override sealed canonical-game membership in governance/PROTECTED_SPLIT_REGISTRY.csv.
9. The successor development-safe contract uses 2010-2022 as historical development inputs, 2023 only for development fit/selection/calibration, and 2024-2025 as protected and inaccessible to tuning/evaluation code.
10. The protected split registry is not altered and no replacement protected period is defined.
...
6. The protected-split contradiction is audited, historical 2024/2025 metrics retain no selection or promotion authority, and the successor development-safe contract is the current contract.
...
- **NEW_AUTOMATED_TEST_REQUIRED** / `PROTECTED_SPLIT` — `tests/test_protected_split_exposure.py` — Current contracts that assign development roles to protected canonical seasons are rejected; labels cannot override registry membership; historical contaminated evidence is preserved without authority.
- **END_TO_END** / `END_TO_END` — `artifacts/governance/protected_split_exposure_audit.json` — The historical contaminated run identities remain preserved and the independent protected-split audit plus successor contract pass.
...
Preserve the historical contaminated run identities, independently audit every 2024/2025 split assignment against governance/PROTECTED_SPLIT_REGISTRY.csv, prove labels cannot override protected membership, and verify the successor contract denies protected-season tuning, evaluation, selection, and promotion.
