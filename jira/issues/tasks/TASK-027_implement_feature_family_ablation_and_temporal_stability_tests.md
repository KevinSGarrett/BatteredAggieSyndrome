<!-- GENERATED VIEW. Canonical record: jira/records/issues/tasks/TASK-027_implement_feature_family_ablation_and_temporal_stability_tests.json -->
# TASK-027 — [TASK-027] Implement feature-family ablation and temporal stability tests
...
```json
{
  ...
  "acceptance_criteria": [
    "Stable ID TASK-027, parent EPIC-005, owner wave W10, and original status DONE are preserved.",
  ...
  "canonical_record": "jira/records/issues/tasks/TASK-027_implement_feature_family_ablation_and_temporal_stability_tests.json",
  ...
  "gap_ids": [],
  "generated_markdown": "jira/issues/tasks/TASK-027_implement_feature_family_ablation_and_temporal_stability_tests.md",
  ...
  "objective": "Implement feature-family ablation and temporal stability tests",
  "operational_jira": {
    "assignee": "",
    "jira_issue_id": "24270",
    "jira_updated_at": "2026-08-09T00:40:20.831-0500",
  ...
  "phase": "PHASE-1",
  "prerequisites": [
    "Historical dependency TASK-025",
    "Historical dependency TASK-026"
  ],
  "primary_source_refs": [
    "SRCREF-00060",
    "SRCREF-02116",
  ...
  "required_evidence": [
    "Authoritative WBS row TASK-027",
    "Existing artifact `family ablation/stability evidence`"
  ],
  "required_tests": [
    {
  ...
  "specificity_fingerprint": "30c71d516327acdf271a0c31b1c161fad9af3fd026af861bac412c9b55744575",
  "stop_conditions": [
  ...
  "title": "[TASK-027] Implement feature-family ablation and temporal stability tests",
...
Implement feature-family ablation and temporal stability tests
...
1. Stable ID TASK-027, parent EPIC-005, owner wave W10, and original status DONE are preserved.
