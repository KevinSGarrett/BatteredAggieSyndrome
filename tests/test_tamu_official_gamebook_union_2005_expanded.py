...
EXPECTED_GATE_IDENTITY = (
    "d58074fd309da1a6fac386c63d08cd1f150d4ec40d23d5720fa057b18cb35fb8"
)
EXPECTED_UNION_IDENTITY = (
    "c15f5c33b14ac42322766c3c1be817be67d5b27f29c0cb77b164893980046200"
)
...
class Compact2005ExpandedUnionTests(unittest.TestCase):
    ...
    def test_committed_counts_and_prior_identities(self) -> None:
        ...
        self.assertEqual(
            self.gate["prior_union_identity"], PINNED_BAT597_UNION_IDENTITY
        )
        self.assertEqual(
            self.gate["prior_union_gate_identity"], PINNED_BAT597_GATE_IDENTITY
        )
        ...
        self.assertEqual(
            self.gate["coverage_by_season"]["2005"]["official_school_games"], 11
        )
        self.assertEqual(
            self.gate["coverage_by_season"]["2005"]["rich_structured_games"], 11
        )
        self.assertEqual(self.gate["coverage_by_season"]["2005"]["became_rich"], 11)
        self.assertEqual(
            self.gate["upstream_identities"]["bat597_union_identity"],
            PINNED_BAT597_UNION_IDENTITY,
        )
        self.assertEqual(
