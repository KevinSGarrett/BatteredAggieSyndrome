...
```json
{
  ...
  "blocked_reason": "",
  "blocks": [],
  "canonical_record": "jira/records/issues/stories/POST-STORY-011_immutable_raw_store_manifests_provenance_and_population_audit.json",
  "canonical_source_role": "AUTHORITATIVE_LOCAL_SPECIFICATION",
  "completion_evidence_contract": {
    "all_child_evidence_required": true,
    "child_gate": "POST-SUBTASK-033",
  ...
  "critical_path": true,
  "definition_of_done": [
    "All child subtasks POST-SUBTASK-031, POST-SUBTASK-032, POST-SUBTASK-033 have verified evidence or an explicit accepted-risk/deferred/cancelled disposition consistent with the Story contract.",
    "The final gate `POST-SUBTASK-033` completes and proves the Story end-to-end requirement; closing implementation children alone is insufficient.",
  ...
  "gap_ids": [],
  "generated_markdown": "jira/issues/stories/POST-STORY-011_immutable_raw_store_manifests_provenance_and_population_audit.md",
  ...
  "operational_jira": {
    "assignee": "",
    "jira_issue_id": "24201",
    "jira_updated_at": "2026-08-09T00:03:30.144-0500",
  ...
  "required_tests": [
    ...
    },
    {
      ...
      "expectation": "The final child gate `POST-SUBTASK-033` must prove the integrated Story outcome and downstream-consumable output.",
  ...
  "work_packet_path": "jira/ai/work_packets/POST-STORY-011.md",
...
1. All child subtasks POST-SUBTASK-031, POST-SUBTASK-032, POST-SUBTASK-033 have verified evidence or an explicit accepted-risk/deferred/cancelled disposition consistent with the Story contract.
2. The final gate `POST-SUBTASK-033` completes and proves the Story end-to-end requirement; closing implementation children alone is insufficient.
