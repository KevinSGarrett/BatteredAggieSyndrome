<!-- GENERATED VIEW. Canonical record: jira/records/issues/tasks/TASK-082_freeze_matchup_context_adjustment_interfaces.json -->
# TASK-082 — [TASK-082] Freeze matchup/context adjustment interfaces
...
```json
{
  ...
  "acceptance_criteria": [
    "Stable ID TASK-082, parent EPIC-014, owner wave W13, and original status DONE are preserved.",
  ...
  "canonical_record": "jira/records/issues/tasks/TASK-082_freeze_matchup_context_adjustment_interfaces.json",
  ...
  "gap_ids": [],
  "generated_markdown": "jira/issues/tasks/TASK-082_freeze_matchup_context_adjustment_interfaces.md",
  ...
  "objective": "Freeze matchup/context adjustment interfaces",
  "operational_jira": {
    "assignee": "",
    "jira_issue_id": "24325",
    "jira_updated_at": "2026-08-09T00:40:31.547-0500",
  ...
  "phase": "PHASE-2",
  "prerequisites": [
    "Historical dependency TASK-077",
    "Historical dependency TASK-078",
    "Historical dependency TASK-080",
  ...
  "required_evidence": [
    "Authoritative WBS row TASK-082",
    "Existing artifact `matchup adjustment baseline`"
  ],
  "required_tests": [
    {
  ...
  "specificity_fingerprint": "d53d7d9eb83ed8255c0c83505f29c1f8ae1571a5983a56691ac5603e83f810d8",
  "stop_conditions": [
  ...
  "title": "[TASK-082] Freeze matchup/context adjustment interfaces",
...
Freeze matchup/context adjustment interfaces
...
1. Stable ID TASK-082, parent EPIC-014, owner wave W13, and original status DONE are preserved.
