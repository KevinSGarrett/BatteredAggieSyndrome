<!-- GENERATED VIEW. Canonical record: jira/records/issues/tasks/TASK-185_verify_prior_wave_pair_before_every_mutation.json -->
# TASK-185 — [TASK-185] Verify prior-wave pair before every mutation
...
```json
{
  ...
  "acceptance_criteria": [
    "Stable ID TASK-185, parent EPIC-033, owner wave W06-W25, and original status DONE are preserved.",
  ...
  "allowed_modification_paths": [
    "verified prior-wave binding evidence"
  ],
  "blocked_reason": "",
  "blocks": [
    "TASK-186",
  ...
  "canonical_record": "jira/records/issues/tasks/TASK-185_verify_prior_wave_pair_before_every_mutation.json",
  ...
  "gap_ids": [],
  "generated_markdown": "jira/issues/tasks/TASK-185_verify_prior_wave_pair_before_every_mutation.md",
  ...
  "objective": "Verify prior-wave pair before every mutation",
  "operational_jira": {
    "assignee": "",
    "jira_issue_id": "24452",
    "jira_updated_at": "2026-08-09T00:40:49.548-0500",
  ...
  "required_evidence": [
    "Authoritative WBS row TASK-185",
    "Existing artifact `verified prior-wave binding evidence`"
  ],
  "required_tests": [
    {
  ...
  "risk_ids": [],
  "schema_version": 2,
  "scope": "Original task type PROGRAM_GATE with mutation scope: as defined by its source documents.",
  "source_ids": [
    "TASK-185"
  ],
  "source_refs": [
  ...
  "specificity_fingerprint": "f6bea348a677142038f1fe152f0f81879fc2ea33ab09ba1e042c45abe7e73418",
  "stop_conditions": [
  ...
  "title": "[TASK-185] Verify prior-wave pair before every mutation",
...
Verify prior-wave pair before every mutation
...
Original task type PROGRAM_GATE with mutation scope: as defined by its source documents.
...
1. Stable ID TASK-185, parent EPIC-033, owner wave W06-W25, and original status DONE are preserved.
