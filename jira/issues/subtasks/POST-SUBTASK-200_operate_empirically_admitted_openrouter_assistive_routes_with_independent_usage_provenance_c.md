<!-- GENERATED VIEW. Canonical record: jira/records/issues/subtasks/POST-SUBTASK-200_operate_empirically_admitted_openrouter_assistive_routes_with_independent_usage_provenance_c.json -->
# POST-SUBTASK-200 — [POST-SUBTASK-200] Operate empirically admitted OpenRouter assistive routes with independent usage, provenance, cleanup, and handoff evidence
...
```json
{
  ...
  "evidence_manifest_path": "artifacts/jira_evidence/POST-SUBTASK-200.json",
  ...
  "gap_ids": [],
  "generated_markdown": "jira/issues/subtasks/POST-SUBTASK-200_operate_empirically_admitted_openrouter_assistive_routes_with_independent_usage_provenance_c.md",
  "governance_review_required": false,
  "governance_traceability_gate": "POST-SUBTASK-200",
  ...
  "local_id": "POST-SUBTASK-200",
  "maturity_before": "NOT_STARTED",
  "objective": "Operate empirically admitted OpenRouter assistive routes with independent usage, provenance, cleanup, and handoff evidence",
  "operational_jira": {
    "assignee": "",
    "jira_issue_id": "24951",
    "jira_updated_at": "2026-08-12T11:33:06.140-0500",
  ...
  "risk_ids": [],
  "schema_version": 2,
  "scope": "Operate only task/model/provider routes that pass the paid pilot and remain inside the separately authorized OpenRouter envelope. Batch Beta stays separately gated.",
  "source_ids": [
  ...
  "work_packet_path": "jira/ai/work_packets/POST-SUBTASK-200.md",
