...
from aggie_analytics.data.historical_game_outcome_spine import materialize  # noqa: E402


def main() -> int:
    parser = argparse.ArgumentParser(
        description="Materialize the governed 1963-2009 historical game/outcome reference spine."
    )
    parser.add_argument(
