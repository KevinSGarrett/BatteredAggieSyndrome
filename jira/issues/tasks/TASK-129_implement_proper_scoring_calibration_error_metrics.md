<!-- GENERATED VIEW. Canonical record: jira/records/issues/tasks/TASK-129_implement_proper_scoring_calibration_error_metrics.json -->
# TASK-129 — [TASK-129] Implement proper scoring/calibration/error metrics
...
```json
{
  ...
  "acceptance_criteria": [
    "Stable ID TASK-129, parent EPIC-023, owner wave W17, and original status DONE are preserved.",
  ...
  "canonical_record": "jira/records/issues/tasks/TASK-129_implement_proper_scoring_calibration_error_metrics.json",
  ...
  "gap_ids": [],
  "generated_markdown": "jira/issues/tasks/TASK-129_implement_proper_scoring_calibration_error_metrics.md",
  ...
  "objective": "Implement proper scoring/calibration/error metrics",
  "operational_jira": {
    "assignee": "",
    "jira_issue_id": "24372",
    "jira_updated_at": "2026-08-09T00:40:40.861-0500",
  ...
  "required_evidence": [
    "Authoritative WBS row TASK-129",
    "Existing artifact `proper scoring/calibration/error metric registry plus dependency-light reference metrics`"
  ],
  "required_tests": [
    {
  ...
  "specificity_fingerprint": "1bdfc221eb31762708fab9a488e19a6af2376373fe2904da34d5e44e9012a92d",
  "stop_conditions": [
  ...
  "title": "[TASK-129] Implement proper scoring/calibration/error metrics",
...
Implement proper scoring/calibration/error metrics
...
1. Stable ID TASK-129, parent EPIC-023, owner wave W17, and original status DONE are preserved.
