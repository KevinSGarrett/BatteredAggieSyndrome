<!-- GENERATED VIEW. Canonical record: jira/records/issues/tasks/TASK-172_prove_pregame_live_isolation_through_leakage_tests.json -->
# TASK-172 — [TASK-172] Prove pregame/live isolation through leakage tests
...
```json
{
  ...
  "acceptance_criteria": [
    "Stable ID TASK-172, parent EPIC-030, owner wave W24+, and original status PLANNED are preserved.",
  ...
  "blocked_reason": "",
  "blocks": [],
  "canonical_record": "jira/records/issues/tasks/TASK-172_prove_pregame_live_isolation_through_leakage_tests.json",
  ...
  "gap_ids": [],
  "generated_markdown": "jira/issues/tasks/TASK-172_prove_pregame_live_isolation_through_leakage_tests.md",
  ...
  "objective": "Prove pregame/live isolation through leakage tests",
  "operational_jira": {
    "assignee": "",
    "jira_issue_id": "24426",
    "jira_updated_at": "2026-08-09T00:05:15.001-0500",
  ...
  "phase": "PHASE-5",
  "prerequisites": [
    "Historical dependency TASK-171"
  ],
  "primary_source_refs": [
    "SRCREF-00205",
    "SRCREF-02116",
  ...
  "required_evidence": [
    "Authoritative WBS row TASK-172",
    "Existing artifact `live isolation evidence`"
  ],
  "required_tests": [
    {
  ...
  "specificity_fingerprint": "b43a1961739515e6e5dcfa7bdbca116cbec76bf62be98097144beeb5c32483cf",
  "stop_conditions": [
  ...
  "title": "[TASK-172] Prove pregame/live isolation through leakage tests",
...
Prove pregame/live isolation through leakage tests
...
1. Stable ID TASK-172, parent EPIC-030, owner wave W24+, and original status PLANNED are preserved.
