"""Acquire and normalize official SRC-014 1996 box scores from Phase 6 allowlist."""
...
CONTRACT_ID = "BAT-XXX-TAMU-OFFICIAL-1996-BOXSCORES-V1"
JIRA_KEY = "BAT-XXX"
SOURCE_ID = "SRC-014"
SEASON = 1996
...
def reconstruct_objects(*, repo_root: Path, data_root: Path) -> dict[str, Any]:
    ...
    payload = {
        ...
        "decision_unit": "POST-TASK-SRC014-1996-OFFICIAL-ACQUISITION-001",
        "jira_key": JIRA_KEY,
        "source_id": SOURCE_ID,
    ...
    gate = {
        ...
        "result": PASS_RESULT if not blocked and counts["normalized_games"] == counts["target_games_total"] else "PARTIAL_OFFICIAL_1996_BOXSCORES",
