...
```json
{
  ...
  "critical_path": false,
  "definition_of_done": [
    "The atomic scope in POST-SUBTASK-053 is completed without absorbing sibling work or weakening any protected requirement, control, split, judging rule, rights decision, or security boundary.",
  ...
  "end_to_end_validation": "Validate that `artifacts/features/feature_computability_profile.json` can be parsed and consumed by `POST-SUBTASK-054` using only documented identities and interfaces; the consumer must reject missing, stale, schema-incompatible, rights-blocked, or provenance-incomplete input without manual repair.",
  ...
  "specificity_fingerprint": "5c48b2ecff8ba18fdc718e20c850cee967359768b8c36e0286f026640e1cb0b4",
  "stop_conditions": [
...
1. The atomic scope in POST-SUBTASK-053 is completed without absorbing sibling work or weakening any protected requirement, control, split, judging rule, rights decision, or security boundary.
