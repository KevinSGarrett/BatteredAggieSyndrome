<!-- GENERATED VIEW. Canonical record: jira/records/issues/subtasks/POST-SUBTASK-083_train_global_only_no_adjustment_residual_hierarchical_calibration_shrinkage_and_.json -->
# POST-SUBTASK-083 — [POST-SUBTASK-083] Train global-only, no-adjustment, residual, hierarchical, calibration, shrinkage, and feature-interaction A&M candidates on permitted history
...
```json
{
  ...
  "ai_context_notes": [
    ...
    "Read the exact source sections in `jira/sources/issue_source_manifests/POST-SUBTASK-083.json`; inspect only the listed implementation files and prerequisite outputs.",
  ...
  "blocked_reason": "UNSATISFIED_HARD_DEPENDENCIES: POST-SUBTASK-078;POST-SUBTASK-081;POST-SUBTASK-082",
  "blocks": [
    "POST-SUBTASK-084"
  ],
  "canonical_record": "jira/records/issues/subtasks/POST-SUBTASK-083_train_global_only_no_adjustment_residual_hierarchical_calibration_shrinkage_and_.json",
  "canonical_source_role": "AUTHORITATIVE_LOCAL_SPECIFICATION",
  "completion_evidence_contract": {
    "acceptance_matrix_required": true,
    "artifact_hashes_required": true,
    "completion_claim_limit": "EMPIRICALLY_VALIDATED",
    "downstream_consumer": "POST-SUBTASK-084",
  ...
  "critical_path": false,
  "definition_of_done": [
    "The atomic scope in POST-SUBTASK-083 is completed without absorbing sibling work or weakening any protected requirement, control, split, judging rule, rights decision, or security boundary.",
    ...
    "The output set `artifacts/tamu/tamu_specialization_runs.json` is demonstrably consumable by POST-SUBTASK-084 without manual reconstruction or undocumented state."
  ],
  "dependencies": [
    "POST-SUBTASK-078",
    "POST-SUBTASK-081",
  ...
  "end_to_end_validation": "Validate that `artifacts/tamu/tamu_specialization_runs.json` can be parsed and consumed by `POST-SUBTASK-084` using only documented identities and interfaces; the consumer must reject missing, stale, schema-incompatible, rights-blocked, or provenance-incomplete input without manual repair.",
  "epic_id": "POST-EPIC-009",
  "evidence_manifest_path": "artifacts/jira_evidence/POST-SUBTASK-083.json",
  ...
  "gap_ids": [],
  "generated_markdown": "jira/issues/subtasks/POST-SUBTASK-083_train_global_only_no_adjustment_residual_hierarchical_calibration_shrinkage_and_.md",
  ...
  "local_id": "POST-SUBTASK-083",
  "maturity_before": "FUNCTIONAL_STARTER",
  "objective": "Train global-only, no-adjustment, residual, hierarchical, calibration, shrinkage, and feature-interaction A&M candidates on permitted history",
  "operational_jira": {
    "assignee": "",
    "jira_issue_id": "24573",
    "jira_updated_at": "2026-08-09T00:03:50.986-0500",
  ...
  "required_tests": [
    {
      ...
      "expectation": "Run as a regression check after completing POST-SUBTASK-083; retain command, exit code, and relevant output.",
    ...
    },
    {
      ...
      "path": "artifacts/tamu/tamu_specialization_runs.json",
  ...
  "risk_failure_conditions": [
    "The work would be invalid if any prerequisite artifact, source/data/code/config identity, or declared maturity differs from the pinned issue contract for POST-SUBTASK-083.",
    ...
    "Acceptance failure: the evidence cannot demonstrate that the declared output `artifacts/tamu/tamu_specialization_runs.json` is produced with deterministic identity, provenance, and validation metadata appropriate to this work.",
  ...
  "specificity_fingerprint": "332baa9678b087e7e157f5408a2ec07fcbdac28a73114ccafb93056979c2b0dc",
  "stop_conditions": [
  ...
  "title": "[POST-SUBTASK-083] Train global-only, no-adjustment, residual, hierarchical, calibration, shrinkage, and feature-interaction A&M candidates on permitted history",
  ...
  "work_packet_path": "jira/ai/work_packets/POST-SUBTASK-083.md",
...
1. The atomic scope in POST-SUBTASK-083 is completed without absorbing sibling work or weakening any protected requirement, control, split, judging rule, rights decision, or security boundary.
...
7. The output set `artifacts/tamu/tamu_specialization_runs.json` is demonstrably consumable by POST-SUBTASK-084 without manual reconstruction or undocumented state.
...
Validate that `artifacts/tamu/tamu_specialization_runs.json` can be parsed and consumed by `POST-SUBTASK-084` using only documented identities and interfaces; the consumer must reject missing, stale, schema-incompatible, rights-blocked, or provenance-incomplete input without manual repair.
