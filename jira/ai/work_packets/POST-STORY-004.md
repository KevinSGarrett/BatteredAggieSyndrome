...
1. `jira/records/issues/stories/POST-STORY-004_evidence_backed_resource_concurrency_and_degradation_envelope.json`
2. `jira/sources/issue_source_manifests/POST-STORY-004.json`
3. `jira/index/ISSUE_GOVERNANCE_CONTEXT.csv` row for `POST-STORY-004`.
