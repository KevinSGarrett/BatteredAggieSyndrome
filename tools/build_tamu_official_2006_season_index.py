...
from aggie_analytics.data.tamu_official_2006_season_index import materialize  # noqa: E402


def main() -> int:
    parser = argparse.ArgumentParser(description="Capture the official 2006 SRC-014 season index and discover box URLs.")
