<!-- GENERATED VIEW. Canonical record: jira/records/issues/tasks/TASK-200_audit_transfer_recruiting_upstream_rights_and_snapshot_semantics.json -->
# TASK-200 — [TASK-200] Audit transfer/recruiting upstream rights and snapshot semantics
...
```json
{
  ...
  "acceptance_criteria": [
    "Stable ID TASK-200, parent EPIC-010, owner wave W12, and original status DONE are preserved.",
  ...
  "ai_context_notes": [
    ...
    "W12 source-rights/snapshot audit completed after TASK-197 provenance catch-up; no legal advice or raw-data redistribution claim."
  ],
  "allowed_modification_paths": [
    "transfer/recruiting source provenance decision"
  ],
  "blocked_reason": "",
  "blocks": [],
  "canonical_record": "jira/records/issues/tasks/TASK-200_audit_transfer_recruiting_upstream_rights_and_snapshot_semantics.json",
  ...
  "gap_ids": [],
  "generated_markdown": "jira/issues/tasks/TASK-200_audit_transfer_recruiting_upstream_rights_and_snapshot_semantics.md",
  ...
  "objective": "Audit transfer/recruiting upstream rights and snapshot semantics",
  "operational_jira": {
    "assignee": "",
    "jira_issue_id": "24489",
    "jira_updated_at": "2026-08-09T00:40:52.484-0500",
  ...
  "prerequisites": [
    ...
    "Historical dependency TASK-197"
  ],
  "primary_source_refs": [
    "SRCREF-00233",
    "SRCREF-02116",
  ...
  "required_evidence": [
    "Authoritative WBS row TASK-200",
    "Existing artifact `transfer/recruiting source provenance decision`"
  ],
  "required_tests": [
    {
  ...
  "risk_ids": [],
  "schema_version": 2,
  "scope": "Original task type DATA_GOVERNANCE with mutation scope: transfer/recruiting.",
  "source_ids": [
    "TASK-200"
  ],
  "source_refs": [
  ...
  "specificity_fingerprint": "c1042d284d3024b5da61a4eee1f92d42d15ee411f05adfd9df838c9dde0705d3",
  "stop_conditions": [
  ...
  "title": "[TASK-200] Audit transfer/recruiting upstream rights and snapshot semantics",
...
Audit transfer/recruiting upstream rights and snapshot semantics
...
Original task type DATA_GOVERNANCE with mutation scope: transfer/recruiting.
...
- Inherited from: None
- Resolution: `DIRECT`
- Effective counts: `{"acceptance_control_ids": 5, "adr_ids": 0, "gap_ids": 0, "requirement_ids": 5, "risk_ids": 0}`

## Acceptance Criteria

1. Stable ID TASK-200, parent EPIC-010, owner wave W12, and original status DONE are preserved.
