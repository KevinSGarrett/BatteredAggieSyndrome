<!-- GENERATED VIEW. Canonical record: jira/records/issues/tasks/TASK-161_benchmark_cpu_gpu_ram_runtime_on_target_hardware.json -->
# TASK-161 — [TASK-161] Benchmark CPU/GPU/RAM/runtime on target hardware
...
```json
{
  ...
  "acceptance_criteria": [
    "Stable ID TASK-161, parent EPIC-028, owner wave W23, and original status BLOCKED_TARGET_HARDWARE are preserved.",
  ...
  "ai_context_notes": [
    ...
    "Representative target Windows/Ryzen/32GB/RTX5060 execution unavailable in this environment; do not fabricate budgets."
  ],
  "allowed_modification_paths": [
    "THR-011/012 remain TBD",
    "target-hardware benchmark harness + non-authoritative smoke evidence"
  ],
  "blocked_reason": "",
  "blocks": [
    "TASK-163"
  ],
  "canonical_record": "jira/records/issues/tasks/TASK-161_benchmark_cpu_gpu_ram_runtime_on_target_hardware.json",
  ...
  "gap_ids": [],
  "generated_markdown": "jira/issues/tasks/TASK-161_benchmark_cpu_gpu_ram_runtime_on_target_hardware.md",
  ...
  "objective": "Benchmark CPU/GPU/RAM/runtime on target hardware",
  "operational_jira": {
    "assignee": "",
    "jira_issue_id": "24405",
    "jira_updated_at": "2026-08-09T00:05:13.849-0500",
  ...
  "prerequisites": [
    ...
    "Historical dependency TASK-151"
  ],
  "primary_source_refs": [
    "SRCREF-00194",
    "SRCREF-02116",
  ...
  "required_evidence": [
    "Authoritative WBS row TASK-161",
    "Existing artifact `THR-011/012 remain TBD`",
    "Existing artifact `target-hardware benchmark harness + non-authoritative smoke evidence`"
  ],
  "required_tests": [
    {
  ...
  "risk_ids": [],
  "schema_version": 2,
  "scope": "Original task type BENCHMARK with mutation scope: as defined by its source documents.",
  "source_ids": [
    "TASK-161"
  ],
  "source_refs": [
  ...
  "specificity_fingerprint": "3620d5956341046166dc591dbcf38a8094586b1e78a7f2d70a3023e24657ab25",
  "stop_conditions": [
  ...
  "title": "[TASK-161] Benchmark CPU/GPU/RAM/runtime on target hardware",
...
Benchmark CPU/GPU/RAM/runtime on target hardware
...
Original task type BENCHMARK with mutation scope: as defined by its source documents.
...
1. Stable ID TASK-161, parent EPIC-028, owner wave W23, and original status BLOCKED_TARGET_HARDWARE are preserved.
