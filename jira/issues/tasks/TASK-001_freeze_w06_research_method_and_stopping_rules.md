<!-- GENERATED VIEW. Canonical record: jira/records/issues/tasks/TASK-001_freeze_w06_research_method_and_stopping_rules.json -->
# TASK-001 — [TASK-001] Freeze W06 research method and stopping rules
...
```json
{
  ...
  "acceptance_criteria": [
    "Stable ID TASK-001, parent EPIC-001, owner wave W06, and original status DONE are preserved.",
  ...
  "canonical_record": "jira/records/issues/tasks/TASK-001_freeze_w06_research_method_and_stopping_rules.json",
  ...
  "gap_ids": [],
  "generated_markdown": "jira/issues/tasks/TASK-001_freeze_w06_research_method_and_stopping_rules.md",
  ...
  "objective": "Freeze W06 research method and stopping rules",
  "operational_jira": {
    "assignee": "",
    "jira_issue_id": "24244",
    "jira_updated_at": "2026-08-09T00:40:15.455-0500",
  ...
  "required_evidence": [
    "Authoritative WBS row TASK-001",
    "Existing artifact `SOURCE_RESEARCH_LOG.csv`",
    "Existing artifact `docs/data_research/w06/DATA_RESEARCH_METHOD.md`"
  ],
  "required_tests": [
    {
  ...
  "risk_ids": [],
  "schema_version": 2,
  "scope": "Original task type RESEARCH_GOVERNANCE with mutation scope: docs/data research governance.",
  "source_ids": [
    "TASK-001"
  ],
  "source_refs": [
  ...
  "specificity_fingerprint": "5355d66739ad2ea2068e8c55d4ae3e6b6abfcef714ee0736910365cba35c3652",
  "stop_conditions": [
  ...
  "title": "[TASK-001] Freeze W06 research method and stopping rules",
...
Freeze W06 research method and stopping rules
...
Original task type RESEARCH_GOVERNANCE with mutation scope: docs/data research governance.
...
1. Stable ID TASK-001, parent EPIC-001, owner wave W06, and original status DONE are preserved.
