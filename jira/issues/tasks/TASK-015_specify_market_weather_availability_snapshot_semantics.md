<!-- GENERATED VIEW. Canonical record: jira/records/issues/tasks/TASK-015_specify_market_weather_availability_snapshot_semantics.json -->
# TASK-015 — [TASK-015] Specify market/weather/availability snapshot semantics
...
```json
{
  ...
  "acceptance_criteria": [
    "Stable ID TASK-015, parent EPIC-003, owner wave W08, and original status DONE are preserved.",
  ...
  "canonical_record": "jira/records/issues/tasks/TASK-015_specify_market_weather_availability_snapshot_semantics.json",
  ...
  "gap_ids": [],
  "generated_markdown": "jira/issues/tasks/TASK-015_specify_market_weather_availability_snapshot_semantics.md",
  ...
  "objective": "Specify market/weather/availability snapshot semantics",
  "operational_jira": {
    "assignee": "",
    "jira_issue_id": "24258",
    "jira_updated_at": "2026-08-09T00:40:18.542-0500",
  ...
  "required_evidence": [
    "Authoritative WBS row TASK-015",
    "Existing artifact `snapshot policy by mutable source domain`"
  ],
  "required_tests": [
    {
  ...
  "specificity_fingerprint": "de1e4f970ea4a013071dd3960b89b48ca68006ba2cbf90b254994dfc8e82389f",
  "stop_conditions": [
  ...
  "title": "[TASK-015] Specify market/weather/availability snapshot semantics",
...
Specify market/weather/availability snapshot semantics
...
1. Stable ID TASK-015, parent EPIC-003, owner wave W08, and original status DONE are preserved.
