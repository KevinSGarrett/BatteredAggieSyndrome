<!-- GENERATED VIEW. Canonical record: jira/records/issues/tasks/TASK-134_define_experiment_identity_config_data_model_lineage_schema.json -->
# TASK-134 — [TASK-134] Define experiment identity/config/data/model lineage schema
...
```json
{
  ...
  "acceptance_criteria": [
    "Stable ID TASK-134, parent EPIC-024, owner wave W18, and original status DONE are preserved.",
  ...
  "ai_context_notes": [
    ...
    "Completed W18 contract/reference scope; no trained/protected empirical winner implied."
  ],
  ...
  "canonical_record": "jira/records/issues/tasks/TASK-134_define_experiment_identity_config_data_model_lineage_schema.json",
  ...
  "gap_ids": [],
  "generated_markdown": "jira/issues/tasks/TASK-134_define_experiment_identity_config_data_model_lineage_schema.md",
  ...
  "objective": "Define experiment identity/config/data/model lineage schema",
  "operational_jira": {
    "assignee": "",
    "jira_issue_id": "24377",
    "jira_updated_at": "2026-08-09T00:40:41.767-0500",
  ...
  "required_evidence": [
    "Authoritative WBS row TASK-134",
    "Existing artifact `experiment lineage contract`"
  ],
  "required_tests": [
    {
  ...
  "specificity_fingerprint": "7a7a866d52067e7221b3cf35a6346723c1f92c96ea3e7655fd6c8dbdd99f1dec",
  "stop_conditions": [
  ...
  "title": "[TASK-134] Define experiment identity/config/data/model lineage schema",
...
Define experiment identity/config/data/model lineage schema
...
1. Stable ID TASK-134, parent EPIC-024, owner wave W18, and original status DONE are preserved.
