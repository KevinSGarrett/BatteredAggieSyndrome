<!-- GENERATED VIEW. Canonical record: jira/records/issues/tasks/TASK-145_pass_starter_forecast_model_integration_gate.json -->
# TASK-145 — [TASK-145] Pass starter forecast-model integration gate
...
```json
{
  ...
  "acceptance_criteria": [
    "Stable ID TASK-145, parent EPIC-025, owner wave W20, and original status DONE are preserved.",
  ...
  "allowed_modification_paths": [
    "functional selected model/calibration starter"
  ],
  "blocked_reason": "",
  "blocks": [
    "TASK-146",
  ...
  "canonical_record": "jira/records/issues/tasks/TASK-145_pass_starter_forecast_model_integration_gate.json",
  ...
  "gap_ids": [],
  "generated_markdown": "jira/issues/tasks/TASK-145_pass_starter_forecast_model_integration_gate.md",
  ...
  "objective": "Pass starter forecast-model integration gate",
  "operational_jira": {
    "assignee": "",
    "jira_issue_id": "24388",
    "jira_updated_at": "2026-08-09T00:40:43.748-0500",
  ...
  "phase": "PHASE-4",
  "prerequisites": [
    "Historical dependency TASK-143",
    "Historical dependency TASK-144",
  ...
  "required_evidence": [
    "Authoritative WBS row TASK-145",
    "Existing artifact `functional selected model/calibration starter`"
  ],
  "required_tests": [
    {
  ...
  "specificity_fingerprint": "b66787f297a090a08d1dc71d5b096e032f3f1a40940a3750d494a78217916553",
  "stop_conditions": [
  ...
  "title": "[TASK-145] Pass starter forecast-model integration gate",
...
Pass starter forecast-model integration gate
...
- Inherited from: None
- Resolution: `DIRECT`
- Effective counts: `{"acceptance_control_ids": 8, "adr_ids": 0, "gap_ids": 0, "requirement_ids": 5, "risk_ids": 0}`

## Acceptance Criteria

1. Stable ID TASK-145, parent EPIC-025, owner wave W20, and original status DONE are preserved.
