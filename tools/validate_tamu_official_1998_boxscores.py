...
def main() -> int:
    parser = argparse.ArgumentParser(
        description="Independently validate official 1998 box-score acquisition."
    )
    ...
    if not args.validate_only:
        ...
        mutations.append(expect_rejection("selected_season_tamper", lambda: _validate(_mutated_gate(gate, selected_seasons=[1999]))))
