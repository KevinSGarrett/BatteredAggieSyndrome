<!-- GENERATED VIEW. Canonical record: jira/records/issues/tasks/TASK-051_design_sparse_ambiguous_injury_evidence_confidence_rules.json -->
# TASK-051 — [TASK-051] Design sparse/ambiguous injury evidence confidence rules
...
```json
{
  ...
  "acceptance_criteria": [
    "Stable ID TASK-051, parent EPIC-009, owner wave W12, and original status DONE are preserved.",
  ...
  "allowed_modification_paths": [
    "injury evidence confidence/missingness policy"
  ],
  "blocked_reason": "",
  "blocks": [
    "TASK-052"
  ],
  "canonical_record": "jira/records/issues/tasks/TASK-051_design_sparse_ambiguous_injury_evidence_confidence_rules.json",
  ...
  "gap_ids": [],
  "generated_markdown": "jira/issues/tasks/TASK-051_design_sparse_ambiguous_injury_evidence_confidence_rules.md",
  ...
  "objective": "Design sparse/ambiguous injury evidence confidence rules",
  "operational_jira": {
    "assignee": "",
    "jira_issue_id": "24294",
    "jira_updated_at": "2026-08-09T00:40:25.459-0500",
  ...
  "phase": "PHASE-2",
  "prerequisites": [
    "Historical dependency TASK-049"
  ],
  "primary_source_refs": [
    "SRCREF-00084",
    "SRCREF-02116",
  ...
  "required_evidence": [
    "Authoritative WBS row TASK-051",
    "Existing artifact `injury evidence confidence/missingness policy`"
  ],
  "required_tests": [
    {
  ...
  "specificity_fingerprint": "96e01b8280a4d88fd6b51588dc50f3034a2c2325827792d9d17d93558db1944e",
  "stop_conditions": [
  ...
  "title": "[TASK-051] Design sparse/ambiguous injury evidence confidence rules",
...
Design sparse/ambiguous injury evidence confidence rules
...
1. Stable ID TASK-051, parent EPIC-009, owner wave W12, and original status DONE are preserved.
