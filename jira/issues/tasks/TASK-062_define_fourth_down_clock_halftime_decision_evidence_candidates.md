<!-- GENERATED VIEW. Canonical record: jira/records/issues/tasks/TASK-062_define_fourth_down_clock_halftime_decision_evidence_candidates.json -->
# TASK-062 — [TASK-062] Define fourth-down/clock/halftime decision evidence candidates
...
```json
{
  ...
  "acceptance_criteria": [
    "Stable ID TASK-062, parent EPIC-011, owner wave W13, and original status DONE are preserved.",
  ...
  "allowed_modification_paths": [
    "decision-quality candidate features"
  ],
  "blocked_reason": "",
  "blocks": [
    "TASK-063"
  ],
  "canonical_record": "jira/records/issues/tasks/TASK-062_define_fourth_down_clock_halftime_decision_evidence_candidates.json",
  ...
  "gap_ids": [],
  "generated_markdown": "jira/issues/tasks/TASK-062_define_fourth_down_clock_halftime_decision_evidence_candidates.md",
  ...
  "objective": "Define fourth-down/clock/halftime decision evidence candidates",
  "operational_jira": {
    "assignee": "",
    "jira_issue_id": "24305",
    "jira_updated_at": "2026-08-09T00:40:27.697-0500",
  ...
  "phase": "PHASE-2",
  "prerequisites": [
    "Historical dependency TASK-061"
  ],
  "primary_source_refs": [
    "SRCREF-00095",
    "SRCREF-02116",
  ...
  "required_evidence": [
    "Authoritative WBS row TASK-062",
    "Existing artifact `decision-quality candidate features`"
  ],
  "required_tests": [
    {
  ...
  "specificity_fingerprint": "5d22ea862af1f946ec054cfe7a142f48cbb04fac3b239ffbd7b4f724ef7dc916",
  "stop_conditions": [
  ...
  "title": "[TASK-062] Define fourth-down/clock/halftime decision evidence candidates",
...
Define fourth-down/clock/halftime decision evidence candidates
...
1. Stable ID TASK-062, parent EPIC-011, owner wave W13, and original status DONE are preserved.
