...
def main() -> int:
    parser = argparse.ArgumentParser(description="Independently validate the official 2004 season-index capture.")
    ...
    if not args.validate_only:
        ...
        invented = list(gate["box_score_urls"]) + [
            "https://files.12thman.com/history/football/stats/2004-2005/invented.html"
        ]
        ...
        upstream["bat599_gate_identity"] = "0" * 64
        mutations.append(
            expect_rejection(
                "bat599_identity_rewrite",
