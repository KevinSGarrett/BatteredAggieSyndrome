...
EXPECTED_GATE_IDENTITY = (
    "6a3a276087d3341b3826dec9c58391d54eaa42055149d7d7705e9e1a1d1601ff"
)
EXPECTED_UNION_IDENTITY = (
    "cd9bd79899bb4c4f0e8d3d7c79482d5146075e4bf51a1bd488597b28607fbe98"
)
...
class Compact2006ExpandedUnionTests(unittest.TestCase):
    ...
    def test_committed_counts_and_prior_identities(self) -> None:
        ...
        self.assertEqual(
            self.gate["prior_union_identity"], PINNED_BAT592_UNION_IDENTITY
        )
        self.assertEqual(
            self.gate["prior_union_gate_identity"], PINNED_BAT592_GATE_IDENTITY
        )
        ...
        self.assertEqual(
            self.gate["coverage_by_season"]["2006"]["official_school_games"], 13
        )
        self.assertEqual(
            self.gate["coverage_by_season"]["2006"]["rich_structured_games"], 13
        )
        ...
        self.assertEqual(
            self.gate["upstream_identities"]["bat596_payload_identity"],
            PINNED_BAT596_PAYLOAD_IDENTITY,
        )
