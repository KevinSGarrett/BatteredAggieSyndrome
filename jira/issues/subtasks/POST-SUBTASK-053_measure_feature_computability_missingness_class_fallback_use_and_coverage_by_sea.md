<!-- GENERATED VIEW. Canonical record: jira/records/issues/subtasks/POST-SUBTASK-053_measure_feature_computability_missingness_class_fallback_use_and_coverage_by_sea.json -->
# POST-SUBTASK-053 — [POST-SUBTASK-053] Measure feature computability, missingness class, fallback use, and coverage by season/team/cutoff/regime/A&M segment
...
```json
{
  ...
  "acceptance_criteria": [
    ...
    "The declared output `artifacts/features/feature_computability_profile.json` is produced with deterministic identity, provenance, and validation metadata appropriate to this work.",
  ...
  "ai_context_notes": [
    ...
    "Read the exact source sections in `jira/sources/issue_source_manifests/POST-SUBTASK-053.json`; inspect only the listed implementation files and prerequisite outputs.",
  ...
  "blocked_reason": "UNSATISFIED_HARD_DEPENDENCIES: POST-SUBTASK-048;POST-SUBTASK-052",
  "blocks": [
    "POST-SUBTASK-054"
  ],
  "canonical_record": "jira/records/issues/subtasks/POST-SUBTASK-053_measure_feature_computability_missingness_class_fallback_use_and_coverage_by_sea.json",
  "canonical_source_role": "AUTHORITATIVE_LOCAL_SPECIFICATION",
  "completion_evidence_contract": {
    "acceptance_matrix_required": true,
    "artifact_hashes_required": true,
    "completion_claim_limit": "EMPIRICALLY_VALIDATED",
    "downstream_consumer": "POST-SUBTASK-054",
  ...
  "critical_path": false,
  "definition_of_done": [
    "The atomic scope in POST-SUBTASK-053 is completed without absorbing sibling work or weakening any protected requirement, control, split, judging rule, private-research publication boundary, or security boundary.",
    ...
    "The output set `artifacts/features/feature_computability_profile.json` is demonstrably consumable by POST-SUBTASK-054 without manual reconstruction or undocumented state."
  ],
  "dependencies": [
    "POST-SUBTASK-048",
    "POST-SUBTASK-052"
  ...
  "end_to_end_validation": "Validate that `artifacts/features/feature_computability_profile.json` can be parsed and consumed by `POST-SUBTASK-054` using only documented identities and interfaces; the consumer must reject missing, stale, schema-incompatible, technically or quality-ineligible, or provenance-incomplete input without manual repair.",
  "epic_id": "POST-EPIC-006",
  "evidence_manifest_path": "artifacts/jira_evidence/POST-SUBTASK-053.json",
  ...
  "gap_ids": [],
  "generated_markdown": "jira/issues/subtasks/POST-SUBTASK-053_measure_feature_computability_missingness_class_fallback_use_and_coverage_by_sea.md",
  ...
  "local_id": "POST-SUBTASK-053",
  "maturity_before": "FUNCTIONAL_STARTER",
  "objective": "Measure feature computability, missingness class, fallback use, and coverage by season/team/cutoff/regime/A&M segment",
  "operational_jira": {
    "assignee": "",
    "jira_issue_id": "24543",
    "jira_updated_at": "2026-08-09T00:03:41.047-0500",
  ...
  "required_tests": [
    {
      ...
      "expectation": "Run as a regression check after completing POST-SUBTASK-053; retain command, exit code, and relevant output.",
    ...
    },
    {
      ...
      "path": "artifacts/features/feature_computability_profile.json",
  ...
  "risk_failure_conditions": [
    "The work would be invalid if any prerequisite artifact, source/data/code/config identity, or declared maturity differs from the pinned issue contract for POST-SUBTASK-053.",
    ...
    "Acceptance failure: the evidence cannot demonstrate that the declared output `artifacts/features/feature_computability_profile.json` is produced with deterministic identity, provenance, and validation metadata appropriate to this work.",
  ...
  "specificity_fingerprint": "259ea24ce2125b45e89eabcb0b7f8a15dbe9ec5aa0ae5db279eb88a2fcfd93c4",
  "stop_conditions": [
  ...
  "title": "[POST-SUBTASK-053] Measure feature computability, missingness class, fallback use, and coverage by season/team/cutoff/regime/A&M segment",
  ...
  "work_packet_path": "jira/ai/work_packets/POST-SUBTASK-053.md",
...
1. The atomic scope in POST-SUBTASK-053 is completed without absorbing sibling work or weakening any protected requirement, control, split, judging rule, private-research publication boundary, or security boundary.
...
7. The output set `artifacts/features/feature_computability_profile.json` is demonstrably consumable by POST-SUBTASK-054 without manual reconstruction or undocumented state.
...
Validate that `artifacts/features/feature_computability_profile.json` can be parsed and consumed by `POST-SUBTASK-054` using only documented identities and interfaces; the consumer must reject missing, stale, schema-incompatible, technically or quality-ineligible, or provenance-incomplete input without manual repair.
