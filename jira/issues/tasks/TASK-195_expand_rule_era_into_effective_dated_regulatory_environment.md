<!-- GENERATED VIEW. Canonical record: jira/records/issues/tasks/TASK-195_expand_rule_era_into_effective_dated_regulatory_environment.json -->
# TASK-195 — [TASK-195] Expand rule-era into effective-dated regulatory environment
...
```json
{
  ...
  "acceptance_criteria": [
    "Stable ID TASK-195, parent EPIC-012, owner wave W13, and original status DONE are preserved.",
  ...
  "blocked_reason": "",
  "blocks": [],
  "canonical_record": "jira/records/issues/tasks/TASK-195_expand_rule_era_into_effective_dated_regulatory_environment.json",
  ...
  "gap_ids": [],
  "generated_markdown": "jira/issues/tasks/TASK-195_expand_rule_era_into_effective_dated_regulatory_environment.md",
  ...
  "operational_jira": {
    "assignee": "",
    "jira_issue_id": "24471",
    "jira_updated_at": "2026-08-09T00:40:51.257-0500",
  ...
  "phase": "PHASE-2",
  "prerequisites": [
    "Historical dependency TASK-069",
  ...
  "required_evidence": [
    "Authoritative WBS row TASK-195",
    "Existing artifact `regulatory environment contract`"
  ],
  "required_tests": [
    {
  ...
  "risk_ids": [],
  "schema_version": 2,
  "scope": "Original task type DOMAIN_DESIGN with mutation scope: context/rule era.",
  "source_ids": [
    "TASK-195"
  ],
  "source_refs": [
  ...
  "specificity_fingerprint": "fc03518e054797e92f6577daea5b8b001ebd092cc49911dfbdc9732570e19ce5",
  "stop_conditions": [
  ...
  "title": "[TASK-195] Expand rule-era into effective-dated regulatory environment",
...
Expand rule-era into effective-dated regulatory environment
...
Original task type DOMAIN_DESIGN with mutation scope: context/rule era.
...
1. Stable ID TASK-195, parent EPIC-012, owner wave W13, and original status DONE are preserved.
