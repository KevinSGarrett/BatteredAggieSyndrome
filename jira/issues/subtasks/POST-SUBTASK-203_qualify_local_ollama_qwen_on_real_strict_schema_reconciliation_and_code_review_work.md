<!-- GENERATED VIEW. Canonical record: jira/records/issues/subtasks/POST-SUBTASK-203_qualify_local_ollama_qwen_on_real_strict_schema_reconciliation_and_code_review_work.json -->
# POST-SUBTASK-203 — [POST-SUBTASK-203] Qualify local Ollama Qwen on real strict-schema, reconciliation, and code-review work
...
```json
{
  ...
  "canonical_record": "jira/records/issues/subtasks/POST-SUBTASK-203_qualify_local_ollama_qwen_on_real_strict_schema_reconciliation_and_code_review_work.json",
  ...
  "gap_ids": [],
  "generated_markdown": "jira/issues/subtasks/POST-SUBTASK-203_qualify_local_ollama_qwen_on_real_strict_schema_reconciliation_and_code_review_work.md",
  ...
  "objective": "Qualify local Ollama Qwen on real strict-schema, reconciliation, and code-review work",
  "operational_jira": {
    "assignee": "",
    "jira_issue_id": "24955",
    "jira_updated_at": "2026-08-12T12:49:19.612-0500",
  ...
  "title": "[POST-SUBTASK-203] Qualify local Ollama Qwen on real strict-schema, reconciliation, and code-review work",
