# AI Work Packet — POST-SUBTASK-027
...
1. `jira/records/issues/subtasks/POST-SUBTASK-027_approve_or_block_the_population_level_core_history_coverage_gate.json`
2. `jira/sources/issue_source_manifests/POST-SUBTASK-027.json`
3. `jira/index/ISSUE_GOVERNANCE_CONTEXT.csv` row for `POST-SUBTASK-027`.
