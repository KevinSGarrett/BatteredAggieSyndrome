...
def main() -> int:
    parser = argparse.ArgumentParser(description="Validate immutable 1996-2009 structured-row corpus successor.")
    ...
    mutations = [
        ...
        expect_rejection(
            "rejection_count_tampered",
            lambda: _validate(_mutated_gate(gate, counts={**gate["counts"], "complete_rejection_count": 0})),
        ),
    ]
