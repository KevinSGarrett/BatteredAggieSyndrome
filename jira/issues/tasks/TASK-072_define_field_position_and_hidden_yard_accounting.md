<!-- GENERATED VIEW. Canonical record: jira/records/issues/tasks/TASK-072_define_field_position_and_hidden_yard_accounting.json -->
# TASK-072 — [TASK-072] Define field-position and hidden-yard accounting
...
```json
{
  ...
  "acceptance_criteria": [
    "Stable ID TASK-072, parent EPIC-013, owner wave W13, and original status DONE are preserved.",
  ...
  "canonical_record": "jira/records/issues/tasks/TASK-072_define_field_position_and_hidden_yard_accounting.json",
  ...
  "gap_ids": [],
  "generated_markdown": "jira/issues/tasks/TASK-072_define_field_position_and_hidden_yard_accounting.md",
  ...
  "objective": "Define field-position and hidden-yard accounting",
  "operational_jira": {
    "assignee": "",
    "jira_issue_id": "24315",
    "jira_updated_at": "2026-08-09T00:40:29.424-0500",
  ...
  "required_evidence": [
    "Authoritative WBS row TASK-072",
    "Existing artifact `field-position value contract`"
  ],
  "required_tests": [
    {
  ...
  "specificity_fingerprint": "c1d552fb7a333ba91e2477a3ffc3037d8b41508a7c6b83b8fbc59b8478d670e9",
  "stop_conditions": [
  ...
  "title": "[TASK-072] Define field-position and hidden-yard accounting",
...
Define field-position and hidden-yard accounting
...
1. Stable ID TASK-072, parent EPIC-013, owner wave W13, and original status DONE are preserved.
