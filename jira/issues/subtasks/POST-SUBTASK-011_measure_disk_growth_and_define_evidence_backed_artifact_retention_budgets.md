<!-- GENERATED VIEW. Canonical record: jira/records/issues/subtasks/POST-SUBTASK-011_measure_disk_growth_and_define_evidence_backed_artifact_retention_budgets.json -->
# POST-SUBTASK-011 — [POST-SUBTASK-011] Measure disk growth and define evidence-backed artifact retention budgets
...
```json
{
  ...
  "adr_ids": [],
  "ai_context_notes": [
    "Canonical parent Story: POST-STORY-004. Governance traceability gate: POST-SUBTASK-009. Inherited traceability is resolved through `jira/index/ISSUE_GOVERNANCE_CONTEXT.csv`.",
    "Read the exact source sections in `jira/sources/issue_source_manifests/POST-SUBTASK-011.json`; inspect only the listed implementation files and prerequisite outputs.",
  ...
  "blocked_reason": "UNSATISFIED_HARD_DEPENDENCIES: POST-SUBTASK-009;POST-SUBTASK-010",
  "blocks": [
    "POST-SUBTASK-012"
  ],
  "canonical_record": "jira/records/issues/subtasks/POST-SUBTASK-011_measure_disk_growth_and_define_evidence_backed_artifact_retention_budgets.json",
  "canonical_source_role": "AUTHORITATIVE_LOCAL_SPECIFICATION",
  "completion_evidence_contract": {
    "acceptance_matrix_required": true,
    "artifact_hashes_required": true,
    "completion_claim_limit": "IMPLEMENTED",
    "downstream_consumer": "POST-SUBTASK-012",
  ...
  "critical_path": false,
  "definition_of_done": [
    "The atomic scope in POST-SUBTASK-011 is completed without absorbing sibling work or weakening any protected requirement, control, split, judging rule, private-research publication boundary, or security boundary.",
    ...
    "The output set `artifacts/benchmarks/storage_growth_profile.json`, `docs/operations/LOCAL_RESOURCE_ENVELOPE.md` is demonstrably consumable by POST-SUBTASK-012 without manual reconstruction or undocumented state."
  ],
  "dependencies": [
    "POST-SUBTASK-009",
    "POST-SUBTASK-010"
  ...
  "end_to_end_validation": "Validate that `artifacts/benchmarks/storage_growth_profile.json`, `docs/operations/LOCAL_RESOURCE_ENVELOPE.md` can be parsed and consumed by `POST-SUBTASK-012` using only documented identities and interfaces; the consumer must reject missing, stale, schema-incompatible, technically or quality-ineligible, or provenance-incomplete input without manual repair.",
  "epic_id": "POST-EPIC-001",
  "evidence_manifest_path": "artifacts/jira_evidence/POST-SUBTASK-011.json",
  ...
  "gap_ids": [],
  "generated_markdown": "jira/issues/subtasks/POST-SUBTASK-011_measure_disk_growth_and_define_evidence_backed_artifact_retention_budgets.md",
  ...
  "in_scope": [
    ...
    "Demonstrate with saved evidence: Deletion rules never remove canonical negative results, provenance, or superseded policy evidence.",
  ...
  "local_id": "POST-SUBTASK-011",
  "maturity_before": "FUNCTIONAL_STARTER",
  "objective": "Measure disk growth and define evidence-backed artifact retention budgets",
  "operational_jira": {
    "assignee": "",
    "jira_issue_id": "24501",
    "jira_updated_at": "2026-08-09T23:24:00.691-0500",
  ...
  "owner_wave": "POST_W25",
  "parent_id": "POST-STORY-004",
  "phase": "PHASE-4",
  "prerequisites": [
    "Dependency POST-SUBTASK-009 complete at required maturity",
    "Dependency POST-SUBTASK-010 complete at required maturity"
  ],
  "primary_source_refs": [
    "SRCREF-01994",
    "SRCREF-01995",
  ...
  "required_tests": [
    {
      ...
      "expectation": "Run as a regression check after completing POST-SUBTASK-011; retain command, exit code, and relevant output.",
    ...
    },
    {
      ...
      "path": "artifacts/benchmarks/storage_growth_profile.json",
  ...
  "risk_failure_conditions": [
    "The work would be invalid if any prerequisite artifact, source/data/code/config identity, or declared maturity differs from the pinned issue contract for POST-SUBTASK-011.",
    "A command may exit successfully while producing stale, partial, synthetic-only, leakage-contaminated, non-reproducible, or legally unusable evidence.",
    "Acceptance failure: the evidence cannot demonstrate that raw snapshots, matrices, model artifacts, forecasts, logs, and backups are measured separately.",
    "Acceptance failure: the evidence cannot demonstrate that retention recommendations preserve required lineage and protected evidence.",
    "Acceptance failure: the evidence cannot demonstrate that deletion rules never remove canonical negative results, provenance, or superseded policy evidence."
  ],
  "risk_ids": [],
  "schema_version": 2,
  "scope": "Execute the atomic 2 of 3 step in Story POST-STORY-004 (Evidence-backed resource, concurrency, and degradation envelope): Measure disk growth and define evidence-backed artifact retention budgets. Consume only verified prerequisite outputs from `POST-SUBTASK-009`, `POST-SUBTASK-010`. Produce `artifacts/benchmarks/storage_growth_profile.json`, `docs/operations/LOCAL_RESOURCE_ENVELOPE.md`; evaluate every issue-specific acceptance condition; preserve negative results; and hand the pinned output to POST-SUBTASK-012.",
  "source_ids": [
    "GAP-001",
    "HANDOFF-001"
  ],
  ...
  "specificity_fingerprint": "845434dc92725ef9a216d7f8d3ab4d356e2e6a3767902d177940d6351a2573fc",
  "stop_conditions": [
  ...
  "title": "[POST-SUBTASK-011] Measure disk growth and define evidence-backed artifact retention budgets",
  ...
  "why_this_exists": "This is an independently executable and verifiable work unit required by Story POST-STORY-004: Evidence-backed resource, concurrency, and degradation envelope.",
  "work_packet_path": "jira/ai/work_packets/POST-SUBTASK-011.md",
...
3. Deletion rules never remove canonical negative results, provenance, or superseded policy evidence.

## Definition of Done

1. The atomic scope in POST-SUBTASK-011 is completed without absorbing sibling work or weakening any protected requirement, control, split, judging rule, private-research publication boundary, or security boundary.
...
7. The output set `artifacts/benchmarks/storage_growth_profile.json`, `docs/operations/LOCAL_RESOURCE_ENVELOPE.md` is demonstrably consumable by POST-SUBTASK-012 without manual reconstruction or undocumented state.
...
Validate that `artifacts/benchmarks/storage_growth_profile.json`, `docs/operations/LOCAL_RESOURCE_ENVELOPE.md` can be parsed and consumed by `POST-SUBTASK-012` using only documented identities and interfaces; the consumer must reject missing, stale, schema-incompatible, technically or quality-ineligible, or provenance-incomplete input without manual repair.
