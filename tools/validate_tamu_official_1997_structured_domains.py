...
def main() -> int:
    parser = argparse.ArgumentParser(description="Validate official 1997 structured-domains artifact.")
    ...
    mutations = [
        expect_rejection("protected_lane_opened", lambda: _validate(_mutated_gate(gate, protected_lane="OPEN"))),
        expect_rejection("rewrite_upstream_identity", lambda: _validate(_mutated_gate(gate, upstream_boxscore_gate_identity="0" * 64))),
    ]
