<!-- GENERATED VIEW. Canonical record: jira/records/issues/tasks/TASK-140_implement_common_model_artifact_runtime_interface.json -->
# TASK-140 — [TASK-140] Implement common model artifact/runtime interface
...
```json
{
  ...
  "acceptance_criteria": [
    "Stable ID TASK-140, parent EPIC-025, owner wave W20, and original status DONE are preserved.",
  ...
  "ai_context_notes": [
    ...
    "W19 foundation gate cleared; first READY W20 model-runtime task. Completed W20 functional starter; no protected empirical winner implied."
  ],
  "allowed_modification_paths": [
    "model runtime/artifact abstraction"
  ],
  "blocked_reason": "",
  "blocks": [
    "TASK-141",
  ...
  "canonical_record": "jira/records/issues/tasks/TASK-140_implement_common_model_artifact_runtime_interface.json",
  ...
  "gap_ids": [],
  "generated_markdown": "jira/issues/tasks/TASK-140_implement_common_model_artifact_runtime_interface.md",
  ...
  "objective": "Implement common model artifact/runtime interface",
  "operational_jira": {
    "assignee": "",
    "jira_issue_id": "24383",
    "jira_updated_at": "2026-08-09T00:40:42.857-0500",
  ...
  "phase": "PHASE-4",
  "prerequisites": [
    "Historical dependency TASK-121",
  ...
  "required_evidence": [
    "Authoritative WBS row TASK-140",
    "Existing artifact `model runtime/artifact abstraction`"
  ],
  "required_tests": [
    {
  ...
  "specificity_fingerprint": "51883f6b8802e4d38c233ae412c94ae8503ab1790c54d6d8ef07b8f4751a0526",
  "stop_conditions": [
  ...
  "title": "[TASK-140] Implement common model artifact/runtime interface",
...
Implement common model artifact/runtime interface
...
1. Stable ID TASK-140, parent EPIC-025, owner wave W20, and original status DONE are preserved.
