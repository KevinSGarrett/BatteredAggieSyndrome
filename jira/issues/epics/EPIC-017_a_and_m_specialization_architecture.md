<!-- GENERATED VIEW. Canonical record: jira/records/issues/epics/EPIC-017_a_and_m_specialization_architecture.json -->
# EPIC-017 — [EPIC-017] A&M specialization architecture
...
```json
{
  ...
  "acceptance_criteria": [
    "The epic retains stable ID EPIC-017, owner wave W14, phase PHASE-3, and all authoritative WBS children.",
  ...
  "blocked_reason": "",
  "blocks": [],
  "canonical_record": "jira/records/issues/epics/EPIC-017_a_and_m_specialization_architecture.json",
  ...
  "expected_outputs": [
    "A&M evaluation slice contract",
    "hierarchical/multi-task candidates",
    "national→A&M specialization interface",
    "residual specialization candidate",
    "specialization candidate baseline",
  ...
  "gap_ids": [],
  "generated_markdown": "jira/issues/epics/EPIC-017_a_and_m_specialization_architecture.md",
  ...
  "objective": "Compare residual, hierarchical multi-task, stacking and other specialization forms without forcing a nonzero adjustment.",
  "operational_jira": {
    "assignee": "",
    "jira_issue_id": "24157",
    "jira_updated_at": "2026-08-09T00:40:12.932-0500",
  ...
  "specificity_fingerprint": "7e34db1d2e16fc8865c7634958d33f23c62dcb6359a7eb6ca2006b9b3b0a59c7",
  "stop_conditions": [
    "Stop if a proposed update renumbers the historical epic or rewrites its original wave provenance."
  ],
  "supporting_source_refs": [],
  "title": "[EPIC-017] A&M specialization architecture",
...
Compare residual, hierarchical multi-task, stacking and other specialization forms without forcing a nonzero adjustment.
...
1. The epic retains stable ID EPIC-017, owner wave W14, phase PHASE-3, and all authoritative WBS children.
