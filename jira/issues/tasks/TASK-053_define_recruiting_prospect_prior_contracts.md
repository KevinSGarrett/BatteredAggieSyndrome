<!-- GENERATED VIEW. Canonical record: jira/records/issues/tasks/TASK-053_define_recruiting_prospect_prior_contracts.json -->
# TASK-053 — [TASK-053] Define recruiting/prospect prior contracts
...
```json
{
  ...
  "acceptance_criteria": [
    "Stable ID TASK-053, parent EPIC-010, owner wave W12, and original status DONE are preserved.",
  ...
  "canonical_record": "jira/records/issues/tasks/TASK-053_define_recruiting_prospect_prior_contracts.json",
  ...
  "gap_ids": [],
  "generated_markdown": "jira/issues/tasks/TASK-053_define_recruiting_prospect_prior_contracts.md",
  ...
  "objective": "Define recruiting/prospect prior contracts",
  "operational_jira": {
    "assignee": "",
    "jira_issue_id": "24296",
    "jira_updated_at": "2026-08-09T00:40:25.742-0500",
  ...
  "required_evidence": [
    "Authoritative WBS row TASK-053",
    "Existing artifact `recruiting and freshman prior schema`"
  ],
  "required_tests": [
    {
  ...
  "specificity_fingerprint": "5a5102e506610d5fcad6dfa4e751ff9b26cd60f34cd8b312f3110361700cbad8",
  "stop_conditions": [
  ...
  "title": "[TASK-053] Define recruiting/prospect prior contracts",
...
Define recruiting/prospect prior contracts
...
1. Stable ID TASK-053, parent EPIC-010, owner wave W12, and original status DONE are preserved.
