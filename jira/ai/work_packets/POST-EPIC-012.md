...
1. `jira/records/issues/epics/POST-EPIC-012_autonomous_weekly_real_data_execution_and_immutable_forecast_publication.json`
2. `jira/sources/issue_source_manifests/POST-EPIC-012.json`
3. `jira/index/ISSUE_GOVERNANCE_CONTEXT.csv` row for `POST-EPIC-012`.
