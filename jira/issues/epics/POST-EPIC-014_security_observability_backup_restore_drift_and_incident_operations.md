<!-- GENERATED VIEW. Canonical record: jira/records/issues/epics/POST-EPIC-014_security_observability_backup_restore_drift_and_incident_operations.json -->
# POST-EPIC-014 — [POST-EPIC-014] Security, observability, backup/restore, drift, and incident operations
...
```json
{
  ...
  "blocked_reason": "",
  "blocks": [],
  "canonical_record": "jira/records/issues/epics/POST-EPIC-014_security_observability_backup_restore_drift_and_incident_operations.json",
  ...
  "critical_path": true,
  "definition_of_done": [
    "Every child Story POST-STORY-042, POST-STORY-043, POST-STORY-044 is completed through its explicit end-to-end gate or has an explicit accepted-risk/deferred/cancelled disposition consistent with release governance.",
  ...
  "gap_ids": [],
  "generated_markdown": "jira/issues/epics/POST-EPIC-014_security_observability_backup_restore_drift_and_incident_operations.md",
  ...
  "operational_jira": {
    "assignee": "",
    "jira_issue_id": "24187",
    "jira_updated_at": "2026-08-09T23:23:54.147-0500",
  ...
  "phase": "PHASE-4",
  "prerequisites": [
    "Completion of POST-SUBTASK-002",
  ...
  "required_tests": [
    {
      ...
      "expectation": "Story gate `POST-SUBTASK-126` must complete with verified evidence before Epic completion.",
      "path": "POST-SUBTASK-126",
      "validation_class": "END_TO_END"
    },
    {
      "classification": "END_TO_END",
      "expectation": "Story gate `POST-SUBTASK-129` must complete with verified evidence before Epic completion.",
      "path": "POST-SUBTASK-129",
      "validation_class": "END_TO_END"
    },
    {
      "classification": "END_TO_END",
      "expectation": "Story gate `POST-SUBTASK-132` must complete with verified evidence before Epic completion.",
  ...
  "risk_ids": [],
  "schema_version": 2,
  "scope": "All Stories and Subtasks under this Epic for the operations domain, including its explicit integrated completion gate.",
  "source_ids": [
    "HANDOFF-012"
  ],
  "source_refs": [
  ...
  "title": "[POST-EPIC-014] Security, observability, backup/restore, drift, and incident operations",
  ...
  "work_packet_path": "jira/ai/work_packets/POST-EPIC-014.md",
...
1. Every child Story POST-STORY-042, POST-STORY-043, POST-STORY-044 is completed through its explicit end-to-end gate or has an explicit accepted-risk/deferred/cancelled disposition consistent with release governance.
