<!-- GENERATED VIEW. Canonical record: jira/records/issues/tasks/TASK-078_define_style_scheme_similarity_representation.json -->
# TASK-078 — [TASK-078] Define style/scheme similarity representation
...
```json
{
  ...
  "acceptance_criteria": [
    "Stable ID TASK-078, parent EPIC-014, owner wave W13, and original status DONE are preserved.",
  ...
  "canonical_record": "jira/records/issues/tasks/TASK-078_define_style_scheme_similarity_representation.json",
  ...
  "gap_ids": [],
  "generated_markdown": "jira/issues/tasks/TASK-078_define_style_scheme_similarity_representation.md",
  ...
  "objective": "Define style/scheme similarity representation",
  "operational_jira": {
    "assignee": "",
    "jira_issue_id": "24321",
    "jira_updated_at": "2026-08-09T00:40:30.798-0500",
  ...
  "required_evidence": [
    "Authoritative WBS row TASK-078",
    "Existing artifact `style similarity candidates`"
  ],
  "required_tests": [
    {
  ...
  "specificity_fingerprint": "fc33f6dad06737d52af1280ff806878ee5e847b6be9e87d8b62265570b6bd8ba",
  "stop_conditions": [
  ...
  "title": "[TASK-078] Define style/scheme similarity representation",
...
Define style/scheme similarity representation
...
1. Stable ID TASK-078, parent EPIC-014, owner wave W13, and original status DONE are preserved.
