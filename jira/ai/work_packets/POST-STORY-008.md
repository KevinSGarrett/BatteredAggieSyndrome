...
1. `jira/records/issues/stories/POST-STORY-008_production_acquisition_contracts_rate_limits_fallbacks_and_drift_hooks.json`
2. `jira/sources/issue_source_manifests/POST-STORY-008.json`
3. `jira/index/ISSUE_GOVERNANCE_CONTEXT.csv` row for `POST-STORY-008`.
