...
```json
{
  ...
  "critical_path": true,
  "definition_of_done": [
    "The atomic scope in POST-SUBTASK-071 is completed without absorbing sibling work or weakening any protected requirement, control, split, judging rule, private-research publication boundary, or security boundary.",
  ...
  "end_to_end_validation": "Validate that `artifacts/modeling/model_split_manifest.json` can be parsed and consumed by `POST-SUBTASK-072` using only documented identities and interfaces; the consumer must reject missing, stale, schema-incompatible, technically or quality-ineligible, or provenance-incomplete input without manual repair.",
  ...
  "operational_jira": {
    "assignee": "",
    "jira_issue_id": "24561",
    "jira_updated_at": "2026-08-09T23:24:06.625-0500",
  ...
  "specificity_fingerprint": "0dcad5488e6cfaf81d0eb2999b7a3f0fc681574e4a5e4c13707b46942caa5e49",
  "stop_conditions": [
...
1. The atomic scope in POST-SUBTASK-071 is completed without absorbing sibling work or weakening any protected requirement, control, split, judging rule, private-research publication boundary, or security boundary.
