...
from aggie_analytics.data.tamu_official_gamebook_union_1996_expanded import (  # noqa: E402  # pylint: disable=import-error
    AuthorityViolation,
    GATE_RELATIVE,
    compute_identity,
    validate_artifact,
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Validate immutable 1996-expanded union successor.")
    ...
    mutations = [
        ...
        expect_rejection(
            "rejected_count_tampered",
            lambda: _validate(_mutated_gate(gate, counts={**gate["counts"], "official_1996_rejected": 0})),
        ),
    ]
