...
```json
{
  ...
  "blocked_reason": "UNSATISFIED_HARD_DEPENDENCIES: POST-SUBTASK-030;POST-SUBTASK-048;POST-SUBTASK-061",
  "blocks": [
    "POST-SUBTASK-063"
  ],
  ...
  "critical_path": false,
  "definition_of_done": [
    "The atomic scope in POST-SUBTASK-062 is completed without absorbing sibling work or weakening any protected requirement, control, split, judging rule, rights decision, or security boundary.",
  ...
  "end_to_end_validation": "Validate that `artifacts/player_intelligence/player_value_availability_report.json` can be parsed and consumed by `POST-SUBTASK-063` using only documented identities and interfaces; the consumer must reject missing, stale, schema-incompatible, rights-blocked, or provenance-incomplete input without manual repair.",
  ...
  "operational_jira": {
    "assignee": "",
    "jira_issue_id": "24552",
    "jira_updated_at": "2026-08-09T00:03:43.599-0500",
  ...
  "specificity_fingerprint": "ac635ec38dbb1a38d268b75a9d8d181a2d9101a2e8347c2960804bab13e0ddd1",
  "stop_conditions": [
...
1. The atomic scope in POST-SUBTASK-062 is completed without absorbing sibling work or weakening any protected requirement, control, split, judging rule, rights decision, or security boundary.
