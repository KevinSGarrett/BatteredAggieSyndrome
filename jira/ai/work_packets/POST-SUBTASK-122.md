# AI Work Packet — POST-SUBTASK-122
...
1. `jira/records/issues/subtasks/POST-SUBTASK-122_run_explanation_faithfulness_stability_privacy_tests_plus_target_host_cold_warm_.json`
2. `jira/sources/issue_source_manifests/POST-SUBTASK-122.json`
3. `jira/index/ISSUE_GOVERNANCE_CONTEXT.csv` row for `POST-SUBTASK-122`.
