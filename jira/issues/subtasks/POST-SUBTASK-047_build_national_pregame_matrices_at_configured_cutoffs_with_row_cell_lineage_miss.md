<!-- GENERATED VIEW. Canonical record: jira/records/issues/subtasks/POST-SUBTASK-047_build_national_pregame_matrices_at_configured_cutoffs_with_row_cell_lineage_miss.json -->
# POST-SUBTASK-047 — [POST-SUBTASK-047] Build national pregame matrices at configured cutoffs with row/cell lineage, missingness class, fallback, and pinned versions
...
```json
{
  ...
  "acceptance_criteria": [
    ...
    "The declared output `artifacts/pit/pregame_matrix_manifest.json` is produced with deterministic identity, provenance, and validation metadata appropriate to this work.",
  ...
  "ai_context_notes": [
    ...
    "Read the exact source sections in `jira/sources/issue_source_manifests/POST-SUBTASK-047.json`; inspect only the listed implementation files and prerequisite outputs.",
  ...
  "canonical_record": "jira/records/issues/subtasks/POST-SUBTASK-047_build_national_pregame_matrices_at_configured_cutoffs_with_row_cell_lineage_miss.json",
  "canonical_source_role": "AUTHORITATIVE_LOCAL_SPECIFICATION",
  "completion_evidence_contract": {
    "acceptance_matrix_required": true,
    "artifact_hashes_required": true,
    "completion_claim_limit": "EMPIRICALLY_VALIDATED",
    "downstream_consumer": "POST-SUBTASK-048",
  ...
  "critical_path": true,
  "definition_of_done": [
    "The atomic scope in POST-SUBTASK-047 is completed without absorbing sibling work or weakening any protected requirement, control, split, judging rule, rights decision, or security boundary.",
    ...
    "The output set `artifacts/pit/pregame_matrix_manifest.json` is demonstrably consumable by POST-SUBTASK-048 without manual reconstruction or undocumented state."
  ],
  "dependencies": [
    "POST-SUBTASK-045",
    "POST-SUBTASK-046"
  ...
  "end_to_end_validation": "Validate that `artifacts/pit/pregame_matrix_manifest.json` can be parsed and consumed by `POST-SUBTASK-048` using only documented identities and interfaces; the consumer must reject missing, stale, schema-incompatible, rights-blocked, or provenance-incomplete input without manual repair.",
  "epic_id": "POST-EPIC-005",
  "evidence_manifest_path": "artifacts/jira_evidence/POST-SUBTASK-047.json",
  ...
  "gap_ids": [],
  "generated_markdown": "jira/issues/subtasks/POST-SUBTASK-047_build_national_pregame_matrices_at_configured_cutoffs_with_row_cell_lineage_miss.md",
  ...
  "local_id": "POST-SUBTASK-047",
  "maturity_before": "FUNCTIONAL_STARTER",
  "objective": "Build national pregame matrices at configured cutoffs with row/cell lineage, missingness class, fallback, and pinned versions",
  "operational_jira": {
    "assignee": "",
    "jira_issue_id": "24537",
    "jira_updated_at": "2026-08-09T00:03:36.091-0500",
  ...
  "required_tests": [
    {
      ...
      "expectation": "Run as a regression check after completing POST-SUBTASK-047; retain command, exit code, and relevant output.",
    ...
    },
    {
      ...
      "path": "artifacts/pit/pregame_matrix_manifest.json",
    ...
    },
    {
      ...
      "path": "NEW_TEST_REQUIRED::POST-SUBTASK-047",
      "validation_class": "NEW_AUTOMATED_TEST_REQUIRED"
    }
  ],
  "requirement_ids": [],
  "risk_failure_conditions": [
    "The work would be invalid if any prerequisite artifact, source/data/code/config identity, or declared maturity differs from the pinned issue contract for POST-SUBTASK-047.",
    ...
    "Acceptance failure: the evidence cannot demonstrate that the declared output `artifacts/pit/pregame_matrix_manifest.json` is produced with deterministic identity, provenance, and validation metadata appropriate to this work.",
  ...
  "specificity_fingerprint": "cb53c34997e9f464d23ae3efddd2a7ed8260598908c40543440e721ad28c1936",
  "stop_conditions": [
  ...
  "title": "[POST-SUBTASK-047] Build national pregame matrices at configured cutoffs with row/cell lineage, missingness class, fallback, and pinned versions",
  ...
  "work_packet_path": "jira/ai/work_packets/POST-SUBTASK-047.md",
...
1. The atomic scope in POST-SUBTASK-047 is completed without absorbing sibling work or weakening any protected requirement, control, split, judging rule, rights decision, or security boundary.
...
7. The output set `artifacts/pit/pregame_matrix_manifest.json` is demonstrably consumable by POST-SUBTASK-048 without manual reconstruction or undocumented state.
...
Validate that `artifacts/pit/pregame_matrix_manifest.json` can be parsed and consumed by `POST-SUBTASK-048` using only documented identities and interfaces; the consumer must reject missing, stale, schema-incompatible, rights-blocked, or provenance-incomplete input without manual repair.
