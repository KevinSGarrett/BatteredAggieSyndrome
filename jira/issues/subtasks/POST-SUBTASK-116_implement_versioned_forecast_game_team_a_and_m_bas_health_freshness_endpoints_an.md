<!-- GENERATED VIEW. Canonical record: jira/records/issues/subtasks/POST-SUBTASK-116_implement_versioned_forecast_game_team_a_and_m_bas_health_freshness_endpoints_an.json -->
# POST-SUBTASK-116 — [POST-SUBTASK-116] Implement versioned forecast/game/team/A&M/BAS/health/freshness endpoints and OpenAPI contract
...
```json
{
  ...
  "ai_context_notes": [
    ...
    "Read the exact source sections in `jira/sources/issue_source_manifests/POST-SUBTASK-116.json`; inspect only the listed implementation files and prerequisite outputs.",
  ...
  "blocked_reason": "UNSATISFIED_HARD_DEPENDENCIES: POST-SUBTASK-111;POST-SUBTASK-115",
  "blocks": [
    "POST-SUBTASK-117"
  ],
  "canonical_record": "jira/records/issues/subtasks/POST-SUBTASK-116_implement_versioned_forecast_game_team_a_and_m_bas_health_freshness_endpoints_an.json",
  "canonical_source_role": "AUTHORITATIVE_LOCAL_SPECIFICATION",
  "completion_evidence_contract": {
    "acceptance_matrix_required": true,
    "artifact_hashes_required": true,
    "completion_claim_limit": "EMPIRICALLY_VALIDATED",
    "downstream_consumer": "POST-SUBTASK-117",
  ...
  "critical_path": false,
  "definition_of_done": [
    "The atomic scope in POST-SUBTASK-116 is completed without absorbing sibling work or weakening any protected requirement, control, split, judging rule, private-research publication boundary, or security boundary.",
    ...
    "The output set `docs/product/OPENAPI_SNAPSHOT.json` is demonstrably consumable by POST-SUBTASK-117 without manual reconstruction or undocumented state."
  ],
  "dependencies": [
    "POST-SUBTASK-111",
    "POST-SUBTASK-115"
  ...
  "end_to_end_validation": "Validate that `docs/product/OPENAPI_SNAPSHOT.json` can be parsed and consumed by `POST-SUBTASK-117` using only documented identities and interfaces; the consumer must reject missing, stale, schema-incompatible, technically or quality-ineligible, or provenance-incomplete input without manual repair.",
  "epic_id": "POST-EPIC-013",
  "evidence_manifest_path": "artifacts/jira_evidence/POST-SUBTASK-116.json",
  ...
  "gap_ids": [],
  "generated_markdown": "jira/issues/subtasks/POST-SUBTASK-116_implement_versioned_forecast_game_team_a_and_m_bas_health_freshness_endpoints_an.md",
  ...
  "local_id": "POST-SUBTASK-116",
  "maturity_before": "FUNCTIONAL_STARTER",
  "objective": "Implement versioned forecast/game/team/A&M/BAS/health/freshness endpoints and OpenAPI contract",
  "operational_jira": {
    "assignee": "",
    "jira_issue_id": "24606",
    "jira_updated_at": "2026-08-09T23:24:11.436-0500",
  ...
  "required_tests": [
    {
      ...
      "expectation": "Run as a regression check after completing POST-SUBTASK-116; retain command, exit code, and relevant output.",
    ...
    },
    {
      ...
      "path": "docs/product/OPENAPI_SNAPSHOT.json",
    ...
    },
    {
      ...
      "path": "NEW_TEST_REQUIRED::POST-SUBTASK-116",
      "validation_class": "NEW_AUTOMATED_TEST_REQUIRED"
    }
  ],
  "requirement_ids": [],
  "risk_failure_conditions": [
    "The work would be invalid if any prerequisite artifact, source/data/code/config identity, or declared maturity differs from the pinned issue contract for POST-SUBTASK-116.",
    ...
    "Acceptance failure: the evidence cannot demonstrate that the declared output `docs/product/OPENAPI_SNAPSHOT.json` is produced with deterministic identity, provenance, and validation metadata appropriate to this work.",
  ...
  "risk_ids": [],
  "schema_version": 2,
  "scope": "Execute the atomic 2 of 3 step in Story POST-STORY-039 (Read-only forecast repository and versioned API): Implement versioned forecast/game/team/A&M/BAS/health/freshness endpoints and OpenAPI contract. Consume only verified prerequisite outputs from `POST-SUBTASK-111`, `POST-SUBTASK-115`. Produce `docs/product/OPENAPI_SNAPSHOT.json`; evaluate every issue-specific acceptance condition; preserve negative results; and hand the pinned output to POST-SUBTASK-117.",
  "source_ids": [
    "GAP-012",
    "HANDOFF-011"
  ],
  ...
  "specificity_fingerprint": "57e2595514d4909fabbf4eafb2977d8e69004c4aacd7a3bb06e1c3706a6f577c",
  "stop_conditions": [
  ...
  "title": "[POST-SUBTASK-116] Implement versioned forecast/game/team/A&M/BAS/health/freshness endpoints and OpenAPI contract",
  ...
  "work_packet_path": "jira/ai/work_packets/POST-SUBTASK-116.md",
...
1. The atomic scope in POST-SUBTASK-116 is completed without absorbing sibling work or weakening any protected requirement, control, split, judging rule, private-research publication boundary, or security boundary.
...
7. The output set `docs/product/OPENAPI_SNAPSHOT.json` is demonstrably consumable by POST-SUBTASK-117 without manual reconstruction or undocumented state.
...
Validate that `docs/product/OPENAPI_SNAPSHOT.json` can be parsed and consumed by `POST-SUBTASK-117` using only documented identities and interfaces; the consumer must reject missing, stale, schema-incompatible, technically or quality-ineligible, or provenance-incomplete input without manual repair.
