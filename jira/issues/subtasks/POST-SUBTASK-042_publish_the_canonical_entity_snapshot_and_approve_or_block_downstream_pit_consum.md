<!-- GENERATED VIEW. Canonical record: jira/records/issues/subtasks/POST-SUBTASK-042_publish_the_canonical_entity_snapshot_and_approve_or_block_downstream_pit_consum.json -->
# POST-SUBTASK-042 — [POST-SUBTASK-042] Publish the canonical entity snapshot and approve or block downstream PIT consumption
...
```json
{
  ...
  "ai_context_notes": [
    ...
    "Read the exact source sections in `jira/sources/issue_source_manifests/POST-SUBTASK-042.json`; inspect only the listed implementation files and prerequisite outputs.",
  ...
  "blocked_reason": "UNSATISFIED_HARD_DEPENDENCIES: POST-SUBTASK-039;POST-SUBTASK-040;POST-SUBTASK-041",
  "blocks": [
    "POST-EPIC-005",
    "POST-STORY-015",
    "POST-SUBTASK-043",
  ...
  "completion_evidence_contract": {
    ...
    "downstream_consumer": "POST-STORY-014",
  ...
  "critical_path": true,
  "definition_of_done": [
    "The atomic scope in POST-SUBTASK-042 is completed without absorbing sibling work or weakening any protected requirement, control, split, judging rule, private-research publication boundary, or security boundary.",
    ...
    "The Story gate consumes the complete prerequisite evidence set and issues an explicit downstream approval/block/reject/defer decision for POST-STORY-014."
  ],
  "dependencies": [
    "POST-SUBTASK-039",
    "POST-SUBTASK-040",
  ...
  "generated_markdown": "jira/issues/subtasks/POST-SUBTASK-042_publish_the_canonical_entity_snapshot_and_approve_or_block_downstream_pit_consum.md",
  ...
  "local_id": "POST-SUBTASK-042",
  "maturity_before": "FUNCTIONAL_STARTER",
  "objective": "Publish the canonical entity snapshot and approve or block downstream PIT consumption",
  "operational_jira": {
    "assignee": "",
    "jira_issue_id": "24532",
    "jira_updated_at": "2026-08-09T00:04:55.807-0500",
  ...
  "prerequisites": [
    ...
    "Dependency POST-SUBTASK-041 complete at required maturity"
  ],
  "primary_source_refs": [
    "SRCREF-02019",
    "SRCREF-02020",
  ...
  "required_tests": [
    {
      ...
      "expectation": "Run as a regression check after completing POST-SUBTASK-042; retain command, exit code, and relevant output.",
    ...
    },
    {
      ...
      "path": "artifacts/entities/CANONICAL_ENTITY_SNAPSHOT.json",
  ...
  "risk_failure_conditions": [
    "The work would be invalid if any prerequisite artifact, source/data/code/config identity, or declared maturity differs from the pinned issue contract for POST-SUBTASK-042.",
    ...
    "Acceptance failure: the evidence cannot demonstrate that coverage/ambiguity/collision/orphan metrics are reported by domain/source/season/entity class; high-impact unresolved identities block affected work and GAP-004 closes only on population evidence.",
  ...
  "specificity_fingerprint": "e0a813732af2b63165d8cc3936aea18ab5ad3f2dc9a08f79a607a3057d7d6e24",
  "stop_conditions": [
...
1. The atomic scope in POST-SUBTASK-042 is completed without absorbing sibling work or weakening any protected requirement, control, split, judging rule, private-research publication boundary, or security boundary.
...
7. The Story gate consumes the complete prerequisite evidence set and issues an explicit downstream approval/block/reject/defer decision for POST-STORY-014.
