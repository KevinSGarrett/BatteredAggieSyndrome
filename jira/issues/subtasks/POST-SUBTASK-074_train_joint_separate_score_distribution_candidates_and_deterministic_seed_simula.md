<!-- GENERATED VIEW. Canonical record: jira/records/issues/subtasks/POST-SUBTASK-074_train_joint_separate_score_distribution_candidates_and_deterministic_seed_simula.json -->
# POST-SUBTASK-074 — [POST-SUBTASK-074] Train joint/separate score-distribution candidates and deterministic-seed simulations deriving margin, win, score, total, interval, and severity outputs coherently
...
```json
{
  ...
  "adr_ids": [],
  "ai_context_notes": [
    "Canonical parent Story: POST-STORY-025. Governance traceability gate: POST-SUBTASK-078. Inherited traceability is resolved through `jira/index/ISSUE_GOVERNANCE_CONTEXT.csv`.",
    "Read the exact source sections in `jira/sources/issue_source_manifests/POST-SUBTASK-074.json`; inspect only the listed implementation files and prerequisite outputs.",
  ...
  "blocked_reason": "UNSATISFIED_HARD_DEPENDENCIES: POST-SUBTASK-072;POST-SUBTASK-073",
  "blocks": [
    "POST-SUBTASK-075"
  ],
  "canonical_record": "jira/records/issues/subtasks/POST-SUBTASK-074_train_joint_separate_score_distribution_candidates_and_deterministic_seed_simula.json",
  "canonical_source_role": "AUTHORITATIVE_LOCAL_SPECIFICATION",
  "completion_evidence_contract": {
    "acceptance_matrix_required": true,
    "artifact_hashes_required": true,
    "completion_claim_limit": "EMPIRICALLY_VALIDATED",
    "downstream_consumer": "POST-SUBTASK-075",
  ...
  "critical_path": false,
  "definition_of_done": [
    "The atomic scope in POST-SUBTASK-074 is completed without absorbing sibling work or weakening any protected requirement, control, split, judging rule, private-research publication boundary, or security boundary.",
    ...
    "The output set `artifacts/modeling/joint_distribution_runs.json` is demonstrably consumable by POST-SUBTASK-075 without manual reconstruction or undocumented state."
  ],
  "dependencies": [
    "POST-SUBTASK-072",
    "POST-SUBTASK-073"
  ...
  "end_to_end_validation": "Validate that `artifacts/modeling/joint_distribution_runs.json` can be parsed and consumed by `POST-SUBTASK-075` using only documented identities and interfaces; the consumer must reject missing, stale, schema-incompatible, technically or quality-ineligible, or provenance-incomplete input without manual repair.",
  "epic_id": "POST-EPIC-008",
  "evidence_manifest_path": "artifacts/jira_evidence/POST-SUBTASK-074.json",
  ...
  "gap_ids": [],
  "generated_markdown": "jira/issues/subtasks/POST-SUBTASK-074_train_joint_separate_score_distribution_candidates_and_deterministic_seed_simula.md",
  ...
  "local_id": "POST-SUBTASK-074",
  "maturity_before": "FUNCTIONAL_STARTER",
  "objective": "Train joint/separate score-distribution candidates and deterministic-seed simulations deriving margin, win, score, total, interval, and severity outputs coherently",
  "operational_jira": {
    "assignee": "",
    "jira_issue_id": "24564",
    "jira_updated_at": "2026-08-09T23:24:06.991-0500",
  ...
  "phase": "PHASE-1",
  "prerequisites": [
    "Dependency POST-SUBTASK-072 complete at required maturity",
    "Dependency POST-SUBTASK-073 complete at required maturity"
  ],
  "primary_source_refs": [
    "SRCREF-02049",
    "SRCREF-02050",
  ...
  "required_tests": [
    {
      ...
      "expectation": "Run as a regression check after completing POST-SUBTASK-074; retain command, exit code, and relevant output.",
    ...
    },
    {
      ...
      "path": "artifacts/modeling/joint_distribution_runs.json",
  ...
  "risk_failure_conditions": [
    "The work would be invalid if any prerequisite artifact, source/data/code/config identity, or declared maturity differs from the pinned issue contract for POST-SUBTASK-074.",
    "A command may exit successfully while producing stale, partial, synthetic-only, leakage-contaminated, non-reproducible, or legally unusable evidence.",
    "Acceptance failure: the evidence cannot demonstrate that derived outputs come from coherent score distributions, persist simulation identities, handle overtime/ties/extremes, and widen uncertainty under missing/OOD inputs rather than becoming confident.",
    "Acceptance failure: the evidence cannot demonstrate that the declared output `artifacts/modeling/joint_distribution_runs.json` is produced with deterministic identity, provenance, and validation metadata appropriate to this work.",
  ...
  "specificity_fingerprint": "a8919aefcbf476cc0136b96889f23b3e1ef5c3a8a3d3dd7f71a84507c7779a68",
  "stop_conditions": [
  ...
  "title": "[POST-SUBTASK-074] Train joint/separate score-distribution candidates and deterministic-seed simulations deriving margin, win, score, total, interval, and severity outputs coherently",
  ...
  "why_this_exists": "This is an independently executable and verifiable work unit required by Story POST-STORY-025: Simple, rating, linear, tree, market, and coherent joint-score candidates.",
  "work_packet_path": "jira/ai/work_packets/POST-SUBTASK-074.md",
...
1. The atomic scope in POST-SUBTASK-074 is completed without absorbing sibling work or weakening any protected requirement, control, split, judging rule, private-research publication boundary, or security boundary.
...
7. The output set `artifacts/modeling/joint_distribution_runs.json` is demonstrably consumable by POST-SUBTASK-075 without manual reconstruction or undocumented state.
...
Validate that `artifacts/modeling/joint_distribution_runs.json` can be parsed and consumed by `POST-SUBTASK-075` using only documented identities and interfaces; the consumer must reject missing, stale, schema-incompatible, technically or quality-ineligible, or provenance-incomplete input without manual repair.
