...
1. `jira/records/issues/stories/POST-STORY-015_known_at_registry_and_timestamp_normalization.json`
2. `jira/sources/issue_source_manifests/POST-STORY-015.json`
3. `jira/index/ISSUE_GOVERNANCE_CONTEXT.csv` row for `POST-STORY-015`.
