...
```json
{
  ...
  "critical_path": false,
  "definition_of_done": [
    "The atomic scope in POST-SUBTASK-139 is completed without absorbing sibling work or weakening any protected requirement, control, split, judging rule, rights decision, or security boundary.",
  ...
  "end_to_end_validation": "Validate that `docs/operations/PRODUCTION_OPERATOR_GUIDE.md` can be parsed and consumed by `POST-SUBTASK-140` using only documented identities and interfaces; the consumer must reject missing, stale, schema-incompatible, rights-blocked, or provenance-incomplete input without manual repair.",
  ...
  "specificity_fingerprint": "7a5c5797e8d605c4086bb313ebdb481d1443ed7ee34fe6ae3157a2f2ec76ce6f",
  "stop_conditions": [
...
1. The atomic scope in POST-SUBTASK-139 is completed without absorbing sibling work or weakening any protected requirement, control, split, judging rule, rights decision, or security boundary.
