...
1. `jira/records/issues/epics/POST-EPIC-018_governed_optional_openai_assistive_research_and_data_engineering_plane.json`
2. `jira/sources/issue_source_manifests/POST-EPIC-018.json`
3. `jira/index/ISSUE_GOVERNANCE_CONTEXT.csv` row for `POST-EPIC-018`.
