<!-- GENERATED VIEW. Canonical record: jira/records/issues/subtasks/POST-SUBTASK-157_run_sealed_event_time_chronological_evaluation_with_precommitted_accuracy_calibr.json -->
# POST-SUBTASK-157 — [POST-SUBTASK-157] Run sealed event-time chronological evaluation with precommitted accuracy/calibration/latency/reliability/outage metrics and simple/pregame baselines
...
```json
{
  ...
  "ai_context_notes": [
    ...
    "Read the exact source sections in `jira/sources/issue_source_manifests/POST-SUBTASK-157.json`; inspect only the listed implementation files and prerequisite outputs.",
  ...
  "canonical_record": "jira/records/issues/subtasks/POST-SUBTASK-157_run_sealed_event_time_chronological_evaluation_with_precommitted_accuracy_calibr.json",
  "canonical_source_role": "AUTHORITATIVE_LOCAL_SPECIFICATION",
  "completion_evidence_contract": {
    "acceptance_matrix_required": true,
    "artifact_hashes_required": true,
    "completion_claim_limit": "IMPLEMENTED",
    "downstream_consumer": "POST-SUBTASK-158",
  ...
  "critical_path": false,
  "definition_of_done": [
    "The atomic scope in POST-SUBTASK-157 is completed without absorbing sibling work or weakening any protected requirement, control, split, judging rule, rights decision, or security boundary.",
    ...
    "The output set `artifacts/live/live_protected_scorecard.json` is demonstrably consumable by POST-SUBTASK-158 without manual reconstruction or undocumented state."
  ],
  "dependencies": [
    "POST-SUBTASK-156"
  ],
  ...
  "end_to_end_validation": "Validate that `artifacts/live/live_protected_scorecard.json` can be parsed and consumed by `POST-SUBTASK-158` using only documented identities and interfaces; the consumer must reject missing, stale, schema-incompatible, rights-blocked, or provenance-incomplete input without manual repair.",
  "epic_id": "POST-EPIC-017",
  "evidence_manifest_path": "artifacts/jira_evidence/POST-SUBTASK-157.json",
  ...
  "gap_ids": [],
  "generated_markdown": "jira/issues/subtasks/POST-SUBTASK-157_run_sealed_event_time_chronological_evaluation_with_precommitted_accuracy_calibr.md",
  ...
  "local_id": "POST-SUBTASK-157",
  "maturity_before": "DEFERRED",
  "objective": "Run sealed event-time chronological evaluation with precommitted accuracy/calibration/latency/reliability/outage metrics and simple/pregame baselines",
  "operational_jira": {
    "assignee": "",
    "jira_issue_id": "24647",
    "jira_updated_at": "2026-08-09T00:04:14.894-0500",
  ...
  "required_tests": [
    {
      ...
      "path": "artifacts/live/live_protected_scorecard.json",
  ...
  "risk_failure_conditions": [
    "The work would be invalid if any prerequisite artifact, source/data/code/config identity, or declared maturity differs from the pinned issue contract for POST-SUBTASK-157.",
    "A command may exit successfully while producing stale, partial, synthetic-only, leakage-contaminated, non-reproducible, or legally unusable evidence.",
    "Acceptance failure: the evidence cannot demonstrate that protected outcomes cannot tune event handling/thresholds/model selection, all outage/delay scenarios and uncertainty are reported, and comparison includes pregame-only/simple live baselines.",
    "Acceptance failure: the evidence cannot demonstrate that the declared output `artifacts/live/live_protected_scorecard.json` is produced with deterministic identity, provenance, and validation metadata appropriate to this work.",
  ...
  "risk_ids": [],
  "schema_version": 2,
  "scope": "Execute the atomic 1 of 3 step in Story POST-STORY-053 (Separate protected evaluation, product integration, and operating authorization): Run sealed event-time chronological evaluation with precommitted accuracy/calibration/latency/reliability/outage metrics and simple/pregame baselines. Consume only verified prerequisite outputs from `POST-SUBTASK-156`. Produce `artifacts/live/live_protected_scorecard.json`; evaluate every issue-specific acceptance condition; preserve negative results; and hand the pinned output to POST-SUBTASK-158.",
  "source_ids": [
    "GAP-014",
    "HANDOFF-014",
    "TASK-169",
  ...
  "specificity_fingerprint": "605bc84d03ee3ed316343c4f996e76f9f88eedb9c466d898e5d6bc4eb7f9fce9",
  "stop_conditions": [
  ...
  "title": "[POST-SUBTASK-157] Run sealed event-time chronological evaluation with precommitted accuracy/calibration/latency/reliability/outage metrics and simple/pregame baselines",
  ...
  "work_packet_path": "jira/ai/work_packets/POST-SUBTASK-157.md",
...
1. The atomic scope in POST-SUBTASK-157 is completed without absorbing sibling work or weakening any protected requirement, control, split, judging rule, rights decision, or security boundary.
...
7. The output set `artifacts/live/live_protected_scorecard.json` is demonstrably consumable by POST-SUBTASK-158 without manual reconstruction or undocumented state.
...
Validate that `artifacts/live/live_protected_scorecard.json` can be parsed and consumed by `POST-SUBTASK-158` using only documented identities and interfaces; the consumer must reject missing, stale, schema-incompatible, rights-blocked, or provenance-incomplete input without manual repair.
