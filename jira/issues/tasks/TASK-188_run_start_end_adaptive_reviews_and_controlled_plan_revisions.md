<!-- GENERATED VIEW. Canonical record: jira/records/issues/tasks/TASK-188_run_start_end_adaptive_reviews_and_controlled_plan_revisions.json -->
# TASK-188 — [TASK-188] Run start/end adaptive reviews and controlled plan revisions
...
```json
{
  ...
  "acceptance_criteria": [
    "Stable ID TASK-188, parent EPIC-033, owner wave W06-W25, and original status DONE are preserved.",
  ...
  "allowed_modification_paths": [
    "adaptive change/plan revision records"
  ],
  "blocked_reason": "",
  "blocks": [],
  "canonical_record": "jira/records/issues/tasks/TASK-188_run_start_end_adaptive_reviews_and_controlled_plan_revisions.json",
  ...
  "gap_ids": [],
  "generated_markdown": "jira/issues/tasks/TASK-188_run_start_end_adaptive_reviews_and_controlled_plan_revisions.md",
  ...
  "operational_jira": {
    "assignee": "",
    "jira_issue_id": "24458",
    "jira_updated_at": "2026-08-09T00:40:50.137-0500",
  ...
  "required_evidence": [
    "Authoritative WBS row TASK-188",
    "Existing artifact `adaptive change/plan revision records`"
  ],
  "required_tests": [
    {
  ...
  "risk_ids": [],
  "schema_version": 2,
  "scope": "Original task type GOVERNANCE with mutation scope: as defined by its source documents.",
  "source_ids": [
    "TASK-188"
  ],
  "source_refs": [
  ...
  "specificity_fingerprint": "1834e47b17cf9340566f28c88359c14c54d1987ed06b96f7eb75cab5357f98bc",
  "stop_conditions": [
  ...
  "title": "[TASK-188] Run start/end adaptive reviews and controlled plan revisions",
...
Run start/end adaptive reviews and controlled plan revisions
...
Original task type GOVERNANCE with mutation scope: as defined by its source documents.
...
- Inherited from: None
- Resolution: `DIRECT`
- Effective counts: `{"acceptance_control_ids": 3, "adr_ids": 0, "gap_ids": 0, "requirement_ids": 7, "risk_ids": 0}`

## Acceptance Criteria

1. Stable ID TASK-188, parent EPIC-033, owner wave W06-W25, and original status DONE are preserved.
