...
```json
{
  ...
  "ai_context_notes": [
    ...
    "Read the exact source sections in `jira/sources/issue_source_manifests/POST-SUBTASK-025.json`; inspect only the listed implementation files and prerequisite outputs.",
  ...
  "blocked_reason": "UNSATISFIED_HARD_DEPENDENCIES: POST-SUBTASK-006;POST-SUBTASK-018;POST-SUBTASK-021;POST-SUBTASK-022",
  "blocks": [
    "POST-SUBTASK-026",
    "POST-SUBTASK-027"
  ],
  ...
  "completion_evidence_contract": {
    ...
    "downstream_consumer": "POST-SUBTASK-026",
  ...
  "gap_ids": [],
  "generated_markdown": "jira/issues/subtasks/POST-SUBTASK-025_acquire_approved_national_team_schedule_game_score_drive_play_box_score_and_game.md",
  ...
  "required_tests": [
    ...
    },
    {
      ...
      "path": "NEW_TEST_REQUIRED::POST-SUBTASK-025",
      "validation_class": "NEW_AUTOMATED_TEST_REQUIRED"
    }
  ],
  "requirement_ids": [],
  "risk_failure_conditions": [
    "The work would be invalid if any prerequisite artifact, source/data/code/config identity, or declared maturity differs from the pinned issue contract for POST-SUBTASK-025.",
    ...
    "Acceptance failure: the evidence cannot demonstrate that the declared output `artifacts/data_lake/core_acquisition_manifest.json` is produced with deterministic identity, provenance, and validation metadata appropriate to this work.",
