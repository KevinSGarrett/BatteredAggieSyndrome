...
1. `jira/records/issues/stories/POST-STORY-020_screening_ablation_stability_and_promotion.json`
2. `jira/sources/issue_source_manifests/POST-STORY-020.json`
3. `jira/index/ISSUE_GOVERNANCE_CONTEXT.csv` row for `POST-STORY-020`.
