<!-- GENERATED VIEW. Canonical record: jira/records/issues/stories/POST-STORY-021_historical_player_roster_depth_value_replacement_and_availability.json -->
# POST-STORY-021 — [POST-STORY-021] Historical player, roster, depth, value, replacement, and availability
...
```json
{
  ...
  "allowed_modification_paths": [
    "artifacts/jira_evidence/POST-STORY-021.json"
  ],
  "blocked_reason": "",
  "blocks": [],
  "canonical_record": "jira/records/issues/stories/POST-STORY-021_historical_player_roster_depth_value_replacement_and_availability.json",
  "canonical_source_role": "AUTHORITATIVE_LOCAL_SPECIFICATION",
  "completion_evidence_contract": {
    "all_child_evidence_required": true,
    "child_gate": "POST-SUBTASK-063",
  ...
  "critical_path": false,
  "definition_of_done": [
    "All child subtasks POST-SUBTASK-061, POST-SUBTASK-062, POST-SUBTASK-063 have verified evidence or an explicit accepted-risk/deferred/cancelled disposition consistent with the Story contract.",
    "The final gate `POST-SUBTASK-063` completes and proves the Story end-to-end requirement; closing implementation children alone is insufficient.",
  ...
  "end_to_end_validation": "At any historical cutoff the system can reconstruct expected players, depth, availability probabilities, replacement options, and uncertainty from evidence.",
  "epic_id": "POST-EPIC-007",
  "evidence_manifest_path": "artifacts/jira_evidence/POST-STORY-021.json",
  ...
  "gap_ids": [],
  "generated_markdown": "jira/issues/stories/POST-STORY-021_historical_player_roster_depth_value_replacement_and_availability.md",
  "governance_review_required": false,
  "governance_traceability_gate": "POST-SUBTASK-069",
  "historical_classification": "ACTIONABLE_POST_WAVE",
  "import_id": 100071,
  "in_scope": [
    "Complete and verify child `POST-SUBTASK-061` — Materialize effective-dated roster, depth, position, participation, eligibility, transfer, and role state.",
    "Complete and verify child `POST-SUBTASK-062` — Estimate leakage-safe player value, replacement distributions, and timestamped availability probabilities.",
    "Complete and verify child `POST-SUBTASK-063` — Validate player-state coverage, uncertainty, double-counting controls, and production eligibility.",
    "Integrate the child outputs and execute final gate `POST-SUBTASK-063`.",
  ...
  "operational_jira": {
    "assignee": "",
    "jira_issue_id": "24211",
    "jira_updated_at": "2026-08-09T00:03:36.610-0500",
  ...
  "related_to": [],
  "required_evidence": [
    "Verified child completion/evidence manifests for POST-SUBTASK-061, POST-SUBTASK-062, POST-SUBTASK-063.",
    "Final gate decision from `POST-SUBTASK-063` with criterion-by-criterion PASS/FAIL/BLOCKED outcomes and output hashes.",
  ...
  "required_tests": [
    ...
    },
    {
      ...
      "expectation": "The final child gate `POST-SUBTASK-063` must prove the integrated Story outcome and downstream-consumable output.",
  ...
  "risk_ids": [],
  "schema_version": 2,
  "scope": "Deliver Story POST-STORY-021 (Historical player, roster, depth, value, replacement, and availability) as one coherent, gated capability inside Epic POST-EPIC-007. Execute child subtasks POST-SUBTASK-061, POST-SUBTASK-062, POST-SUBTASK-063 in dependency order, reconcile their pinned outputs, and require the final gate `POST-SUBTASK-063` to issue an evidence-backed approve/block/reject/defer decision before any downstream use.",
  "source_ids": [
    "GAP-006",
    "HANDOFF-008"
  ],
  ...
  "title": "[POST-STORY-021] Historical player, roster, depth, value, replacement, and availability",
  ...
  "work_packet_path": "jira/ai/work_packets/POST-STORY-021.md",
...
Build PIT player intelligence that represents who was expected to play and the value at risk.
...
Deliver Story POST-STORY-021 (Historical player, roster, depth, value, replacement, and availability) as one coherent, gated capability inside Epic POST-EPIC-007. Execute child subtasks POST-SUBTASK-061, POST-SUBTASK-062, POST-SUBTASK-063 in dependency order, reconcile their pinned outputs, and require the final gate `POST-SUBTASK-063` to issue an evidence-backed approve/block/reject/defer decision before any downstream use.
...
1. All child subtasks POST-SUBTASK-061, POST-SUBTASK-062, POST-SUBTASK-063 have verified evidence or an explicit accepted-risk/deferred/cancelled disposition consistent with the Story contract.
2. The final gate `POST-SUBTASK-063` completes and proves the Story end-to-end requirement; closing implementation children alone is insufficient.
...
- **END_TO_END** / `END_TO_END` — `POST-SUBTASK-063` — The final child gate `POST-SUBTASK-063` must prove the integrated Story outcome and downstream-consumable output.
...
At any historical cutoff the system can reconstruct expected players, depth, availability probabilities, replacement options, and uncertainty from evidence.
