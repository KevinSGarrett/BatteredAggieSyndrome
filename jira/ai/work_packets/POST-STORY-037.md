...
1. `jira/records/issues/stories/POST-STORY-037_governed_retraining_promotion_immutable_forecasts_and_activation.json`
2. `jira/sources/issue_source_manifests/POST-STORY-037.json`
3. `jira/index/ISSUE_GOVERNANCE_CONTEXT.csv` row for `POST-STORY-037`.
