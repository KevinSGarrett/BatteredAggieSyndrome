...
from aggie_analytics.data.tamu_ncaa_contest_route_discovery import materialize  # noqa: E402


def main() -> int:
    parser = argparse.ArgumentParser(
        description="Materialize bounded 2010-2011 Texas A&M NCAA contest-ID route discovery."
    )
