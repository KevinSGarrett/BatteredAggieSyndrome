<!-- GENERATED VIEW. Canonical record: jira/records/issues/tasks/TASK-065_define_weather_forecast_versus_observed_weather_contracts.json -->
# TASK-065 — [TASK-065] Define weather forecast versus observed-weather contracts
...
```json
{
  ...
  "acceptance_criteria": [
    "Stable ID TASK-065, parent EPIC-012, owner wave W13, and original status DONE are preserved.",
  ...
  "canonical_record": "jira/records/issues/tasks/TASK-065_define_weather_forecast_versus_observed_weather_contracts.json",
  ...
  "gap_ids": [],
  "generated_markdown": "jira/issues/tasks/TASK-065_define_weather_forecast_versus_observed_weather_contracts.md",
  ...
  "objective": "Define weather forecast versus observed-weather contracts",
  "operational_jira": {
    "assignee": "",
    "jira_issue_id": "24308",
    "jira_updated_at": "2026-08-09T00:40:28.115-0500",
  ...
  "required_evidence": [
    "Authoritative WBS row TASK-065",
    "Existing artifact `weather snapshot feature contract`"
  ],
  "required_tests": [
    {
  ...
  "specificity_fingerprint": "fa550fbce7ab93ae37b03908ffbee5fed807c10005879633a7db5d6990b34b88",
  "stop_conditions": [
  ...
  "title": "[TASK-065] Define weather forecast versus observed-weather contracts",
...
Define weather forecast versus observed-weather contracts
...
1. Stable ID TASK-065, parent EPIC-012, owner wave W13, and original status DONE are preserved.
