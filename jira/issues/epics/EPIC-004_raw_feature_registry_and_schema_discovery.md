<!-- GENERATED VIEW. Canonical record: jira/records/issues/epics/EPIC-004_raw_feature_registry_and_schema_discovery.json -->
# EPIC-004 — [EPIC-004] Raw feature registry and schema discovery
...
```json
{
  ...
  "acceptance_criteria": [
    "The epic retains stable ID EPIC-004, owner wave W09, phase PHASE-1, and all authoritative WBS children.",
  ...
  "blocked_reason": "",
  "blocks": [],
  "canonical_record": "jira/records/issues/epics/EPIC-004_raw_feature_registry_and_schema_discovery.json",
  ...
  "gap_ids": [],
  "generated_markdown": "jira/issues/epics/EPIC-004_raw_feature_registry_and_schema_discovery.md",
  ...
  "operational_jira": {
    "assignee": "",
    "jira_issue_id": "24144",
    "jira_updated_at": "2026-08-09T00:40:09.683-0500",
  ...
  "specificity_fingerprint": "777dad14543b08b6d09d6d0fc6be9d6e7cb90637d7db43d57b84868bf268ef15",
  "stop_conditions": [
    "Stop if a proposed update renumbers the historical epic or rewrites its original wave provenance."
  ],
  "supporting_source_refs": [],
  "title": "[EPIC-004] Raw feature registry and schema discovery",
...
Build schema discovery and feature metadata so raw fields are classified before engineering/promotion.
...
1. The epic retains stable ID EPIC-004, owner wave W09, phase PHASE-1, and all authoritative WBS children.
