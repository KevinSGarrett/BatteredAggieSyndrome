...
- Cursor has a separate nontransferable USD 200 hard limit, initially releasing USD 20 for two serial safety pilots. It uses exact live model `gpt-5.3-codex`, reasoning low/medium, `fast=false`, isolated branches, `workOnCurrentBranch=false`, and `autoCreatePR=false`. Serial pilot 1 executed on 2026-08-13 as one real candidate-only agent, produced one accepted-with-review-edits result, settled USD 0.26948065, and did not establish operational readiness; pilot 2 and the remaining campaign remain pending.
