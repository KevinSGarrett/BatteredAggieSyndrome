<!-- GENERATED VIEW. Canonical record: jira/records/issues/epics/EPIC-018_scientific_bas_labels_and_cross_fitting.json -->
# EPIC-018 — [EPIC-018] Scientific BAS labels and cross-fitting
...
```json
{
  ...
  "acceptance_criteria": [
    "The epic retains stable ID EPIC-018, owner wave W15, phase PHASE-3, and all authoritative WBS children.",
  ...
  "blocked_reason": "",
  "blocks": [],
  "canonical_record": "jira/records/issues/epics/EPIC-018_scientific_bas_labels_and_cross_fitting.json",
  ...
  "expected_outputs": [
    ...
    "BAS severity label interface",
    "accepted BAS label baseline",
  ...
  "gap_ids": [],
  "generated_markdown": "jira/issues/epics/EPIC-018_scientific_bas_labels_and_cross_fitting.md",
  ...
  "objective": "Formalize leakage-safe performance residuals and BAS severity labels.",
  "operational_jira": {
    "assignee": "",
    "jira_issue_id": "24158",
    "jira_updated_at": "2026-08-09T00:40:13.030-0500",
  ...
  "specificity_fingerprint": "fce8fa3dcead09c3ee05b4432da26952305854dbdf2d3507a03a3278e6a17a98",
  "stop_conditions": [
    "Stop if a proposed update renumbers the historical epic or rewrites its original wave provenance."
  ],
  "supporting_source_refs": [],
  "title": "[EPIC-018] Scientific BAS labels and cross-fitting",
...
Formalize leakage-safe performance residuals and BAS severity labels.
...
1. The epic retains stable ID EPIC-018, owner wave W15, phase PHASE-3, and all authoritative WBS children.
