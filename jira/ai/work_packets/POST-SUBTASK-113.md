# AI Work Packet — POST-SUBTASK-113
...
1. `jira/records/issues/subtasks/POST-SUBTASK-113_run_source_outage_schema_drift_disk_pressure_corrupt_artifact_stale_forecast_int.json`
2. `jira/sources/issue_source_manifests/POST-SUBTASK-113.json`
3. `jira/index/ISSUE_GOVERNANCE_CONTEXT.csv` row for `POST-SUBTASK-113`.
