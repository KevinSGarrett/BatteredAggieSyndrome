...
from aggie_analytics.temporal.weather_previous_runs_snapshot import materialize  # noqa: E402


def main() -> int:
    parser = argparse.ArgumentParser(
        description="Materialize the governed nominal-lead historical previous-run weather candidate snapshot."
    )
