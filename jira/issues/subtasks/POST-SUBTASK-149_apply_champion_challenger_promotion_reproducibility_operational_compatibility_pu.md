...
```json
{
  ...
  "critical_path": false,
  "definition_of_done": [
    "The atomic scope in POST-SUBTASK-149 is completed without absorbing sibling work or weakening any protected requirement, control, split, judging rule, rights decision, or security boundary.",
  ...
  "end_to_end_validation": "Validate that `artifacts/advanced/challenger_promotion_decision.json` can be parsed and consumed by `POST-SUBTASK-150` using only documented identities and interfaces; the consumer must reject missing, stale, schema-incompatible, rights-blocked, or provenance-incomplete input without manual repair.",
  ...
  "operational_jira": {
    "assignee": "",
    "jira_issue_id": "24639",
    "jira_updated_at": "2026-08-09T00:04:13.047-0500",
  ...
  "specificity_fingerprint": "4a388effb30e94b3fed5aff39abc60d587d823e3b007ffd291034b69a333f8c6",
  "stop_conditions": [
...
1. The atomic scope in POST-SUBTASK-149 is completed without absorbing sibling work or weakening any protected requirement, control, split, judging rule, rights decision, or security boundary.
...
Validate that `artifacts/advanced/challenger_promotion_decision.json` can be parsed and consumed by `POST-SUBTASK-150` using only documented identities and interfaces; the consumer must reject missing, stale, schema-incompatible, rights-blocked, or provenance-incomplete input without manual repair.
