<!-- GENERATED VIEW. Canonical record: jira/records/issues/tasks/TASK-075_define_penalty_turnover_field_position_interactions.json -->
# TASK-075 — [TASK-075] Define penalty/turnover/field-position interactions
...
```json
{
  ...
  "acceptance_criteria": [
    "Stable ID TASK-075, parent EPIC-013, owner wave W13, and original status DONE are preserved.",
  ...
  "canonical_record": "jira/records/issues/tasks/TASK-075_define_penalty_turnover_field_position_interactions.json",
  ...
  "gap_ids": [],
  "generated_markdown": "jira/issues/tasks/TASK-075_define_penalty_turnover_field_position_interactions.md",
  ...
  "objective": "Define penalty/turnover/field-position interactions",
  "operational_jira": {
    "assignee": "",
    "jira_issue_id": "24318",
    "jira_updated_at": "2026-08-09T00:40:30.114-0500",
  ...
  "phase": "PHASE-2",
  "prerequisites": [
    "Historical dependency TASK-072",
    "Historical dependency TASK-074"
  ],
  "primary_source_refs": [
    "SRCREF-00108",
    "SRCREF-02116",
  ...
  "required_evidence": [
    "Authoritative WBS row TASK-075",
    "Existing artifact `mechanics interaction candidates`"
  ],
  "required_tests": [
    {
  ...
  "specificity_fingerprint": "45909b97b757eab29fbd54e07bbc804cb77779cfe1218ebd5b241d992d2d9a7f",
  "stop_conditions": [
  ...
  "title": "[TASK-075] Define penalty/turnover/field-position interactions",
...
Define penalty/turnover/field-position interactions
...
1. Stable ID TASK-075, parent EPIC-013, owner wave W13, and original status DONE are preserved.
