# AI Work Packet — POST-SUBTASK-130
...
1. `jira/records/issues/subtasks/POST-SUBTASK-130_finalize_authority_retention_frequency_encryption_access_rights_deletion_rules_f.json`
2. `jira/sources/issue_source_manifests/POST-SUBTASK-130.json`
3. `jira/index/ISSUE_GOVERNANCE_CONTEXT.csv` row for `POST-SUBTASK-130`.
