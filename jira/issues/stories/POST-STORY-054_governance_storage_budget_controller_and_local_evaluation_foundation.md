<!-- GENERATED VIEW. Canonical record: jira/records/issues/stories/POST-STORY-054_governance_storage_budget_controller_and_local_evaluation_foundation.json -->
# POST-STORY-054 — [POST-STORY-054] Governance, storage, budget, controller, and local evaluation foundation
...
```json
{
  ...
  "acceptance_criteria": [
    "The single controller and local evaluation harness satisfy the complete Section 16 authority, storage, schema, budget, provenance, isolation, and cleanup contract.",
    "No paid call occurs until foundation validation and normal review integration pass."
  ],
  "adr_ids": [],
  "ai_context_notes": [
    "Canonical contract source is `SRCREF-02119`. Read `jira/sources/issue_source_manifests/POST-STORY-054.json` before execution.",
  ...
  "blocked_reason": "",
  "blocks": [],
  "canonical_record": "jira/records/issues/stories/POST-STORY-054_governance_storage_budget_controller_and_local_evaluation_foundation.json",
  ...
  "end_to_end_validation": "Integrate POST-SUBTASK-160 and POST-SUBTASK-161 and prove every later API job is forced through their controller, ledger, schema, validation, and evaluation boundaries.",
  "epic_id": "POST-EPIC-018",
  "evidence_manifest_path": "artifacts/jira_evidence/POST-STORY-054.json",
  ...
  "gap_ids": [],
  "generated_markdown": "jira/issues/stories/POST-STORY-054_governance_storage_budget_controller_and_local_evaluation_foundation.md",
  "governance_review_required": false,
  "governance_traceability_gate": "POST-SUBTASK-040",
  ...
  "local_id": "POST-STORY-054",
  "maturity_before": "NOT_STARTED",
  "objective": "Governance, storage, budget, controller, and local evaluation foundation",
  "operational_jira": {
    "assignee": "",
    "jira_issue_id": "24653",
    "jira_updated_at": "2026-08-09T23:18:49.872-0500",
  ...
  "required_tests": [
    ...
    },
    {
      ...
      "expectation": "Integrate POST-SUBTASK-160 and POST-SUBTASK-161 and prove every later API job is forced through their controller, ledger, schema, validation, and evaluation boundaries.",
      "path": "artifacts/jira_evidence/POST-STORY-054.json",
  ...
  "risk_ids": [],
  "schema_version": 2,
  "scope": "Execute POST-STORY-054 within the optional OpenAI assistive plane. Consume `POST-SUBTASK-040`; produce `artifacts/jira_evidence/POST-STORY-054.json`; preserve the deterministic forecast path and candidate-only authority boundary.",
  "source_ids": [
    "OPENAI-ASSIST-PLAN"
  ],
  "source_refs": [
  ...
  "title": "[POST-STORY-054] Governance, storage, budget, controller, and local evaluation foundation",
  ...
  "work_packet_path": "jira/ai/work_packets/POST-STORY-054.md",
