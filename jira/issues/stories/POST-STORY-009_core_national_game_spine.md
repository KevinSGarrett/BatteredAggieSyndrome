<!-- GENERATED VIEW. Canonical record: jira/records/issues/stories/POST-STORY-009_core_national_game_spine.json -->
# POST-STORY-009 — [POST-STORY-009] Core national game spine
...
```json
{
  ...
  "acceptance_criteria": [
    ...
    "The declared output `artifacts/data_lake/core_acquisition_manifest.json` is produced with deterministic identity, provenance, and validation metadata appropriate to this work.",
    ...
    "The declared output `artifacts/data_lake/core_normalization_report.json` is produced with deterministic identity, provenance, and validation metadata appropriate to this work.",
  ...
  "blocked_reason": "",
  "blocks": [],
  "canonical_record": "jira/records/issues/stories/POST-STORY-009_core_national_game_spine.json",
  "canonical_source_role": "AUTHORITATIVE_LOCAL_SPECIFICATION",
  "completion_evidence_contract": {
    "all_child_evidence_required": true,
    "child_gate": "POST-SUBTASK-027",
  ...
  "critical_path": true,
  "definition_of_done": [
    "All child subtasks POST-SUBTASK-025, POST-SUBTASK-026, POST-SUBTASK-027 have verified evidence or an explicit accepted-risk/deferred/cancelled disposition consistent with the Story contract.",
    "The final gate `POST-SUBTASK-027` completes and proves the Story end-to-end requirement; closing implementation children alone is insufficient.",
  ...
  "end_to_end_validation": "A clean acquisition run produces immutable national game history, deterministic normalized evidence, and an honest coverage decision.",
  "epic_id": "POST-EPIC-003",
  "evidence_manifest_path": "artifacts/jira_evidence/POST-STORY-009.json",
  ...
  "gap_ids": [],
  "generated_markdown": "jira/issues/stories/POST-STORY-009_core_national_game_spine.md",
  ...
  "local_id": "POST-STORY-009",
  "maturity_before": "SCAFFOLD",
  "objective": "Materialize teams, conferences, venues, schedules, games, outcomes, drives, plays, and official game evidence.",
  "operational_jira": {
    "assignee": "",
    "jira_issue_id": "24199",
    "jira_updated_at": "2026-08-09T23:23:55.018-0500",
  ...
  "prerequisites": [
    ...
    "Hard dependency POST-SUBTASK-022",
  ...
  "required_tests": [
    ...
    },
    {
      ...
      "expectation": "The final child gate `POST-SUBTASK-027` must prove the integrated Story outcome and downstream-consumable output.",
  ...
  "risk_ids": [],
  "schema_version": 2,
  "scope": "Deliver Story POST-STORY-009 (Core national game spine) as one coherent, gated capability inside Epic POST-EPIC-003. Execute child subtasks POST-SUBTASK-025, POST-SUBTASK-026, POST-SUBTASK-027 in dependency order, reconcile their pinned outputs, and require the final gate `POST-SUBTASK-027` to issue an evidence-backed approve/block/reject/defer decision before any downstream use.",
  "source_ids": [
    "GAP-002",
    "HANDOFF-003"
  ],
  ...
  "specificity_fingerprint": "fb0b7ef6f803249f25c31553f944a005f86362b0808fa652a99c7e6deeb604e0",
  "stop_conditions": [
  ...
  "title": "[POST-STORY-009] Core national game spine",
  ...
  "work_packet_path": "jira/ai/work_packets/POST-STORY-009.md",
...
1. All child subtasks POST-SUBTASK-025, POST-SUBTASK-026, POST-SUBTASK-027 have verified evidence or an explicit accepted-risk/deferred/cancelled disposition consistent with the Story contract.
2. The final gate `POST-SUBTASK-027` completes and proves the Story end-to-end requirement; closing implementation children alone is insufficient.
