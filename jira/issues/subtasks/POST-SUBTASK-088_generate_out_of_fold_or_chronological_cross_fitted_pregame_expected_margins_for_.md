<!-- GENERATED VIEW. Canonical record: jira/records/issues/subtasks/POST-SUBTASK-088_generate_out_of_fold_or_chronological_cross_fitted_pregame_expected_margins_for_.json -->
# POST-SUBTASK-088 — [POST-SUBTASK-088] Generate out-of-fold or chronological cross-fitted pregame expected margins for every eligible historical game
...
```json
{
  ...
  "ai_context_notes": [
    ...
    "Read the exact source sections in `jira/sources/issue_source_manifests/POST-SUBTASK-088.json`; inspect only the listed implementation files and prerequisite outputs.",
  ...
  "canonical_record": "jira/records/issues/subtasks/POST-SUBTASK-088_generate_out_of_fold_or_chronological_cross_fitted_pregame_expected_margins_for_.json",
  "canonical_source_role": "AUTHORITATIVE_LOCAL_SPECIFICATION",
  "completion_evidence_contract": {
    "acceptance_matrix_required": true,
    "artifact_hashes_required": true,
    "completion_claim_limit": "IMPLEMENTED",
    "downstream_consumer": "POST-SUBTASK-089",
  ...
  "gap_ids": [],
  "generated_markdown": "jira/issues/subtasks/POST-SUBTASK-088_generate_out_of_fold_or_chronological_cross_fitted_pregame_expected_margins_for_.md",
  "governance_review_required": false,
  "governance_traceability_gate": "POST-SUBTASK-096",
  "historical_classification": "ACTIONABLE_POST_WAVE",
  "import_id": 100392,
  "in_scope": [
    "Perform the exact action: Generate out-of-fold or chronological cross-fitted pregame expected margins for every eligible historical game.",
    "Consume only verified prerequisite outputs from `POST-SUBTASK-051`, `POST-SUBTASK-078`.",
    ...
    "Demonstrate with saved evidence: The declared output `artifacts/bas/crossfit_expectation_manifest.json` is produced with deterministic identity, provenance, and validation metadata appropriate to this work.",
    "Demonstrate with saved evidence: The work does not fabricate source availability, empirical results, thresholds, model performance, operational readiness, or completion evidence.",
    "Produce, validate, content-hash, and register `artifacts/bas/crossfit_expectation_manifest.json`.",
  ...
  "operational_jira": {
    "assignee": "",
    "jira_issue_id": "24578",
    "jira_updated_at": "2026-08-09T23:24:08.430-0500",
  ...
  "related_to": [],
  "required_evidence": [
    "`artifacts/bas/crossfit_expectation_manifest.json` plus SHA-256/content identity, producer command/version, prerequisite artifact identities, creation time, and validation disposition.",
  ...
  "required_tests": [
    {
      ...
      "expectation": "Run as a regression check after completing POST-SUBTASK-088; retain command, exit code, and relevant output.",
    ...
    },
    {
      ...
      "path": "artifacts/bas/crossfit_expectation_manifest.json",
    ...
    },
    {
      ...
      "path": "NEW_TEST_REQUIRED::POST-SUBTASK-088",
      "validation_class": "NEW_AUTOMATED_TEST_REQUIRED"
    }
  ],
  "requirement_ids": [],
  "risk_failure_conditions": [
    "The work would be invalid if any prerequisite artifact, source/data/code/config identity, or declared maturity differs from the pinned issue contract for POST-SUBTASK-088.",
    ...
    "Acceptance failure: the evidence cannot demonstrate that the declared output `artifacts/bas/crossfit_expectation_manifest.json` is produced with deterministic identity, provenance, and validation metadata appropriate to this work.",
  ...
  "risk_ids": [],
  "schema_version": 2,
  "scope": "Execute the atomic 1 of 3 step in Story POST-STORY-030 (Cross-fitted expectation and protected severity labels): Generate out-of-fold or chronological cross-fitted pregame expected margins for every eligible historical game. Consume only verified prerequisite outputs from `POST-SUBTASK-051`, `POST-SUBTASK-078`. Produce `artifacts/bas/crossfit_expectation_manifest.json`; evaluate every issue-specific acceptance condition; preserve negative results; and hand the pinned output to POST-SUBTASK-089.",
  "source_ids": [
    "AC-020",
    "AC-021",
    "GAP-009",
  ...
  "title": "[POST-SUBTASK-088] Generate out-of-fold or chronological cross-fitted pregame expected margins for every eligible historical game",
  ...
  "work_packet_path": "jira/ai/work_packets/POST-SUBTASK-088.md",
...
Execute the atomic 1 of 3 step in Story POST-STORY-030 (Cross-fitted expectation and protected severity labels): Generate out-of-fold or chronological cross-fitted pregame expected margins for every eligible historical game. Consume only verified prerequisite outputs from `POST-SUBTASK-051`, `POST-SUBTASK-078`. Produce `artifacts/bas/crossfit_expectation_manifest.json`; evaluate every issue-specific acceptance condition; preserve negative results; and hand the pinned output to POST-SUBTASK-089.
...
- **EXISTING_AUTOMATED_TEST** / `REGRESSION` — `tests/test_bas_science_governance.py` — Run as a regression check after completing POST-SUBTASK-088; retain command, exit code, and relevant output.
- **EXISTING_AUTOMATED_TEST** / `REGRESSION` — `tests/test_w20_model_starter.py` — Run as a regression check after completing POST-SUBTASK-088; retain command, exit code, and relevant output.
- **EXISTING_AUTOMATED_TEST** / `REGRESSION` — `tools/validate_bas_science.py` — Run as a regression check after completing POST-SUBTASK-088; retain command, exit code, and relevant output.
- **CHRONOLOGICAL_REPLAY** / `CHRONOLOGICAL_REPLAY` — `artifacts/bas/crossfit_expectation_manifest.json` — Demonstrate cutoff eligibility and negative leakage behavior using pinned chronology; future/same-game/postgame contamination must fail closed.
- **SCIENTIFIC** / `SCIENTIFIC` — `artifacts/bas/crossfit_expectation_manifest.json` — Evaluate the precommitted hypothesis/metric against pinned data and splits; preserve null, negative, unstable, and failed results.
- **CALIBRATION** / `CALIBRATION` — `artifacts/bas/crossfit_expectation_manifest.json` — Report calibration/reliability evidence on the allowed evaluation lane with sample size and uncertainty.
- **INTEGRATION** / `INTEGRATION` — `artifacts/bas/crossfit_expectation_manifest.json` — Prove the produced artifact can be parsed and consumed by the next declared task without manual reconstruction or hidden state.
- **REPRODUCIBILITY** / `REPRODUCIBILITY` — `ISSUE_COMPLETION_MANIFEST` — Record exact source/data/code/config/tool/runtime identities and content hashes needed to reproduce or audit the result.
- **NEW_AUTOMATED_TEST_REQUIRED** / `NEW_AUTOMATED_TEST_REQUIRED` — `NEW_TEST_REQUIRED::POST-SUBTASK-088` — Add the smallest deterministic unit/integration/E2E test that directly proves at least one issue-specific acceptance condition not already covered by an existing test.
