<!-- GENERATED VIEW. Canonical record: jira/records/issues/tasks/TASK-085_implement_coaching_context_mechanics_starter_features.json -->
# TASK-085 — [TASK-085] Implement coaching/context/mechanics starter features
...
```json
{
  ...
  "acceptance_criteria": [
    "Stable ID TASK-085, parent EPIC-015, owner wave W19, and original status DONE are preserved.",
  ...
  "allowed_modification_paths": [
    "context/mechanics starter modules"
  ],
  "blocked_reason": "",
  "blocks": [
    "TASK-086"
  ],
  "canonical_record": "jira/records/issues/tasks/TASK-085_implement_coaching_context_mechanics_starter_features.json",
  ...
  "gap_ids": [],
  "generated_markdown": "jira/issues/tasks/TASK-085_implement_coaching_context_mechanics_starter_features.md",
  ...
  "objective": "Implement coaching/context/mechanics starter features",
  "operational_jira": {
    "assignee": "",
    "jira_issue_id": "24328",
    "jira_updated_at": "2026-08-09T00:40:31.992-0500",
  ...
  "required_evidence": [
    "Authoritative WBS row TASK-085",
    "Existing artifact `context/mechanics starter modules`"
  ],
  "required_tests": [
    {
  ...
  "specificity_fingerprint": "f320ac6aa067f6f85912e9b2512729d11f6e981d1f147c9b746f07f9dd0ed58b",
  "stop_conditions": [
  ...
  "title": "[TASK-085] Implement coaching/context/mechanics starter features",
...
Implement coaching/context/mechanics starter features
...
1. Stable ID TASK-085, parent EPIC-015, owner wave W19, and original status DONE are preserved.
