<!-- GENERATED VIEW. Canonical record: jira/records/issues/tasks/TASK-149_implement_promotion_rollback_prediction_snapshot_workflow.json -->
# TASK-149 — [TASK-149] Implement promotion/rollback/prediction snapshot workflow
...
```json
{
  ...
  "acceptance_criteria": [
    "Stable ID TASK-149, parent EPIC-026, owner wave W21, and original status DONE are preserved.",
  ...
  "allowed_modification_paths": [
    "promotion+rollback+snapshot workflow"
  ],
  "blocked_reason": "",
  "blocks": [
    "TASK-150"
  ],
  "canonical_record": "jira/records/issues/tasks/TASK-149_implement_promotion_rollback_prediction_snapshot_workflow.json",
  ...
  "gap_ids": [],
  "generated_markdown": "jira/issues/tasks/TASK-149_implement_promotion_rollback_prediction_snapshot_workflow.md",
  ...
  "objective": "Implement promotion/rollback/prediction snapshot workflow",
  "operational_jira": {
    "assignee": "",
    "jira_issue_id": "24392",
    "jira_updated_at": "2026-08-09T00:40:44.483-0500",
  ...
  "phase": "PHASE-4",
  "prerequisites": [
    "Historical dependency TASK-148"
  ],
  "primary_source_refs": [
    "SRCREF-00182",
    "SRCREF-02116",
  ...
  "required_evidence": [
    "Authoritative WBS row TASK-149",
    "Existing artifact `promotion+rollback+snapshot workflow`"
  ],
  "required_tests": [
    {
  ...
  "specificity_fingerprint": "aa12cd4e27554a65874ef4955e629fbfc0cfbb4e6f5429f0608cb7701cf7af02",
  "stop_conditions": [
  ...
  "title": "[TASK-149] Implement promotion/rollback/prediction snapshot workflow",
...
Implement promotion/rollback/prediction snapshot workflow
...
1. Stable ID TASK-149, parent EPIC-026, owner wave W21, and original status DONE are preserved.
