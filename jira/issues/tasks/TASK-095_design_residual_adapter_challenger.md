<!-- GENERATED VIEW. Canonical record: jira/records/issues/tasks/TASK-095_design_residual_adapter_challenger.json -->
# TASK-095 — [TASK-095] Design residual-adapter challenger
...
```json
{
  ...
  "acceptance_criteria": [
    "Stable ID TASK-095, parent EPIC-017, owner wave W14, and original status DONE are preserved.",
  ...
  "canonical_record": "jira/records/issues/tasks/TASK-095_design_residual_adapter_challenger.json",
  ...
  "gap_ids": [],
  "generated_markdown": "jira/issues/tasks/TASK-095_design_residual_adapter_challenger.md",
  ...
  "objective": "Design residual-adapter challenger",
  "operational_jira": {
    "assignee": "",
    "jira_issue_id": "24338",
    "jira_updated_at": "2026-08-09T00:40:33.929-0500",
  ...
  "required_evidence": [
    "Authoritative WBS row TASK-095",
    "Existing artifact `residual specialization candidate`"
  ],
  "required_tests": [
    {
  ...
  "specificity_fingerprint": "ac8bb7311c2118fb90324e157c737144d09c19095e79374a27efdd3bc9dcf9d6",
  "stop_conditions": [
  ...
  "title": "[TASK-095] Design residual-adapter challenger",
...
Design residual-adapter challenger
...
1. Stable ID TASK-095, parent EPIC-017, owner wave W14, and original status DONE are preserved.
