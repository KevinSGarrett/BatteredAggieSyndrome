<!-- GENERATED VIEW. Canonical record: jira/records/issues/stories/POST-STORY-007_credential_configuration_and_access_smoke_tests.json -->
# POST-STORY-007 — [POST-STORY-007] Credential configuration and access smoke tests
...
```json
{
  ...
  "blocked_reason": "",
  "blocks": [],
  "canonical_record": "jira/records/issues/stories/POST-STORY-007_credential_configuration_and_access_smoke_tests.json",
  "canonical_source_role": "AUTHORITATIVE_LOCAL_SPECIFICATION",
  "completion_evidence_contract": {
    "all_child_evidence_required": true,
    "child_gate": "POST-SUBTASK-021",
  ...
  "critical_path": true,
  "definition_of_done": [
    "All child subtasks POST-SUBTASK-019, POST-SUBTASK-020, POST-SUBTASK-021 have verified evidence or an explicit accepted-risk/deferred/cancelled disposition consistent with the Story contract.",
    "The final gate `POST-SUBTASK-021` completes and proves the Story end-to-end requirement; closing implementation children alone is insufficient.",
  ...
  "gap_ids": [],
  "generated_markdown": "jira/issues/stories/POST-STORY-007_credential_configuration_and_access_smoke_tests.md",
  ...
  "operational_jira": {
    "assignee": "",
    "jira_issue_id": "24197",
    "jira_updated_at": "2026-08-09T15:42:09.126-0500",
  ...
  "required_tests": [
    ...
    },
    {
      ...
      "expectation": "The final child gate `POST-SUBTASK-021` must prove the integrated Story outcome and downstream-consumable output.",
  ...
  "risk_ids": [],
  "schema_version": 2,
  "scope": "Deliver Story POST-STORY-007 (Credential configuration and access smoke tests) as one coherent, gated capability inside Epic POST-EPIC-002. Execute child subtasks POST-SUBTASK-019, POST-SUBTASK-020, POST-SUBTASK-021 in dependency order, reconcile their pinned outputs, and require the final gate `POST-SUBTASK-021` to issue an evidence-backed approve/block/reject/defer decision before any downstream use.",
  "source_ids": [
    "GAP-010",
    "HANDOFF-002",
    "HANDOFF-012",
  ...
  "title": "[POST-STORY-007] Credential configuration and access smoke tests",
  ...
  "work_packet_path": "jira/ai/work_packets/POST-STORY-007.md",
...
1. All child subtasks POST-SUBTASK-019, POST-SUBTASK-020, POST-SUBTASK-021 have verified evidence or an explicit accepted-risk/deferred/cancelled disposition consistent with the Story contract.
2. The final gate `POST-SUBTASK-021` completes and proves the Story end-to-end requirement; closing implementation children alone is insufficient.
