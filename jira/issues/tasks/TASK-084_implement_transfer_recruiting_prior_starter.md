<!-- GENERATED VIEW. Canonical record: jira/records/issues/tasks/TASK-084_implement_transfer_recruiting_prior_starter.json -->
# TASK-084 — [TASK-084] Implement transfer/recruiting prior starter
...
```json
{
  ...
  "acceptance_criteria": [
    "Stable ID TASK-084, parent EPIC-015, owner wave W19, and original status DONE are preserved.",
  ...
  "canonical_record": "jira/records/issues/tasks/TASK-084_implement_transfer_recruiting_prior_starter.json",
  ...
  "gap_ids": [],
  "generated_markdown": "jira/issues/tasks/TASK-084_implement_transfer_recruiting_prior_starter.md",
  ...
  "objective": "Implement transfer/recruiting prior starter",
  "operational_jira": {
    "assignee": "",
    "jira_issue_id": "24327",
    "jira_updated_at": "2026-08-09T00:40:31.754-0500",
  ...
  "required_evidence": [
    "Authoritative WBS row TASK-084",
    "Existing artifact `transfer/recruiting starter modules`"
  ],
  "required_tests": [
    {
  ...
  "specificity_fingerprint": "ee133f611db342e6c1939b12cddf6edc38b6f76662769449f266704a56039f9d",
  "stop_conditions": [
  ...
  "title": "[TASK-084] Implement transfer/recruiting prior starter",
...
Implement transfer/recruiting prior starter
...
1. Stable ID TASK-084, parent EPIC-015, owner wave W19, and original status DONE are preserved.
