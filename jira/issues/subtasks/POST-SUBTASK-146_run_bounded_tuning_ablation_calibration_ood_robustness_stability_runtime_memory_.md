<!-- GENERATED VIEW. Canonical record: jira/records/issues/subtasks/POST-SUBTASK-146_run_bounded_tuning_ablation_calibration_ood_robustness_stability_runtime_memory_.json -->
# POST-SUBTASK-146 — [POST-SUBTASK-146] Run bounded tuning, ablation, calibration, OOD, robustness, stability, runtime, memory, maintainability, and simple-baseline comparisons retaining all failures
...
```json
{
  ...
  "acceptance_criteria": [
    ...
    "The declared output `artifacts/advanced/challenger_tuning_scorecard.json` is produced with deterministic identity, provenance, and validation metadata appropriate to this work.",
  ...
  "ai_context_notes": [
    ...
    "Read the exact source sections in `jira/sources/issue_source_manifests/POST-SUBTASK-146.json`; inspect only the listed implementation files and prerequisite outputs.",
  ...
  "canonical_record": "jira/records/issues/subtasks/POST-SUBTASK-146_run_bounded_tuning_ablation_calibration_ood_robustness_stability_runtime_memory_.json",
  "canonical_source_role": "AUTHORITATIVE_LOCAL_SPECIFICATION",
  "completion_evidence_contract": {
    "acceptance_matrix_required": true,
    "artifact_hashes_required": true,
    "completion_claim_limit": "EMPIRICALLY_VALIDATED",
    "downstream_consumer": "POST-SUBTASK-147",
  ...
  "critical_path": false,
  "definition_of_done": [
    "The atomic scope in POST-SUBTASK-146 is completed without absorbing sibling work or weakening any protected requirement, control, split, judging rule, private-research publication boundary, or security boundary.",
    ...
    "The output set `artifacts/advanced/challenger_tuning_scorecard.json` is demonstrably consumable by POST-SUBTASK-147 without manual reconstruction or undocumented state."
  ],
  "dependencies": [
    "POST-SUBTASK-144",
    "POST-SUBTASK-145"
  ...
  "end_to_end_validation": "Validate that `artifacts/advanced/challenger_tuning_scorecard.json` can be parsed and consumed by `POST-SUBTASK-147` using only documented identities and interfaces; the consumer must reject missing, stale, schema-incompatible, technically or quality-ineligible, or provenance-incomplete input without manual repair.",
  "epic_id": "POST-EPIC-016",
  "evidence_manifest_path": "artifacts/jira_evidence/POST-SUBTASK-146.json",
  ...
  "gap_ids": [],
  "generated_markdown": "jira/issues/subtasks/POST-SUBTASK-146_run_bounded_tuning_ablation_calibration_ood_robustness_stability_runtime_memory_.md",
  ...
  "local_id": "POST-SUBTASK-146",
  "maturity_before": "CONDITIONAL",
  "objective": "Run bounded tuning, ablation, calibration, OOD, robustness, stability, runtime, memory, maintainability, and simple-baseline comparisons retaining all failures",
  "operational_jira": {
    "assignee": "",
    "jira_issue_id": "24636",
    "jira_updated_at": "2026-08-09T23:24:14.517-0500",
  ...
  "required_tests": [
    {
      ...
      "expectation": "Run as a regression check after completing POST-SUBTASK-146; retain command, exit code, and relevant output.",
    ...
    },
    {
      ...
      "path": "artifacts/advanced/challenger_tuning_scorecard.json",
  ...
  "risk_failure_conditions": [
    "The work would be invalid if any prerequisite artifact, source/data/code/config identity, or declared maturity differs from the pinned issue contract for POST-SUBTASK-146.",
    ...
    "Acceptance failure: the evidence cannot demonstrate that the declared output `artifacts/advanced/challenger_tuning_scorecard.json` is produced with deterministic identity, provenance, and validation metadata appropriate to this work.",
  ...
  "specificity_fingerprint": "b9211860c15e7126ae9b82ed3b697c77399822b1fc6830aa1804a357c516d1cd",
  "stop_conditions": [
  ...
  "title": "[POST-SUBTASK-146] Run bounded tuning, ablation, calibration, OOD, robustness, stability, runtime, memory, maintainability, and simple-baseline comparisons retaining all failures",
  ...
  "work_packet_path": "jira/ai/work_packets/POST-SUBTASK-146.md",
...
1. The atomic scope in POST-SUBTASK-146 is completed without absorbing sibling work or weakening any protected requirement, control, split, judging rule, private-research publication boundary, or security boundary.
...
7. The output set `artifacts/advanced/challenger_tuning_scorecard.json` is demonstrably consumable by POST-SUBTASK-147 without manual reconstruction or undocumented state.
...
Validate that `artifacts/advanced/challenger_tuning_scorecard.json` can be parsed and consumed by `POST-SUBTASK-147` using only documented identities and interfaces; the consumer must reject missing, stale, schema-incompatible, technically or quality-ineligible, or provenance-incomplete input without manual repair.
