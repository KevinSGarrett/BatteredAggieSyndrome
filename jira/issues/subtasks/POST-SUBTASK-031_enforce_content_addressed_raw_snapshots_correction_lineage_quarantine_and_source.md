...
```json
{
  ...
  "ai_context_notes": [
    ...
    "Read the exact source sections in `jira/sources/issue_source_manifests/POST-SUBTASK-031.json`; inspect only the listed implementation files and prerequisite outputs.",
  ...
  "canonical_record": "jira/records/issues/subtasks/POST-SUBTASK-031_enforce_content_addressed_raw_snapshots_correction_lineage_quarantine_and_source.json",
  "canonical_source_role": "AUTHORITATIVE_LOCAL_SPECIFICATION",
  "completion_evidence_contract": {
    "acceptance_matrix_required": true,
    "artifact_hashes_required": true,
    "completion_claim_limit": "IMPLEMENTED",
    "downstream_consumer": "POST-SUBTASK-032",
  ...
  "gap_ids": [],
  "generated_markdown": "jira/issues/subtasks/POST-SUBTASK-031_enforce_content_addressed_raw_snapshots_correction_lineage_quarantine_and_source.md",
  ...
  "operational_jira": {
    "assignee": "",
    "jira_issue_id": "24521",
    "jira_updated_at": "2026-08-09T17:12:34.500-0500",
    "last_synced_at": "2026-08-09T22:16:21.651283+00:00",
    "source_export": "C:\\BatteredAggieSyndrome.data\\runtime\\BAT-381\\BAT-381-live-row.csv",
    "sprint": "",
  ...
  "required_tests": [
    {
      ...
      "expectation": "Run as a regression check after completing POST-SUBTASK-031; retain command, exit code, and relevant output.",
    ...
    },
    {
      ...
      "path": "artifacts/data_lake/immutability_and_correction_test.json",
    ...
    },
    {
      ...
      "path": "NEW_TEST_REQUIRED::POST-SUBTASK-031",
      "validation_class": "NEW_AUTOMATED_TEST_REQUIRED"
    }
  ],
  "requirement_ids": [],
  "risk_failure_conditions": [
    "The work would be invalid if any prerequisite artifact, source/data/code/config identity, or declared maturity differs from the pinned issue contract for POST-SUBTASK-031.",
    ...
    "Acceptance failure: the evidence cannot demonstrate that the declared output `artifacts/data_lake/immutability_and_correction_test.json` is produced with deterministic identity, provenance, and validation metadata appropriate to this work.",
  ...
  "work_packet_path": "jira/ai/work_packets/POST-SUBTASK-031.md",
