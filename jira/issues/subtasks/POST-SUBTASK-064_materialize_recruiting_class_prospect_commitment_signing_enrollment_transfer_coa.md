<!-- GENERATED VIEW. Canonical record: jira/records/issues/subtasks/POST-SUBTASK-064_materialize_recruiting_class_prospect_commitment_signing_enrollment_transfer_coa.json -->
# POST-SUBTASK-064 — [POST-SUBTASK-064] Materialize recruiting class, prospect, commitment, signing, enrollment, transfer, coach, coordinator, role, tenure, and transition events
...
```json
{
  ...
  "acceptance_criteria": [
    ...
    "The declared output `artifacts/player_intelligence/program_event_manifest.json` is produced with deterministic identity, provenance, and validation metadata appropriate to this work.",
  ...
  "ai_context_notes": [
    ...
    "Read the exact source sections in `jira/sources/issue_source_manifests/POST-SUBTASK-064.json`; inspect only the listed implementation files and prerequisite outputs.",
  ...
  "blocked_reason": "UNSATISFIED_HARD_DEPENDENCIES: POST-SUBTASK-063",
  "blocks": [
    "POST-SUBTASK-065",
    "POST-SUBTASK-066"
  ],
  "canonical_record": "jira/records/issues/subtasks/POST-SUBTASK-064_materialize_recruiting_class_prospect_commitment_signing_enrollment_transfer_coa.json",
  "canonical_source_role": "AUTHORITATIVE_LOCAL_SPECIFICATION",
  "completion_evidence_contract": {
    "acceptance_matrix_required": true,
    "artifact_hashes_required": true,
    "completion_claim_limit": "IMPLEMENTED",
    "downstream_consumer": "POST-SUBTASK-065",
  ...
  "critical_path": false,
  "definition_of_done": [
    "The atomic scope in POST-SUBTASK-064 is completed without absorbing sibling work or weakening any protected requirement, control, split, judging rule, private-research publication boundary, or security boundary.",
    ...
    "The output set `artifacts/player_intelligence/program_event_manifest.json` is demonstrably consumable by POST-SUBTASK-065 without manual reconstruction or undocumented state."
  ],
  "dependencies": [
    "POST-SUBTASK-063"
  ],
  ...
  "end_to_end_validation": "Validate that `artifacts/player_intelligence/program_event_manifest.json` can be parsed and consumed by `POST-SUBTASK-065` using only documented identities and interfaces; the consumer must reject missing, stale, schema-incompatible, technically or quality-ineligible, or provenance-incomplete input without manual repair.",
  "epic_id": "POST-EPIC-007",
  "evidence_manifest_path": "artifacts/jira_evidence/POST-SUBTASK-064.json",
  ...
  "gap_ids": [],
  "generated_markdown": "jira/issues/subtasks/POST-SUBTASK-064_materialize_recruiting_class_prospect_commitment_signing_enrollment_transfer_coa.md",
  ...
  "local_id": "POST-SUBTASK-064",
  "maturity_before": "FUNCTIONAL_STARTER",
  "objective": "Materialize recruiting class, prospect, commitment, signing, enrollment, transfer, coach, coordinator, role, tenure, and transition events",
  "operational_jira": {
    "assignee": "",
    "jira_issue_id": "24554",
    "jira_updated_at": "2026-08-09T23:24:05.949-0500",
  ...
  "required_tests": [
    {
      ...
      "expectation": "Run as a regression check after completing POST-SUBTASK-064; retain command, exit code, and relevant output.",
    ...
    },
    {
      ...
      "path": "artifacts/player_intelligence/program_event_manifest.json",
    ...
    },
    {
      ...
      "path": "NEW_TEST_REQUIRED::POST-SUBTASK-064",
      "validation_class": "NEW_AUTOMATED_TEST_REQUIRED"
    }
  ],
  "requirement_ids": [],
  "risk_failure_conditions": [
    "The work would be invalid if any prerequisite artifact, source/data/code/config identity, or declared maturity differs from the pinned issue contract for POST-SUBTASK-064.",
    "A command may exit successfully while producing stale, partial, synthetic-only, leakage-contaminated, non-reproducible, or legally unusable evidence.",
    "Acceptance failure: the evidence cannot demonstrate that events preserve published/effective times, source scales, identity confidence, decommitments/re-rankings/portal withdrawals, interim/overlapping staff roles, and prior versions.",
    "Acceptance failure: the evidence cannot demonstrate that the declared output `artifacts/player_intelligence/program_event_manifest.json` is produced with deterministic identity, provenance, and validation metadata appropriate to this work.",
  ...
  "risk_ids": [],
  "schema_version": 2,
  "scope": "Execute the atomic 1 of 3 step in Story POST-STORY-022 (Recruiting, transfer, freshman, coaching, and continuity intelligence): Materialize recruiting class, prospect, commitment, signing, enrollment, transfer, coach, coordinator, role, tenure, and transition events. Consume only verified prerequisite outputs from `POST-SUBTASK-063`. Produce `artifacts/player_intelligence/program_event_manifest.json`; evaluate every issue-specific acceptance condition; preserve negative results; and hand the pinned output to POST-SUBTASK-065.",
  "source_ids": [
    "GAP-006",
    "HANDOFF-008"
  ],
  ...
  "specificity_fingerprint": "affe92f050b589f7ad6ba8114f38fd9ab4a88bd1d183b5dce6e0ad6cc9725c86",
  "stop_conditions": [
  ...
  "title": "[POST-SUBTASK-064] Materialize recruiting class, prospect, commitment, signing, enrollment, transfer, coach, coordinator, role, tenure, and transition events",
  ...
  "work_packet_path": "jira/ai/work_packets/POST-SUBTASK-064.md",
...
1. The atomic scope in POST-SUBTASK-064 is completed without absorbing sibling work or weakening any protected requirement, control, split, judging rule, private-research publication boundary, or security boundary.
...
7. The output set `artifacts/player_intelligence/program_event_manifest.json` is demonstrably consumable by POST-SUBTASK-065 without manual reconstruction or undocumented state.
...
Validate that `artifacts/player_intelligence/program_event_manifest.json` can be parsed and consumed by `POST-SUBTASK-065` using only documented identities and interfaces; the consumer must reject missing, stale, schema-incompatible, technically or quality-ineligible, or provenance-incomplete input without manual repair.
