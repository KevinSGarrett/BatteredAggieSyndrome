<!-- GENERATED VIEW. Canonical record: jira/records/issues/tasks/TASK-141_implement_selected_baseline_and_boosting_model_starters.json -->
# TASK-141 — [TASK-141] Implement selected baseline and boosting model starters
...
```json
{
  ...
  "acceptance_criteria": [
    "Stable ID TASK-141, parent EPIC-025, owner wave W20, and original status DONE are preserved.",
  ...
  "allowed_modification_paths": [
    "functional model starters"
  ],
  "blocked_reason": "",
  "blocks": [
    "TASK-143"
  ],
  "canonical_record": "jira/records/issues/tasks/TASK-141_implement_selected_baseline_and_boosting_model_starters.json",
  ...
  "gap_ids": [],
  "generated_markdown": "jira/issues/tasks/TASK-141_implement_selected_baseline_and_boosting_model_starters.md",
  ...
  "objective": "Implement selected baseline and boosting model starters",
  "operational_jira": {
    "assignee": "",
    "jira_issue_id": "24384",
    "jira_updated_at": "2026-08-09T00:40:43.012-0500",
  ...
  "phase": "PHASE-4",
  "prerequisites": [
    "Historical dependency TASK-140",
  ...
  "required_evidence": [
    "Authoritative WBS row TASK-141",
    "Existing artifact `functional model starters`"
  ],
  "required_tests": [
    {
  ...
  "specificity_fingerprint": "a524d045e62f8bfd3700478fba94d927b962c1e755bb9748da5d6de61605fe6e",
  "stop_conditions": [
  ...
  "title": "[TASK-141] Implement selected baseline and boosting model starters",
...
Implement selected baseline and boosting model starters
...
1. Stable ID TASK-141, parent EPIC-025, owner wave W20, and original status DONE are preserved.
