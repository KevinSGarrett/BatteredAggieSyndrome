...
| 9 | Represent the entire project | PASS | Current strict coverage and derivative validation agree at 498 canonical issues. |
...
| 33 | Jira import strategy | PASS | Strict import dry-run passes for 498 issues and 1136 links. |
...
| 51 | Coverage gates | PASS | Current strict coverage and derivative validation agree at 498 canonical issues. |
...
| 53 | Import dry-run | PASS | Strict import dry-run passes for 498 issues and 1136 links. |
