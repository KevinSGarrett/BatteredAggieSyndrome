...
from aggie_analytics.data.tamu_official_1996_season_index import materialize  # noqa: E402  # pylint: disable=import-error


def main() -> int:
    parser = argparse.ArgumentParser(description="Capture the official 1996 SRC-014 season index and discover box URLs.")
