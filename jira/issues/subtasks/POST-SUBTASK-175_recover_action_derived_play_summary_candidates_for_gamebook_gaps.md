...
```json
{
  ...
  "adr_ids": [],
  "ai_context_notes": [
    "Retired POST-SUBTASK-168 (now BATQ-54; see jira/reconciliation/BAT_RETIRED_CANONICAL_ISSUE_REGISTRY.json) historically established the source schema distinction and candidate-only action/play mapping evidence; it is not an active BAT dependency. This unit converts only the deterministic defensible subset.",
  ...
  "operational_jira": {
    "assignee": "",
    "jira_issue_id": "24672",
    "jira_updated_at": "2026-08-19T16:55:38.642-0500",
