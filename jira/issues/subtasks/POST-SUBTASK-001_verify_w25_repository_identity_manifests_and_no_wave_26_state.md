<!-- GENERATED VIEW. Canonical record: jira/records/issues/subtasks/POST-SUBTASK-001_verify_w25_repository_identity_manifests_and_no_wave_26_state.json -->
# POST-SUBTASK-001 — [POST-SUBTASK-001] Verify W25 repository identity, manifests, and no-Wave-26 state
...
```json
{
  ...
  "ai_context_notes": [
    ...
    "Read the exact source sections in `jira/sources/issue_source_manifests/POST-SUBTASK-001.json`; inspect only the listed implementation files and prerequisite outputs.",
  ...
  "blocked_reason": "STARTUP_RECONCILIATION_BLOCKERS: authoritative W25 hydration ZIP/PACK_BINDING unavailable; full Windows unit baseline has a diagnosed lock-cleanup error; root activation control tools referenced by START_HERE are absent; AGGIE_ANALYTICS_DATA_ROOT is an invalid placeholder.",
  "blocks": [
    "POST-STORY-002",
    "POST-SUBTASK-002",
    "POST-SUBTASK-003",
  ...
  "canonical_record": "jira/records/issues/subtasks/POST-SUBTASK-001_verify_w25_repository_identity_manifests_and_no_wave_26_state.json",
  "canonical_source_role": "AUTHORITATIVE_LOCAL_SPECIFICATION",
  "completion_evidence_contract": {
    "acceptance_matrix_required": true,
    "artifact_hashes_required": true,
    "completion_claim_limit": "IMPLEMENTED",
    "downstream_consumer": "POST-SUBTASK-002",
  ...
  "critical_path": true,
  "definition_of_done": [
    "The atomic scope in POST-SUBTASK-001 is completed without absorbing sibling work or weakening any protected requirement, control, split, judging rule, rights decision, or security boundary.",
    ...
    "The output set `artifacts/implementation_preflight/repository_identity.json` is demonstrably consumable by POST-SUBTASK-002 without manual reconstruction or undocumented state."
  ],
  "dependencies": [],
  ...
  "end_to_end_validation": "Validate that `artifacts/implementation_preflight/repository_identity.json` can be parsed and consumed by `POST-SUBTASK-002` using only documented identities and interfaces; the consumer must reject missing, stale, schema-incompatible, rights-blocked, or provenance-incomplete input without manual repair.",
  "epic_id": "POST-EPIC-001",
  "evidence_manifest_path": "artifacts/jira_evidence/POST-SUBTASK-001.json",
  ...
  "gap_ids": [],
  "generated_markdown": "jira/issues/subtasks/POST-SUBTASK-001_verify_w25_repository_identity_manifests_and_no_wave_26_state.md",
  ...
  "objective": "Verify W25 repository identity, manifests, and no-Wave-26 state",
  "operational_jira": {
    "assignee": "GARRETT TRAINING SYSTEMS INC.",
    "jira_issue_id": "24491",
    "jira_updated_at": "2026-08-09T01:08:39.385-0500",
    "last_synced_at": "2026-08-09T06:11:10.760890+00:00",
    "source_export": "C:\\BatteredAggieSyndrome.reconciliation\\BAT-351-live-row.csv",
    "sprint": "",
  ...
  "required_tests": [
    {
      ...
      "expectation": "Run as a regression check after completing POST-SUBTASK-001; retain command, exit code, and relevant output.",
    ...
    },
    {
      ...
      "path": "artifacts/implementation_preflight/repository_identity.json",
  ...
  "risk_failure_conditions": [
    "The work would be invalid if any prerequisite artifact, source/data/code/config identity, or declared maturity differs from the pinned issue contract for POST-SUBTASK-001.",
    "A command may exit successfully while producing stale, partial, synthetic-only, leakage-contaminated, non-reproducible, or legally unusable evidence.",
    "Acceptance failure: the evidence cannot demonstrate that the recorded repository hash and project identity match the W25 handoff.",
    "Acceptance failure: the evidence cannot demonstrate that the preflight explicitly records that the next state is CODEX_IMPLEMENTATION_HANDOFF and no Wave 26 is created.",
    "Acceptance failure: the evidence cannot demonstrate that any manifest mismatch fails closed before mutation."
  ],
  "risk_ids": [],
  "schema_version": 2,
  "scope": "Execute the atomic 1 of 3 step in Story POST-STORY-001 (Canonical handoff and target-environment preflight): Verify W25 repository identity, manifests, and no-Wave-26 state. Begin from the verified repository/current-state contract and the exact source sections in this issue manifest. Produce `artifacts/implementation_preflight/repository_identity.json`; evaluate every issue-specific acceptance condition; preserve negative results; and hand the pinned output to POST-SUBTASK-002.",
  "source_ids": [
    "GAP-001",
    "HANDOFF-001"
  ],
  ...
  "specificity_fingerprint": "ec1aa184afc7d0afd7324b375eae9073a99e2023bcb79998f2ff4d2013b6848e",
  "stop_conditions": [
  ...
  "title": "[POST-SUBTASK-001] Verify W25 repository identity, manifests, and no-Wave-26 state",
  "traceability_inherited_from": [
    "POST-SUBTASK-009"
  ],
  "traceability_resolution": "INHERITED_DOMAIN_GATE",
  "unblock_condition": "Supply or formally supersede the missing W25 hydration binding; fix and pass the Windows lock cleanup regression; reconcile and validate the four missing root activation tools; and configure a concrete external AGGIE_ANALYTICS_DATA_ROOT.",
  "validation_classes": [
    "END_TO_END",
    "REGRESSION",
    "REPRODUCIBILITY"
...
1. The atomic scope in POST-SUBTASK-001 is completed without absorbing sibling work or weakening any protected requirement, control, split, judging rule, rights decision, or security boundary.
...
7. The output set `artifacts/implementation_preflight/repository_identity.json` is demonstrably consumable by POST-SUBTASK-002 without manual reconstruction or undocumented state.
