...
1. `jira/records/issues/stories/POST-STORY-021_historical_player_roster_depth_value_replacement_and_availability.json`
2. `jira/sources/issue_source_manifests/POST-STORY-021.json`
3. `jira/index/ISSUE_GOVERNANCE_CONTEXT.csv` row for `POST-STORY-021`.
