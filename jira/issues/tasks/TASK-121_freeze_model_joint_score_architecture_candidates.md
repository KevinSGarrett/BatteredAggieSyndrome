<!-- GENERATED VIEW. Canonical record: jira/records/issues/tasks/TASK-121_freeze_model_joint_score_architecture_candidates.json -->
# TASK-121 — [TASK-121] Freeze model/joint-score architecture candidates
...
```json
{
  ...
  "acceptance_criteria": [
    "Stable ID TASK-121, parent EPIC-021, owner wave W16, and original status DONE are preserved.",
  ...
  "canonical_record": "jira/records/issues/tasks/TASK-121_freeze_model_joint_score_architecture_candidates.json",
  ...
  "effective_traceability_total": 29,
  ...
  "gap_ids": [],
  "generated_markdown": "jira/issues/tasks/TASK-121_freeze_model_joint_score_architecture_candidates.md",
  ...
  "objective": "Freeze model/joint-score architecture candidates",
  "operational_jira": {
    "assignee": "",
    "jira_issue_id": "24364",
    "jira_updated_at": "2026-08-09T00:40:39.370-0500",
  ...
  "phase": "PHASE-4",
  "prerequisites": [
    "Historical dependency TASK-118",
    "Historical dependency TASK-120"
  ],
  "primary_source_refs": [
    "SRCREF-00154",
    "SRCREF-02116",
  ...
  "required_evidence": [
    "Authoritative WBS row TASK-121",
    "Existing artifact `model architecture baseline`"
  ],
  "required_tests": [
    {
  ...
  "specificity_fingerprint": "c9a54ef200ba3e5939fe3155f3b530ea791700dd07167687e40d2ffb06c9753e",
  "stop_conditions": [
  ...
  "title": "[TASK-121] Freeze model/joint-score architecture candidates",
...
Freeze model/joint-score architecture candidates
...
- Inherited from: None
- Resolution: `DIRECT`
- Effective counts: `{"acceptance_control_ids": 8, "adr_ids": 0, "gap_ids": 0, "requirement_ids": 21, "risk_ids": 0}`

## Acceptance Criteria

1. Stable ID TASK-121, parent EPIC-021, owner wave W16, and original status DONE are preserved.
