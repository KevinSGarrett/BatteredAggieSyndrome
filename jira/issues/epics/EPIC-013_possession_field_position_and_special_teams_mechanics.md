<!-- GENERATED VIEW. Canonical record: jira/records/issues/epics/EPIC-013_possession_field_position_and_special_teams_mechanics.json -->
# EPIC-013 — [EPIC-013] Possession, field position and special teams mechanics
...
```json
{
  ...
  "acceptance_criteria": [
    "The epic retains stable ID EPIC-013, owner wave W13, phase PHASE-2, and all authoritative WBS children.",
  ...
  "blocked_reason": "",
  "blocks": [],
  "canonical_record": "jira/records/issues/epics/EPIC-013_possession_field_position_and_special_teams_mechanics.json",
  ...
  "expected_outputs": [
    "field-position value contract",
    "mechanics interaction candidates",
    "mechanics interface baseline",
    "possession/tempo contract",
    "score-state policy candidates",
    "special teams component contracts"
  ],
  ...
  "gap_ids": [],
  "generated_markdown": "jira/issues/epics/EPIC-013_possession_field_position_and_special_teams_mechanics.md",
  ...
  "objective": "Represent opportunity volume, hidden yards and specialists as separable candidate subsystems.",
  "operational_jira": {
    "assignee": "",
    "jira_issue_id": "24153",
    "jira_updated_at": "2026-08-09T00:40:12.084-0500",
  ...
  "specificity_fingerprint": "5245a623fb51cc5ffbc43c96683feced9502ef5f6d7fc094f6f2289bb9656af2",
  "stop_conditions": [
    "Stop if a proposed update renumbers the historical epic or rewrites its original wave provenance."
  ],
  "supporting_source_refs": [],
  "title": "[EPIC-013] Possession, field position and special teams mechanics",
...
Represent opportunity volume, hidden yards and specialists as separable candidate subsystems.
...
1. The epic retains stable ID EPIC-013, owner wave W13, phase PHASE-2, and all authoritative WBS children.
