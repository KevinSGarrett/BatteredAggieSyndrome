...
```json
{
  ...
  "critical_path": true,
  "definition_of_done": [
    "The atomic scope in POST-SUBTASK-101 is completed without absorbing sibling work or weakening any protected requirement, control, split, judging rule, rights decision, or security boundary.",
  ...
  "end_to_end_validation": "Validate that `artifacts/validation/protected_scorecards.json` can be parsed and consumed by `POST-SUBTASK-102` using only documented identities and interfaces; the consumer must reject missing, stale, schema-incompatible, rights-blocked, or provenance-incomplete input without manual repair.",
  ...
  "operational_jira": {
    "assignee": "",
    "jira_issue_id": "24591",
    "jira_updated_at": "2026-08-09T00:03:57.190-0500",
  ...
  "specificity_fingerprint": "c9b47efaffdac1665b3a04c0ee2665b9b88dc6f36b2b51b5f91d2a775a0b6048",
  "stop_conditions": [
...
1. The atomic scope in POST-SUBTASK-101 is completed without absorbing sibling work or weakening any protected requirement, control, split, judging rule, rights decision, or security boundary.
...
Validate that `artifacts/validation/protected_scorecards.json` can be parsed and consumed by `POST-SUBTASK-102` using only documented identities and interfaces; the consumer must reject missing, stale, schema-incompatible, rights-blocked, or provenance-incomplete input without manual repair.
