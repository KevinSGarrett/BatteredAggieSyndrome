<!-- GENERATED VIEW. Canonical record: jira/records/issues/tasks/TASK-175_refresh_source_landscape_against_w06_baseline.json -->
# TASK-175 — [TASK-175] Refresh source landscape against W06 baseline
...
```json
{
  ...
  "acceptance_criteria": [
    "Stable ID TASK-175, parent EPIC-031, owner wave W24, and original status DONE are preserved.",
  ...
  "ai_context_notes": [
    ...
    "Targeted current refresh; no exhaustive-internet claim."
  ],
  ...
  "canonical_record": "jira/records/issues/tasks/TASK-175_refresh_source_landscape_against_w06_baseline.json",
  ...
  "gap_ids": [],
  "generated_markdown": "jira/issues/tasks/TASK-175_refresh_source_landscape_against_w06_baseline.md",
  ...
  "objective": "Refresh source landscape against W06 baseline",
  "operational_jira": {
    "assignee": "",
    "jira_issue_id": "24433",
    "jira_updated_at": "2026-08-09T00:40:47.472-0500",
  ...
  "phase": "PHASE-5",
  "prerequisites": [
    "Historical dependency TASK-173"
  ],
  "primary_source_refs": [
    "SRCREF-00208",
    "SRCREF-02116",
  ...
  "required_evidence": [
    "Authoritative WBS row TASK-175",
    "Existing artifact `source refresh delta report`"
  ],
  "required_tests": [
    {
  ...
  "specificity_fingerprint": "887b9134cf13692a4f3913ccafa97020a4d47c607a541210076da5764c0dad00",
  "stop_conditions": [
  ...
  "title": "[TASK-175] Refresh source landscape against W06 baseline",
...
Refresh source landscape against W06 baseline
...
1. Stable ID TASK-175, parent EPIC-031, owner wave W24, and original status DONE are preserved.
