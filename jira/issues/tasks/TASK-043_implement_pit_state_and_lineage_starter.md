<!-- GENERATED VIEW. Canonical record: jira/records/issues/tasks/TASK-043_implement_pit_state_and_lineage_starter.json -->
# TASK-043 — [TASK-043] Implement PIT state and lineage starter
...
```json
{
  ...
  "acceptance_criteria": [
    "Stable ID TASK-043, parent EPIC-008, owner wave W19, and original status DONE are preserved.",
  ...
  "canonical_record": "jira/records/issues/tasks/TASK-043_implement_pit_state_and_lineage_starter.json",
  ...
  "gap_ids": [],
  "generated_markdown": "jira/issues/tasks/TASK-043_implement_pit_state_and_lineage_starter.md",
  ...
  "objective": "Implement PIT state and lineage starter",
  "operational_jira": {
    "assignee": "",
    "jira_issue_id": "24286",
    "jira_updated_at": "2026-08-09T00:40:23.943-0500",
  ...
  "prerequisites": [
    ...
    "Historical dependency TASK-042"
  ],
  "primary_source_refs": [
    "SRCREF-00076",
    "SRCREF-02116",
  ...
  "required_evidence": [
    "Authoritative WBS row TASK-043",
    "Existing artifact `as-of state builder`",
    "Existing artifact `lineage artifacts`"
  ],
  "required_tests": [
    {
  ...
  "specificity_fingerprint": "dd8a31d29d4ae3186dd208d4d6036240587491a339ab37f24488c73900872ff6",
  "stop_conditions": [
  ...
  "title": "[TASK-043] Implement PIT state and lineage starter",
...
Implement PIT state and lineage starter
...
1. Stable ID TASK-043, parent EPIC-008, owner wave W19, and original status DONE are preserved.
