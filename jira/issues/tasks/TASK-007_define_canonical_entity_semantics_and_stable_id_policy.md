<!-- GENERATED VIEW. Canonical record: jira/records/issues/tasks/TASK-007_define_canonical_entity_semantics_and_stable_id_policy.json -->
# TASK-007 — [TASK-007] Define canonical entity semantics and stable ID policy
...
```json
{
  ...
  "acceptance_criteria": [
    "Stable ID TASK-007, parent EPIC-002, owner wave W07, and original status DONE are preserved.",
  ...
  "ai_context_notes": [
    ...
    "W07 contract complete; materialized canonical data remains W19."
  ],
  "allowed_modification_paths": [
    "configs/entity_registry.json",
    "docs/14_CANONICAL_ENTITY_ARCHITECTURE.md",
    "governance/CANONICAL_ENTITY_CATALOG.csv",
    "governance/CANONICAL_RELATIONSHIP_CATALOG.csv",
    "schemas/canonical/entities.json"
  ],
  "blocked_reason": "",
  "blocks": [
    "TASK-008",
  ...
  "canonical_record": "jira/records/issues/tasks/TASK-007_define_canonical_entity_semantics_and_stable_id_policy.json",
  ...
  "effective_traceability_total": 19,
  ...
  "gap_ids": [],
  "generated_markdown": "jira/issues/tasks/TASK-007_define_canonical_entity_semantics_and_stable_id_policy.md",
  ...
  "objective": "Define canonical entity semantics and stable ID policy",
  "operational_jira": {
    "assignee": "",
    "jira_issue_id": "24250",
    "jira_updated_at": "2026-08-09T00:40:16.952-0500",
  ...
  "required_evidence": [
    "Authoritative WBS row TASK-007",
    "Existing artifact `configs/entity_registry.json`",
    "Existing artifact `docs/14_CANONICAL_ENTITY_ARCHITECTURE.md`",
    "Existing artifact `governance/CANONICAL_ENTITY_CATALOG.csv`",
    "Existing artifact `governance/CANONICAL_RELATIONSHIP_CATALOG.csv`",
    "Existing artifact `schemas/canonical/entities.json`"
  ],
  "required_tests": [
    {
  ...
  "risk_ids": [],
  "schema_version": 2,
  "scope": "Original task type DESIGN with mutation scope: canonical schema/contracts.",
  "source_ids": [
    "TASK-007"
  ],
  "source_refs": [
  ...
  "specificity_fingerprint": "0a83d8ba8c716661b0282222a75786e3c53f0b4486321e26decd95d1abcc46fd",
  "stop_conditions": [
  ...
  "title": "[TASK-007] Define canonical entity semantics and stable ID policy",
  ...
  "why_this_exists": "Preserve the original W07 WBS work unit, its dependencies, outputs, and scoped completion semantics as provenance for post-wave execution.",
  "work_packet_path": "",
  "workflow_state": "DONE"
}
```
...
Define canonical entity semantics and stable ID policy

## Why This Exists

Preserve the original W07 WBS work unit, its dependencies, outputs, and scoped completion semantics as provenance for post-wave execution.

## Scope

Original task type DESIGN with mutation scope: canonical schema/contracts.
...
- Inherited from: None
- Resolution: `DIRECT`
- Effective counts: `{"acceptance_control_ids": 6, "adr_ids": 0, "gap_ids": 0, "requirement_ids": 13, "risk_ids": 0}`

## Acceptance Criteria

1. Stable ID TASK-007, parent EPIC-002, owner wave W07, and original status DONE are preserved.
...
- **EXISTING_AUTOMATED_TEST** / `EXISTING_AUTOMATED_TEST` — `tools/validate_entities.py` — Run and retain the result when this issue touches the covered contract.
