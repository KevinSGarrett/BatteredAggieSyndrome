<!-- GENERATED VIEW. Canonical record: jira/records/issues/tasks/TASK-004_inventory_schemas_endpoints_redundancy_and_source_risks.json -->
# TASK-004 — [TASK-004] Inventory schemas/endpoints, redundancy and source risks
...
```json
{
  ...
  "acceptance_criteria": [
    "Stable ID TASK-004, parent EPIC-001, owner wave W06, and original status DONE are preserved.",
  ...
  "allowed_modification_paths": [
    "docs/data_research/w06/DATASET_ENDPOINT_COLUMN_INVENTORY.csv",
    "docs/data_research/w06/DATA_SOURCE_RISK_REGISTER.csv",
    "docs/data_research/w06/SOURCE_REDUNDANCY_MAP.csv"
  ],
  "blocked_reason": "",
  "blocks": [
    "TASK-005"
  ],
  "canonical_record": "jira/records/issues/tasks/TASK-004_inventory_schemas_endpoints_redundancy_and_source_risks.json",
  ...
  "gap_ids": [],
  "generated_markdown": "jira/issues/tasks/TASK-004_inventory_schemas_endpoints_redundancy_and_source_risks.md",
  ...
  "objective": "Inventory schemas/endpoints, redundancy and source risks",
  "operational_jira": {
    "assignee": "",
    "jira_issue_id": "24247",
    "jira_updated_at": "2026-08-09T00:40:16.156-0500",
  ...
  "phase": "PHASE-1",
  "prerequisites": [
    "Historical dependency TASK-002"
  ],
  "primary_source_refs": [
    "SRCREF-00037",
    "SRCREF-02116",
  ...
  "required_evidence": [
    "Authoritative WBS row TASK-004",
    "Existing artifact `docs/data_research/w06/DATASET_ENDPOINT_COLUMN_INVENTORY.csv`",
    "Existing artifact `docs/data_research/w06/DATA_SOURCE_RISK_REGISTER.csv`",
    "Existing artifact `docs/data_research/w06/SOURCE_REDUNDANCY_MAP.csv`"
  ],
  "required_tests": [
    {
  ...
  "risk_ids": [],
  "schema_version": 2,
  "scope": "Original task type RESEARCH with mutation scope: as defined by its source documents.",
  "source_ids": [
    "TASK-004"
  ],
  "source_refs": [
  ...
  "specificity_fingerprint": "ef687b84d3305f633a8d4d4f9efd4ed8cbd5dc934a25ea45cca42f8d7dcd5b4a",
  "stop_conditions": [
  ...
  "title": "[TASK-004] Inventory schemas/endpoints, redundancy and source risks",
  ...
  "why_this_exists": "Preserve the original W06 WBS work unit, its dependencies, outputs, and scoped completion semantics as provenance for post-wave execution.",
  "work_packet_path": "",
  "workflow_state": "DONE"
}
```
...
Inventory schemas/endpoints, redundancy and source risks

## Why This Exists

Preserve the original W06 WBS work unit, its dependencies, outputs, and scoped completion semantics as provenance for post-wave execution.

## Scope

Original task type RESEARCH with mutation scope: as defined by its source documents.
...
1. Stable ID TASK-004, parent EPIC-001, owner wave W06, and original status DONE are preserved.
