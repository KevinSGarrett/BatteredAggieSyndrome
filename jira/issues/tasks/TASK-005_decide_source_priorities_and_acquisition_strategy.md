<!-- GENERATED VIEW. Canonical record: jira/records/issues/tasks/TASK-005_decide_source_priorities_and_acquisition_strategy.json -->
# TASK-005 — [TASK-005] Decide source priorities and acquisition strategy
...
```json
{
  ...
  "acceptance_criteria": [
    "Stable ID TASK-005, parent EPIC-001, owner wave W06, and original status DONE are preserved.",
  ...
  "allowed_modification_paths": [
    ...
    "docs/data_research/w06/DATA_MISSINGNESS_STRATEGY.md",
  ...
  "canonical_record": "jira/records/issues/tasks/TASK-005_decide_source_priorities_and_acquisition_strategy.json",
  ...
  "gap_ids": [],
  "generated_markdown": "jira/issues/tasks/TASK-005_decide_source_priorities_and_acquisition_strategy.md",
  ...
  "objective": "Decide source priorities and acquisition strategy",
  "operational_jira": {
    "assignee": "",
    "jira_issue_id": "24248",
    "jira_updated_at": "2026-08-09T00:40:16.208-0500",
  ...
  "phase": "PHASE-1",
  "prerequisites": [
    "Historical dependency TASK-003",
    "Historical dependency TASK-004"
  ],
  "primary_source_refs": [
    "SRCREF-00038",
    "SRCREF-02116",
  ...
  "required_evidence": [
    "Authoritative WBS row TASK-005",
    "Existing artifact `docs/data_research/w06/DATA_ACQUISITION_PLAN.md`",
    "Existing artifact `docs/data_research/w06/DATA_MISSINGNESS_STRATEGY.md`",
    "Existing artifact `docs/data_research/w06/SOURCE_PRIORITY_DECISIONS.md`"
  ],
  "required_tests": [
    {
  ...
  "risk_ids": [],
  "schema_version": 2,
  "scope": "Original task type DECISION with mutation scope: as defined by its source documents.",
  "source_ids": [
    "TASK-005"
  ],
  "source_refs": [
  ...
  "specificity_fingerprint": "4ac4c650de34d95502bf0e1f20876c7d02c6acbdcc6e5845260a3af91ce35c1a",
  "stop_conditions": [
  ...
  "title": "[TASK-005] Decide source priorities and acquisition strategy",
...
Decide source priorities and acquisition strategy
...
Original task type DECISION with mutation scope: as defined by its source documents.
...
1. Stable ID TASK-005, parent EPIC-001, owner wave W06, and original status DONE are preserved.
