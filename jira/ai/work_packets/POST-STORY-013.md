...
1. `jira/records/issues/stories/POST-STORY-013_canonical_registries_aliases_and_temporal_relationships.json`
2. `jira/sources/issue_source_manifests/POST-STORY-013.json`
3. `jira/index/ISSUE_GOVERNANCE_CONTEXT.csv` row for `POST-STORY-013`.
