<!-- GENERATED VIEW. Canonical record: jira/records/issues/tasks/TASK-155_implement_uncertainty_bas_availability_matchup_explanation_views.json -->
# TASK-155 — [TASK-155] Implement uncertainty/BAS/availability/matchup explanation views
...
```json
{
  ...
  "acceptance_criteria": [
    "Stable ID TASK-155, parent EPIC-027, owner wave W22, and original status DONE are preserved.",
  ...
  "allowed_modification_paths": [
    "explanation and warning surfaces"
  ],
  "blocked_reason": "",
  "blocks": [
    "TASK-157"
  ],
  "canonical_record": "jira/records/issues/tasks/TASK-155_implement_uncertainty_bas_availability_matchup_explanation_views.json",
  ...
  "gap_ids": [],
  "generated_markdown": "jira/issues/tasks/TASK-155_implement_uncertainty_bas_availability_matchup_explanation_views.md",
  ...
  "objective": "Implement uncertainty/BAS/availability/matchup explanation views",
  "operational_jira": {
    "assignee": "",
    "jira_issue_id": "24398",
    "jira_updated_at": "2026-08-09T00:40:45.655-0500",
  ...
  "phase": "PHASE-4",
  "prerequisites": [
    "Historical dependency TASK-154"
  ],
  "primary_source_refs": [
    "SRCREF-00188",
    "SRCREF-02116",
  ...
  "required_evidence": [
    "Authoritative WBS row TASK-155",
    "Existing artifact `explanation and warning surfaces`"
  ],
  "required_tests": [
    {
  ...
  "specificity_fingerprint": "afaebb8855d2ee66f1603c25a93aa6e45222f92e1d7df2038ca4ef9a1eb27516",
  "stop_conditions": [
  ...
  "title": "[TASK-155] Implement uncertainty/BAS/availability/matchup explanation views",
...
Implement uncertainty/BAS/availability/matchup explanation views
...
- Inherited from: None
- Resolution: `DIRECT`
- Effective counts: `{"acceptance_control_ids": 3, "adr_ids": 0, "gap_ids": 0, "requirement_ids": 5, "risk_ids": 0}`

## Acceptance Criteria

1. Stable ID TASK-155, parent EPIC-027, owner wave W22, and original status DONE are preserved.
