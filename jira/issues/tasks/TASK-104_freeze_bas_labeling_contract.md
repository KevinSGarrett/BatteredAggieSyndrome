<!-- GENERATED VIEW. Canonical record: jira/records/issues/tasks/TASK-104_freeze_bas_labeling_contract.json -->
# TASK-104 — [TASK-104] Freeze BAS labeling contract
...
```json
{
  ...
  "acceptance_criteria": [
    "Stable ID TASK-104, parent EPIC-018, owner wave W15, and original status DONE are preserved.",
  ...
  "canonical_record": "jira/records/issues/tasks/TASK-104_freeze_bas_labeling_contract.json",
  ...
  "gap_ids": [],
  "generated_markdown": "jira/issues/tasks/TASK-104_freeze_bas_labeling_contract.md",
  ...
  "objective": "Freeze BAS labeling contract",
  "operational_jira": {
    "assignee": "",
    "jira_issue_id": "24347",
    "jira_updated_at": "2026-08-09T00:40:35.676-0500",
  ...
  "phase": "PHASE-3",
  "prerequisites": [
    "Historical dependency TASK-103"
  ],
  "primary_source_refs": [
    "SRCREF-00137",
    "SRCREF-02116",
  ...
  "required_evidence": [
    "Authoritative WBS row TASK-104",
    "Existing artifact `accepted BAS label baseline`"
  ],
  "required_tests": [
    {
  ...
  "specificity_fingerprint": "c77ba01ab8f02b0745e66f50547a012e98416721b292a18993d044a00f6c6144",
  "stop_conditions": [
  ...
  "title": "[TASK-104] Freeze BAS labeling contract",
...
- Inherited from: None
- Resolution: `DIRECT`
- Effective counts: `{"acceptance_control_ids": 10, "adr_ids": 0, "gap_ids": 0, "requirement_ids": 14, "risk_ids": 0}`

## Acceptance Criteria

1. Stable ID TASK-104, parent EPIC-018, owner wave W15, and original status DONE are preserved.
