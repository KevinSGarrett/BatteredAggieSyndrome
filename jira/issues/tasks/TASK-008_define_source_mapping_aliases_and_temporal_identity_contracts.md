<!-- GENERATED VIEW. Canonical record: jira/records/issues/tasks/TASK-008_define_source_mapping_aliases_and_temporal_identity_contracts.json -->
# TASK-008 — [TASK-008] Define source mapping, aliases and temporal identity contracts
...
```json
{
  ...
  "acceptance_criteria": [
    "Stable ID TASK-008, parent EPIC-002, owner wave W07, and original status DONE are preserved.",
  ...
  "ai_context_notes": [
    ...
    "Source mapping/evidence identity contract frozen in W07."
  ],
  "allowed_modification_paths": [
    "docs/15_SOURCE_MAPPING_AND_EVIDENCE_IDENTITY.md",
    "governance/SOURCE_MAPPING_METHODS.csv",
    "schemas/canonical/source_mapping.json"
  ],
  "blocked_reason": "",
  "blocks": [
    "TASK-009"
  ],
  "canonical_record": "jira/records/issues/tasks/TASK-008_define_source_mapping_aliases_and_temporal_identity_contracts.json",
  ...
  "gap_ids": [],
  "generated_markdown": "jira/issues/tasks/TASK-008_define_source_mapping_aliases_and_temporal_identity_contracts.md",
  ...
  "objective": "Define source mapping, aliases and temporal identity contracts",
  "operational_jira": {
    "assignee": "",
    "jira_issue_id": "24251",
    "jira_updated_at": "2026-08-09T00:40:17.021-0500",
  ...
  "required_evidence": [
    "Authoritative WBS row TASK-008",
    "Existing artifact `docs/15_SOURCE_MAPPING_AND_EVIDENCE_IDENTITY.md`",
    "Existing artifact `governance/SOURCE_MAPPING_METHODS.csv`",
    "Existing artifact `schemas/canonical/source_mapping.json`"
  ],
  "required_tests": [
    {
  ...
  "specificity_fingerprint": "2230d3d5d3b4b8bf3ec88205fad036428fb1c32516c4ea184d0900d9a2d90c67",
  "stop_conditions": [
  ...
  "title": "[TASK-008] Define source mapping, aliases and temporal identity contracts",
...
Define source mapping, aliases and temporal identity contracts
...
- Inherited from: None
- Resolution: `DIRECT`
- Effective counts: `{"acceptance_control_ids": 5, "adr_ids": 0, "gap_ids": 0, "requirement_ids": 13, "risk_ids": 0}`

## Acceptance Criteria

1. Stable ID TASK-008, parent EPIC-002, owner wave W07, and original status DONE are preserved.
