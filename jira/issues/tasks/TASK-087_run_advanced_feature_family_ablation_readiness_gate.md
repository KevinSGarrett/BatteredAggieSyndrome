<!-- GENERATED VIEW. Canonical record: jira/records/issues/tasks/TASK-087_run_advanced_feature_family_ablation_readiness_gate.json -->
# TASK-087 — [TASK-087] Run advanced feature family ablation readiness gate
...
```json
{
  ...
  "acceptance_criteria": [
    "Stable ID TASK-087, parent EPIC-015, owner wave W20, and original status DONE are preserved.",
  ...
  "allowed_modification_paths": [
    "advanced intelligence implementation evidence"
  ],
  "blocked_reason": "",
  "blocks": [],
  "canonical_record": "jira/records/issues/tasks/TASK-087_run_advanced_feature_family_ablation_readiness_gate.json",
  ...
  "gap_ids": [],
  "generated_markdown": "jira/issues/tasks/TASK-087_run_advanced_feature_family_ablation_readiness_gate.md",
  ...
  "objective": "Run advanced feature family ablation readiness gate",
  "operational_jira": {
    "assignee": "",
    "jira_issue_id": "24330",
    "jira_updated_at": "2026-08-09T00:40:32.426-0500",
  ...
  "phase": "PHASE-2",
  "prerequisites": [
    "Historical dependency TASK-086",
  ...
  "required_evidence": [
    "Authoritative WBS row TASK-087",
    "Existing artifact `advanced intelligence implementation evidence`"
  ],
  "required_tests": [
    {
  ...
  "specificity_fingerprint": "aa4f937991f449f617371c42dcf1954fea8b665be0e0cfd269c63afa7b685b6a",
  "stop_conditions": [
  ...
  "title": "[TASK-087] Run advanced feature family ablation readiness gate",
...
Run advanced feature family ablation readiness gate
...
1. Stable ID TASK-087, parent EPIC-015, owner wave W20, and original status DONE are preserved.
