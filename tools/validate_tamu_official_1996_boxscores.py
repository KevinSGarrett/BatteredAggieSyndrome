...
from aggie_analytics.data.tamu_official_1996_boxscores import (  # noqa: E402  # pylint: disable=import-error
    AuthorityViolation,
    GATE_RELATIVE,
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Validate official 1996 box-score acquisition.")
    ...
    mutations = [
        ...
        expect_rejection(
            ...
            lambda: _validate(_mutated_gate(gate, counts={**gate["counts"], "ncaa_contest_ids_created": 1})),
        ),
    ]
