<!-- GENERATED VIEW. Canonical record: jira/records/issues/tasks/TASK-013_define_observation_effective_known_at_temporal_contract.json -->
# TASK-013 — [TASK-013] Define observation/effective/known-at temporal contract
...
```json
{
  ...
  "acceptance_criteria": [
    "Stable ID TASK-013, parent EPIC-003, owner wave W08, and original status DONE are preserved.",
  ...
  "ai_context_notes": [
    ...
    "First W08 task; W07 identity gate TASK-012 is complete.;Completed W08 contract + synthetic evidence"
  ],
  ...
  "canonical_record": "jira/records/issues/tasks/TASK-013_define_observation_effective_known_at_temporal_contract.json",
  ...
  "gap_ids": [],
  "generated_markdown": "jira/issues/tasks/TASK-013_define_observation_effective_known_at_temporal_contract.md",
  ...
  "objective": "Define observation/effective/known-at temporal contract",
  "operational_jira": {
    "assignee": "",
    "jira_issue_id": "24256",
    "jira_updated_at": "2026-08-09T00:40:17.773-0500",
  ...
  "phase": "PHASE-1",
  "prerequisites": [
    "Historical dependency TASK-012"
  ],
  "primary_source_refs": [
    "SRCREF-00046",
    "SRCREF-02116",
  ...
  "required_evidence": [
    "Authoritative WBS row TASK-013",
    "Existing artifact `PIT observation schema and temporal semantics`"
  ],
  "required_tests": [
    {
  ...
  "specificity_fingerprint": "0951c8ada1cbdece6d3a1ceb99fb974bb269e1222d90d7391d841b2f8f746edb",
  "stop_conditions": [
  ...
  "title": "[TASK-013] Define observation/effective/known-at temporal contract",
...
Define observation/effective/known-at temporal contract
...
1. Stable ID TASK-013, parent EPIC-003, owner wave W08, and original status DONE are preserved.
