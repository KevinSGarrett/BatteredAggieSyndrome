<!-- GENERATED VIEW. Canonical record: jira/records/issues/tasks/TASK-066_define_venue_travel_timezone_rest_context_contracts.json -->
# TASK-066 — [TASK-066] Define venue/travel/timezone/rest context contracts
...
```json
{
  ...
  "acceptance_criteria": [
    "Stable ID TASK-066, parent EPIC-012, owner wave W13, and original status DONE are preserved.",
  ...
  "canonical_record": "jira/records/issues/tasks/TASK-066_define_venue_travel_timezone_rest_context_contracts.json",
  ...
  "gap_ids": [],
  "generated_markdown": "jira/issues/tasks/TASK-066_define_venue_travel_timezone_rest_context_contracts.md",
  ...
  "objective": "Define venue/travel/timezone/rest context contracts",
  "operational_jira": {
    "assignee": "",
    "jira_issue_id": "24309",
    "jira_updated_at": "2026-08-09T00:40:28.526-0500",
  ...
  "required_evidence": [
    "Authoritative WBS row TASK-066",
    "Existing artifact `venue/travel context schema`"
  ],
  "required_tests": [
    {
  ...
  "specificity_fingerprint": "7648c64f56a9e4f1ef253f606f0e3c4e7f0cba82034c69de02ad45a5faf9b673",
  "stop_conditions": [
  ...
  "title": "[TASK-066] Define venue/travel/timezone/rest context contracts",
...
Define venue/travel/timezone/rest context contracts
...
1. Stable ID TASK-066, parent EPIC-012, owner wave W13, and original status DONE are preserved.
