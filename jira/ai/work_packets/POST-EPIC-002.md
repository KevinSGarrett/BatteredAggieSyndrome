...
- Maturity before → after: `CONTRACT_DEFINED` → `EMPIRICALLY_VALIDATED`
- Evidence state: `PLANNED`
- Governance traceability gate: `POST-SUBTASK-024`

## Read first

1. `jira/records/issues/epics/POST-EPIC-002_source_access_rights_credentials_and_acquisition_governance.json`
2. `jira/sources/issue_source_manifests/POST-EPIC-002.json`
3. `jira/index/ISSUE_GOVERNANCE_CONTEXT.csv` row for `POST-EPIC-002`.
