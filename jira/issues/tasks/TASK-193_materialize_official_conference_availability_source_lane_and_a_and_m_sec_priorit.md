<!-- GENERATED VIEW. Canonical record: jira/records/issues/tasks/TASK-193_materialize_official_conference_availability_source_lane_and_a_and_m_sec_priorit.json -->
# TASK-193 — [TASK-193] Materialize official conference availability source lane and A&M SEC priority
...
```json
{
  ...
  "acceptance_criteria": [
    "Stable ID TASK-193, parent EPIC-009, owner wave W12, and original status DONE are preserved.",
  ...
  "ai_context_notes": [
    ...
    "W12 source-lane/materialization PLAN completed; actual report archive acquisition remains W19."
  ],
  ...
  "gap_ids": [],
  "generated_markdown": "jira/issues/tasks/TASK-193_materialize_official_conference_availability_source_lane_and_a_and_m_sec_priorit.md",
  ...
  "objective": "Materialize official conference availability source lane and A&M SEC priority",
  "operational_jira": {
    "assignee": "",
    "jira_issue_id": "24468",
    "jira_updated_at": "2026-08-09T00:40:51.153-0500",
  ...
  "phase": "PHASE-2",
  "prerequisites": [
    "Historical dependency TASK-052",
    "Historical dependency TASK-191"
  ],
  "primary_source_refs": [
    "SRCREF-00226",
    "SRCREF-02116",
  ...
  "required_evidence": [
    "Authoritative WBS row TASK-193",
    "Existing artifact `official availability adapter/materialization plan`"
  ],
  "required_tests": [
    {
  ...
  "risk_ids": [],
  "schema_version": 2,
  "scope": "Original task type DATA_DESIGN with mutation scope: availability source adapters.",
  "source_ids": [
    "TASK-193"
  ],
  "source_refs": [
  ...
  "specificity_fingerprint": "644611f6f44110cb384e2455c4006d6cad3c3b136788d6a6bd1c5b2785af578a",
  "stop_conditions": [
  ...
  "title": "[TASK-193] Materialize official conference availability source lane and A&M SEC priority",
...
Materialize official conference availability source lane and A&M SEC priority
...
Original task type DATA_DESIGN with mutation scope: availability source adapters.
...
1. Stable ID TASK-193, parent EPIC-009, owner wave W12, and original status DONE are preserved.
