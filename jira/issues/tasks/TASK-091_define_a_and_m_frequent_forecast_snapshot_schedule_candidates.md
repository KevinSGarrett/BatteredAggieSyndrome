<!-- GENERATED VIEW. Canonical record: jira/records/issues/tasks/TASK-091_define_a_and_m_frequent_forecast_snapshot_schedule_candidates.json -->
# TASK-091 — [TASK-091] Define A&M frequent forecast snapshot schedule candidates
...
```json
{
  ...
  "acceptance_criteria": [
    "Stable ID TASK-091, parent EPIC-016, owner wave W14, and original status DONE are preserved.",
  ...
  "canonical_record": "jira/records/issues/tasks/TASK-091_define_a_and_m_frequent_forecast_snapshot_schedule_candidates.json",
  ...
  "gap_ids": [],
  "generated_markdown": "jira/issues/tasks/TASK-091_define_a_and_m_frequent_forecast_snapshot_schedule_candidates.md",
  ...
  "objective": "Define A&M frequent forecast snapshot schedule candidates",
  "operational_jira": {
    "assignee": "",
    "jira_issue_id": "24334",
    "jira_updated_at": "2026-08-09T00:40:33.182-0500",
  ...
  "required_evidence": [
    "Authoritative WBS row TASK-091",
    "Existing artifact `A&M snapshot cadence proposal`"
  ],
  "required_tests": [
    {
  ...
  "specificity_fingerprint": "35c781fe0f54d9848a071e056a0995aa2efb52fe4a658bb2b1e530f1ecbbb107",
  "stop_conditions": [
  ...
  "title": "[TASK-091] Define A&M frequent forecast snapshot schedule candidates",
...
Define A&M frequent forecast snapshot schedule candidates
...
1. Stable ID TASK-091, parent EPIC-016, owner wave W14, and original status DONE are preserved.
