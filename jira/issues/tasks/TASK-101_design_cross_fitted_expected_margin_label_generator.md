<!-- GENERATED VIEW. Canonical record: jira/records/issues/tasks/TASK-101_design_cross_fitted_expected_margin_label_generator.json -->
# TASK-101 — [TASK-101] Design cross-fitted expected-margin label generator
...
```json
{
  ...
  "acceptance_criteria": [
    "Stable ID TASK-101, parent EPIC-018, owner wave W15, and original status DONE are preserved.",
  ...
  "allowed_modification_paths": [
    "cross-fit label-generation contract"
  ],
  "blocked_reason": "",
  "blocks": [
    "TASK-102",
  ...
  "canonical_record": "jira/records/issues/tasks/TASK-101_design_cross_fitted_expected_margin_label_generator.json",
  ...
  "gap_ids": [],
  "generated_markdown": "jira/issues/tasks/TASK-101_design_cross_fitted_expected_margin_label_generator.md",
  ...
  "objective": "Design cross-fitted expected-margin label generator",
  "operational_jira": {
    "assignee": "",
    "jira_issue_id": "24344",
    "jira_updated_at": "2026-08-09T00:40:35.234-0500",
  ...
  "phase": "PHASE-3",
  "prerequisites": [
    "Historical dependency TASK-100",
  ...
  "required_evidence": [
    "Authoritative WBS row TASK-101",
    "Existing artifact `cross-fit label-generation contract`"
  ],
  "required_tests": [
    {
  ...
  "specificity_fingerprint": "74c9e1c5e4d542631d3e7d7766c9562ab57abd717000b3cc94ea27e8b694b5db",
  "stop_conditions": [
  ...
  "title": "[TASK-101] Design cross-fitted expected-margin label generator",
...
Design cross-fitted expected-margin label generator
...
- Inherited from: None
- Resolution: `DIRECT`
- Effective counts: `{"acceptance_control_ids": 7, "adr_ids": 0, "gap_ids": 0, "requirement_ids": 10, "risk_ids": 0}`

## Acceptance Criteria

1. Stable ID TASK-101, parent EPIC-018, owner wave W15, and original status DONE are preserved.
