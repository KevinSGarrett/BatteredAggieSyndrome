<!-- GENERATED VIEW. Canonical record: jira/records/issues/tasks/TASK-074_define_score_state_garbage_time_leverage_policy_candidates.json -->
# TASK-074 — [TASK-074] Define score-state/garbage-time/leverage policy candidates
...
```json
{
  ...
  "acceptance_criteria": [
    "Stable ID TASK-074, parent EPIC-013, owner wave W13, and original status DONE are preserved.",
  ...
  "canonical_record": "jira/records/issues/tasks/TASK-074_define_score_state_garbage_time_leverage_policy_candidates.json",
  ...
  "gap_ids": [],
  "generated_markdown": "jira/issues/tasks/TASK-074_define_score_state_garbage_time_leverage_policy_candidates.md",
  ...
  "objective": "Define score-state/garbage-time/leverage policy candidates",
  "operational_jira": {
    "assignee": "",
    "jira_issue_id": "24317",
    "jira_updated_at": "2026-08-09T00:40:30.037-0500",
  ...
  "required_evidence": [
    "Authoritative WBS row TASK-074",
    "Existing artifact `score-state policy candidates`"
  ],
  "required_tests": [
    {
  ...
  "specificity_fingerprint": "f93d898815b227731141543b64cf42ec525afd3184ab1d2dbaa9b3f67246e75f",
  "stop_conditions": [
  ...
  "title": "[TASK-074] Define score-state/garbage-time/leverage policy candidates",
...
Define score-state/garbage-time/leverage policy candidates
...
1. Stable ID TASK-074, parent EPIC-013, owner wave W13, and original status DONE are preserved.
