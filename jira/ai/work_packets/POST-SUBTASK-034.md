# AI Work Packet — POST-SUBTASK-034
...
1. `jira/records/issues/subtasks/POST-SUBTASK-034_profile_every_materialized_table_for_rows_types_nulls_uniqueness_ranges_duplicat.json`
2. `jira/sources/issue_source_manifests/POST-SUBTASK-034.json`
3. `jira/index/ISSUE_GOVERNANCE_CONTEXT.csv` row for `POST-SUBTASK-034`.
