<!-- GENERATED VIEW. Canonical record: jira/records/issues/tasks/TASK-083_implement_player_roster_availability_starter.json -->
# TASK-083 — [TASK-083] Implement player/roster/availability starter
...
```json
{
  ...
  "acceptance_criteria": [
    "Stable ID TASK-083, parent EPIC-015, owner wave W19, and original status DONE are preserved.",
  ...
  "canonical_record": "jira/records/issues/tasks/TASK-083_implement_player_roster_availability_starter.json",
  ...
  "gap_ids": [],
  "generated_markdown": "jira/issues/tasks/TASK-083_implement_player_roster_availability_starter.md",
  ...
  "objective": "Implement player/roster/availability starter",
  "operational_jira": {
    "assignee": "",
    "jira_issue_id": "24326",
    "jira_updated_at": "2026-08-09T00:40:31.660-0500",
  ...
  "required_evidence": [
    "Authoritative WBS row TASK-083",
    "Existing artifact `player/availability starter modules`"
  ],
  "required_tests": [
    {
  ...
  "specificity_fingerprint": "e04ea7f51b5ef863f5987e45d31d47dcd9f703a61b3b3c30b7535496b8bbc9f3",
  "stop_conditions": [
  ...
  "title": "[TASK-083] Implement player/roster/availability starter",
...
Implement player/roster/availability starter
...
1. Stable ID TASK-083, parent EPIC-015, owner wave W19, and original status DONE are preserved.
