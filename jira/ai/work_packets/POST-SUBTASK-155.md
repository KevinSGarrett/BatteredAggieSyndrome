# AI Work Packet — POST-SUBTASK-155
...
1. `jira/records/issues/subtasks/POST-SUBTASK-155_build_live_features_model_candidates_and_historical_streaming_replay_with_calibr.json`
2. `jira/sources/issue_source_manifests/POST-SUBTASK-155.json`
3. `jira/index/ISSUE_GOVERNANCE_CONTEXT.csv` row for `POST-SUBTASK-155`.
