<!-- GENERATED VIEW. Canonical record: jira/records/issues/subtasks/POST-SUBTASK-115_implement_approved_active_archive_snapshot_repository_model_run_lookup_and_atomi.json -->
# POST-SUBTASK-115 — [POST-SUBTASK-115] Implement approved active/archive snapshot repository, model/run lookup, and atomic read behavior
...
```json
{
  ...
  "ai_context_notes": [
    ...
    "Read the exact source sections in `jira/sources/issue_source_manifests/POST-SUBTASK-115.json`; inspect only the listed implementation files and prerequisite outputs.",
  ...
  "canonical_record": "jira/records/issues/subtasks/POST-SUBTASK-115_implement_approved_active_archive_snapshot_repository_model_run_lookup_and_atomi.json",
  "canonical_source_role": "AUTHORITATIVE_LOCAL_SPECIFICATION",
  "completion_evidence_contract": {
    "acceptance_matrix_required": true,
    "artifact_hashes_required": true,
    "completion_claim_limit": "IMPLEMENTED",
    "downstream_consumer": "POST-SUBTASK-116",
  ...
  "critical_path": false,
  "definition_of_done": [
    "The atomic scope in POST-SUBTASK-115 is completed without absorbing sibling work or weakening any protected requirement, control, split, judging rule, private-research publication boundary, or security boundary.",
    ...
    "The output set `artifacts/product/snapshot_repository_test.json` is demonstrably consumable by POST-SUBTASK-116 without manual reconstruction or undocumented state."
  ],
  "dependencies": [
    "POST-SUBTASK-111"
  ],
  ...
  "end_to_end_validation": "Validate that `artifacts/product/snapshot_repository_test.json` can be parsed and consumed by `POST-SUBTASK-116` using only documented identities and interfaces; the consumer must reject missing, stale, schema-incompatible, technically or quality-ineligible, or provenance-incomplete input without manual repair.",
  "epic_id": "POST-EPIC-013",
  "evidence_manifest_path": "artifacts/jira_evidence/POST-SUBTASK-115.json",
  ...
  "gap_ids": [],
  "generated_markdown": "jira/issues/subtasks/POST-SUBTASK-115_implement_approved_active_archive_snapshot_repository_model_run_lookup_and_atomi.md",
  ...
  "local_id": "POST-SUBTASK-115",
  "maturity_before": "FUNCTIONAL_STARTER",
  "objective": "Implement approved active/archive snapshot repository, model/run lookup, and atomic read behavior",
  "operational_jira": {
    "assignee": "",
    "jira_issue_id": "24605",
    "jira_updated_at": "2026-08-09T23:24:11.312-0500",
  ...
  "required_tests": [
    {
      ...
      "expectation": "Run as a regression check after completing POST-SUBTASK-115; retain command, exit code, and relevant output.",
    ...
    },
    {
      ...
      "path": "artifacts/product/snapshot_repository_test.json",
    ...
    },
    {
      ...
      "path": "NEW_TEST_REQUIRED::POST-SUBTASK-115",
      "validation_class": "NEW_AUTOMATED_TEST_REQUIRED"
    }
  ],
  "requirement_ids": [],
  "risk_failure_conditions": [
    "The work would be invalid if any prerequisite artifact, source/data/code/config identity, or declared maturity differs from the pinned issue contract for POST-SUBTASK-115.",
    ...
    "Acceptance failure: the evidence cannot demonstrate that the declared output `artifacts/product/snapshot_repository_test.json` is produced with deterministic identity, provenance, and validation metadata appropriate to this work.",
  ...
  "specificity_fingerprint": "38c9087362365e0dcb9a4e769d7db47912aa760f092dd1f6a5a1ee531d93e88a",
  "stop_conditions": [
  ...
  "title": "[POST-SUBTASK-115] Implement approved active/archive snapshot repository, model/run lookup, and atomic read behavior",
  ...
  "work_packet_path": "jira/ai/work_packets/POST-SUBTASK-115.md",
...
1. The atomic scope in POST-SUBTASK-115 is completed without absorbing sibling work or weakening any protected requirement, control, split, judging rule, private-research publication boundary, or security boundary.
...
7. The output set `artifacts/product/snapshot_repository_test.json` is demonstrably consumable by POST-SUBTASK-116 without manual reconstruction or undocumented state.
...
Validate that `artifacts/product/snapshot_repository_test.json` can be parsed and consumed by `POST-SUBTASK-116` using only documented identities and interfaces; the consumer must reject missing, stale, schema-incompatible, technically or quality-ineligible, or provenance-incomplete input without manual repair.
