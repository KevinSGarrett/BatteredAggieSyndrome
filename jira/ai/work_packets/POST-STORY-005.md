...
1. `jira/records/issues/stories/POST-STORY-005_reconcile_the_final_source_universe_and_authority_decisions.json`
2. `jira/sources/issue_source_manifests/POST-STORY-005.json`
3. `jira/index/ISSUE_GOVERNANCE_CONTEXT.csv` row for `POST-STORY-005`.
