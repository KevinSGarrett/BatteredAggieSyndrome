<!-- GENERATED VIEW. Canonical record: jira/records/issues/subtasks/POST-SUBTASK-133_regenerate_bidirectional_source_requirement_acceptance_adr_gap_risk_test_artifac.json -->
# POST-SUBTASK-133 — [POST-SUBTASK-133] Regenerate bidirectional source, requirement, acceptance, ADR, gap, risk, test, artifact, issue, and evidence traceability
...
```json
{
  ...
  "ai_context_notes": [
    ...
    "Read the exact source sections in `jira/sources/issue_source_manifests/POST-SUBTASK-133.json`; inspect only the listed implementation files and prerequisite outputs.",
  ...
  "canonical_record": "jira/records/issues/subtasks/POST-SUBTASK-133_regenerate_bidirectional_source_requirement_acceptance_adr_gap_risk_test_artifac.json",
  "canonical_source_role": "AUTHORITATIVE_LOCAL_SPECIFICATION",
  "completion_evidence_contract": {
    "acceptance_matrix_required": true,
    "artifact_hashes_required": true,
    "completion_claim_limit": "IMPLEMENTED",
    "downstream_consumer": "POST-SUBTASK-134",
  ...
  "critical_path": false,
  "definition_of_done": [
    "The atomic scope in POST-SUBTASK-133 is completed without absorbing sibling work or weakening any protected requirement, control, split, judging rule, private-research publication boundary, or security boundary.",
    ...
    "The output set `artifacts/release/final_traceability_audit.json` is demonstrably consumable by POST-SUBTASK-134 without manual reconstruction or undocumented state."
  ],
  "dependencies": [
    "POST-SUBTASK-105",
    "POST-SUBTASK-114",
  ...
  "end_to_end_validation": "Validate that `artifacts/release/final_traceability_audit.json` can be parsed and consumed by `POST-SUBTASK-134` using only documented identities and interfaces; the consumer must reject missing, stale, schema-incompatible, technically or quality-ineligible, or provenance-incomplete input without manual repair.",
  "epic_id": "POST-EPIC-015",
  "evidence_manifest_path": "artifacts/jira_evidence/POST-SUBTASK-133.json",
  ...
  "gap_ids": [],
  "generated_markdown": "jira/issues/subtasks/POST-SUBTASK-133_regenerate_bidirectional_source_requirement_acceptance_adr_gap_risk_test_artifac.md",
  ...
  "local_id": "POST-SUBTASK-133",
  "maturity_before": "DESIGN_ONLY",
  "objective": "Regenerate bidirectional source, requirement, acceptance, ADR, gap, risk, test, artifact, issue, and evidence traceability",
  "operational_jira": {
    "assignee": "",
    "jira_issue_id": "24623",
    "jira_updated_at": "2026-08-09T23:24:13.110-0500",
  ...
  "required_tests": [
    {
      ...
      "expectation": "Run as a regression check after completing POST-SUBTASK-133; retain command, exit code, and relevant output.",
    ...
    },
    {
      ...
      "path": "artifacts/release/final_traceability_audit.json",
  ...
  "risk_failure_conditions": [
    "The work would be invalid if any prerequisite artifact, source/data/code/config identity, or declared maturity differs from the pinned issue contract for POST-SUBTASK-133.",
    ...
    "Acceptance failure: the evidence cannot demonstrate that the declared output `artifacts/release/final_traceability_audit.json` is produced with deterministic identity, provenance, and validation metadata appropriate to this work.",
  ...
  "specificity_fingerprint": "cb9d0a562355f8a4f886252aefc0785f0c4515e33076483f2a2be8d69f1add29",
  "stop_conditions": [
  ...
  "title": "[POST-SUBTASK-133] Regenerate bidirectional source, requirement, acceptance, ADR, gap, risk, test, artifact, issue, and evidence traceability",
  ...
  "work_packet_path": "jira/ai/work_packets/POST-SUBTASK-133.md",
...
1. The atomic scope in POST-SUBTASK-133 is completed without absorbing sibling work or weakening any protected requirement, control, split, judging rule, private-research publication boundary, or security boundary.
...
7. The output set `artifacts/release/final_traceability_audit.json` is demonstrably consumable by POST-SUBTASK-134 without manual reconstruction or undocumented state.
...
Validate that `artifacts/release/final_traceability_audit.json` can be parsed and consumed by `POST-SUBTASK-134` using only documented identities and interfaces; the consumer must reject missing, stale, schema-incompatible, technically or quality-ineligible, or provenance-incomplete input without manual repair.
