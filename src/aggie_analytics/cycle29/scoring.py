"""Cycle #29 official-final scoring successor.

Does not import scientific_reference. Probability 0.5 is not a directional pick.
"""
...
def admit_official_final(
    *,
    ...
    if not upstream_ok:
        raise ScoringError("upstream failure cannot admit a score")
