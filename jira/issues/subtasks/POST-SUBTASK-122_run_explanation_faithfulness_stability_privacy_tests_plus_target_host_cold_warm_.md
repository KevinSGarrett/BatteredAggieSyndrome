...
```json
{
  ...
  "critical_path": false,
  "definition_of_done": [
    "The atomic scope in POST-SUBTASK-122 is completed without absorbing sibling work or weakening any protected requirement, control, split, judging rule, rights decision, or security boundary.",
  ...
  "end_to_end_validation": "Validate that `artifacts/product/product_performance_benchmark.json` can be parsed and consumed by `POST-SUBTASK-123` using only documented identities and interfaces; the consumer must reject missing, stale, schema-incompatible, rights-blocked, or provenance-incomplete input without manual repair.",
  ...
  "operational_jira": {
    "assignee": "",
    "jira_issue_id": "24612",
    "jira_updated_at": "2026-08-09T00:04:05.020-0500",
  ...
  "prerequisites": [
    ...
    "External condition: AUTHORITATIVE_TARGET_WINDOWS_HOST_REQUIRED_FOR_FINAL_PRODUCT_BENCHMARK"
  ],
  "primary_source_refs": [
    "SRCREF-02085",
    "SRCREF-02086",
  ...
  "specificity_fingerprint": "fc7a24635d5715fa366d15403dd2a87356e61cec4c8fc817eb86d4e5c3f261ea",
  "stop_conditions": [
...
1. The atomic scope in POST-SUBTASK-122 is completed without absorbing sibling work or weakening any protected requirement, control, split, judging rule, rights decision, or security boundary.
...
Validate that `artifacts/product/product_performance_benchmark.json` can be parsed and consumed by `POST-SUBTASK-123` using only documented identities and interfaces; the consumer must reject missing, stale, schema-incompatible, rights-blocked, or provenance-incomplete input without manual repair.
