<!-- GENERATED VIEW. Canonical record: jira/records/issues/tasks/TASK-107_define_offensive_defensive_st_coaching_collapse_candidate_decompositions.json -->
# TASK-107 — [TASK-107] Define offensive/defensive/ST/coaching/collapse candidate decompositions
...
```json
{
  ...
  "acceptance_criteria": [
    "Stable ID TASK-107, parent EPIC-019, owner wave W15, and original status DONE are preserved.",
  ...
  "allowed_modification_paths": [
    "BAS component candidate registry"
  ],
  "blocked_reason": "",
  "blocks": [
    "TASK-108"
  ],
  "canonical_record": "jira/records/issues/tasks/TASK-107_define_offensive_defensive_st_coaching_collapse_candidate_decompositions.json",
  ...
  "gap_ids": [],
  "generated_markdown": "jira/issues/tasks/TASK-107_define_offensive_defensive_st_coaching_collapse_candidate_decompositions.md",
  ...
  "objective": "Define offensive/defensive/ST/coaching/collapse candidate decompositions",
  "operational_jira": {
    "assignee": "",
    "jira_issue_id": "24350",
    "jira_updated_at": "2026-08-09T00:40:36.297-0500",
  ...
  "required_evidence": [
    "Authoritative WBS row TASK-107",
    "Existing artifact `BAS component candidate registry`"
  ],
  "required_tests": [
    {
  ...
  "specificity_fingerprint": "517b3fb25205a7bb9cbc6a927cc846bc7f11bf1d88debc5728d1afe3200f7bc0",
  "stop_conditions": [
  ...
  "title": "[TASK-107] Define offensive/defensive/ST/coaching/collapse candidate decompositions",
...
Define offensive/defensive/ST/coaching/collapse candidate decompositions
...
- Inherited from: None
- Resolution: `DIRECT`
- Effective counts: `{"acceptance_control_ids": 6, "adr_ids": 0, "gap_ids": 0, "requirement_ids": 11, "risk_ids": 0}`

## Acceptance Criteria

1. Stable ID TASK-107, parent EPIC-019, owner wave W15, and original status DONE are preserved.
