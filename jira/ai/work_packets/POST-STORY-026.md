...
1. `jira/records/issues/stories/POST-STORY-026_calibration_ensembles_ood_abstention_and_candidate_artifact_registry.json`
2. `jira/sources/issue_source_manifests/POST-STORY-026.json`
3. `jira/index/ISSUE_GOVERNANCE_CONTEXT.csv` row for `POST-STORY-026`.
